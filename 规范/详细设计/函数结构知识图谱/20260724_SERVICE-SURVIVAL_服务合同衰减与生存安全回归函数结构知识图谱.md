...
绑定逐节点分析：`规范/详细设计/20260729_SERVICE-P1_六函数逐函数逐节点实现分析_v0.1.md`。

绑定功能确认：`规范/详细设计/20260729_SERVICE-P1_六函数功能确认_v0.1.md`。
