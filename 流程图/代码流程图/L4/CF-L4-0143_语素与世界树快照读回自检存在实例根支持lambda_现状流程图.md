...
唯一根函数：F0537
完整签名：`std::optional<海中鱼巣::节点句柄> 海中鱼巣::运行语素与世界树快照读回自检(const 海中鱼巣::入口初始化自检运行配置&)::<lambda@自检.入口初始化.ixx:343>::operator()(海中鱼巣::节点句柄 实例) const`
...
验证输出：第 343 行完整映射；1 个项目入边、1 个项目出边、0 个外部边界、0 个未解析调用
