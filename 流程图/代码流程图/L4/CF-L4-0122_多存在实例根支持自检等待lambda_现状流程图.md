...
唯一根函数：F0512
完整签名：`bool 海中鱼巣::运行多存在实例根支持自检(const 海中鱼巣::入口初始化自检运行配置&)::<lambda@自检.入口初始化.ixx:258>::operator()(std::chrono::milliseconds 时限) const`
...
偏差清单：无；本文只冻结当前代码事实
依据提交 / 结构化消息：当前提交、F0512、E1124、E1130 与源码第 258 行交叉复核
