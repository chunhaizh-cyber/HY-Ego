...
唯一根函数：F0494
完整签名：`std::optional<海中鱼巣::节点句柄> 海中鱼巣::运行概念图根名绑定自检(const 海中鱼巣::入口初始化自检运行配置&)::<lambda@自检.入口初始化.ixx:172>::operator()(海中鱼巣::节点句柄 实例) const`
...
依据提交 / 结构化消息：当前提交、F0494、E1059 与源码第 172 行交叉复核
