...
唯一根函数：F0515
完整签名：`std::optional<海中鱼巣::节点句柄> 海中鱼巣::运行多存在实例根支持自检(const 海中鱼巣::入口初始化自检运行配置&)::<lambda@自检.入口初始化.ixx:261>::operator()(海中鱼巣::节点句柄 实例) const`
...
偏差清单：无；本文只冻结当前代码事实
依据提交 / 结构化消息：当前提交、F0515、E1127、E1133 与源码第 261 行交叉复核
