...
已发布代码基线：HEAD `95b4df74` 的海中鱼巣/启动.应用程序.ixx
...
| --- | --- | --- | --- |
| BIZ-L0-01 系统启动 | N01—N16 | 001-03完成初始化与T02停门；支持旁路先启动；再使T04消费者池关闭门进入，由001-06启动T03并开放T04门，随后启动T06、开放T02治理门并按模式启动T05 | HEAD内联001-03子步骤，并由运行包先启动T03、后启动一个旧结果尾部线程；消费者—生产者顺序、T04关闭门和001-06开门事务均漂移，支持、T06、T05仍为空壳 |
