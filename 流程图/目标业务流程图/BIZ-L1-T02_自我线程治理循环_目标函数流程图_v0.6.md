...
被调函数流程图：BIZ-L2-002-01—10、BIZ-L2-003-01—02、BIZ-L2-003-04、BIZ-L2-004-01、BIZ-L2-004-06 v0.2，共15个直接根；其中 BIZ-L2-002-08 v0.2 每次只提交一个具名任务管理输入。旧BIZ-L2-003-03全局调用边退出；当前003-03 v0.3已重挂T03 v0.5的执行冻结后、真实派发前路径
...
- BIZ-L2-003-03不得在本线程每批全局计算；其 v0.3 父图已由 T03 v0.5 在执行冻结后、真实派发前调用，本图不以旧调用边或其结果占位。
