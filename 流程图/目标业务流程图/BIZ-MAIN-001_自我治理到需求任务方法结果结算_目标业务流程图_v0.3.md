...
flowchart TD
    ...
    A12 -->|任务最新状态| A08
    A09 -->|执行冻结完成并待普通派发| A12C["A12C【T03 / L2-003-03 v0.5】读完整候选、正式根调度与逐来源材料并选择0..1可普通派发任务"]
...
| A12C—A13 | 任务管理线程内fresh选择 + 异步消息后继 | L2-003-03 v0.5、L2-004-04 | 执行冻结完成后读取完整候选、正式A/L/H根配额、当前T→D/目标/B和安全/服务材料并选择0..1项；调度场景正式来源缺失时零派发，只有已选择才发布不可变执行工作包 |
