...
代码基线：<code>3920a74638264f9f539d50f32f3c9fe5fb1982ab</code>；配置：<code>Debug\|x64</code>；项目调用边：3498。
...
| RCE2469 | R0040 | R0127 | <code>海中鱼巣/核心/会话.结构写入.ixx:635, 海中鱼巣/核心/会话.结构写入.ixx:636</code> | direct-free-operator | 左=当前主键绑定记录, 右=临时期望记录 | 记录相等bool | optional相等比较且左侧有值 | 本批现状单函数图、逐行映射与源码调用点交叉复核 |
| RCE2470 | R0040 | R0747 | <code>海中鱼巣/核心/会话.结构写入.ixx:642</code> | direct-free-operator | 左=记录.请求, 右=输入请求 | 请求相等bool | 主键绑定匹配成功后遍历索引写集 | 本批现状单函数图、逐行映射与源码调用点交叉复核 |
| RCE2471 | R0747 | F0051 | <code>海中鱼巣/核心/索引所有权.数据.h:110</code> | direct-free-operator | 左=左.目标, 右=右.目标 | 节点句柄相等bool | 最终物理键相等后按&amp;&amp;求值 | 本批现状单函数图、逐行映射与源码调用点交叉复核 |
| RCE2472 | R0747 | R0132 | <code>海中鱼巣/核心/索引所有权.数据.h:111</code> | direct-free-operator | 左=左.所有者声明, 右=右.所有者声明 | 所有者声明相等bool | 物理键与目标均相等后按&amp;&amp;求值 | 本批现状单函数图、逐行映射与源码调用点交叉复核 |
