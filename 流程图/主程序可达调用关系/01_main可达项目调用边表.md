...
项目直接调用边：2752。多调用点保留在同一 caller/callee 边记录中。
...
| RCE1682 | F0389 | F0396 | <code>海中鱼巣/界面/控制面板窗口.cpp:435</code> | resolved-function-pointer-callback | <code>未单独冻结；读取源码调用点</code> | 窗口类注册成功后，创建窗口与消息派发由 Windows 调用已登记窗口过程 | 专项源码静态类型与实际装配人工复核 |
