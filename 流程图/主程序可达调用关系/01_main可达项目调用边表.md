...
代码基线：<code>4b80f1617dd70ec7a19e1a34efa9da768dce8927</code>；配置：<code>Debug&#124;x64</code>；项目调用边：5327。
...
| RCE4333 | F0001 | R1415 | <code>海中鱼巣/入口.cpp:10</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
...
| E0008 | F0005 | F0007 | <code>海中鱼巣/启动.应用程序.ixx:475</code> | direct_free_function | 选项.模式 | 普通结果 | 普通控制面板 &#124;&#124; 无窗口常驻 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核 |
| E0009 | F0005 | F0008 | <code>海中鱼巣/启动.应用程序.ixx:477</code> | direct_free_function |  | 生产结果 | 生产运行期 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核 |
| E0010 | F0005 | F0009 | <code>海中鱼巣/启动.应用程序.ixx:479</code> | direct_free_function |  | 自检结果 | 完整自检 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核 |
| E0011 | F0005 | F0010 | <code>海中鱼巣/启动.应用程序.ixx:481</code> | direct_free_function | 覆盖端口=nullptr | 数据库结果 | 数据库专项 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核 |
| E0012 | F0005 | F0011 | <code>海中鱼巣/启动.应用程序.ixx:483</code> | direct_free_function |  | 性能结果 | 关系仓库性能专项 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核 |
| E0014 | F0007 | F0013 | <code>海中鱼巣/启动.应用程序.ixx:54</code> | direct_free_function+unique_name | 配置 | 装配 | 普通模式有效；调用方可达且源码分支条件成立 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核；全项目唯一函数名并经调用方源码范围复核 |
| E0015 | F0007 | F0014 | <code>海中鱼巣/启动.应用程序.ixx:55</code> | direct_const_member | this=&amp;装配 | 装配成功 | after E0014 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核 |
| E0016 | F0007 | F0015 | <code>海中鱼巣/启动.应用程序.ixx:67</code> | direct_free_function+unique_name | 系统端口, 初始化请求 | 初始化 | 装配成功；调用方可达且源码分支条件成立 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核；全项目唯一函数名并经调用方源码范围复核 |
| E0017 | F0007 | F0016 | <code>海中鱼巣/启动.应用程序.ixx:69</code> | direct_const_member | this=&amp;初始化 | 初始化成功 | after E0016 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核 |
| E0018 | F0007 | F0017 | <code>海中鱼巣/启动.应用程序.ixx:70</code> | lambda_direct | 捕获初始化 | 失败阶段 | 初始化失败 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核 |
| E0019 | F0007 | F0018 | <code>海中鱼巣/启动.应用程序.ixx:98</code> | direct_free_function+unique_name | 审计端口, 最佳努力 | 审计 | 初始化成功；调用方可达且源码分支条件成立 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核；全项目唯一函数名并经调用方源码范围复核 |
| E0020 | F0007 | F0019 | <code>海中鱼巣/启动.应用程序.ixx:99</code> | direct_free_function+unique_name | 默认安装函数 | 信号 | after E0019；调用方可达且源码分支条件成立 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核；全项目唯一函数名并经调用方源码范围复核 |
| E0021 | F0007 | F0020 | <code>海中鱼巣/启动.应用程序.ixx:100</code> | direct_const_member | this=&amp;信号 | 信号成功 | after E0020 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核 |
| E0022 | F0007 | F0021 | <code>海中鱼巣/启动.应用程序.ixx:104</code> | direct_free_function+unique_name | *装配.上下文, *信号.租约 | 运行结果 | 信号成功 &amp;&amp; 无窗口常驻；调用方可达且源码分支条件成立 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核；全项目唯一函数名并经调用方源码范围复核 |
| E0023 | F0007 | F0022 | <code>海中鱼巣/启动.应用程序.ixx:106</code> | direct_free_function+unique_name | *装配.上下文, 初始化 | 投影 | 信号成功 &amp;&amp; 普通控制面板；调用方可达且源码分支条件成立 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核；全项目唯一函数名并经调用方源码范围复核 |
| E0024 | F0007 | F0023 | <code>海中鱼巣/启动.应用程序.ixx:107</code> | direct_const_member | this=&amp;投影 | 投影成功 | after E0023 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核 |
| E0025 | F0007 | F0024 | <code>海中鱼巣/启动.应用程序.ixx:111</code> | direct_free_function+unique_name | 上下文, 初始化, 投影, 审计, 信号租约 | 运行结果 | 投影成功；调用方可达且源码分支条件成立 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核；全项目唯一函数名并经调用方源码范围复核 |
| E0026 | F0007 | F0025 | <code>海中鱼巣/启动.应用程序.ixx:105, 海中鱼巣/启动.应用程序.ixx:110, 海中鱼巣/启动.应用程序.ixx:113</code> | compiler_implicit_destructor | this=信号.租约.get() |  | 无窗口宿主返回后；投影失败返回前；控制面板宿主返回后 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核 |
| RCE0001 | F0007 | F0045 | <code>海中鱼巣/启动.应用程序.ixx:62</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0002 | F0007 | F0046 | <code>海中鱼巣/启动.应用程序.ixx:63</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0003 | F0007 | F0048 | <code>海中鱼巣/启动.应用程序.ixx:64</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0004 | F0007 | F0053 | <code>海中鱼巣/启动.应用程序.ixx:85</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0005 | F0007 | F0054 | <code>海中鱼巣/启动.应用程序.ixx:90</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| E0029 | F0008 | F0026 | <code>海中鱼巣/启动.应用程序.ixx:40</code> | direct_constructor |  | 会话 | always | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核 |
| E0030 | F0008 | F0027 | <code>海中鱼巣/启动.应用程序.ixx:41</code> | direct_member | this=&amp;会话, 生产运行期启动请求{} | 结果 | always | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核 |
| E0031 | F0008 | F0028 | <code>海中鱼巣/启动.应用程序.ixx:42</code> | direct_const_member | this=&amp;结果 | 启动成功 | after E0030 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核 |
| E0032 | F0009 | F0029 | <code>海中鱼巣/启动.应用程序.ixx:402</code> | direct_free_function+unique_name | 运行器, 空配置 | 入口登记成功 | always；调用方可达且源码分支条件成立 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核；全项目唯一函数名并经调用方源码范围复核 |
| E0033 | F0009 | F0030 | <code>海中鱼巣/启动.应用程序.ixx:403-404, 海中鱼巣/启动.应用程序.ixx:405-406, 海中鱼巣/启动.应用程序.ixx:407-408, 海中鱼巣/启动.应用程序.ixx:409-410, 海中鱼巣/启动.应用程序.ixx:411-412</code> | direct_member | this=&amp;运行器, 150, F27编号名称, 回调 | 端口登记成功 | 入口登记成功；入口登记成功 &amp;&amp; 端口登记成功 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核 |
| E0035 | F0009 | F0031 | <code>海中鱼巣/启动.应用程序.ixx:417</code> | direct_member+unique_name | this=&amp;运行器 | 批次 | 三段登记均成功；调用方可达且源码分支条件成立 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核；全项目唯一函数名并经调用方源码范围复核 |
| E0036 | F0009 | F0032 | <code>海中鱼巣/启动.应用程序.ixx:404</code> | callback_bind+lsp_direct | 无捕获转发回调 | F27回调槽 | 端口自检登记；调用方可达且源码分支条件成立 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核；LSP 直接解析并经源码调用词复核 |
| E0037 | F0009 | F0033 | <code>海中鱼巣/启动.应用程序.ixx:406</code> | callback_bind+lsp_direct | 无捕获转发回调 | F29回调槽 | 隔离自检登记；调用方可达且源码分支条件成立 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核；LSP 直接解析并经源码调用词复核 |
| RCE3350 | F0009 | R0895 | <code>海中鱼巣/启动.应用程序.ixx:408</code> | callback_bind | 无捕获转发回调 | P1A2自检回调槽 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3351 | F0009 | R0896 | <code>海中鱼巣/启动.应用程序.ixx:410</code> | callback_bind | 无捕获转发回调 | P1A3F自检回调槽 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4455 | F0009 | R1460 | <code>海中鱼巣/启动.应用程序.ixx:412</code> | callback_bind | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| E0040 | F0010 | F0013 | <code>海中鱼巣/启动.应用程序.ixx:117</code> | direct_free_function+unique_name | 配置 | 装配 | always；调用方可达且源码分支条件成立 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核；全项目唯一函数名并经调用方源码范围复核 |
| E0041 | F0010 | F0014 | <code>海中鱼巣/启动.应用程序.ixx:118</code> | direct_const_member | this=&amp;装配 | 装配成功 | after E0040 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核 |
| E0042 | F0010 | F0015 | <code>海中鱼巣/启动.应用程序.ixx:131, 海中鱼巣/启动.应用程序.ixx:131-132</code> | direct_free_function+unique_name | 系统端口, 初始化请求 | 初始化 | 装配成功；调用方可达且源码分支条件成立 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核；全项目唯一函数名并经调用方源码范围复核 |
| E0043 | F0010 | F0016 | <code>海中鱼巣/启动.应用程序.ixx:133</code> | direct_const_member | this=&amp;初始化 | 初始化成功 | after E0042 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核 |
| E0045 | F0010 | F0018 | <code>海中鱼巣/启动.应用程序.ixx:162, 海中鱼巣/启动.应用程序.ixx:162-164</code> | direct_free_function+unique_name | 选中端口, 必须往返一致 | 审计 | 初始化成功；调用方可达且源码分支条件成立 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核；全项目唯一函数名并经调用方源码范围复核 |
| E0044 | F0010 | F0034 | <code>海中鱼巣/启动.应用程序.ixx:134-143</code> | lambda_direct | 捕获初始化 | 失败阶段 | 初始化失败 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核 |
| E0046 | F0010 | F0035 | <code>海中鱼巣/启动.应用程序.ixx:166, 海中鱼巣/启动.应用程序.ixx:170</code> | direct_const_member | this=&amp;审计 | 摘要成功 | after E0045；always after summary | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核 |
| RCE0006 | F0010 | F0045 | <code>海中鱼巣/启动.应用程序.ixx:126</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0007 | F0010 | F0046 | <code>海中鱼巣/启动.应用程序.ixx:127</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0008 | F0010 | F0048 | <code>海中鱼巣/启动.应用程序.ixx:128</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0009 | F0010 | F0053 | <code>海中鱼巣/启动.应用程序.ixx:149</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0010 | F0010 | F0054 | <code>海中鱼巣/启动.应用程序.ixx:154</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| E0050 | F0011 | F0037 | <code>海中鱼巣/启动.应用程序.ixx:429</code> | direct_free_function+unique_name |  | 结果 | 性能能力宏开启；调用方可达且源码分支条件成立 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核；全项目唯一函数名并经调用方源码范围复核 |
...
| RCE4293 | F0027 | R1315 | <code>海中鱼巣/启动.生产运行期.ixx:106</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
...
| E0187 | F0032 | F0010 | <code>海中鱼巣/启动.应用程序.ixx:283</code> | direct_free_function+lsp_direct | &amp;不一致端口 | 专项 | 写入失败状态验收后；调用方可达且源码分支条件成立 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核；LSP 直接解析并经源码调用词复核 |
| E0182 | F0032 | F0013 | <code>海中鱼巣/启动.应用程序.ixx:200</code> | direct_free_function+unique_name | 配置 | 装配 | 六轮各一次；调用方可达且源码分支条件成立 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核；全项目唯一函数名并经调用方源码范围复核 |
| E0183 | F0032 | F0014 | <code>海中鱼巣/启动.应用程序.ixx:201</code> | direct_const_member | this=&amp;装配 | 装配成功 | 每轮装配后 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核 |
| E0184 | F0032 | F0015 | <code>海中鱼巣/启动.应用程序.ixx:245, 海中鱼巣/启动.应用程序.ixx:245-246</code> | direct_free_function+unique_name | 故障注入端口, {配置.方法登记根稳定键,配置.根需求参数} | 结果 | 装配成功；六轮；调用方可达且源码分支条件成立 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核；全项目唯一函数名并经调用方源码范围复核 |
| E0186 | F0032 | F0018 | <code>海中鱼巣/启动.应用程序.ixx:263-264, 海中鱼巣/启动.应用程序.ixx:264</code> | direct_free_function+unique_name | 写入失败端口, 数据库审计要求::最佳努力 | 写入失败 | 六轮结束；调用方可达且源码分支条件成立 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核；全项目唯一函数名并经调用方源码范围复核 |
| E0188 | F0032 | F0019 | <code>海中鱼巣/启动.应用程序.ixx:296, 海中鱼巣/启动.应用程序.ixx:297</code> | direct_free_function+unique_name | F0067信号安装替身 | 信号失败 | 数据库验收后；after E0188；调用方可达且源码分支条件成立 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核；全项目唯一函数名并经调用方源码范围复核 |
| E0190 | F0032 | F0020 | <code>海中鱼巣/启动.应用程序.ixx:299, 海中鱼巣/启动.应用程序.ixx:304</code> | direct_const_member | this=&amp;信号失败 | 成功谓词并取反 | 状态为SIGTERM失败；前置短路项全部为真 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核 |
| E0193 | F0032 | F0025 | <code>海中鱼巣/启动.应用程序.ixx:323</code> | compiler_implicit_destructor | this=后续可安装.租约.get() |  | 根函数退出且租约存在 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核 |
| RCE0026 | F0032 | F0045 | <code>海中鱼巣/启动.应用程序.ixx:224</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0027 | F0032 | F0046 | <code>海中鱼巣/启动.应用程序.ixx:230</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0028 | F0032 | F0048 | <code>海中鱼巣/启动.应用程序.ixx:236</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| E0185 | F0032 | F0131 | <code>海中鱼巣/启动.应用程序.ixx:249</code> | compiler_implicit_member_destructor | this=&amp;上下文.自我线程实例 |  | 每轮上下文作用域退出；成员已构造 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核 |
| E0214 | F0033 | F0029 | <code>海中鱼巣/启动.应用程序.ixx:338, 海中鱼巣/启动.应用程序.ixx:356</code> | direct_free_function+unique_name | 第一运行器,第一配置 | 第一登记 | always；调用方可达且源码分支条件成立 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核；全项目唯一函数名并经调用方源码范围复核 |
| E0215 | F0033 | F0031 | <code>海中鱼巣/启动.应用程序.ixx:339, 海中鱼巣/启动.应用程序.ixx:357</code> | direct_member+unique_name | this=&amp;第一运行器 | 第一批次 | 第一登记结果无论真假；第二登记结果无论真假；调用方可达且源码分支条件成立 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核；全项目唯一函数名并经调用方源码范围复核 |
| E0213 | F0033 | F0132 | <code>海中鱼巣/启动.应用程序.ixx:330-336</code> | callback_bind | 捕获第一编号组,第一地址全非零,第一初始为零 | 第一配置.观察回调 | 构造第一配置 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核 |
| E0216 | F0033 | F0133 | <code>海中鱼巣/启动.应用程序.ixx:353-354</code> | callback_bind | 捕获第二观察数量 | 第二配置.观察回调 | 构造第二配置 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核 |
...
| RCE1633 | F0048 | F0177 | <code>海中鱼巣/领域/初始化.概念图.ixx:104-105</code> | direct_member_template_instance |  | None | 初始化四个根按源码顺序调用 F0177；对应 lambda@105 | 专项源码静态类型与实际装配人工复核 |
| RCE1634 | F0048 | F0178 | <code>海中鱼巣/领域/初始化.概念图.ixx:106-107</code> | direct_member_template_instance |  | None | 初始化四个根按源码顺序调用 F0178；对应 lambda@107 | 专项源码静态类型与实际装配人工复核 |
| RCE1635 | F0048 | F0179 | <code>海中鱼巣/领域/初始化.概念图.ixx:108-109</code> | direct_member_template_instance |  | None | 初始化四个根按源码顺序调用 F0179；对应 lambda@109 | 专项源码静态类型与实际装配人工复核 |
| E0282 | F0048 | F0180 | <code>海中鱼巣/领域/初始化.概念图.ixx:110-111</code> | direct_member_template_instance |  | None | 初始化四个根按源码顺序调用 F0180；对应 lambda@111 | 专项源码静态类型与实际装配人工复核 |
...
| RCE3352 | R0895 | R0897 | <code>海中鱼巣/启动.应用程序.ixx:382, 海中鱼巣/启动.应用程序.ixx:383</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3353 | R0896 | R0898 | <code>海中鱼巣/启动.应用程序.ixx:389</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4448 | R1460 | R1484 | <code>海中鱼巣/启动.应用程序.ixx:395</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
...
| RCE0033 | F0049 | F0168 | <code>海中鱼巣/领域/初始化.概念图.ixx:54, 海中鱼巣/领域/初始化.概念图.ixx:55, 海中鱼巣/领域/初始化.概念图.ixx:56</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0034 | F0071 | F0450 | <code>海中鱼巣/生产运行期配置.数据.h:77, 海中鱼巣/生产运行期配置.数据.h:79</code> | field_type_hint |  | None | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
| RCE0035 | F0071 | F0452 | <code>海中鱼巣/生产运行期配置.数据.h:77, 海中鱼巣/生产运行期配置.数据.h:79</code> | field_type_hint |  | None | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
...
| E0200 | F0120 | F0043 | <code>海中鱼巣/启动.应用程序.ixx:212</code> | captured_member_direct+direct_member | 键, 上下文.状态 | 方法登记根材料候选 | 失败点!=0；实际五轮；失败点 != 0 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核 |
| E0201 | F0121 | F0044 | <code>海中鱼巣/启动.应用程序.ixx:218</code> | captured_member_direct+direct_member | 参数 | 自我线程操作结果 | 失败点!=1；实际四轮；失败点 != 1 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核 |
| E0202 | F0122 | F0045 | <code>海中鱼巣/启动.应用程序.ixx:224</code> | captured_member_direct+direct_member | 时限 | 等待结果 | 失败点!=2；实际三轮；失败点 != 2 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核 |
| E0203 | F0123 | F0046 | <code>海中鱼巣/启动.应用程序.ixx:230</code> | captured_member_direct+direct_member | 上下文.自我线程实例隐式this | 初始化快照候选 | 失败点!=3；实际三轮；失败点 != 3 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核 |
| E0204 | F0124 | F0048 | <code>海中鱼巣/启动.应用程序.ixx:236</code> | captured_member_direct+direct_member | 上下文.概念图初始化隐式this | 概念图初始化结果 | 失败点!=4；实际一轮；失败点 != 4 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核 |
| E0611 | F0125 | F0050 | <code>海中鱼巣/启动.应用程序.ixx:242</code> | direct_member | 上下文.概念图隐式this,实例 | 支持句柄optional直接返回 | 失败点 != 5 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug&#124;x64 条件复核 |
...
| RCE1641 | F0177 | F0051 | <code>海中鱼巣/领域/初始化.概念图.ixx:166</code> | operator |  | None | 登记结果有值后比较根节点 | 专项源码静态类型与实际装配人工复核 |
| RCE1638 | F0177 | F0163 | <code>海中鱼巣/领域/初始化.概念图.ixx:162</code> | direct_free |  | None | 创建回调返回后复核根节点句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE1640 | F0177 | F0184 | <code>海中鱼巣/领域/初始化.概念图.ixx:166-167</code> | direct_free |  | None | 登记完成后复核发布读回 | 专项源码静态类型与实际装配人工复核 |
| RCE1637 | F0177 | F0185 | <code>海中鱼巣/领域/初始化.概念图.ixx:161</code> | callback_invoke |  | None | 不存在已登记根时调用本实例绑定的创建回调 | 专项源码静态类型与实际装配人工复核 |
| RCE1639 | F0177 | F0356 | <code>海中鱼巣/领域/初始化.概念图.ixx:165</code> | direct_member |  | None | 根节点有效后登记概念根 | 专项源码静态类型与实际装配人工复核 |
| RCE1636 | F0177 | R0531 | <code>海中鱼巣/领域/初始化.概念图.ixx:150</code> | direct_const_member |  | None | 函数进入读取同类别已登记根 | 专项源码静态类型与实际装配人工复核 |
| RCE1647 | F0178 | F0051 | <code>海中鱼巣/领域/初始化.概念图.ixx:166</code> | operator |  | None | 登记结果有值后比较根节点 | 专项源码静态类型与实际装配人工复核 |
| RCE1644 | F0178 | F0163 | <code>海中鱼巣/领域/初始化.概念图.ixx:162</code> | direct_free |  | None | 创建回调返回后复核根节点句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE1646 | F0178 | F0184 | <code>海中鱼巣/领域/初始化.概念图.ixx:166-167</code> | direct_free |  | None | 登记完成后复核发布读回 | 专项源码静态类型与实际装配人工复核 |
| RCE1643 | F0178 | F0186 | <code>海中鱼巣/领域/初始化.概念图.ixx:161</code> | callback_invoke |  | None | 不存在已登记根时调用本实例绑定的创建回调 | 专项源码静态类型与实际装配人工复核 |
| RCE1645 | F0178 | F0356 | <code>海中鱼巣/领域/初始化.概念图.ixx:165</code> | direct_member |  | None | 根节点有效后登记概念根 | 专项源码静态类型与实际装配人工复核 |
| RCE1642 | F0178 | R0531 | <code>海中鱼巣/领域/初始化.概念图.ixx:150</code> | direct_const_member |  | None | 函数进入读取同类别已登记根 | 专项源码静态类型与实际装配人工复核 |
| RCE1653 | F0179 | F0051 | <code>海中鱼巣/领域/初始化.概念图.ixx:166</code> | operator |  | None | 登记结果有值后比较根节点 | 专项源码静态类型与实际装配人工复核 |
| RCE1650 | F0179 | F0163 | <code>海中鱼巣/领域/初始化.概念图.ixx:162</code> | direct_free |  | None | 创建回调返回后复核根节点句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE1652 | F0179 | F0184 | <code>海中鱼巣/领域/初始化.概念图.ixx:166-167</code> | direct_free |  | None | 登记完成后复核发布读回 | 专项源码静态类型与实际装配人工复核 |
| RCE1649 | F0179 | F0187 | <code>海中鱼巣/领域/初始化.概念图.ixx:161</code> | callback_invoke |  | None | 不存在已登记根时调用本实例绑定的创建回调 | 专项源码静态类型与实际装配人工复核 |
| RCE1651 | F0179 | F0356 | <code>海中鱼巣/领域/初始化.概念图.ixx:165</code> | direct_member |  | None | 根节点有效后登记概念根 | 专项源码静态类型与实际装配人工复核 |
| RCE1648 | F0179 | R0531 | <code>海中鱼巣/领域/初始化.概念图.ixx:150</code> | direct_const_member |  | None | 函数进入读取同类别已登记根 | 专项源码静态类型与实际装配人工复核 |
...
| RCE1654 | F0180 | R0531 | <code>海中鱼巣/领域/初始化.概念图.ixx:150</code> | direct_const_member |  | None | 函数进入读取同类别已登记根 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0038 | F0181 | F0168 | <code>海中鱼巣/领域/初始化.概念图.ixx:192, 海中鱼巣/领域/初始化.概念图.ixx:195</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0042 | F0197 | F0397 | <code>海中鱼巣/核心/节点仓库.cpp:455</code> | resolved-function-pointer |  | None | 事务接线已接域；生产运行期唯一正式共享许可目标 | 专项源码静态类型与实际装配人工复核 |
...
| E0793 | F0198 | F0375 | <code>海中鱼巣/核心/关系仓库.cpp:1013</code> | move-constructor+macro-expanded-move-constructor |  | None | 共享许可宏的 optional.emplace 以许可临时量构造承载值；关系共享许可范围宏在 line 120 以 optional.emplace 接收函数返回值并移动构造结构事务许可 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0043 | F0199 | F0397 | <code>海中鱼巣/核心/索引仓库.cpp:404</code> | resolved-function-pointer |  | None | 事务接线已接域；生产运行期唯一正式共享许可目标 | 专项源码静态类型与实际装配人工复核 |
...
| RCE3878 | R0897 | R1118 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1497</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3879 | R0897 | R1128 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1489</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3880 | R0897 | R1135 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1490</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3881 | R0897 | R1138 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1491</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3882 | R0897 | R1141 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1492</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3883 | R0897 | R1144 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1493</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3884 | R0897 | R1147 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3874 | R0897 | R1148 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1494</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3875 | R0897 | R1149 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1498</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3876 | R0897 | R1150 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1499</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3877 | R0897 | R1152 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1495</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4150 | R1248 | R1156 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:202</code> | direct_or_implicit_move_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4151 | R1163 | R1158 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:218</code> | direct_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4153 | R1174 | R1160 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:492</code> | direct_or_implicit_move_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4154 | R1174 | R1161 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:492</code> | direct_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4163 | R0897 | R1165 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4173 | R0897 | R1171 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4176 | R0897 | R1172 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4179 | R0897 | R1174 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4181 | R0897 | R1175 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4182 | R0897 | R1176 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4186 | R0897 | R1177 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4188 | R0897 | R1179 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4190 | R0897 | R1180 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4192 | R0897 | R1181 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3924 | R0897 | R1198 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3925 | R0897 | R1199 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3926 | R0897 | R1200 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3938 | R0897 | R1204 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3946 | R0897 | R1207 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3948 | R0897 | R1208 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3949 | R0897 | R1209 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3951 | R0897 | R1210 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3953 | R0897 | R1211 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3955 | R0897 | R1212 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3957 | R0897 | R1213 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3961 | R0897 | R1214 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3963 | R0897 | R1217 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3965 | R0897 | R1218 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3966 | R0897 | R1219 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3969 | R0897 | R1220 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3981 | R0897 | R1226 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4007 | R0897 | R1243 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4013 | R0897 | R1244 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4020 | R0897 | R1246 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4023 | R0897 | R1247 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4029 | R0897 | R1248 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4033 | R0897 | R1249 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4046 | R0897 | R1253 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4047 | R0897 | R1254 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4050 | R0897 | R1256 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4052 | R0897 | R1258 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4053 | R0897 | R1259 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4064 | R0897 | R1268 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4065 | R0897 | R1269 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4071 | R0897 | R1270 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4074 | R0897 | R1271 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4077 | R0897 | R1272 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4078 | R0897 | R1276 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4079 | R0897 | R1277 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4080 | R0897 | R1278 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4002 | R0897 | R1279 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4083 | R0897 | R1286 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4084 | R0897 | R1288 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4085 | R0897 | R1290 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4089 | R0897 | R1294 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1496-1499</code> | 经验证世界树P1A1记录仓 / 验证P1A2节点关系事务或其构造/容器实例化链可达 | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4457 | R0898 | R0900 | <code>海中鱼巣/领域/自检.节点直接世界结构骨架.ixx:160</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4476 | R0898 | R0901 | <code>海中鱼巣/领域/自检.节点直接世界结构骨架.ixx:190</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4468 | R0898 | R0902 | <code>海中鱼巣/领域/自检.节点直接世界结构骨架.ixx:179</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4477 | R0898 | R0903 | <code>海中鱼巣/领域/自检.节点直接世界结构骨架.ixx:223</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4466 | R0898 | R0904 | <code>海中鱼巣/领域/自检.节点直接世界结构骨架.ixx:174</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4475 | R0898 | R0905 | <code>海中鱼巣/领域/自检.节点直接世界结构骨架.ixx:187</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4465 | R0898 | R0906 | <code>海中鱼巣/领域/自检.节点直接世界结构骨架.ixx:173</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4469 | R0898 | R0907 | <code>海中鱼巣/领域/自检.节点直接世界结构骨架.ixx:181</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4470 | R0898 | R0908 | <code>海中鱼巣/领域/自检.节点直接世界结构骨架.ixx:182</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4471 | R0898 | R0909 | <code>海中鱼巣/领域/自检.节点直接世界结构骨架.ixx:183</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4467 | R0898 | R0910 | <code>海中鱼巣/领域/自检.节点直接世界结构骨架.ixx:176</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4472 | R0898 | R0911 | <code>海中鱼巣/领域/自检.节点直接世界结构骨架.ixx:184</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4473 | R0898 | R0912 | <code>海中鱼巣/领域/自检.节点直接世界结构骨架.ixx:185</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4474 | R0898 | R0913 | <code>海中鱼巣/领域/自检.节点直接世界结构骨架.ixx:186</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4208 | R0898 | R0914 | <code>海中鱼巣/领域/自检.节点直接世界结构骨架.ixx:172</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4464 | R0898 | R0915 | <code>海中鱼巣/领域/自检.节点直接世界结构骨架.ixx:171</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4461 | R0898 | R0924 | <code>海中鱼巣/领域/自检.节点直接世界结构骨架.ixx:165</code> | direct_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4462 | R0898 | R1053 | <code>海中鱼巣/领域/自检.节点直接世界结构骨架.ixx:169</code> | direct_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4463 | R0898 | R1090 | <code>海中鱼巣/领域/自检.节点直接世界结构骨架.ixx:170</code> | direct_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3355 | R0898 | R1093 | <code>海中鱼巣/领域/自检.节点直接世界结构骨架.ixx:229</code> | compiler_implicit_base_destructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3885 | R0898 | R1094 | <code>海中鱼巣/领域/自检.节点直接世界结构骨架.ixx:229</code> | compiler_implicit_base_destructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4460 | R0898 | R1162 | <code>海中鱼巣/领域/自检.节点直接世界结构骨架.ixx:161</code> | direct_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4459 | R0898 | R1200 | <code>海中鱼巣/领域/自检.节点直接世界结构骨架.ixx:160</code> | direct_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4458 | R0898 | R1416 | <code>海中鱼巣/领域/自检.节点直接世界结构骨架.ixx:159</code> | direct_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4291 | R1315 | R1286 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:84</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4292 | R1315 | R1339 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:86</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4446 | R1484 | R0950 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:435</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4441 | R1484 | R1163 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:387</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4443 | R1484 | R1164 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:407</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4447 | R1484 | R1165 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:554</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4444 | R1484 | R1168 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:412</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4442 | R1484 | R1169 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:392</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4445 | R1484 | R1170 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:414</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4450 | R1484 | R1465 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:431</code> | direct_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4396 | R1484 | R1470 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:431</code> | implicit lifetime | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4402 | R1484 | R1471 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:353, 海中鱼巣/核心/自检.节点直接结构查询.ixx:379, 海中鱼巣/核心/自检.节点直接结构查询.ixx:401, 海中鱼巣/核心/自检.节点直接结构查询.ixx:537</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4403 | R1484 | R1472 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:353, 海中鱼巣/核心/自检.节点直接结构查询.ixx:379, 海中鱼巣/核心/自检.节点直接结构查询.ixx:401, 海中鱼巣/核心/自检.节点直接结构查询.ixx:537</code> | implicit lifetime | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4408 | R1484 | R1474 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:465, 海中鱼巣/核心/自检.节点直接结构查询.ixx:493, 海中鱼巣/核心/自检.节点直接结构查询.ixx:498, 海中鱼巣/核心/自检.节点直接结构查询.ixx:516, 海中鱼巣/核心/自检.节点直接结构查询.ixx:527, 海中鱼巣/核心/自检.节点直接结构查询.ixx:556</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4412 | R1484 | R1475 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:474, 海中鱼巣/核心/自检.节点直接结构查询.ixx:505, 海中鱼巣/核心/自检.节点直接结构查询.ixx:511, 海中鱼巣/核心/自检.节点直接结构查询.ixx:518, 海中鱼巣/核心/自检.节点直接结构查询.ixx:535, 海中鱼巣/核心/自检.节点直接结构查询.ixx:552</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4417 | R1484 | R1477 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:465, 海中鱼巣/核心/自检.节点直接结构查询.ixx:478, 海中鱼巣/核心/自检.节点直接结构查询.ixx:494, 海中鱼巣/核心/自检.节点直接结构查询.ixx:499, 海中鱼巣/核心/自检.节点直接结构查询.ixx:506, 海中鱼巣/核心/自检.节点直接结构查询.ixx:512, 海中鱼巣/核心/自检.节点直接结构查询.ixx:558</code> | direct defaulted equality | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4425 | R1484 | R1478 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:452, 海中鱼巣/核心/自检.节点直接结构查询.ixx:465, 海中鱼巣/核心/自检.节点直接结构查询.ixx:478, 海中鱼巣/核心/自检.节点直接结构查询.ixx:494, 海中鱼巣/核心/自检.节点直接结构查询.ixx:499, 海中鱼巣/核心/自检.节点直接结构查询.ixx:506, 海中鱼巣/核心/自检.节点直接结构查询.ixx:512, 海中鱼巣/核心/自检.节点直接结构查询.ixx:558</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4434 | R1484 | R1479 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:354, 海中鱼巣/核心/自检.节点直接结构查询.ixx:402, 海中鱼巣/核心/自检.节点直接结构查询.ixx:538</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4435 | R1484 | R1480 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:464, 海中鱼巣/核心/自检.节点直接结构查询.ixx:498, 海中鱼巣/核心/自检.节点直接结构查询.ixx:546</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4436 | R1484 | R1481 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:510, 海中鱼巣/核心/自检.节点直接结构查询.ixx:534</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4437 | R1484 | R1482 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:493</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4438 | R1484 | R1483 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:504</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4439 | R1484 | R1485 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:434</code> | std::thread callback | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4440 | R1484 | R1486 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:480, 海中鱼巣/核心/自检.节点直接结构查询.ixx:483, 海中鱼巣/核心/自检.节点直接结构查询.ixx:486</code> | direct lambda invocation | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4203 | R1484 | R1487 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:368, 海中鱼巣/核心/自检.节点直接结构查询.ixx:373, 海中鱼巣/核心/自检.节点直接结构查询.ixx:389, 海中鱼巣/核心/自检.节点直接结构查询.ixx:415, 海中鱼巣/核心/自检.节点直接结构查询.ixx:462, 海中鱼巣/核心/自检.节点直接结构查询.ixx:463, 海中鱼巣/核心/自检.节点直接结构查询.ixx:491, 海中鱼巣/核心/自检.节点直接结构查询.ixx:492, 海中鱼巣/核心/自检.节点直接结构查询.ixx:496, 海中鱼巣/核心/自检.节点直接结构查询.ixx:497, 海中鱼巣/核心/自检.节点直接结构查询.ixx:516, 海中鱼巣/核心/自检.节点直接结构查询.ixx:523, 海中鱼巣/核心/自检.节点直接结构查询.ixx:524, 海中鱼巣/核心/自检.节点直接结构查询.ixx:525, 海中鱼巣/核心/自检.节点直接结构查询.ixx:541, 海中鱼巣/核心/自检.节点直接结构查询.ixx:543</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4204 | R1484 | R1488 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:490</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4205 | R1484 | R1489 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:495, 海中鱼巣/核心/自检.节点直接结构查询.ixx:539</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4206 | R1484 | R1490 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:461, 海中鱼巣/核心/自检.节点直接结构查询.ixx:515, 海中鱼巣/核心/自检.节点直接结构查询.ixx:521</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4222 | R1484 | R1494 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:369, 海中鱼巣/核心/自检.节点直接结构查询.ixx:374, 海中鱼巣/核心/自检.节点直接结构查询.ixx:382, 海中鱼巣/核心/自检.节点直接结构查询.ixx:390, 海中鱼巣/核心/自检.节点直接结构查询.ixx:417-418, 海中鱼巣/核心/自检.节点直接结构查询.ixx:444, 海中鱼巣/核心/自检.节点直接结构查询.ixx:502, 海中鱼巣/核心/自检.节点直接结构查询.ixx:503, 海中鱼巣/核心/自检.节点直接结构查询.ixx:508, 海中鱼巣/核心/自检.节点直接结构查询.ixx:509, 海中鱼巣/核心/自检.节点直接结构查询.ixx:518, 海中鱼巣/核心/自检.节点直接结构查询.ixx:530, 海中鱼巣/核心/自检.节点直接结构查询.ixx:531, 海中鱼巣/核心/自检.节点直接结构查询.ixx:532, 海中鱼巣/核心/自检.节点直接结构查询.ixx:549, 海中鱼巣/核心/自检.节点直接结构查询.ixx:551</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4224 | R1484 | R1495 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:501</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4225 | R1484 | R1496 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:507</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4227 | R1484 | R1497 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:517, 海中鱼巣/核心/自检.节点直接结构查询.ixx:528-529</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
...
| E0614 | F0136 | F0321 | <code>海中鱼巣/核心/节点仓库.cpp:45</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0037 | F0175 | F0168 | <code>海中鱼巣/领域/初始化.需求.ixx:63</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0040 | F0189 | F0168 | <code>海中鱼巣/领域/初始化.概念图.ixx:34</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0041 | F0190 | F0397 | <code>海中鱼巣/核心/节点仓库.cpp:235</code> | resolved-function-pointer |  | None | 事务接线已接域；生产运行期唯一正式共享许可目标 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0044 | F0217 | F0397 | <code>海中鱼巣/核心/主信息仓库.cpp:432</code> | resolved-function-pointer |  | None | 事务接线已接域；生产运行期唯一正式共享许可目标 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0045 | F0218 | F0168 | <code>海中鱼巣/界面/投影.控制面板启动.ixx:78</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0046 | F0220 | F0168 | <code>海中鱼巣/领域/初始化.语素.ixx:25</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| E0864 | F0223 | F0396 | <code>海中鱼巣/界面/控制面板窗口.cpp:1578</code> | resolved-win32-callback |  | None | 窗口过程已由注册窗口类在 line 435 登记为 WNDPROC；消息循环调用 DispatchMessageW 后由 Win32 同步调度 | 专项源码静态类型与实际装配人工复核 |
...
| E0867 | F0227 | F0230 | <code>海中鱼巣/生产运行期配置.数据.h:68</code> | direct_const_member |  | None | 配置比较在基础字段相等后读取左侧与右侧系统角色稳定键组 | 专项源码静态类型与实际装配人工复核 |
...
| RCE4381 | F0239 | R1446 | <code>海中鱼巣/启动.运行期上下文.ixx:62</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
...
| E0949 | F0244 | F0456 | <code>海中鱼巣/领域/系统角色清单.数据.h:264</code> | implicit-defaulted-member+defaulted-member-comparison |  | None | 默认比较依次比较主体字段；系统角色清单默认等值比较逐成员比较主体材料 | 专项源码静态类型与实际装配人工复核 |
| E0950 | F0244 | F0457 | <code>海中鱼巣/领域/系统角色清单.数据.h:264</code> | implicit-defaulted-member+defaulted-member-comparison |  | None | 默认比较依次比较两项关系材料字段；系统角色清单默认等值比较逐成员比较两项系统角色关系材料 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0047 | F0254 | F0045 | <code>海中鱼巣/自检.入口初始化.ixx:83</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0048 | F0254 | F0046 | <code>海中鱼巣/自检.入口初始化.ixx:84</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0049 | F0254 | F0048 | <code>海中鱼巣/自检.入口初始化.ixx:85</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0050 | F0255 | F0045 | <code>海中鱼巣/自检.入口初始化.ixx:112</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0051 | F0255 | F0046 | <code>海中鱼巣/自检.入口初始化.ixx:113</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0052 | F0255 | F0048 | <code>海中鱼巣/自检.入口初始化.ixx:114</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0053 | F0256 | F0045 | <code>海中鱼巣/自检.入口初始化.ixx:140</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0054 | F0256 | F0046 | <code>海中鱼巣/自检.入口初始化.ixx:141</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0055 | F0256 | F0048 | <code>海中鱼巣/自检.入口初始化.ixx:142</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0056 | F0257 | F0045 | <code>海中鱼巣/自检.入口初始化.ixx:169</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0057 | F0257 | F0046 | <code>海中鱼巣/自检.入口初始化.ixx:170</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0058 | F0257 | F0048 | <code>海中鱼巣/自检.入口初始化.ixx:171</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0059 | F0257 | F0496 | <code>海中鱼巣/自检.入口初始化.ixx:176</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0060 | F0257 | F0497 | <code>海中鱼巣/自检.入口初始化.ixx:177</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0061 | F0258 | F0045 | <code>海中鱼巣/自检.入口初始化.ixx:202</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0062 | F0258 | F0046 | <code>海中鱼巣/自检.入口初始化.ixx:203</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0065 | F0259 | F0045 | <code>海中鱼巣/自检.入口初始化.ixx:234</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0066 | F0259 | F0046 | <code>海中鱼巣/自检.入口初始化.ixx:235</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0067 | F0259 | F0048 | <code>海中鱼巣/自检.入口初始化.ixx:236</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0068 | F0260 | F0045 | <code>海中鱼巣/自检.入口初始化.ixx:258</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0069 | F0260 | F0046 | <code>海中鱼巣/自检.入口初始化.ixx:259</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0070 | F0260 | F0048 | <code>海中鱼巣/自检.入口初始化.ixx:260</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0071 | F0261 | F0045 | <code>海中鱼巣/自检.入口初始化.ixx:282</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0072 | F0261 | F0046 | <code>海中鱼巣/自检.入口初始化.ixx:283</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0073 | F0261 | F0048 | <code>海中鱼巣/自检.入口初始化.ixx:284</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0074 | F0261 | R0147 | <code>海中鱼巣/自检.入口初始化.ixx:289</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0077 | F0262 | F0045 | <code>海中鱼巣/自检.入口初始化.ixx:315</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0078 | F0262 | F0046 | <code>海中鱼巣/自检.入口初始化.ixx:316</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0079 | F0262 | F0048 | <code>海中鱼巣/自检.入口初始化.ixx:317</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0082 | F0263 | F0045 | <code>海中鱼巣/自检.入口初始化.ixx:340</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0083 | F0263 | F0046 | <code>海中鱼巣/自检.入口初始化.ixx:341</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0084 | F0263 | F0048 | <code>海中鱼巣/自检.入口初始化.ixx:342</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0086 | F0264 | F0045 | <code>海中鱼巣/自检.入口初始化.ixx:372</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0087 | F0264 | F0046 | <code>海中鱼巣/自检.入口初始化.ixx:373</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0088 | F0264 | F0048 | <code>海中鱼巣/自检.入口初始化.ixx:374</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0085 | F0264 | F0189 | <code>海中鱼巣/自检.入口初始化.ixx:365, 海中鱼巣/自检.入口初始化.ixx:381</code> | field_type_hint |  | None | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
| RCE0089 | F0264 | F0441 | <code>海中鱼巣/自检.入口初始化.ixx:379, 海中鱼巣/自检.入口初始化.ixx:380</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0091 | F0265 | F0045 | <code>海中鱼巣/自检.入口初始化.ixx:398</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0092 | F0265 | F0046 | <code>海中鱼巣/自检.入口初始化.ixx:399</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0093 | F0265 | F0048 | <code>海中鱼巣/自检.入口初始化.ixx:400</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0090 | F0265 | F0350 | <code>海中鱼巣/自检.入口初始化.ixx:392, 海中鱼巣/自检.入口初始化.ixx:407, 海中鱼巣/自检.入口初始化.ixx:418</code> | field_type_hint |  | None | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
...
| RCE0095 | F0265 | F0553 | <code>海中鱼巣/自检.入口初始化.ixx:408</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0096 | F0265 | F0554 | <code>海中鱼巣/自检.入口初始化.ixx:410</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0097 | F0265 | F0555 | <code>海中鱼巣/自检.入口初始化.ixx:413</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0098 | F0266 | F0045 | <code>海中鱼巣/自检.入口初始化.ixx:436</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0099 | F0266 | F0046 | <code>海中鱼巣/自检.入口初始化.ixx:437</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0100 | F0266 | F0048 | <code>海中鱼巣/自检.入口初始化.ixx:438</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE4378 | F0343 | R1442 | <code>海中鱼巣/核心/关系仓库.cpp:181</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4379 | F0343 | R1443 | <code>海中鱼巣/核心/关系仓库.cpp:181</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
...
| RCE1657 | F0356 | F0051 | <code>海中鱼巣/领域/概念图服务.h:870, 海中鱼巣/领域/概念图服务.h:875, 海中鱼巣/领域/概念图服务.h:885</code> | operator |  | None | 稳定键前置成立后比较根节点；发布读回前三项成立后比较根节点 | 专项源码静态类型与实际装配人工复核 |
| RCE0113 | F0356 | F0184 | <code>海中鱼巣/领域/概念图服务.h:882</code> | direct_free |  | None | 发布后读回完整条件形成 | 专项源码静态类型与实际装配人工复核 |
| RCE1655 | F0356 | F0190 | <code>海中鱼巣/领域/概念图服务.h:850</code> | direct_const_member |  | None | 函数进入读取根节点记录 | 专项源码静态类型与实际装配人工复核 |
| RCE0111 | F0356 | F0639 | <code>海中鱼巣/领域/概念图服务.h:852</code> | direct_static |  | None | 入口短路首先复核根类别 | 专项源码静态类型与实际装配人工复核 |
| RCE0112 | F0356 | F0640 | <code>海中鱼巣/领域/概念图服务.h:880, 海中鱼巣/领域/概念图服务.h:881</code> | direct_static |  | None | 唯一性遍历完成后写入并读回根登记槽 | 专项源码静态类型与实际装配人工复核 |
| RCE1656 | F0356 | R0088 | <code>海中鱼巣/领域/概念图服务.h:860</code> | direct_const_member |  | None | 入口通过并取得图写锁后读取上位来源节点 | 专项源码静态类型与实际装配人工复核 |
| RCE0110 | F0356 | R0521 | <code>海中鱼巣/领域/概念图服务.h:851</code> | direct_static |  | None | 根记录存在时映射根类别 | 专项源码静态类型与实际装配人工复核 |
| RCE1658 | F0357 | F0051 | <code>海中鱼巣/领域/概念图服务.h:953, 海中鱼巣/领域/概念图服务.h:956, 海中鱼巣/领域/概念图服务.h:962</code> | operator |  | None | 各 optional has_value 前置成立后比较状态节点句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE0116 | F0357 | F0184 | <code>海中鱼巣/领域/概念图服务.h:962</code> | direct_free |  | None | 发布后读回完整条件形成 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0114 | F0357 | F0641 | <code>海中鱼巣/领域/概念图服务.h:940</code> | direct_static |  | None | 入口短路首先复核生命周期阶段 | 专项源码静态类型与实际装配人工复核 |
| RCE0115 | F0357 | F0642 | <code>海中鱼巣/领域/概念图服务.h:950</code> | direct_static |  | None | 取得生命周期状态独占锁后计算槽索引 | 专项源码静态类型与实际装配人工复核 |
| RCE1659 | F0358 | F0051 | <code>海中鱼巣/领域/概念图服务.h:3011</code> | standard-library-callback |  | None | std::adjacent_find 默认相等谓词按需比较节点句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE0117 | F0358 | F0377 | <code>海中鱼巣/领域/概念图服务.h:3005</code> | direct_const_member+direct-const-member |  | None | 逐个已登记状态复核节点有效；optional 状态有值后复核节点有效；单实参无令牌重载 | 专项源码静态类型与实际装配人工复核 |
| RCE0118 | F0358 | R0518 | <code>海中鱼巣/领域/概念图服务.h:3010</code> | standard-library-callback |  | None | std::sort 按需调用具名节点句柄小于；std::sort 注册同类静态比较函数 | 专项源码静态类型与实际装配人工复核 |
| RCE1664 | F0359 | F0051 | <code>海中鱼巣/领域/概念图服务.h:3111, 海中鱼巣/领域/概念图服务.h:3124, 海中鱼巣/领域/概念图服务.h:3125</code> | operator |  | None | any_of 简单 lambda 或写后读回短路前置成立后比较节点句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE1665 | F0359 | F0167 | <code>海中鱼巣/领域/概念图服务.h:3119</code> | direct_member |  | None | 允许创建、预期状态存在且无残留登记 | 专项源码静态类型与实际装配人工复核 |
| RCE0124 | F0359 | F0168 | <code>海中鱼巣/领域/概念图服务.h:3121, 海中鱼巣/领域/概念图服务.h:3127</code> | direct_free |  | None | 写后读回检查及失败清理前复核关系句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE0122 | F0359 | F0184 | <code>海中鱼巣/领域/概念图服务.h:3062, 海中鱼巣/领域/概念图服务.h:3068, 海中鱼巣/领域/概念图服务.h:3072, 海中鱼巣/领域/概念图服务.h:3090, 海中鱼巣/领域/概念图服务.h:3114, 海中鱼巣/领域/概念图服务.h:3121, 海中鱼巣/领域/概念图服务.h:3128</code> | direct_free |  | None | 各具名内部一致性与清理结果检查按源码短路成立 | 专项源码静态类型与实际装配人工复核 |
| RCE0121 | F0359 | F0354 | <code>海中鱼巣/领域/概念图服务.h:3054</code> | direct_const_member |  | None | 预期阶段有值时读取预期状态 | 专项源码静态类型与实际装配人工复核 |
| RCE0119 | F0359 | F0369 | <code>海中鱼巣/领域/概念图服务.h:3047</code> | direct_const_member |  | None | 函数进入读取概念类别 | 专项源码静态类型与实际装配人工复核 |
| RCE1660 | F0359 | F0575 | <code>海中鱼巣/领域/概念图服务.h:3060</code> | direct_const_member |  | None | 入口通过后读取概念生命周期关系组 | 专项源码静态类型与实际装配人工复核 |
| RCE1666 | F0359 | F0587 | <code>海中鱼巣/领域/概念图服务.h:3120, 海中鱼巣/领域/概念图服务.h:3129</code> | direct_const_member |  | None | 创建后无条件读回；删除失败后再次读回 | 专项源码静态类型与实际装配人工复核 |
| RCE1667 | F0359 | F0590 | <code>海中鱼巣/领域/概念图服务.h:3129</code> | direct_member |  | None | 新关系句柄有效且写后检查失败 | 专项源码静态类型与实际装配人工复核 |
| RCE0120 | F0359 | F0641 | <code>海中鱼巣/领域/概念图服务.h:3048</code> | direct_static |  | None | 预期阶段有值时复核阶段有效 | 专项源码静态类型与实际装配人工复核 |
| RCE1661 | F0359 | R0605 | <code>海中鱼巣/领域/概念图服务.h:3067</code> | direct_const_member |  | None | 已有唯一关系时读取非令牌生命周期阶段 | 专项源码静态类型与实际装配人工复核 |
| RCE1662 | F0359 | R0606 | <code>海中鱼巣/领域/概念图服务.h:3078</code> | standard-library-callback |  | None | std::count_if 注册并调用非平凡完整匹配 lambda | 专项源码静态类型与实际装配人工复核 |
| RCE1663 | F0359 | R0607 | <code>海中鱼巣/领域/概念图服务.h:3095</code> | standard-library-callback |  | None | std::find_if 注册并调用非平凡编号版本匹配 lambda | 专项源码静态类型与实际装配人工复核 |
| RCE1671 | F0360 | F0051 | <code>海中鱼巣/领域/概念图服务.h:3154, 海中鱼巣/领域/概念图服务.h:3162, 海中鱼巣/领域/概念图服务.h:3163</code> | operator |  | None | 登记/记录节点比较按短路顺序执行 | 专项源码静态类型与实际装配人工复核 |
| RCE1669 | F0360 | F0184 | <code>海中鱼巣/领域/概念图服务.h:3144, 海中鱼巣/领域/概念图服务.h:3149, 海中鱼巣/领域/概念图服务.h:3165, 海中鱼巣/领域/概念图服务.h:3170</code> | direct_free |  | None | 唯一关系、阶段、登记一致性和最终命中检查 | 专项源码静态类型与实际装配人工复核 |
| RCE1668 | F0360 | F0575 | <code>海中鱼巣/领域/概念图服务.h:3140</code> | direct_const_member |  | None | 函数进入读取概念生命周期关系组 | 专项源码静态类型与实际装配人工复核 |
| RCE1672 | F0360 | F0587 | <code>海中鱼巣/领域/概念图服务.h:3157</code> | direct_const_member |  | None | 登记概念与状态匹配后读取登记关系 | 专项源码静态类型与实际装配人工复核 |
| RCE1670 | F0360 | R0605 | <code>海中鱼巣/领域/概念图服务.h:3148</code> | direct_const_member |  | None | 唯一记录已借用后读取非令牌生命周期阶段 | 专项源码静态类型与实际装配人工复核 |
| RCE1673 | F0360 | R0608 | <code>海中鱼巣/领域/概念图服务.h:3174</code> | direct_const_member |  | None | 组合生命周期材料后复核完整 | 专项源码静态类型与实际装配人工复核 |
| RCE0126 | F0361 | F0587 | <code>海中鱼巣/领域/概念图服务.h:3232</code> | direct_const_member+direct-const-member |  | None | 删除返回 false 后复核关系已不可读；删除失败后复核关系已不可读；单实参无令牌重载 | 专项源码静态类型与实际装配人工复核 |
| RCE0125 | F0361 | F0590 | <code>海中鱼巣/领域/概念图服务.h:3231</code> | direct_member+direct-member |  | None | 生命周期登记命中后删除待清理关系；反向清理已登记生命周期关系；单实参写重载 | 专项源码静态类型与实际装配人工复核 |
| RCE1674 | F0361 | R0598 | <code>海中鱼巣/领域/概念图服务.h:3226</code> | operator |  | None | std::find_if 简单 lambda 比较登记关系与待清理关系 | 专项源码静态类型与实际装配人工复核 |
| RCE1675 | F0362 | F0051 | <code>海中鱼巣/领域/概念图服务.h:4203, 海中鱼巣/领域/概念图服务.h:4216, 海中鱼巣/领域/概念图服务.h:4235, 海中鱼巣/领域/概念图服务.h:4236, 海中鱼巣/领域/概念图服务.h:4267, 海中鱼巣/领域/概念图服务.h:4270, 海中鱼巣/领域/概念图服务.h:4281, 海中鱼巣/领域/概念图服务.h:4285, 海中鱼巣/领域/概念图服务.h:4290, 海中鱼巣/领域/概念图服务.h:4296</code> | operator+standard-library-callback |  | None | std::find/unique 默认比较、显式端点比较和简单 any_of lambda 比较节点句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE1679 | F0362 | F0190 | <code>海中鱼巣/领域/概念图服务.h:4258</code> | direct_const_member |  | None | 其它关系角色读取目标材料节点 | 专项源码静态类型与实际装配人工复核 |
| RCE0128 | F0362 | F0358 | <code>海中鱼巣/领域/概念图服务.h:4208</code> | direct_const_member |  | None | 根与概念集合通过后复核生命周期状态登记完整 | 专项源码静态类型与实际装配人工复核 |
| RCE1676 | F0362 | F0360 | <code>海中鱼巣/领域/概念图服务.h:4212</code> | direct_const_member |  | None | 逐个快照概念读取非令牌生命周期材料 | 专项源码静态类型与实际装配人工复核 |
| RCE0130 | F0362 | F0369 | <code>海中鱼巣/领域/概念图服务.h:4223, 海中鱼巣/领域/概念图服务.h:4249</code> | direct_const_member |  | None | 读取签名概念与实例来源概念类别 | 专项源码静态类型与实际装配人工复核 |
| RCE1677 | F0362 | F0587 | <code>海中鱼巣/领域/概念图服务.h:4231</code> | direct_const_member |  | None | 逐个快照关系读取当前关系记录 | 专项源码静态类型与实际装配人工复核 |
| RCE1680 | F0362 | R0518 | <code>海中鱼巣/领域/概念图服务.h:4295</code> | standard-library-callback |  | None | std::sort 按需调用具名节点句柄小于 | 专项源码静态类型与实际装配人工复核 |
| RCE0134 | F0362 | R0522 | <code>海中鱼巣/领域/概念图服务.h:4261</code> | direct_static |  | None | 源签名和目标材料记录存在后复核类型 | 专项源码静态类型与实际装配人工复核 |
| RCE0132 | F0362 | R0523 | <code>海中鱼巣/领域/概念图服务.h:4240, 海中鱼巣/领域/概念图服务.h:4241, 海中鱼巣/领域/概念图服务.h:4250, 海中鱼巣/领域/概念图服务.h:4259</code> | direct_static |  | None | 按关系角色从快照读取源或目标概念签名 | 专项源码静态类型与实际装配人工复核 |
| RCE0127 | F0362 | R0531 | <code>海中鱼巣/领域/概念图服务.h:4202</code> | direct_const_member |  | None | 逐根复核概念根登记 | 专项源码静态类型与实际装配人工复核 |
| RCE0131 | F0362 | R0532 | <code>海中鱼巣/领域/概念图服务.h:4226</code> | direct_static |  | None | 类别匹配前置后规范化签名 | 专项源码静态类型与实际装配人工复核 |
| RCE0133 | F0362 | R0533 | <code>海中鱼巣/领域/概念图服务.h:4244</code> | direct_static |  | None | 上下位两份签名均存在后复核一般性 | 专项源码静态类型与实际装配人工复核 |
| RCE1678 | F0362 | R0604 | <code>海中鱼巣/领域/概念图服务.h:4232</code> | direct_const_member |  | None | 读取关系后复核概念活动关系材料完整 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0158 | F0373 | F0192 | <code>海中鱼巣/领域/统计服务.h:959</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0159 | F0373 | F0193 | <code>海中鱼巣/领域/统计服务.h:960</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0160 | F0373 | F0194 | <code>海中鱼巣/领域/统计服务.h:963</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0161 | F0373 | F0195 | <code>海中鱼巣/领域/统计服务.h:964</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1681 | F0375 | R0600 | <code>海中鱼巣/核心/结构事务接线.数据.h:28</code> | direct-operator |  | None | 移动构造函数体委托移动赋值 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0162 | F0376 | R0120 | <code>海中鱼巣/核心/索引仓库.cpp:419</code> | same_module+direct-free | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 逐边源码/静态类型审计 PASS；专项源码静态类型与实际装配人工复核 |
...
| RCE0194 | F0397 | R0101 | <code>海中鱼巣/核心/协调.结构事务.ixx:152</code> | source-audited |  | None | 正式接线共享许可 lambda 被调用 | 专项源码静态类型与实际装配人工复核 |
| RCE0219 | F0450 | F0336 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:38</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE4456 | R0900 | R0899 | <code>海中鱼巣/领域/自检.节点直接世界结构骨架.ixx:43</code> | callback_address_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4480 | R0902 | R0916 | <code>海中鱼巣/领域/自检.节点直接世界结构骨架.ixx:118</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4481 | R0902 | R0917 | <code>海中鱼巣/领域/自检.节点直接世界结构骨架.ixx:118</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4478 | R0902 | R0925 | <code>海中鱼巣/领域/自检.节点直接世界结构骨架.ixx:110</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4305 | R0902 | R1322 | <code>海中鱼巣/领域/自检.节点直接世界结构骨架.ixx:116</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4488 | R0902 | R1356 | <code>海中鱼巣/领域/自检.节点直接世界结构骨架.ixx:115</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4487 | R0902 | R1387 | <code>海中鱼巣/领域/自检.节点直接世界结构骨架.ixx:114</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4479 | R0902 | R1448 | <code>海中鱼巣/领域/自检.节点直接世界结构骨架.ixx:111</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3477 | R0950 | R0056 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:647</code> | formal_03a8_identity | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3478 | R0950 | R0058 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:647, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:650</code> | formal_03a8_identity | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3479 | R0950 | R0059 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:650</code> | formal_03a8_identity | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3469 | R0950 | R0919 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:641</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3460 | R0950 | R0920 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:645</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3461 | R0950 | R0927 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:640</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3462 | R0950 | R0932 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:637</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3463 | R0950 | R1045 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:638</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3464 | R0950 | R1046 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:637</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3465 | R0950 | R1047 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:657</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3466 | R0950 | R1048 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:675</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3467 | R0950 | R1050 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:686</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3468 | R0950 | R1052 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:648, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:664, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:672, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:681</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3470 | R0950 | R1111 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:685</code> | virtual_dispatch_target | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3471 | R0950 | R1112 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:685</code> | virtual_dispatch_target | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3472 | R0950 | R1126 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:685</code> | virtual_dispatch_target | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3474 | R0950 | R1241 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:660, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:677</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3473 | R0950 | R1259 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:645</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3476 | R0950 | R1268 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:646</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3475 | R0950 | R1269 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:670</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4451 | R0950 | R1466 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3122</code> | resolved_virtual_dispatch_to_p1a2q_concrete_participant | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4452 | R0950 | R1467 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3131</code> | resolved_virtual_dispatch_to_p1a2q_concrete_participant | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4454 | R0950 | R1468 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3148</code> | resolved_virtual_dispatch_to_p1a2q_concrete_participant | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4453 | R0950 | R1469 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3140</code> | resolved_virtual_dispatch_to_p1a2q_concrete_participant | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3669 | R1118 | R0935 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:204</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3670 | R1118 | R1053 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:206</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3662 | R1118 | R1055 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:210</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3671 | R1118 | R1090 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:208</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3663 | R1118 | R1091 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:232, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:233, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:236, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:264, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:265, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:274, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:288, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:297, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:304, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:311, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:320, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:335, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:346, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:347, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:357, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:366, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:367, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:377, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:378, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:390, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:391, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:404, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:405</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3354 | R1118 | R1093 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:524</code> | compiler_implicit_base_destructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3665 | R1118 | R1096 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:197</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3664 | R1118 | R1119 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:284, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:290, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:299, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:306, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:313, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:330, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:339, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:349, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:360, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:372, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:382, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:397</code> | local_lambda_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3673 | R1118 | R1162 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:198</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3667 | R1118 | R1165 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:392, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:393, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:407</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3666 | R1118 | R1200 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:197</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3672 | R1118 | R1207 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:244, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:379</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3680 | R1118 | R1348 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:358, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:368</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3682 | R1118 | R1382 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:266</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3681 | R1118 | R1405 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:412</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3668 | R1118 | R1416 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:196, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:409</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3678 | R1118 | R1419 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:410</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3677 | R1118 | R1426 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:416</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3674 | R1118 | R1428 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:418</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3679 | R1118 | R1440 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:238, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:241, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:406</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3676 | R1118 | R1445 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:414</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3675 | R1118 | R1448 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:408, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:420</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3683 | R1128 | R0933 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:614, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:625, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:636, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:643, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:649, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:655</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3684 | R1128 | R1097 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:611, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:612</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3685 | R1128 | R1098 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:610</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3691 | R1128 | R1129 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:614</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3692 | R1128 | R1130 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:625</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3693 | R1128 | R1131 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:636</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3694 | R1128 | R1132 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:643</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3695 | R1128 | R1133 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:649</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3696 | R1128 | R1134 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:655</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3690 | R1128 | R1437 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:671</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3689 | R1128 | R1440 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:661, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:662</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3687 | R1128 | R1445 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:687</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3688 | R1128 | R1447 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:678</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3686 | R1128 | R1457 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:663</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3713 | R1135 | R0919 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:782</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3711 | R1135 | R0925 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:755</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3712 | R1135 | R0933 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:715</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3717 | R1135 | R1097 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:704, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:705</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3724 | R1135 | R1098 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:699</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3720 | R1135 | R1099 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:701</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3719 | R1135 | R1100 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:702</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3714 | R1135 | R1103 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:778</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3715 | R1135 | R1104 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:778</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3716 | R1135 | R1121 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:778</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4539 | R1135 | R1136 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:716</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3723 | R1135 | R1165 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:765, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:767</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3722 | R1135 | R1171 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:764</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3721 | R1135 | R1172 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:766</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3725 | R1135 | R1203 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:758</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3727 | R1135 | R1209 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:761</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3726 | R1135 | R1221 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:756, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:763, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:791</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3718 | R1135 | R1279 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:768</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3729 | R1135 | R1437 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:783</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3728 | R1135 | R1445 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:773, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:790</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3756 | R1138 | R1139 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:850, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:851</code> | local_lambda_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3771 | R1141 | R0919 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:878</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3768 | R1141 | R0925 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:873</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3769 | R1141 | R0926 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:876</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3770 | R1141 | R0933 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:859, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:871</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3776 | R1141 | R1098 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:855</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3775 | R1141 | R1099 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:857</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3772 | R1141 | R1105 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:875</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3773 | R1141 | R1106 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:875</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3774 | R1141 | R1122 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:875</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4541 | R1141 | R1142 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:860</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4542 | R1141 | R1143 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:872</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3777 | R1141 | R1437 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:879</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3798 | R1147 | F0272 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:931</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3829 | R1147 | R0095 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:943</code> | formal_03a8_identity | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3793 | R1147 | R1074 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1097, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1109</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3794 | R1147 | R1111 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1018, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1046, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1063, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1078, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1106, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:956, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:976</code> | virtual_dispatch_target | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3795 | R1147 | R1112 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1018, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1046, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1063, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1078, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1106, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:956, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:976</code> | virtual_dispatch_target | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3796 | R1147 | R1126 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1018, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1046, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1063, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1078, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1106, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:956, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:976</code> | virtual_dispatch_target | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3797 | R1147 | R1145 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:934</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3828 | R1147 | R1193 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:957, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:977</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3802 | R1147 | R1203 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:939, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:961, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:969, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:989</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3808 | R1147 | R1207 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:944</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3809 | R1147 | R1208 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:946, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:988</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3803 | R1147 | R1209 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1127, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:967</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3804 | R1147 | R1210 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:948, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:979, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:984, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:986</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3805 | R1147 | R1211 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:950</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3806 | R1147 | R1212 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:981</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3807 | R1147 | R1213 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:983</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3799 | R1147 | R1214 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:992</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3801 | R1147 | R1223 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:954, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:974</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3800 | R1147 | R1224 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:965</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3810 | R1147 | R1292 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1157</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3815 | R1147 | R1317 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1110, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1113, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1118</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3812 | R1147 | R1318 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1112</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3811 | R1147 | R1320 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1115, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1116, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1117</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3814 | R1147 | R1329 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1093, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1098, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1101</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3813 | R1147 | R1330 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1104</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3827 | R1147 | R1344 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1096</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3820 | R1147 | R1348 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1041, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1057, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1066, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1071, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1149</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3818 | R1147 | R1350 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1037, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1055</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3819 | R1147 | R1351 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1067, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1073</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3817 | R1147 | R1352 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1044, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1061, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1076</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3816 | R1147 | R1353 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1069</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3825 | R1147 | R1377 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1040</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3824 | R1147 | R1382 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1009, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1027, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1143</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3823 | R1147 | R1383 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1006, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1010, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1013, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1023</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3822 | R1147 | R1384 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1016</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3821 | R1147 | R1385 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1025</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3826 | R1147 | R1404 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1008</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3830 | R1148 | R0926 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1169</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3832 | R1148 | R1098 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1165</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3831 | R1148 | R1172 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1168</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3833 | R1148 | R1221 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1167</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3834 | R1148 | R1445 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1166</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3838 | R1149 | R0919 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1236</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3835 | R1149 | R0921 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1237</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3841 | R1149 | R0924 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1184</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3836 | R1149 | R0925 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1229</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3844 | R1149 | R0935 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1185</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3837 | R1149 | R0939 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1228</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3839 | R1149 | R1074 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1234</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3840 | R1149 | R1096 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1178</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3846 | R1149 | R1162 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1179</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3843 | R1149 | R1165 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1233</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3842 | R1149 | R1200 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1178</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3845 | R1149 | R1207 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1232</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3848 | R1149 | R1317 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1242</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3847 | R1149 | R1416 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1177</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3849 | R1149 | R1440 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1230, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1231</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3855 | R1150 | R0935 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1255</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3856 | R1150 | R1053 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1258</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3850 | R1150 | R1054 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1270, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1283</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3851 | R1150 | R1055 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1259</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3853 | R1150 | R1096 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1249</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3852 | R1150 | R1151 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1305, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1309, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1312, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1315, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1318, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1322</code> | local_lambda_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3857 | R1150 | R1162 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1250</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3854 | R1150 | R1200 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1249</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3858 | R1150 | R1416 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1248</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3863 | R1152 | R0926 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1465</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3864 | R1152 | R0933 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1353</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3867 | R1152 | R1098 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1341, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1356, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1364, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1375, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1384, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1423, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1436</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3866 | R1152 | R1120 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1346, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1358, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1366, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1368, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1377, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1379, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1386, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1388, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1425, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1431, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1438, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1444</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3865 | R1152 | R1121 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1455, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1461</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3910 | R1152 | R1123 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1461</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4543 | R1152 | R1153 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1354</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3872 | R1152 | R1154 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1412, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1417</code> | frozen_source_exact_local_lambda_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3868 | R1152 | R1172 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1472</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3869 | R1152 | R1221 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1471</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3870 | R1152 | R1319 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1343, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1351, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1352, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1362, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1373, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1382, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1392, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1428, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1434, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1442, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1447</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3871 | R1152 | R1445 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1470</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4145 | R1163 | R1155 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:178</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4158 | R1163 | R1182 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:198</code> | direct | 记录 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4156 | R1163 | R1183 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:182</code> | direct | 记录、事务序号 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4157 | R1163 | R1185 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:189</code> | direct | 既有记录、输入记录 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4082 | R1164 | R1283 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:231</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4087 | R1164 | R1292 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:231</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4160 | R1164 | R1438 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:237</code> | direct | 当前身份 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4159 | R1164 | R1441 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:232</code> | direct | 预期目标.稳定主键 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4162 | R1165 | R1487 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:317</code> | direct | 键 | 结构化精确读取结果 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4167 | R1168 | R1185 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:368</code> | direct | 仓内记录、候选记录 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4166 | R1168 | R1186 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:364</code> | direct | 候选、事务序号、持有阶段 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4169 | R1169 | R1182 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:393</code> | direct | 候选记录 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4168 | R1169 | R1186 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:379</code> | direct | 候选、事务序号、持有阶段 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4172 | R1170 | R1182 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:412</code> | direct | 候选记录 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4171 | R1170 | R1185 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:411</code> | direct | 仓内记录、候选记录 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4170 | R1170 | R1186 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:406</code> | direct | 候选、事务序号、已确认阶段 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4146 | R1172 | R1155 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:444</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4175 | R1172 | R1182 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:451</code> | direct | 记录 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4174 | R1172 | R1183 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:444</code> | direct | 记录、事务序号 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3998 | R1174 | R1167 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:361</code> | callback | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4177 | R1174 | R1491 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:466</code> | callback | 恢复记录左右项 |  | std::sort比较 | 4b80f161 冻结源码逐调用点复核 |
| RCE4178 | R1174 | R1492 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:474</code> | std_any_of_callback | 记录 | 记录是否不完整 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4180 | R1175 | R1187 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:501</code> | direct | 候选、事务序号、持有阶段 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4184 | R1177 | R1182 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:530</code> | direct | 恢复记录 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4183 | R1177 | R1183 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:527</code> | direct | 恢复记录、无事务序号 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4185 | R1177 | R1187 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:533</code> | direct | 候选、事务序号、已确认阶段 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3937 | R1204 | R1240 | <code>海中鱼巣/核心/仓库.正式关系.ixx:356</code> | direct | 关系、空新端点、事务序号、失效种类 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3945 | R1207 | R1229 | <code>海中鱼巣/核心/仓库.正式关系.ixx:389</code> | direct | 稳定主键、无事务序号 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3947 | R1208 | R1229 | <code>海中鱼巣/核心/仓库.正式关系.ixx:396</code> | direct | 稳定主键、事务序号 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3950 | R1210 | R1235 | <code>海中鱼巣/核心/仓库.正式关系.ixx:407</code> | direct | 节点、类型/方向、可选事务序号 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3952 | R1211 | R1235 | <code>海中鱼巣/核心/仓库.正式关系.ixx:413</code> | direct | 节点、类型/方向、可选事务序号 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3954 | R1212 | R1235 | <code>海中鱼巣/核心/仓库.正式关系.ixx:417</code> | direct | 节点、类型/方向、可选事务序号 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3956 | R1213 | R1235 | <code>海中鱼巣/核心/仓库.正式关系.ixx:427</code> | direct | 节点、类型/方向、可选事务序号 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3958 | R1214 | R1215 | <code>海中鱼巣/核心/仓库.正式关系.ixx:451</code> | callback | 每域高水位左右项 |  | std::sort比较 | 4b80f161 冻结源码逐调用点复核 |
| RCE3959 | R1214 | R1216 | <code>海中鱼巣/核心/仓库.正式关系.ixx:454</code> | callback | 历史占用左右项 |  | std::sort比较 | 4b80f161 冻结源码逐调用点复核 |
| RCE3960 | R1214 | R1230 | <code>海中鱼巣/核心/仓库.正式关系.ixx:459</code> | callback | 记录左右项 |  | std::sort比较 | 4b80f161 冻结源码逐调用点复核 |
| RCE3928 | R1217 | R1201 | <code>海中鱼巣/核心/仓库.正式关系.ixx:466</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3962 | R1217 | R1231 | <code>海中鱼巣/核心/仓库.正式关系.ixx:466</code> | direct | 恢复材料 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3964 | R1218 | R1238 | <code>海中鱼巣/核心/仓库.正式关系.ixx:493</code> | direct | 候选、事务序号、持有阶段 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3967 | R1220 | R1238 | <code>海中鱼巣/核心/仓库.正式关系.ixx:548</code> | direct | 候选、事务序号、已确认阶段 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3968 | R1220 | R1437 | <code>海中鱼巣/核心/仓库.正式关系.ixx:526, 海中鱼巣/核心/仓库.正式关系.ixx:527</code> | direct | 记录.源节点 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4004 | R1244 | R1502 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:106</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4008 | R1244 | R1261 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:102</code> | direct | this | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4011 | R1244 | R1267 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:111, 海中鱼巣/核心/会话.节点直接身份结构写入.ixx:125</code> | direct | 失败结果 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4010 | R1244 | R1273 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:104</code> | direct | 节点仓结果 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4009 | R1244 | R1429 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:103</code> | direct | 类型、稳定主键、事务序号_ | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4012 | R1244 | R1431 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:121</code> | direct | 候选、事务序号_ | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3936 | R1246 | R1203 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:155</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4018 | R1246 | R1261 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:154</code> | direct | this | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4019 | R1246 | R1265 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:155</code> | direct | 关系仓写入结果 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3944 | R1247 | R1206 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:175</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4021 | R1247 | R1262 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:174</code> | direct | this | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4022 | R1247 | R1266 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:177</code> | direct | 关系编号 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4025 | R1248 | R1163 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:193</code> | direct | 记录、事务序号_ | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4028 | R1248 | R1169 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:206</code> | direct | 候选、事务序号_ | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4005 | R1248 | R1159 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:197</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4024 | R1248 | R1261 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:192</code> | direct | this | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4027 | R1248 | R1267 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:198, 海中鱼巣/核心/会话.节点直接身份结构写入.ixx:210</code> | direct | 失败结果 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4026 | R1248 | R1275 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:194</code> | direct | 索引结果 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4032 | R1249 | R1157 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:220</code> | direct | 候选 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4031 | R1249 | R1166 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:217</code> | direct | 键、事务序号_ | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4030 | R1249 | R1262 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:216</code> | direct | this | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4042 | R1253 | R1261 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:241</code> | direct | this | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4043 | R1253 | R1263 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:241</code> | direct | this | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4044 | R1253 | R1264 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:242</code> | direct | this | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4045 | R1253 | R1267 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:243</code> | direct | 提交前置失败结果 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4056 | R1268 | R1261 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:360</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4058 | R1268 | R1264 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:360</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4063 | R1268 | R1267 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:361</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4048 | R1269 | R1255 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:370</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4051 | R1269 | R1257 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:370</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4059 | R1269 | R1264 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:371</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4069 | R1270 | R1168 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:408</code> | direct | 索引候选、事务序号_ | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3913 | R1270 | R1188 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:396, 海中鱼巣/核心/会话.节点直接身份结构写入.ixx:403</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3920 | R1270 | R1194 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:397, 海中鱼巣/核心/会话.节点直接身份结构写入.ixx:404</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3931 | R1270 | R1202 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:397, 海中鱼巣/核心/会话.节点直接身份结构写入.ixx:404</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3974 | R1270 | R1223 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:394, 海中鱼巣/核心/会话.节点直接身份结构写入.ixx:401</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4049 | R1270 | R1255 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:379</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4057 | R1270 | R1263 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:379</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4060 | R1270 | R1264 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:382</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4067 | R1270 | R1273 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:390</code> | direct | 节点确认结果 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4068 | R1270 | R1274 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:396, 海中鱼巣/核心/会话.节点直接身份结构写入.ixx:403</code> | direct | 关系确认状态、当前句柄 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4070 | R1270 | R1275 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:410</code> | direct | 索引确认状态 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4313 | R1270 | R1330 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:394</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4266 | R1270 | R1352 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:394</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4238 | R1270 | R1384 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:394</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4066 | R1270 | R1430 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:388</code> | direct | 节点候选、事务序号_ | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4072 | R1271 | R1169 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:426</code> | direct | 索引候选、事务序号_ | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3978 | R1271 | R1224 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:432, 海中鱼巣/核心/会话.节点直接身份结构写入.ixx:438</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4073 | R1271 | R1431 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:444</code> | direct | 节点候选、事务序号_ | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4076 | R1272 | R1170 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:461</code> | direct | 索引候选、事务序号_ | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3980 | R1272 | R1225 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:459, 海中鱼巣/核心/会话.节点直接身份结构写入.ixx:460</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4318 | R1272 | R1332 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:459</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4272 | R1272 | R1354 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:459</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4243 | R1272 | R1386 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:459</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4075 | R1272 | R1432 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:458</code> | direct | 节点候选、事务序号_ | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4038 | R1276 | R1250 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:580</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4039 | R1277 | R1251 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:585</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4041 | R1278 | R1252 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:590</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4001 | R1279 | R1178 | <code>海中鱼巣/核心/冻结.节点直接身份结构.ixx:99</code> | direct | 索引仓库 | 索引材料 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3930 | R1279 | R1202 | <code>海中鱼巣/核心/冻结.节点直接身份结构.ixx:85</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3971 | R1279 | R1221 | <code>海中鱼巣/核心/冻结.节点直接身份结构.ixx:86</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4000 | R1279 | R1448 | <code>海中鱼巣/核心/冻结.节点直接身份结构.ixx:68</code> | direct | 节点仓库 | 节点材料 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4095 | R1339 | R1285 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:386</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4207 | R1471 | R0914 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:115</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4400 | R1471 | R0924 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:112</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4401 | R1471 | R0935 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:113</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4399 | R1471 | R1162 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:111</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4398 | R1471 | R1200 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:110</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4397 | R1471 | R1416 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:109</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4393 | R1471 | R1462 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:110</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4394 | R1471 | R1463 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:125</code> | implicit member construction | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4395 | R1472 | R1464 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:128</code> | implicit member destruction | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4407 | R1474 | R1473 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:147</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4410 | R1475 | R1282 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:158</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4409 | R1475 | R1291 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:157</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4418 | R1478 | R0925 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:209</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4421 | R1478 | R1178 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:212</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4420 | R1478 | R1214 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:211</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4424 | R1478 | R1322 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:215</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4423 | R1478 | R1356 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:214</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4422 | R1478 | R1387 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:213</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4419 | R1478 | R1448 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:210</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4428 | R1479 | F0163 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:289</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4429 | R1479 | F0168 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:290</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4427 | R1479 | R0925 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:277</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4426 | R1479 | R0939 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:271</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4431 | R1479 | R1205 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:295</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4433 | R1479 | R1280 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:303</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4430 | R1479 | R1437 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:294</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4432 | R1479 | R1459 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:301, 海中鱼巣/核心/自检.节点直接结构查询.ixx:306, 海中鱼巣/核心/自检.节点直接结构查询.ixx:308</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4411 | R1479 | R1475 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:310</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4415 | R1479 | R1476 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:312</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4202 | R1479 | R1487 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:282, 海中鱼巣/核心/自检.节点直接结构查询.ixx:283</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4221 | R1479 | R1494 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:310, 海中鱼巣/核心/自检.节点直接结构查询.ixx:312</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4449 | R1485 | R0950 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:435</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4416 | R1486 | R1476 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:475</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4223 | R1486 | R1494 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:471, 海中鱼巣/核心/自检.节点直接结构查询.ixx:472</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4226 | R1486 | R1497 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:470</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4148 | R1487 | R1155 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:279</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4189 | R1487 | R1179 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:270</code> | unordered_map_hash_callback | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4191 | R1487 | R1180 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:287</code> | unordered_map_equal_callback | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4193 | R1487 | R1181 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:287</code> | unordered_map_hash_callback | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4195 | R1487 | R1182 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:286</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4198 | R1487 | R1183 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:305</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4200 | R1487 | R1291 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:270, 海中鱼巣/核心/仓库.可重建索引.ixx:283, 海中鱼巣/核心/仓库.可重建索引.ixx:296</code> | unordered_map_equal_callback | 键与桶内键 | 等值布尔 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4199 | R1487 | R1292 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:259</code> | direct | 键 | 物理键完整性 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4215 | R1494 | F0163 | <code>海中鱼巣/核心/服务.节点直接结构.ixx:154, 海中鱼巣/核心/服务.节点直接结构.ixx:169</code> | existing_function_id | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4216 | R1494 | F0168 | <code>海中鱼巣/核心/服务.节点直接结构.ixx:154, 海中鱼巣/核心/服务.节点直接结构.ixx:169</code> | existing_function_id | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4211 | R1494 | R0916 | <code>海中鱼巣/核心/服务.节点直接结构.ixx:130</code> | sibling_candidate_key | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4212 | R1494 | R0917 | <code>海中鱼巣/核心/服务.节点直接结构.ixx:133</code> | sibling_candidate_key | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4210 | R1494 | R0925 | <code>海中鱼巣/核心/服务.节点直接结构.ixx:129</code> | sibling_candidate_key | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4219 | R1494 | R1205 | <code>海中鱼巣/核心/服务.节点直接结构.ixx:175</code> | sibling_candidate_key | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4213 | R1494 | R1291 | <code>海中鱼巣/核心/服务.节点直接结构.ixx:145</code> | sibling_candidate_key | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4209 | R1494 | R1292 | <code>海中鱼巣/核心/服务.节点直接结构.ixx:119</code> | sibling_candidate_key | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4217 | R1494 | R1437 | <code>海中鱼巣/核心/服务.节点直接结构.ixx:160</code> | sibling_candidate_key | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4201 | R1494 | R1487 | <code>海中鱼巣/核心/服务.节点直接结构.ixx:137</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4218 | R1494 | R1498 | <code>海中鱼巣/核心/服务.节点直接结构.ixx:167</code> | candidate_key | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4220 | R1494 | R1499 | <code>海中鱼巣/核心/服务.节点直接结构.ixx:182</code> | candidate_key | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4214 | R1494 | R1501 | <code>海中鱼巣/核心/服务.节点直接结构.ixx:149</code> | candidate_key | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| E1639 | F0321 | F0336 | <code>海中鱼巣/核心/结构事务接线.数据.h:83</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| E1638 | F0321 | F0618 | <code>海中鱼巣/核心/结构事务接线.数据.h:83</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| E1640 | F0322 | F0336 | <code>海中鱼巣/核心/节点仓库.cpp:17, 海中鱼巣/核心/节点仓库.cpp:18</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| E1644 | F0323 | F0336 | <code>海中鱼巣/核心/关系仓库.cpp:82, 海中鱼巣/核心/关系仓库.cpp:83</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| E1648 | F0324 | F0336 | <code>海中鱼巣/核心/索引仓库.cpp:13, 海中鱼巣/核心/索引仓库.cpp:14</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0105 | F0326 | F0168 | <code>海中鱼巣/领域/方法服务.h:139, 海中鱼巣/领域/方法服务.h:140, 海中鱼巣/领域/方法服务.h:141</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0107 | F0332 | F0397 | <code>海中鱼巣/核心/节点仓库.cpp:55</code> | resolved-function-pointer |  | None | 事务接线已接域；生产运行期唯一正式共享许可目标 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0108 | F0350 | F0168 | <code>海中鱼巣/领域/初始化.需求.ixx:48, 海中鱼巣/领域/初始化.需求.ixx:50, 海中鱼巣/领域/初始化.需求.ixx:51, 海中鱼巣/领域/初始化.需求.ixx:52, 海中鱼巣/领域/初始化.需求.ixx:53</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0144 | F0365 | F0184 | <code>海中鱼巣/领域/存在服务.h:107</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
...
| RCE0145 | F0366 | F0184 | <code>海中鱼巣/领域/动态服务.h:290</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
...
| RCE0148 | F0367 | F0184 | <code>海中鱼巣/领域/二次特征服务.h:52</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0149 | F0367 | R0204 | <code>海中鱼巣/领域/二次特征服务.h:55</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0147 | F0367 | R0206 | <code>海中鱼巣/领域/二次特征服务.h:50</code> | suffix_match |  | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE0152 | F0369 | R0521 | <code>海中鱼巣/领域/概念图服务.h:931</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE0153 | F0370 | F0369 | <code>海中鱼巣/领域/概念图服务.h:1032, 海中鱼巣/领域/概念图服务.h:1033</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0155 | F0370 | R0526 | <code>海中鱼巣/领域/概念图服务.h:1041</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0154 | F0370 | R0531 | <code>海中鱼巣/领域/概念图服务.h:1038</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0156 | F0371 | F0621 | <code>海中鱼巣/领域/概念图服务.h:1045</code> | direct-const-member |  | None | 实例到实例支持概念；二实参目标节点组重载 | 专项源码静态类型与实际装配人工复核 |
| RCE0157 | F0372 | R0088 | <code>海中鱼巣/领域/概念图服务.h:1049</code> | direct-const-member |  | None | 概念到实例支持概念；二实参来源节点组重载 | 专项源码静态类型与实际装配人工复核 |
| RCE0165 | F0381 | F0207 | <code>海中鱼巣/适配/SQL数据库适配.cpp:251</code> | constructor |  | None | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0166 | F0381 | F0208 | <code>海中鱼巣/适配/SQL数据库适配.cpp:252</code> | field_type_hint+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 逐边源码/静态类型审计 PASS；专项源码静态类型与实际装配人工复核 |
| RCE0167 | F0381 | F0209 | <code>海中鱼巣/适配/SQL数据库适配.cpp:257, 海中鱼巣/适配/SQL数据库适配.cpp:261</code> | field_type_hint+direct-member+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 逐边源码/静态类型审计 PASS；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核 |
| RCE0168 | F0381 | F0210 | <code>海中鱼巣/适配/SQL数据库适配.cpp:260</code> | lsp_direct+direct-free | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 逐边源码/静态类型审计 PASS；专项源码静态类型与实际装配人工复核 |
| RCE0169 | F0381 | F0211 | <code>海中鱼巣/适配/SQL数据库适配.cpp:261</code> | lsp_direct+direct-free | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 逐边源码/静态类型审计 PASS；专项源码静态类型与实际装配人工复核 |
...
| RCE0170 | F0383 | F0439 | <code>海中鱼巣/核心/主信息仓库.cpp:447</code> | suffix_match+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
...
| RCE0171 | F0384 | F0439 | <code>海中鱼巣/核心/主信息仓库.cpp:199</code> | direct-member |  | None | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0173 | F0385 | R0149 | <code>海中鱼巣/界面/投影.控制面板启动.ixx:49</code> | lsp_direct | None | None | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
| RCE0175 | F0385 | R0240 | <code>海中鱼巣/界面/投影.控制面板启动.ixx:50</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0172 | F0385 | R0247 | <code>海中鱼巣/界面/投影.控制面板启动.ixx:52</code> | field_type_hint |  | None | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
| RCE0174 | F0385 | R0248 | <code>海中鱼巣/界面/投影.控制面板启动.ixx:49</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0179 | F0388 | F0393 | <code>海中鱼巣/界面/控制面板窗口.cpp:406</code> | unique_name+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 逐边源码/静态类型审计 PASS；专项源码静态类型与实际装配人工复核 |
| RCE0180 | F0388 | R0176 | <code>海中鱼巣/界面/控制面板窗口.cpp:411</code> | unique_name+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 逐边源码/静态类型审计 PASS；专项源码静态类型与实际装配人工复核 |
| RCE0176 | F0388 | R0202 | <code>海中鱼巣/界面/控制面板窗口.cpp:387</code> | same_module+direct-free |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 逐边源码/静态类型审计 PASS；专项源码静态类型与实际装配人工复核 |
| RCE0177 | F0388 | R0304 | <code>海中鱼巣/界面/控制面板窗口.cpp:387</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
| RCE0178 | F0388 | R0306 | <code>海中鱼巣/界面/控制面板窗口.cpp:388</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
...
| RCE0181 | F0389 | F0393 | <code>海中鱼巣/界面/控制面板窗口.cpp:428, 海中鱼巣/界面/控制面板窗口.cpp:445</code> | unique_name+direct-member+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 逐边源码/静态类型审计 PASS；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核 |
| RCE0182 | F0390 | F0393 | <code>海中鱼巣/界面/控制面板窗口.cpp:470</code> | unique_name+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 逐边源码/静态类型审计 PASS；专项源码静态类型与实际装配人工复核 |
| RCE0183 | F0391 | F0393 | <code>海中鱼巣/界面/控制面板窗口.cpp:480, 海中鱼巣/界面/控制面板窗口.cpp:488</code> | unique_name+direct-member+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 逐边源码/静态类型审计 PASS；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核 |
| RCE0184 | F0391 | R0194 | <code>海中鱼巣/界面/控制面板窗口.cpp:493</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 逐边源码/静态类型审计 PASS；专项源码静态类型与实际装配人工复核 |
| RCE0185 | F0392 | F0393 | <code>海中鱼巣/界面/控制面板窗口.cpp:509</code> | unique_name+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 逐边源码/静态类型审计 PASS；专项源码静态类型与实际装配人工复核 |
| RCE0186 | F0396 | R0151 | <code>海中鱼巣/界面/控制面板窗口.cpp:1609</code> | direct-member |  | None | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0189 | F0396 | R0153 | <code>海中鱼巣/界面/控制面板窗口.cpp:1633</code> | direct-member |  | None | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0187 | F0396 | R0156 | <code>海中鱼巣/界面/控制面板窗口.cpp:1617</code> | direct-member |  | None | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0191 | F0396 | R0160 | <code>海中鱼巣/界面/控制面板窗口.cpp:1644</code> | direct-member |  | None | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0193 | F0396 | R0166 | <code>海中鱼巣/界面/控制面板窗口.cpp:1660</code> | direct-member |  | None | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0190 | F0396 | R0167 | <code>海中鱼巣/界面/控制面板窗口.cpp:1634</code> | direct-member |  | None | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0188 | F0396 | R0185 | <code>海中鱼巣/界面/控制面板窗口.cpp:1626</code> | direct-member |  | None | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0192 | F0396 | R0201 | <code>海中鱼巣/界面/控制面板窗口.cpp:1652</code> | direct-member |  | None | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0195 | F0398 | R0101 | <code>海中鱼巣/核心/协调.结构事务.ixx:153</code> | source-audited |  | None | 正式接线独占许可 lambda 被调用 | 专项源码静态类型与实际装配人工复核 |
| RCE0196 | F0399 | R0098 | <code>海中鱼巣/核心/协调.结构事务.ixx:154</code> | source-audited |  | None | 正式接线共享令牌验证 lambda 被调用 | 专项源码静态类型与实际装配人工复核 |
| RCE0197 | F0400 | R0098 | <code>海中鱼巣/核心/协调.结构事务.ixx:155</code> | source-audited |  | None | 正式接线独占令牌验证 lambda 被调用 | 专项源码静态类型与实际装配人工复核 |
| RCE0198 | F0401 | R0099 | <code>海中鱼巣/核心/协调.结构事务.ixx:156</code> | source-audited |  | None | 正式接线撤销失败隔离 lambda 被调用 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0199 | F0403 | R0114 | <code>海中鱼巣/领域/数据操作.状态动态.ixx:321</code> | constructor |  | None | 状态动态数据操作构造其结构写入执行器 | 专项源码静态类型与实际装配人工复核 |
| RCE0200 | F0404 | R0114 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:468</code> | constructor |  | None | 特征体系数据操作构造其结构写入执行器 | 专项源码静态类型与实际装配人工复核 |
| RCE0201 | F0404 | R0265 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:468</code> | constructor |  | None | 特征体系数据操作构造原始材料侧表访问器 | 专项源码静态类型与实际装配人工复核 |
| RCE0202 | F0404 | R0272 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:469</code> | constructor |  | None | 特征体系数据操作构造批次发布记录只读访问器；只构造访问器，不使未接线批次写入路径可达 | 专项源码静态类型与实际装配人工复核 |
| RCE0203 | F0405 | R0114 | <code>海中鱼巣/领域/数据操作.语素基础.ixx:215</code> | constructor |  | None | 语素基础数据操作构造其结构写入执行器 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0204 | F0407 | R0114 | <code>海中鱼巣/领域/数据操作.概念图结构.ixx:254</code> | constructor |  | None | 概念图结构数据操作构造其结构写入执行器 | 专项源码静态类型与实际装配人工复核 |
| RCE0205 | F0408 | R0114 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:875</code> | constructor |  | None | 需求任务方法数据操作构造其结构写入执行器 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0206 | F0410 | R0114 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:34</code> | constructor |  | None | 概念活动数据操作构造其结构写入执行器 | 专项源码静态类型与实际装配人工复核 |
| RCE0207 | F0439 | R0002 | <code>海中鱼巣/核心/主信息仓库.cpp:213</code> | same_module+direct-free | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 逐边源码/静态类型审计 PASS；专项源码静态类型与实际装配人工复核 |
...
| RCE0209 | F0440 | F0587 | <code>海中鱼巣/核心/关系仓库.cpp:1432</code> | direct-member |  | None | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0210 | F0441 | R0120 | <code>海中鱼巣/核心/索引仓库.cpp:189</code> | same_module+direct-free | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 逐边源码/静态类型审计 PASS；专项源码静态类型与实际装配人工复核 |
| RCE0211 | F0442 | F0336 | <code>海中鱼巣/领域/数据操作.存在场景.ixx:154</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0212 | F0443 | F0336 | <code>海中鱼巣/领域/数据操作.状态动态.ixx:325</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0213 | F0444 | F0336 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:472</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
...
| RCE0214 | F0445 | F0336 | <code>海中鱼巣/领域/数据操作.语素基础.ixx:218</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
...
| RCE0215 | F0446 | F0336 | <code>海中鱼巣/领域/数据操作.轻量因果.ixx:105</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
...
| RCE0216 | F0447 | F0336 | <code>海中鱼巣/领域/数据操作.概念图结构.ixx:257</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
...
| RCE0217 | F0448 | F0336 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:878</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
...
| RCE0218 | F0449 | F0336 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:39</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
...
| RCE0222 | F0454 | R0236 | <code>海中鱼巣/领域/初始化.系统角色.ixx:180</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0221 | F0454 | R0239 | <code>海中鱼巣/领域/初始化.系统角色.ixx:179</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE0223 | F0455 | R0229 | <code>海中鱼巣/领域/初始化.系统角色.ixx:103, 海中鱼巣/领域/初始化.系统角色.ixx:111</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0225 | F0455 | R0231 | <code>海中鱼巣/领域/初始化.系统角色.ixx:154</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0229 | F0455 | R0232 | <code>海中鱼巣/领域/初始化.系统角色.ixx:72</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0226 | F0455 | R0236 | <code>海中鱼巣/领域/初始化.系统角色.ixx:156, 海中鱼巣/领域/初始化.系统角色.ixx:162</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE0227 | F0455 | R0409 | <code>海中鱼巣/领域/初始化.系统角色.ixx:160</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0228 | F0455 | R0422 | <code>海中鱼巣/领域/初始化.系统角色.ixx:70, 海中鱼巣/领域/初始化.系统角色.ixx:152</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0230 | F0455 | R0496 | <code>海中鱼巣/领域/初始化.系统角色.ixx:77</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0224 | F0455 | R0499 | <code>海中鱼巣/领域/初始化.系统角色.ixx:146</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0231 | F0455 | R0565 | <code>海中鱼巣/领域/初始化.系统角色.ixx:86, 海中鱼巣/领域/初始化.系统角色.ixx:87</code> | direct_const_member |  | None | 系统角色初始化读取写前预检中的既有身份与稳定键 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0233 | F0458 | R0564 | <code>海中鱼巣/领域/系统角色清单.数据.h:196</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE0234 | F0459 | F0168 | <code>海中鱼巣/领域/系统角色清单.数据.h:134</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
...
| RCE0235 | F0461 | R0331 | <code>海中鱼巣/领域/服务.概念活动.ixx:73</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0236 | F0461 | R0500 | <code>海中鱼巣/领域/服务.概念活动.ixx:74</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0237 | F0461 | R0539 | <code>海中鱼巣/领域/服务.概念活动.ixx:75</code> | field_type_hint |  | None | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
...
| RCE0239 | F0462 | R0331 | <code>海中鱼巣/领域/服务.概念活动.ixx:38</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0240 | F0462 | R0340 | <code>海中鱼巣/领域/服务.概念活动.ixx:59</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0238 | F0462 | R0500 | <code>海中鱼巣/领域/服务.概念活动.ixx:33</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE0241 | F0464 | F0465 | <code>海中鱼巣/领域/概念活动状态.数据.h:146</code> | direct-const-member |  | None | 逐项比较两侧概念活动根材料 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0242 | F0465 | R0542 | <code>海中鱼巣/领域/概念活动状态.数据.h:117, 海中鱼巣/领域/概念活动状态.数据.h:118</code> | same_module | None | None | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
...
| RCE1683 | F0466 | R0538 | <code>海中鱼巣/领域/概念活动状态.数据.h:138</code> | direct-const-member |  | None | 重建视图逐根复核给定活跃角色 | 专项源码静态类型与实际装配人工复核 |
| RCE0244 | F0467 | F0163 | <code>海中鱼巣/领域/概念活动状态.数据.h:65</code> | direct-free |  | None | 状态节点静态类型为节点句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE0245 | F0467 | F0565 | <code>海中鱼巣/领域/概念活动状态.数据.h:65</code> | direct-free |  | None | 主信息静态类型为主信息句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE0246 | F0468 | F0013 | <code>海中鱼巣/自检.入口初始化.ixx:56</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0247 | F0468 | F0014 | <code>海中鱼巣/自检.入口初始化.ixx:57</code> | field_type_hint |  | None | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
...
| RCE0252 | F0523 | R0147 | <code>海中鱼巣/核心/节点仓库.cpp:334</code> | direct-member |  | None | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0253 | F0544 | F0441 | <code>海中鱼巣/核心/索引仓库.cpp:175</code> | direct-member |  | None | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0254 | F0553 | R0576 | <code>海中鱼巣/领域/需求服务.h:544, 海中鱼巣/领域/需求服务.h:548</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE0255 | F0554 | R0559 | <code>海中鱼巣/领域/特征服务.h:263</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0256 | F0554 | R0561 | <code>海中鱼巣/领域/特征服务.h:263, 海中鱼巣/领域/特征服务.h:268</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0257 | F0555 | R0558 | <code>海中鱼巣/领域/特征服务.h:364</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE0507 | R0088 | F0051 | <code>海中鱼巣/核心/关系仓库.cpp:879</code> | direct-free |  | None | 记录目标等于目标节点 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0505 | R0088 | F0341 | <code>海中鱼巣/核心/关系仓库.cpp:873</code> | direct-free |  | None | 目标节点有效；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0506 | R0088 | F0343 | <code>海中鱼巣/核心/关系仓库.cpp:873, 海中鱼巣/核心/关系仓库.cpp:880</code> | direct-const-member+direct-member+direct-member |  | None | 入口；目标节点；读取有效来源节点；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0508 | R0088 | R0090 | <code>海中鱼巣/核心/关系仓库.cpp:884</code> | standard-library-callback |  | None | std::sort 注册的唯一比较回调 | 专项源码静态类型与实际装配人工复核 |
| RCE0518 | R0101 | R0097 | <code>海中鱼巣/核心/协调.结构事务.ixx:85</code> | same_module+source-audited | None | None | 调用方可达且源码分支条件成立；结构事务内部直接调用 | 逐边源码/静态类型审计 PASS；专项源码静态类型与实际装配人工复核 |
| RCE0517 | R0101 | R0137 | <code>海中鱼巣/核心/协调.结构事务.ixx:130</code> | unique_name+source-audited | None | None | 调用方可达且源码分支条件成立；结构事务内部直接调用 | 逐边源码/静态类型审计 PASS；专项源码静态类型与实际装配人工复核 |
...
| RCE0551 | R0115 | F0336 | <code>海中鱼巣/核心/执行器.结构写入.ixx:70</code> | unique_name+source-audited |  | None | 调用方可达且源码分支条件成立；执行器有效性首先复核事务接线已接域 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
| RCE0577 | R0120 | F0336 | <code>海中鱼巣/核心/索引仓库.cpp:19</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0578 | R0120 | F0399 | <code>海中鱼巣/核心/索引仓库.cpp:19</code> | resolved-function-pointer |  | None | 运行期上下文把结构事务协调器::生成接线的共享验证 lambda 按值装入索引仓库接线 | 专项源码静态类型与实际装配人工复核 |
| RCE0618 | R0147 | R0145 | <code>海中鱼巣/核心/节点仓库.cpp:351</code> | direct+direct-free |  | None | 删除节点令牌重载进入后验证独占令牌；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE1724 | R0277 | R0609 | <code>海中鱼巣/领域/存在服务.h:140</code> | direct_const_member | this, 存在节点 | 存在记录有值判定 | R0277进入 | 同一具名类型一参数重载与定义范围复核 |
| RCE1690 | R0523 | F0051 | <code>海中鱼巣/领域/概念图服务.h:3775</code> | operator |  | None | 逐份签名材料比较概念节点 | 专项源码静态类型与实际装配人工复核 |
| RCE1538 | R0532 | R0534 | <code>海中鱼巣/领域/概念图算法.h:233</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1539 | R0532 | R0535 | <code>海中鱼巣/领域/概念图算法.h:234</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1540 | R0533 | R0532 | <code>海中鱼巣/领域/概念图算法.h:254, 海中鱼巣/领域/概念图算法.h:255</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1541 | R0533 | R0537 | <code>海中鱼巣/领域/概念图算法.h:258</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1584 | R0573 | F0496 | <code>海中鱼巣/领域/语素服务.h:361</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1585 | R0573 | R0570 | <code>海中鱼巣/领域/语素服务.h:361</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1582 | R0573 | R0574 | <code>海中鱼巣/领域/语素服务.h:342, 海中鱼巣/领域/语素服务.h:348, 海中鱼巣/领域/语素服务.h:355, 海中鱼巣/领域/语素服务.h:366</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1592 | R0575 | R0569 | <code>海中鱼巣/领域/语素服务.h:66</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1692 | R0600 | F0631 | <code>海中鱼巣/核心/结构事务接线.数据.h:31</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；非自赋值分支先释放当前许可 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE1694 | R0604 | F0163 | <code>海中鱼巣/领域/概念图服务.h:245, 海中鱼巣/领域/概念图服务.h:246</code> | direct_free |  | None | 依次复核源节点和目标节点句柄有效 | 专项源码静态类型与实际装配人工复核 |
| RCE1693 | R0604 | F0168 | <code>海中鱼巣/领域/概念图服务.h:244</code> | unique_name+direct_free | None | None | 调用方可达且源码分支条件成立；复核关系句柄有效 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
| RCE1695 | R0605 | F0051 | <code>海中鱼巣/领域/概念图服务.h:3019</code> | operator |  | None | 登记槽有值后比较状态节点 | 专项源码静态类型与实际装配人工复核 |
| RCE1696 | R0605 | F0377 | <code>海中鱼巣/领域/概念图服务.h:3020</code> | direct_const_member |  | None | 登记状态等于输入后复核节点仍有效 | 专项源码静态类型与实际装配人工复核 |
| RCE1697 | R0606 | F0051 | <code>海中鱼巣/领域/概念图服务.h:3079, 海中鱼巣/领域/概念图服务.h:3087, 海中鱼巣/领域/概念图服务.h:3088</code> | operator |  | None | lambda 先比较登记概念和状态，再比较读回端点 | 专项源码静态类型与实际装配人工复核 |
| RCE1698 | R0606 | F0587 | <code>海中鱼巣/领域/概念图服务.h:3082</code> | direct_const_member |  | None | 登记概念和状态均匹配后读取登记关系 | 专项源码静态类型与实际装配人工复核 |
| RCE1699 | R0607 | F0051 | <code>海中鱼巣/领域/概念图服务.h:3096</code> | operator |  | None | lambda 比较登记概念和状态 | 专项源码静态类型与实际装配人工复核 |
| RCE1700 | R0607 | F0587 | <code>海中鱼巣/领域/概念图服务.h:3099</code> | direct_const_member |  | None | 登记概念和状态均匹配后读取登记关系 | 专项源码静态类型与实际装配人工复核 |
| RCE1701 | R0608 | F0163 | <code>海中鱼巣/领域/概念图服务.h:56, 海中鱼巣/领域/概念图服务.h:59</code> | direct_free |  | None | 复核概念和状态节点句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE1702 | R0608 | F0168 | <code>海中鱼巣/领域/概念图服务.h:60</code> | direct_free |  | None | 阶段和两个节点句柄前置成立后复核关系句柄 | 专项源码静态类型与实际装配人工复核 |
...
| RCE3212 | R0868 | R0874 | <code>海中鱼巣/领域/状态服务.h:227, 海中鱼巣/领域/状态服务.h:232</code> | source-audited-direct | 按列示调用点的当前源码实参绑定 | 被调结果按源码用于局部绑定、条件判断、回调或直接返回 | 调用方当前可达且列示源码分支条件成立 | 当前源码 blob、正式身份表与递归闭包逐调用点复核 |
...
| RCE3384 | R0917 | R0916 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:62</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3385 | R0921 | R0919 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:102</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3386 | R0925 | R0918 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:149</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3387 | R0927 | R0922 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:163</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3388 | R0927 | R0926 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:161</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3393 | R0933 | R0933 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:238</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3394 | R0933 | R0934 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:238</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3395 | R0933 | R0951 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:238</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3455 | R0939 | F0438 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:445</code> | formal_03a8_identity | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3427 | R0939 | R0919 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:432</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3419 | R0939 | R0920 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:586, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:588, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:589, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:590, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:591, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:592, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:593, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:594, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:595, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:596, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:597, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:599, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:600, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:601, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:602, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:603, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:604, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:606, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:607, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:608, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:609, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:610, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:611, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:614, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:615, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:616, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:617, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:618, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:619</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3420 | R0939 | R0921 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:432</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3421 | R0939 | R0923 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:622, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:629</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3422 | R0939 | R0928 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:431</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3423 | R0939 | R0930 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:620</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3424 | R0939 | R0932 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:428</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4520 | R0939 | R0940 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:437</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4521 | R0939 | R0941 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:440</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3456 | R0939 | R0942 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:461</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3457 | R0939 | R0943 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:481</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3425 | R0939 | R0944 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:553, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:554, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:571</code> | local_lambda_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3458 | R0939 | R0946 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:540</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4523 | R0939 | R0947 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:548</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3426 | R0939 | R0948 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:575</code> | local_lambda_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3431 | R0939 | R1174 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:594</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3430 | R0939 | R1175 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:603</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3429 | R0939 | R1176 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:597, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:607</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3428 | R0939 | R1177 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:618</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3435 | R0939 | R1217 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:592</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3434 | R0939 | R1218 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:602</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3433 | R0939 | R1219 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:595, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:597, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:608</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3432 | R0939 | R1220 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:617</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3454 | R0939 | R1283 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:456</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3441 | R0939 | R1286 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:429</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3440 | R0939 | R1325 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:586, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:596</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3439 | R0939 | R1326 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:599, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:604</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3438 | R0939 | R1327 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:589, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:606</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3437 | R0939 | R1328 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:614, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:619</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3445 | R0939 | R1360 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:586, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:590</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3444 | R0939 | R1361 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:599, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:601</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3443 | R0939 | R1362 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:589, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:593, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:595, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:597, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:609</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3442 | R0939 | R1363 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:614, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:616</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3449 | R0939 | R1391 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:586, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:588</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3448 | R0939 | R1392 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:599, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:600</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3447 | R0939 | R1393 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:589, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:591, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:593, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:595, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:597, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:610</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3446 | R0939 | R1394 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:614, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:615</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3453 | R0939 | R1419 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:586</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3452 | R0939 | R1426 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:599</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3451 | R0939 | R1427 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:589, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:591, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:593, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:595, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:597, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:611</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3450 | R0939 | R1428 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:614</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3436 | R0939 | R1457 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:450</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3641 | R1047 | R1107 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3117-3126, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3122</code> | virtual_dispatch_target | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3642 | R1047 | R1108 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3117-3126, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3122</code> | virtual_dispatch_target | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3643 | R1047 | R1124 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3117-3126, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3122</code> | virtual_dispatch_target | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3644 | R1047 | R1243 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3121</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3645 | R1048 | R1109 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3128-3135, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3131</code> | virtual_dispatch_target | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3646 | R1048 | R1110 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3128-3135, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3131</code> | virtual_dispatch_target | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3647 | R1048 | R1125 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3128-3135, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3131</code> | virtual_dispatch_target | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3651 | R1050 | R1111 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3146-3149, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3148</code> | virtual_dispatch_target | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3652 | R1050 | R1112 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3146-3149, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3148</code> | virtual_dispatch_target | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3653 | R1050 | R1126 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3146-3149, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3148</code> | virtual_dispatch_target | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3655 | R1052 | R0923 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3173</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3656 | R1052 | R1051 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3167</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3657 | R1052 | R1113 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3168</code> | virtual_dispatch_target | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3658 | R1052 | R1114 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3168</code> | virtual_dispatch_target | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3659 | R1052 | R1127 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3168</code> | virtual_dispatch_target | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3358 | R1054 | R0937 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:29</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3359 | R1055 | R0938 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:39</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3356 | R1091 | R1054 | <code>海中鱼巣/核心/服务.节点直接类型化结构提交.ixx:48</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3357 | R1091 | R1092 | <code>海中鱼巣/核心/服务.节点直接类型化结构提交.ixx:48</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4486 | R1096 | R1095 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:52</code> | callback_address_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4482 | R1098 | R0931 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:68</code> | direct_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3660 | R1098 | R1096 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:66</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3699 | R1129 | R0022 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:615</code> | formal_03a8_identity | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3698 | R1129 | R1245 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:618</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3697 | R1129 | R1254 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:620</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3701 | R1130 | R0022 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:626</code> | formal_03a8_identity | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3702 | R1130 | R0041 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:632</code> | formal_03a8_identity | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3700 | R1130 | R1245 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:629</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3703 | R1131 | R0022 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:637</code> | formal_03a8_identity | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3704 | R1131 | R0041 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:639</code> | formal_03a8_identity | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3706 | R1132 | R0022 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:644</code> | formal_03a8_identity | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3705 | R1132 | R1254 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:645</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3708 | R1133 | R0022 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:650</code> | formal_03a8_identity | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3707 | R1133 | R1254 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:651</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3710 | R1134 | R0022 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:656</code> | formal_03a8_identity | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3709 | R1134 | R1254 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:658</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3743 | R1136 | R0022 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:717, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:718</code> | formal_03a8_identity | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3744 | R1136 | R0041 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:751</code> | formal_03a8_identity | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3731 | R1136 | R0919 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:732</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3730 | R1136 | R0925 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:731</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3732 | R1136 | R1101 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:726, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:727</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3733 | R1136 | R1102 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:726, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:727</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3735 | R1136 | R1209 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:736</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3734 | R1136 | R1242 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:719, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:739, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:748</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3742 | R1136 | R1245 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:728, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:729</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3737 | R1136 | R1246 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:737</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3740 | R1136 | R1247 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:744</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3738 | R1136 | R1248 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:747</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3741 | R1136 | R1249 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:749</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3739 | R1136 | R1254 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:721, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:751</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3736 | R1136 | R1437 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:730</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3757 | R1139 | R0926 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:848</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3758 | R1139 | R0933 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:834</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3759 | R1139 | R1105 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:843</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3760 | R1139 | R1106 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:843</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3761 | R1139 | R1122 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:843</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4540 | R1139 | R1140 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:835</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3762 | R1139 | R1172 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:847</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3763 | R1139 | R1221 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:846</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3764 | R1139 | R1445 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:845</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3783 | R1142 | R0022 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:862</code> | formal_03a8_identity | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3778 | R1142 | R1097 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:861</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3779 | R1142 | R1101 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:865</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3780 | R1142 | R1102 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:865</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3782 | R1142 | R1245 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:866</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3781 | R1142 | R1254 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:868</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3784 | R1143 | R1254 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:872</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3785 | R1145 | R0933 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:901</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3787 | R1145 | R1146 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:901</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3786 | R1145 | R1437 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:921</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3859 | R1151 | R1056 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1297</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3860 | R1151 | R1096 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1287</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3861 | R1151 | R1165 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1302</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3862 | R1151 | R1440 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1299</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3873 | R1153 | R0041 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1354</code> | formal_03a8_identity | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3905 | R1154 | R0926 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1410</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3909 | R1154 | R0950 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1407</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3908 | R1154 | R1098 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1399</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3907 | R1154 | R1120 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1401, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1403</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3906 | R1154 | R1122 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:1409</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4143 | R1155 | F0163 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:41, 海中鱼巣/核心/仓库.可重建索引.ixx:44</code> | direct | 记录节点句柄 | 有效性布尔值 | 目标种类节点 | 4b80f161 冻结源码逐调用点复核 |
| RCE4144 | R1155 | F0168 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:41, 海中鱼巣/核心/仓库.可重建索引.ixx:44</code> | direct | 记录关系句柄 | 有效性布尔值 | 目标种类关系 | 4b80f161 冻结源码逐调用点复核 |
| RCE4086 | R1155 | R1292 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:39</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4165 | R1166 | R1183 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:345</code> | direct | 当前记录、事务序号 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4164 | R1166 | R1184 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:344</code> | direct | 键、事务序号 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3999 | R1178 | R1173 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:443</code> | callback | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4187 | R1178 | R1493 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:548</code> | callback | 索引记录左右项 |  | std::sort比较 | 4b80f161 冻结源码逐调用点复核 |
| RCE3941 | R1183 | R1205 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:500, 海中鱼巣/核心/仓库.可重建索引.ixx:605</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4196 | R1183 | R1437 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:602</code> | direct | 记录节点与可选事务序号 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4197 | R1183 | R1438 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:602</code> | direct | 记录节点与可选事务序号 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4091 | R1185 | R1282 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:520, 海中鱼巣/核心/仓库.可重建索引.ixx:625</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4092 | R1185 | R1291 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:520, 海中鱼巣/核心/仓库.可重建索引.ixx:625</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3915 | R1201 | R1190 | <code>海中鱼巣/核心/仓库.正式关系.ixx:251</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3933 | R1203 | R0899 | <code>海中鱼巣/核心/仓库.正式关系.ixx:281</code> | function_pointer_callback | 源类型、目标类型、顺序号 | 准入布尔值 | 具名准入规则已定位 | 4b80f161 冻结源码逐调用点复核 |
| RCE3911 | R1203 | R1188 | <code>海中鱼巣/核心/仓库.正式关系.ixx:304, 海中鱼巣/核心/仓库.正式关系.ixx:347</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3927 | R1203 | R1201 | <code>海中鱼巣/核心/仓库.正式关系.ixx:269</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3935 | R1203 | R1236 | <code>海中鱼巣/核心/仓库.正式关系.ixx:314</code> | direct | 源节点、目标节点、事务序号 |  | 新关系类型要求子链检查 | 4b80f161 冻结源码逐调用点复核 |
| RCE3934 | R1203 | R1281 | <code>海中鱼巣/核心/仓库.正式关系.ixx:290</code> | direct | 计划稳定主键 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3932 | R1203 | R1437 | <code>海中鱼巣/核心/仓库.正式关系.ixx:273, 海中鱼巣/核心/仓库.正式关系.ixx:274</code> | direct | 源节点 | 源节点记录 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3939 | R1205 | R1228 | <code>海中鱼巣/核心/仓库.正式关系.ixx:371</code> | direct | 关系、无事务序号、不允许非有效 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3940 | R1205 | R1437 | <code>海中鱼巣/核心/仓库.正式关系.ixx:373, 海中鱼巣/核心/仓库.正式关系.ixx:374</code> | direct | 记录.源节点 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3942 | R1206 | R1228 | <code>海中鱼巣/核心/仓库.正式关系.ixx:381</code> | direct | 关系、事务序号、不允许非有效 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3943 | R1206 | R1438 | <code>海中鱼巣/核心/仓库.正式关系.ixx:383, 海中鱼巣/核心/仓库.正式关系.ixx:384</code> | direct | 记录.源节点、事务序号 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3970 | R1221 | R1222 | <code>海中鱼巣/核心/仓库.正式关系.ixx:586</code> | callback | 正式关系记录左右项 |  | std::sort比较 | 4b80f161 冻结源码逐调用点复核 |
| RCE3972 | R1223 | R1237 | <code>海中鱼巣/核心/仓库.正式关系.ixx:613</code> | direct | 候选、事务序号、持有阶段 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3973 | R1223 | R1239 | <code>海中鱼巣/核心/仓库.正式关系.ixx:619</code> | direct | 仓内记录、候选写后记录 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3975 | R1224 | R1237 | <code>海中鱼巣/核心/仓库.正式关系.ixx:628</code> | direct | 候选、事务序号、持有阶段 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3976 | R1224 | R1239 | <code>海中鱼巣/核心/仓库.正式关系.ixx:652</code> | direct | 历史末项、写前记录 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3979 | R1225 | R1237 | <code>海中鱼巣/核心/仓库.正式关系.ixx:665</code> | direct | 候选、事务序号、已确认阶段 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3984 | R1229 | R1281 | <code>海中鱼巣/核心/仓库.正式关系.ixx:728</code> | direct | 稳定主键 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3990 | R1231 | F0163 | <code>海中鱼巣/核心/仓库.正式关系.ixx:792</code> | direct | 记录源/目标节点 | 有效性布尔值 | 恢复材料完整性判断 | 4b80f161 冻结源码逐调用点复核 |
| RCE3986 | R1231 | R1232 | <code>海中鱼巣/核心/仓库.正式关系.ixx:766</code> | callback | 恢复材料排序项 |  | std::sort比较 | 4b80f161 冻结源码逐调用点复核 |
| RCE3987 | R1231 | R1233 | <code>海中鱼巣/核心/仓库.正式关系.ixx:769</code> | callback | 恢复材料排序项 |  | std::sort比较 | 4b80f161 冻结源码逐调用点复核 |
| RCE3988 | R1231 | R1234 | <code>海中鱼巣/核心/仓库.正式关系.ixx:774</code> | callback | 恢复材料排序项 |  | std::sort比较 | 4b80f161 冻结源码逐调用点复核 |
| RCE3989 | R1231 | R1281 | <code>海中鱼巣/核心/仓库.正式关系.ixx:784, 海中鱼巣/核心/仓库.正式关系.ixx:790</code> | direct | 每域高水位稳定主键 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3991 | R1235 | F0163 | <code>海中鱼巣/核心/仓库.正式关系.ixx:809</code> | direct | 输入节点 | 有效性布尔值 | 入口检查 | 4b80f161 冻结源码逐调用点复核 |
| RCE3985 | R1235 | R1230 | <code>海中鱼巣/核心/仓库.正式关系.ixx:848</code> | callback | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3992 | R1235 | R1437 | <code>海中鱼巣/核心/仓库.正式关系.ixx:812, 海中鱼巣/核心/仓库.正式关系.ixx:813</code> | direct | 关系源节点 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3995 | R1240 | F0168 | <code>海中鱼巣/核心/仓库.正式关系.ixx:912</code> | direct | 关系 | 有效性布尔值 | 入口检查 | 4b80f161 冻结源码逐调用点复核 |
| RCE3997 | R1240 | R0899 | <code>海中鱼巣/核心/仓库.正式关系.ixx:957</code> | function_pointer_callback | 源类型、目标类型、顺序号 | 准入布尔值 | 具名准入规则已定位 | 4b80f161 冻结源码逐调用点复核 |
| RCE3912 | R1240 | R1188 | <code>海中鱼巣/核心/仓库.正式关系.ixx:989</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3929 | R1240 | R1201 | <code>海中鱼巣/核心/仓库.正式关系.ixx:908</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3993 | R1240 | R1236 | <code>海中鱼巣/核心/仓库.正式关系.ixx:972</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3996 | R1240 | R1437 | <code>海中鱼巣/核心/仓库.正式关系.ixx:920, 海中鱼巣/核心/仓库.正式关系.ixx:921</code> | direct | 新源节点 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4003 | R1242 | R1241 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:54</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4034 | R1250 | R1262 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:226</code> | direct | this | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4035 | R1250 | R1444 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:226</code> | direct | 节点、事务序号_ | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4017 | R1251 | R1245 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:231</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4036 | R1251 | R1250 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:230</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4037 | R1252 | R1250 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:236</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4040 | R1252 | R1439 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:237</code> | direct | 节点 | 稳定主键 | 先前135口径未登记该被调包装；保留真实调用端点 | 4b80f161 冻结源码逐调用点复核 |
| RCE4054 | R1261 | R1260 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:299</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4055 | R1262 | R1260 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:303</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3917 | R1265 | R1192 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:330</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3977 | R1265 | R1224 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:336</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4006 | R1265 | R1242 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:325</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4062 | R1265 | R1267 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:326, 海中鱼巣/核心/会话.节点直接身份结构写入.ixx:340</code> | direct | 失败结果 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4061 | R1265 | R1274 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:322</code> | direct | 关系写入状态、当前关系 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE3919 | R1266 | R1194 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:347, 海中鱼巣/核心/会话.节点直接身份结构写入.ixx:350</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4090 | R1282 | R1458 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:35</code> | defaulted | 稳定主键成员比较 | bool | 编译器生成defaulted equality比较体 | 4b80f161 冻结源码逐调用点复核 |
| RCE4081 | R1283 | R1457 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:39</code> | direct | 见证.稳定主键 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4295 | R1317 | R1316 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:105</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4297 | R1318 | R1286 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:111</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4298 | R1318 | R1340 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:113</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4299 | R1319 | R1340 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:122</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4296 | R1320 | R1316 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:133</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4300 | R1320 | R1321 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:134</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4303 | R1322 | R1323 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:174</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4304 | R1322 | R1324 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:179</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4132 | R1329 | R1309 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:268</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4492 | R1329 | R1311 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:275</code> | direct_or_implicit_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4491 | R1329 | R1312 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:275</code> | direct_or_implicit_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4309 | R1329 | R1334 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:260</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4310 | R1329 | R1338 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:260</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4312 | R1330 | R1338 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:287</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4311 | R1330 | R1342 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:287</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4317 | R1332 | R1338 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:316</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4316 | R1332 | R1342 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:316</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4325 | R1344 | R1338 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:413</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4256 | R1348 | R1349 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:100</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4258 | R1348 | R1457 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:92</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4257 | R1348 | R1458 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:96</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4126 | R1350 | R1307 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:122</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4494 | R1350 | R1345 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:153</code> | direct_or_implicit_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4493 | R1350 | R1346 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:153</code> | direct_or_implicit_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4259 | R1350 | R1366 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:114</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4260 | R1350 | R1372 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:114</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4261 | R1350 | R1374 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:114</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4127 | R1351 | R1307 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:168</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4496 | R1351 | R1345 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:189</code> | direct_or_implicit_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4495 | R1351 | R1346 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:189</code> | direct_or_implicit_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4262 | R1351 | R1366 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:168</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4263 | R1351 | R1372 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:168</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4265 | R1352 | R1372 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:195</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4264 | R1352 | R1375 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:195</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4267 | R1353 | R1372 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:210</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4271 | R1354 | R1367 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:266</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4270 | R1354 | R1372 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:243</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4269 | R1354 | R1375 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:243</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4273 | R1356 | R1357 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:296</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4274 | R1356 | R1358 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:299</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4275 | R1356 | R1359 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:303</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4288 | R1377 | R1372 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:500</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4289 | R1377 | R1373 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:505</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4232 | R1382 | R1401 | <code>海中鱼巣/核心/仓库.节点直接类型合同.ixx:91</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4120 | R1383 | R1306 | <code>海中鱼巣/核心/仓库.节点直接类型合同.ixx:110</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4499 | R1383 | R1378 | <code>海中鱼巣/核心/仓库.节点直接类型合同.ixx:126</code> | direct_or_implicit_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4498 | R1383 | R1379 | <code>海中鱼巣/核心/仓库.节点直接类型合同.ixx:126</code> | direct_or_implicit_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4234 | R1383 | R1395 | <code>海中鱼巣/核心/仓库.节点直接类型合同.ixx:102</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4235 | R1383 | R1400 | <code>海中鱼巣/核心/仓库.节点直接类型合同.ixx:102</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4237 | R1384 | R1400 | <code>海中鱼巣/核心/仓库.节点直接类型合同.ixx:141</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4236 | R1384 | R1402 | <code>海中鱼巣/核心/仓库.节点直接类型合同.ixx:141</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4239 | R1385 | R1400 | <code>海中鱼巣/核心/仓库.节点直接类型合同.ixx:156</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4242 | R1386 | R1400 | <code>海中鱼巣/核心/仓库.节点直接类型合同.ixx:182</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4241 | R1386 | R1402 | <code>海中鱼巣/核心/仓库.节点直接类型合同.ixx:182</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4244 | R1387 | R1388 | <code>海中鱼巣/核心/仓库.节点直接类型合同.ixx:218</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4245 | R1387 | R1389 | <code>海中鱼巣/核心/仓库.节点直接类型合同.ixx:221</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4246 | R1387 | R1390 | <code>海中鱼巣/核心/仓库.节点直接类型合同.ixx:225</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4254 | R1404 | R1400 | <code>海中鱼巣/核心/仓库.节点直接类型合同.ixx:394</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4502 | R1419 | R1406 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:444</code> | direct_or_implicit_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4334 | R1419 | R1417 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:342</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4336 | R1419 | R1418 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:378, 海中鱼巣/核心/仓库.节点直接身份.ixx:389</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4338 | R1419 | R1420 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:356</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4339 | R1419 | R1421 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:359</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4340 | R1419 | R1422 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:364</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4341 | R1419 | R1423 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:395</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4342 | R1419 | R1424 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:405</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4343 | R1419 | R1425 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:425</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4346 | R1419 | R1457 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:377, 海中鱼巣/核心/仓库.节点直接身份.ixx:388</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4344 | R1419 | R1458 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:391</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4345 | R1419 | R1459 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:399</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4347 | R1428 | R1449 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:496</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4348 | R1428 | R1458 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:496</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4504 | R1429 | R1407 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:595</code> | direct_or_implicit_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4503 | R1429 | R1410 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:595</code> | direct_or_implicit_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4337 | R1429 | R1418 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:517</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4350 | R1429 | R1449 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:532, 海中鱼巣/核心/仓库.节点直接身份.ixx:575</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4349 | R1429 | R1450 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:517</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4352 | R1429 | R1457 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:527</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4351 | R1429 | R1458 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:532, 海中鱼巣/核心/仓库.节点直接身份.ixx:575</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4326 | R1430 | R1408 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:600</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4354 | R1430 | R1452 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:600</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4355 | R1430 | R1454 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:600</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4327 | R1431 | R1408 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:626</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4356 | R1431 | R1452 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:626</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4357 | R1431 | R1454 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:626</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4360 | R1432 | R1449 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:667</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4358 | R1432 | R1452 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:654</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4359 | R1432 | R1454 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:654</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4361 | R1432 | R1458 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:667</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4369 | R1437 | R1451 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:800</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4374 | R1440 | R1456 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:854</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4376 | R1441 | R1456 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:858</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4370 | R1442 | R1437 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:865</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4373 | R1443 | R1438 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:869</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4391 | R1459 | R1458 | <code>海中鱼巣/核心/句柄.h:106</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4392 | R1462 | R1461 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:48</code> | function_pointer_callback | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4405 | R1473 | F0051 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:140</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4406 | R1473 | R0598 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:140</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4404 | R1473 | R1291 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:139</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4414 | R1476 | R1284 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:181</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4413 | R1476 | R1291 | <code>海中鱼巣/核心/自检.节点直接结构查询.ixx:179</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4149 | R1492 | R1155 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:474</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4229 | R1499 | R1437 | <code>海中鱼巣/核心/服务.节点直接结构.ixx:236, 海中鱼巣/核心/服务.节点直接结构.ixx:237</code> | sibling_candidate_key | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4228 | R1499 | R1498 | <code>海中鱼巣/核心/服务.节点直接结构.ixx:240</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4230 | R1501 | R1500 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:307</code> | candidate_key | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
...
| RCE0295 | F0635 | F0059 | <code>海中鱼巣/领域/初始化.世界树.ixx:73</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE0293 | F0635 | F0168 | <code>海中鱼巣/领域/初始化.世界树.ixx:65, 海中鱼巣/领域/初始化.世界树.ixx:66, 海中鱼巣/领域/初始化.世界树.ixx:67</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0289 | F0635 | R0203 | <code>海中鱼巣/领域/初始化.世界树.ixx:54</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
| RCE0294 | F0635 | R0223 | <code>海中鱼巣/领域/初始化.世界树.ixx:68</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0292 | F0635 | R0225 | <code>海中鱼巣/领域/初始化.世界树.ixx:58, 海中鱼巣/领域/初始化.世界树.ixx:69, 海中鱼巣/领域/初始化.世界树.ixx:81</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0290 | F0635 | R0275 | <code>海中鱼巣/领域/初始化.世界树.ixx:56</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
| RCE0291 | F0635 | R0277 | <code>海中鱼巣/领域/初始化.世界树.ixx:57</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
...
| RCE0296 | F0636 | F0184 | <code>海中鱼巣/领域/初始化.需求.ixx:104</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0298 | F0636 | F0328 | <code>海中鱼巣/领域/初始化.需求.ixx:107</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
...
| RCE0300 | F0636 | R0249 | <code>海中鱼巣/领域/初始化.需求.ixx:81, 海中鱼巣/领域/初始化.需求.ixx:92</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE4353 | R0022 | R1429 | <code>海中鱼巣/核心/会话.结构写入.ixx:265</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE0387 | R0041 | R0043 | <code>海中鱼巣/核心/会话.结构写入.ixx:648</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0388 | R0041 | R0055 | <code>海中鱼巣/核心/会话.结构写入.ixx:648</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0509 | R0089 | F0336 | <code>海中鱼巣/核心/关系仓库.cpp:88</code> | unique_name+direct-const-member |  | None | 调用方可达且源码分支条件成立；短路复核接线已接域 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
| RCE0510 | R0089 | F0399 | <code>海中鱼巣/核心/关系仓库.cpp:88</code> | resolved-function-pointer |  | None | 正式生产接线唯一共享令牌验证目标 | 专项源码静态类型与实际装配人工复核 |
| RCE0513 | R0098 | R0097 | <code>海中鱼巣/核心/协调.结构事务.ixx:45</code> | same_module+source-audited | None | None | 调用方可达且源码分支条件成立；结构事务内部直接调用 | 逐边源码/静态类型审计 PASS；专项源码静态类型与实际装配人工复核 |
| RCE0514 | R0099 | R0097 | <code>海中鱼巣/核心/协调.结构事务.ixx:59</code> | same_module+source-audited | None | None | 调用方可达且源码分支条件成立；结构事务内部直接调用 | 逐边源码/静态类型审计 PASS；专项源码静态类型与实际装配人工复核 |
| RCE0515 | R0099 | R0098 | <code>海中鱼巣/核心/协调.结构事务.ixx:60</code> | same_module+source-audited | None | None | 调用方可达且源码分支条件成立；结构事务内部直接调用 | 逐边源码/静态类型审计 PASS；专项源码静态类型与实际装配人工复核 |
| RCE0516 | R0100 | R0097 | <code>海中鱼巣/核心/协调.结构事务.ixx:67</code> | source-audited |  | None | 结构事务内部直接调用 | 专项源码静态类型与实际装配人工复核 |
| RCE1686 | R0137 | R0599 | <code>海中鱼巣/核心/结构事务接线.数据.h:47</code> | constructor |  | None | 创建工厂先默认构造结果对象 | 专项源码静态类型与实际装配人工复核 |
| RCE0616 | R0145 | F0336 | <code>海中鱼巣/核心/节点仓库.cpp:28</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0620 | R0151 | F0393 | <code>海中鱼巣/界面/控制面板窗口.cpp:1017, 海中鱼巣/界面/控制面板窗口.cpp:1086, 海中鱼巣/界面/控制面板窗口.cpp:1121</code> | unique_name+direct-member+direct-member+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核 |
| RCE0626 | R0151 | R0152 | <code>海中鱼巣/界面/控制面板窗口.cpp:1127</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0627 | R0151 | R0155 | <code>海中鱼巣/界面/控制面板窗口.cpp:1128</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0631 | R0151 | R0156 | <code>海中鱼巣/界面/控制面板窗口.cpp:1132</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0625 | R0151 | R0177 | <code>海中鱼巣/界面/控制面板窗口.cpp:1126</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0621 | R0151 | R0183 | <code>海中鱼巣/界面/控制面板窗口.cpp:1097</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0622 | R0151 | R0189 | <code>海中鱼巣/界面/控制面板窗口.cpp:1100</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0623 | R0151 | R0192 | <code>海中鱼巣/界面/控制面板窗口.cpp:1100</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0624 | R0151 | R0193 | <code>海中鱼巣/界面/控制面板窗口.cpp:1103</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0629 | R0151 | R0194 | <code>海中鱼巣/界面/控制面板窗口.cpp:1130</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0630 | R0151 | R0195 | <code>海中鱼巣/界面/控制面板窗口.cpp:1131</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0628 | R0151 | R0198 | <code>海中鱼巣/界面/控制面板窗口.cpp:1129</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0633 | R0153 | R0154 | <code>海中鱼巣/界面/控制面板窗口.cpp:1155, 海中鱼巣/界面/控制面板窗口.cpp:1188</code> | direct-free |  | None | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0632 | R0153 | R0186 | <code>海中鱼巣/界面/控制面板窗口.cpp:1146</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0634 | R0153 | R0327 | <code>海中鱼巣/界面/控制面板窗口.cpp:1167</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0637 | R0156 | R0157 | <code>海中鱼巣/界面/控制面板窗口.cpp:1338</code> | direct-local-lambda |  | None | 当前分页为系统信息且当前系统信息导航为数据库审计 | 专项源码静态类型与实际装配人工复核 |
| RCE0636 | R0156 | R0181 | <code>海中鱼巣/界面/控制面板窗口.cpp:1323, 海中鱼巣/界面/控制面板窗口.cpp:1331</code> | unique_name+direct-member+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核 |
| RCE0635 | R0156 | R0195 | <code>海中鱼巣/界面/控制面板窗口.cpp:1251</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0647 | R0160 | F0393 | <code>海中鱼巣/界面/控制面板窗口.cpp:1393</code> | unique_name+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0648 | R0160 | R0158 | <code>海中鱼巣/界面/控制面板窗口.cpp:1400</code> | unique_name+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0671 | R0166 | R0161 | <code>海中鱼巣/界面/控制面板窗口.cpp:1506</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0670 | R0166 | R0163 | <code>海中鱼巣/界面/控制面板窗口.cpp:1504</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0669 | R0166 | R0164 | <code>海中鱼巣/界面/控制面板窗口.cpp:1502</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0672 | R0166 | R0165 | <code>海中鱼巣/界面/控制面板窗口.cpp:1508</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0667 | R0166 | R0199 | <code>海中鱼巣/界面/控制面板窗口.cpp:1492, 海中鱼巣/界面/控制面板窗口.cpp:1494, 海中鱼巣/界面/控制面板窗口.cpp:1496</code> | unique_name+direct-member+direct-member+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核 |
| RCE0668 | R0166 | R0200 | <code>海中鱼巣/界面/控制面板窗口.cpp:1498, 海中鱼巣/界面/控制面板窗口.cpp:1500</code> | unique_name+direct-member+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核 |
| RCE0685 | R0176 | F0393 | <code>海中鱼巣/界面/控制面板窗口.cpp:328, 海中鱼巣/界面/控制面板窗口.cpp:372</code> | unique_name+direct-member+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 逐边源码/静态类型审计 PASS；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核 |
| RCE0684 | R0176 | R0150 | <code>海中鱼巣/界面/控制面板窗口.cpp:323</code> | same_module+direct-free | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 逐边源码/静态类型审计 PASS；专项源码静态类型与实际装配人工复核 |
| RCE0686 | R0176 | R0167 | <code>海中鱼巣/界面/控制面板窗口.cpp:332</code> | unique_name+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 逐边源码/静态类型审计 PASS；专项源码静态类型与实际装配人工复核 |
| RCE0687 | R0176 | R0175 | <code>海中鱼巣/界面/控制面板窗口.cpp:342</code> | same_module+direct-free | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 逐边源码/静态类型审计 PASS；专项源码静态类型与实际装配人工复核 |
| RCE0688 | R0176 | R0303 | <code>海中鱼巣/界面/控制面板窗口.cpp:350</code> | field_type_hint |  | None | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
| RCE0683 | R0176 | R0307 | <code>海中鱼巣/界面/控制面板窗口.cpp:322</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
| RCE0707 | R0194 | R0168 | <code>海中鱼巣/界面/控制面板窗口.cpp:760</code> | same_module+direct-free | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 逐边源码/静态类型审计 PASS；专项源码静态类型与实际装配人工复核 |
| RCE0732 | R0201 | F0393 | <code>海中鱼巣/界面/控制面板窗口.cpp:1003, 海中鱼巣/界面/控制面板窗口.cpp:940, 海中鱼巣/界面/控制面板窗口.cpp:968, 海中鱼巣/界面/控制面板窗口.cpp:984, 海中鱼巣/界面/控制面板窗口.cpp:993</code> | unique_name+direct-member+direct-member+direct-member+direct-member+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核 |
| RCE0734 | R0201 | R0153 | <code>海中鱼巣/界面/控制面板窗口.cpp:947, 海中鱼巣/界面/控制面板窗口.cpp:979</code> | unique_name+direct-member+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核 |
| RCE0740 | R0201 | R0156 | <code>海中鱼巣/界面/控制面板窗口.cpp:978, 海中鱼巣/界面/控制面板窗口.cpp:999</code> | unique_name+direct-member+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核 |
| RCE0731 | R0201 | R0167 | <code>海中鱼巣/界面/控制面板窗口.cpp:1000, 海中鱼巣/界面/控制面板窗口.cpp:980, 海中鱼巣/界面/控制面板窗口.cpp:989</code> | unique_name+direct-member+direct-member+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核 |
| RCE0735 | R0201 | R0176 | <code>海中鱼巣/界面/控制面板窗口.cpp:954</code> | unique_name+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0736 | R0201 | R0189 | <code>海中鱼巣/界面/控制面板窗口.cpp:963, 海中鱼巣/界面/控制面板窗口.cpp:967</code> | unique_name+direct-member+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核 |
| RCE0733 | R0201 | R0191 | <code>海中鱼巣/界面/控制面板窗口.cpp:944, 海中鱼巣/界面/控制面板窗口.cpp:973</code> | unique_name+direct-member+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核 |
| RCE0737 | R0201 | R0192 | <code>海中鱼巣/界面/控制面板窗口.cpp:963, 海中鱼巣/界面/控制面板窗口.cpp:967</code> | unique_name+direct-member+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核 |
| RCE0738 | R0201 | R0193 | <code>海中鱼巣/界面/控制面板窗口.cpp:976</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0739 | R0201 | R0195 | <code>海中鱼巣/界面/控制面板窗口.cpp:977, 海中鱼巣/界面/控制面板窗口.cpp:997</code> | unique_name+direct-member+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核 |
| RCE0741 | R0201 | R0197 | <code>海中鱼巣/界面/控制面板窗口.cpp:988</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0742 | R0201 | R0198 | <code>海中鱼巣/界面/控制面板窗口.cpp:998</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0743 | R0204 | F0620 | <code>海中鱼巣/领域/二次特征服务.h:111</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0744 | R0204 | R0205 | <code>海中鱼巣/领域/二次特征服务.h:113</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE0745 | R0206 | F0622 | <code>海中鱼巣/领域/二次特征服务.h:39</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0746 | R0206 | F0623 | <code>海中鱼巣/领域/二次特征服务.h:40</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0747 | R0206 | R0009 | <code>海中鱼巣/领域/二次特征服务.h:43</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0794 | R0229 | R0465 | <code>海中鱼巣/领域/初始化.系统角色.ixx:234</code> | direct-const-member |  | None | 需求返回值静态类型为需求提交结果 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0792 | R0229 | R0514 | <code>海中鱼巣/领域/初始化.系统角色.ixx:231</code> | direct-const-member |  | None | 需求服务字段静态类型为需求业务服务&amp; | 专项源码静态类型与实际装配人工复核 |
| RCE0791 | R0229 | R0566 | <code>海中鱼巣/领域/初始化.系统角色.ixx:224</code> | direct-const-member |  | None | 特征状态组合器字段静态类型为特征状态组合器&amp; | 专项源码静态类型与实际装配人工复核 |
...
| RCE1688 | R0229 | R0602 | <code>海中鱼巣/领域/初始化.系统角色.ixx:234</code> | direct-static-member |  | None | 需求结果状态静态类型为需求任务方法业务状态 | 专项源码静态类型与实际装配人工复核 |
| RCE1689 | R0229 | R0603 | <code>海中鱼巣/领域/初始化.系统角色.ixx:235</code> | direct-static-member |  | None | 需求结果状态静态类型为需求任务方法业务状态 | 专项源码静态类型与实际装配人工复核 |
| RCE0797 | R0231 | R0230 | <code>海中鱼巣/领域/初始化.系统角色.ixx:253, 海中鱼巣/领域/初始化.系统角色.ixx:254, 海中鱼巣/领域/初始化.系统角色.ixx:255, 海中鱼巣/领域/初始化.系统角色.ixx:260, 海中鱼巣/领域/初始化.系统角色.ixx:261, 海中鱼巣/领域/初始化.系统角色.ixx:262, 海中鱼巣/领域/初始化.系统角色.ixx:263, 海中鱼巣/领域/初始化.系统角色.ixx:264, 海中鱼巣/领域/初始化.系统角色.ixx:267, 海中鱼巣/领域/初始化.系统角色.ixx:268, 海中鱼巣/领域/初始化.系统角色.ixx:269, 海中鱼巣/领域/初始化.系统角色.ixx:270, 海中鱼巣/领域/初始化.系统角色.ixx:271, 海中鱼巣/领域/初始化.系统角色.ixx:273, 海中鱼巣/领域/初始化.系统角色.ixx:274, 海中鱼巣/领域/初始化.系统角色.ixx:275, 海中鱼巣/领域/初始化.系统角色.ixx:276, 海中鱼巣/领域/初始化.系统角色.ixx:278, 海中鱼巣/领域/初始化.系统角色.ixx:279, 海中鱼巣/领域/初始化.系统角色.ixx:280, 海中鱼巣/领域/初始化.系统角色.ixx:281</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0799 | R0232 | R0233 | <code>海中鱼巣/领域/初始化.系统角色.ixx:294, 海中鱼巣/领域/初始化.系统角色.ixx:296</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0802 | R0232 | R0234 | <code>海中鱼巣/领域/初始化.系统角色.ixx:334</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0800 | R0232 | R0398 | <code>海中鱼巣/领域/初始化.系统角色.ixx:302</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0801 | R0232 | R0512 | <code>海中鱼巣/领域/初始化.系统角色.ixx:308</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0798 | R0232 | R0565 | <code>海中鱼巣/领域/初始化.系统角色.ixx:288, 海中鱼巣/领域/初始化.系统角色.ixx:299, 海中鱼巣/领域/初始化.系统角色.ixx:306, 海中鱼巣/领域/初始化.系统角色.ixx:312, 海中鱼巣/领域/初始化.系统角色.ixx:313</code> | direct_const_member |  | None | 按短路顺序查找世界根、动态根、因果根、关系根和存在根用途 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0810 | R0236 | R0237 | <code>海中鱼巣/领域/初始化.系统角色.ixx:441, 海中鱼巣/领域/初始化.系统角色.ixx:442</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0814 | R0236 | R0238 | <code>海中鱼巣/领域/初始化.系统角色.ixx:468, 海中鱼巣/领域/初始化.系统角色.ixx:471, 海中鱼巣/领域/初始化.系统角色.ixx:474</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0812 | R0236 | R0398 | <code>海中鱼巣/领域/初始化.系统角色.ixx:447</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0813 | R0236 | R0497 | <code>海中鱼巣/领域/初始化.系统角色.ixx:462</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0811 | R0236 | R0512 | <code>海中鱼巣/领域/初始化.系统角色.ixx:445</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0837 | R0247 | F0220 | <code>海中鱼巣/领域/初始化.语素.ixx:36</code> | direct-const-member |  | None | 名称和类型两字段依次短路调用 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0988 | R0304 | R0302 | <code>海中鱼巣/领域/控制面板服务.h:280</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0989 | R0304 | R0495 | <code>海中鱼巣/领域/控制面板服务.h:285</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
| RCE0990 | R0306 | R0305 | <code>海中鱼巣/领域/控制面板服务.h:302, 海中鱼巣/领域/控制面板服务.h:303, 海中鱼巣/领域/控制面板服务.h:304, 海中鱼巣/领域/控制面板服务.h:305, 海中鱼巣/领域/控制面板服务.h:306, 海中鱼巣/领域/控制面板服务.h:307</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1051 | R0331 | F0231 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:138</code> | direct_const_member |  | None | 四项入口前置通过后读取参数稳定键组 | 专项源码静态类型与实际装配人工复核 |
...
| RCE1054 | R0331 | F0339 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:151</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1058 | R0331 | R0073 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:169</code> | direct-const-member |  | None | 概念活动审计读取令牌重载 | 专项源码静态类型与实际装配人工复核 |
| RCE1057 | R0331 | R0078 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:158</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1055 | R0331 | R0332 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:152</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1050 | R0331 | R0333 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:135</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1053 | R0331 | R0334 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:146</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1056 | R0331 | R0338 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:155</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1052 | R0331 | R0407 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:142</code> | direct-member |  | None | 逐个主键状态材料复核完整抽象状态 | 专项源码静态类型与实际装配人工复核 |
...
| RCE1079 | R0340 | R0116 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:63</code> | direct-const-member |  | None | 外层入口前置通过并形成 std::function&lt;void(结构写入会话&amp;)&gt; | 专项源码静态类型与实际装配人工复核 |
| RCE1078 | R0340 | R0332 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:59</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1077 | R0340 | R0333 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:57</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1076 | R0340 | R0339 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:126</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1284 | R0409 | R0116 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:132</code> | direct-const-member |  | None | 外层入口前置通过并形成 std::function&lt;void(结构写入会话&amp;)&gt; | 专项源码静态类型与实际装配人工复核 |
| RCE1285 | R0409 | R0421 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:172</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1314 | R0422 | F0339 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:51</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE2867 | R0422 | F0345 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:46-122</code> | implicit_destructor | this=&amp;许可 | None | 调用方从 F0001 可达且对应源码分支成立 | 冻结源码 3920a746 + 本批现状单函数图、逐行映射与调用点复核 |
...
| RCE1315 | R0422 | F0441 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:53</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1318 | R0422 | R0079 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:98</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1313 | R0422 | R0411 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:45</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1316 | R0422 | R0412 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:76, 海中鱼巣/领域/数据操作.系统角色.ixx:77, 海中鱼巣/领域/数据操作.系统角色.ixx:78, 海中鱼巣/领域/数据操作.系统角色.ixx:79, 海中鱼巣/领域/数据操作.系统角色.ixx:97</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1317 | R0422 | R0420 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:88, 海中鱼巣/领域/数据操作.系统角色.ixx:91</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1531 | R0526 | R0524 | <code>海中鱼巣/领域/概念图服务.h:4402</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1542 | R0535 | R0534 | <code>海中鱼巣/领域/概念图算法.h:632</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1544 | R0537 | R0536 | <code>海中鱼巣/领域/概念图算法.h:689</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1550 | R0538 | F0459 | <code>海中鱼巣/领域/概念活动状态.数据.h:109</code> | direct-const-member |  | None | 签名成立后复核活跃关系材料 | 专项源码静态类型与实际装配人工复核 |
| RCE1545 | R0538 | F0467 | <code>海中鱼巣/领域/概念活动状态.数据.h:105</code> | direct-const-member |  | None | 活跃角色静态类型为概念活动状态角色材料 | 专项源码静态类型与实际装配人工复核 |
| RCE1547 | R0538 | R0540 | <code>海中鱼巣/领域/概念活动状态.数据.h:106</code> | direct-free |  | None | 根身份完整后映射系统角色用途 | 专项源码静态类型与实际装配人工复核 |
| RCE1548 | R0538 | R0541 | <code>海中鱼巣/领域/概念活动状态.数据.h:107</code> | direct-free |  | None | 用途匹配后映射节点类型 | 专项源码静态类型与实际装配人工复核 |
| RCE1549 | R0538 | R0542 | <code>海中鱼巣/领域/概念活动状态.数据.h:108</code> | direct-free |  | None | 类型匹配后复核概念根签名 | 专项源码静态类型与实际装配人工复核 |
| RCE1546 | R0538 | R0563 | <code>海中鱼巣/领域/概念活动状态.数据.h:105</code> | direct-const-member |  | None | 根身份静态类型为系统角色身份材料 | 专项源码静态类型与实际装配人工复核 |
...
| RCE1593 | R0576 | R0077 | <code>海中鱼巣/领域/需求服务.h:1010</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 本批逐函数源码静态类型、完整签名、调用点与当前 Debug&#124;x64 可达闭包复核 |
...
| RCE1608 | R0582 | R0576 | <code>海中鱼巣/领域/需求服务.h:514</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1609 | R0583 | R0576 | <code>海中鱼巣/领域/需求服务.h:519</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1610 | R0583 | R0582 | <code>海中鱼巣/领域/需求服务.h:523</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1612 | R0584 | R0576 | <code>海中鱼巣/领域/需求服务.h:540</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE3340 | R0864 | R0599 | <code>海中鱼巣/领域/特征值服务.h:292</code> | constructor | 无 | 局部结构事务许可 许可 | 进入R0864且接线形态有效 | 本批现状图、逐行映射与源码生命周期逐调用点复核 |
| RCE3341 | R0864 | R0600 | <code>海中鱼巣/领域/特征值服务.h:295</code> | direct-operator | this=&amp;许可, 其它=事务接线_.取得独占许可()临时 | 许可覆盖为取得的独占许可 | 事务接线已接域并取得独占许可 | 本批现状图、逐行映射与源码生命周期逐调用点复核 |
...
| RCE3342 | R0865 | R0599 | <code>海中鱼巣/领域/特征值服务.h:349</code> | constructor | 无 | 局部结构事务许可 许可 | 进入R0865且接线形态有效 | 本批现状图、逐行映射与源码生命周期逐调用点复核 |
| RCE3343 | R0865 | R0600 | <code>海中鱼巣/领域/特征值服务.h:352</code> | direct-operator | this=&amp;许可, 其它=事务接线_.取得共享许可()临时 | 许可覆盖为取得的共享许可 | 事务接线已接域并取得共享许可 | 本批现状图、逐行映射与源码生命周期逐调用点复核 |
...
| RCE3344 | R0866 | R0599 | <code>海中鱼巣/领域/特征值服务.h:371</code> | constructor | 无 | 局部结构事务许可 许可 | 进入R0866且接线形态有效 | 本批现状图、逐行映射与源码生命周期逐调用点复核 |
| RCE3345 | R0866 | R0600 | <code>海中鱼巣/领域/特征值服务.h:374</code> | direct-operator | this=&amp;许可, 其它=事务接线_.取得独占许可()临时 | 许可覆盖为取得的独占许可 | 事务接线已接域并取得独占许可 | 本批现状图、逐行映射与源码生命周期逐调用点复核 |
...
| RCE3346 | R0867 | R0599 | <code>海中鱼巣/领域/特征值服务.h:428</code> | constructor | 无 | 局部结构事务许可 许可 | 进入R0867且接线形态有效 | 本批现状图、逐行映射与源码生命周期逐调用点复核 |
| RCE3347 | R0867 | R0600 | <code>海中鱼巣/领域/特征值服务.h:431</code> | direct-operator | this=&amp;许可, 其它=事务接线_.取得共享许可()临时 | 许可覆盖为取得的共享许可 | 事务接线已接域并取得共享许可 | 本批现状图、逐行映射与源码生命周期逐调用点复核 |
...
| RCE3389 | R0928 | R0922 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:170</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3390 | R0928 | R0926 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:168</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3392 | R0930 | R0919 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:187</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3411 | R0934 | R0056 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:260</code> | formal_03a8_identity | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3412 | R0934 | R0057 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:261</code> | formal_03a8_identity | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3413 | R0934 | R0058 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:257</code> | formal_03a8_identity | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3414 | R0934 | R0059 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:258</code> | formal_03a8_identity | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3415 | R0934 | R0060 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:275</code> | formal_03a8_identity | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3405 | R0934 | R0919 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:246</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3396 | R0934 | R0920 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:248</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3397 | R0934 | R0927 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:245</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3398 | R0934 | R0932 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:244</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3399 | R0934 | R1045 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:244, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:265</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3400 | R0934 | R1046 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:244</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3401 | R0934 | R1047 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:269</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3402 | R0934 | R1048 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:280</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3403 | R0934 | R1050 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:287</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3404 | R0934 | R1052 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:252, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:258, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:262, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:271, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:277, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:282</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3406 | R0934 | R1111 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:286</code> | virtual_dispatch_target | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3407 | R0934 | R1112 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:286</code> | virtual_dispatch_target | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3408 | R0934 | R1126 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:286</code> | virtual_dispatch_target | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3410 | R0934 | R1241 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:270, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:276, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:281</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3409 | R0934 | R1259 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:248</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3417 | R0937 | R1006 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:343</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3418 | R0938 | R1006 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:422</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4522 | R0944 | R0945 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:509</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3459 | R0948 | F0438 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:564</code> | formal_03a8_identity | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4524 | R0948 | R0949 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:562</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3480 | R0951 | R0933 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:693, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:698</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3481 | R0951 | R0934 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:693, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:698</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3482 | R0951 | R0951 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:693, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:698</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3654 | R1051 | R1049 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3155</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3360 | R1056 | R0939 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:293</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3363 | R1056 | R1055 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:102</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3365 | R1056 | R1057 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:53</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3366 | R1056 | R1058 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:115</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3361 | R1056 | R1059 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:209</code> | local_lambda_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4508 | R1056 | R1061 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:168</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4509 | R1056 | R1062 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:180</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4510 | R1056 | R1063 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:191</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4511 | R1056 | R1064 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:201</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4512 | R1056 | R1065 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:216</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4513 | R1056 | R1066 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:237</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4514 | R1056 | R1067 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:245</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4515 | R1056 | R1068 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:251</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4516 | R1056 | R1069 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:258</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3367 | R1056 | R1070 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:269</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3368 | R1056 | R1071 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:281</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4517 | R1056 | R1072 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:287</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3362 | R1056 | R1073 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:145</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3364 | R1056 | R1286 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:46, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:65</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3767 | R1140 | R0041 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:838</code> | formal_03a8_identity | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3765 | R1140 | R1137 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:836</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3766 | R1140 | R1254 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:838</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3791 | R1146 | R0022 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:906</code> | formal_03a8_identity | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3792 | R1146 | R0041 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:917</code> | formal_03a8_identity | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3788 | R1146 | R1097 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:904</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3790 | R1146 | R1245 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:912</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3789 | R1146 | R1254 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:917</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4194 | R1184 | R1182 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:618</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4088 | R1184 | R1292 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:507, 海中鱼巣/核心/仓库.可重建索引.ixx:612</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3914 | R1190 | R1189 | <code>海中鱼巣/核心/仓库.正式关系.ixx:99</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3983 | R1228 | R1227 | <code>海中鱼巣/核心/仓库.正式关系.ixx:717</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3994 | R1239 | R1280 | <code>海中鱼巣/核心/仓库.正式关系.ixx:895</code> | direct | 左右记录稳定主键 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4014 | R1245 | R1262 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:132</code> | direct | this | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4016 | R1245 | R1408 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:136</code> | direct | 节点 | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4015 | R1245 | R1438 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:133</code> | direct | 节点、事务序号_ | 返回值由源码当前语句接收或直接返回 | 按源码所在顺序或分支 | 4b80f161 冻结源码逐调用点复核 |
| RCE4136 | R1284 | R1280 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:51</code> | defaulted | defaulted成员比较 | bool | 编译器生成比较体 | 4b80f161 冻结源码逐调用点复核 |
| RCE4137 | R1284 | R1282 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:51</code> | defaulted | defaulted成员比较 | bool | 编译器生成比较体 | 4b80f161 冻结源码逐调用点复核 |
| RCE4104 | R1306 | R1287 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:266</code> | defaulted | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4118 | R1306 | R1293 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:266</code> | defaulted | defaulted成员/variant/container元素比较 | bool | 编译器生成defaulted equality比较体 | 4b80f161 冻结源码逐调用点复核 |
| RCE4113 | R1306 | R1295 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:266</code> | defaulted | defaulted成员/variant/container元素比较 | bool | 编译器生成defaulted equality比较体 | 4b80f161 冻结源码逐调用点复核 |
| RCE4110 | R1306 | R1298 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:266</code> | defaulted | defaulted成员/variant/container元素比较 | bool | 编译器生成defaulted equality比较体 | 4b80f161 冻结源码逐调用点复核 |
| RCE4111 | R1306 | R1299 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:266</code> | defaulted | defaulted成员/variant/container元素比较 | bool | 编译器生成defaulted equality比较体 | 4b80f161 冻结源码逐调用点复核 |
| RCE4112 | R1306 | R1300 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:266</code> | defaulted | defaulted成员/variant/container元素比较 | bool | 编译器生成defaulted equality比较体 | 4b80f161 冻结源码逐调用点复核 |
| RCE4114 | R1306 | R1301 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:266</code> | defaulted | defaulted成员/variant/container元素比较 | bool | 编译器生成defaulted equality比较体 | 4b80f161 冻结源码逐调用点复核 |
| RCE4115 | R1306 | R1302 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:266</code> | defaulted | defaulted成员/variant/container元素比较 | bool | 编译器生成defaulted equality比较体 | 4b80f161 冻结源码逐调用点复核 |
| RCE4116 | R1306 | R1303 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:266</code> | defaulted | defaulted成员/variant/container元素比较 | bool | 编译器生成defaulted equality比较体 | 4b80f161 冻结源码逐调用点复核 |
| RCE4117 | R1306 | R1304 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:266</code> | defaulted | defaulted成员/variant/container元素比较 | bool | 编译器生成defaulted equality比较体 | 4b80f161 冻结源码逐调用点复核 |
| RCE4119 | R1306 | R1305 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:266</code> | defaulted | defaulted成员/variant/container元素比较 | bool | 编译器生成defaulted equality比较体 | 4b80f161 冻结源码逐调用点复核 |
| RCE4121 | R1307 | R1282 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:292</code> | defaulted | defaulted成员/variant/container元素比较 | bool | 编译器生成defaulted equality比较体 | 4b80f161 冻结源码逐调用点复核 |
| RCE4105 | R1307 | R1287 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:292</code> | defaulted | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4109 | R1307 | R1289 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:292</code> | defaulted | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4125 | R1307 | R1293 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:292</code> | defaulted | defaulted成员/variant/container元素比较 | bool | 编译器生成defaulted equality比较体 | 4b80f161 冻结源码逐调用点复核 |
| RCE4122 | R1307 | R1295 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:292</code> | defaulted | defaulted成员/variant/container元素比较 | bool | 编译器生成defaulted equality比较体 | 4b80f161 冻结源码逐调用点复核 |
| RCE4123 | R1307 | R1296 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:292</code> | defaulted | defaulted成员/variant/container元素比较 | bool | 编译器生成defaulted equality比较体 | 4b80f161 冻结源码逐调用点复核 |
| RCE4124 | R1307 | R1297 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:292</code> | defaulted | defaulted成员/variant/container元素比较 | bool | 编译器生成defaulted equality比较体 | 4b80f161 冻结源码逐调用点复核 |
| RCE4129 | R1309 | R1282 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:331</code> | defaulted | defaulted成员/variant/container元素比较 | bool | 编译器生成defaulted equality比较体 | 4b80f161 冻结源码逐调用点复核 |
| RCE4130 | R1309 | R1284 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:331</code> | defaulted | defaulted成员/variant/container元素比较 | bool | 编译器生成defaulted equality比较体 | 4b80f161 冻结源码逐调用点复核 |
| RCE4098 | R1309 | R1285 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:331</code> | defaulted | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4128 | R1309 | R1307 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:331</code> | defaulted | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4131 | R1309 | R1308 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:331</code> | defaulted | defaulted成员/variant/container元素比较 | bool | 编译器生成defaulted equality比较体 | 4b80f161 冻结源码逐调用点复核 |
| RCE4294 | R1316 | R1341 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:96</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4301 | R1321 | R1286 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:137</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4302 | R1321 | R1340 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:137</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4490 | R1325 | R1313 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:206</code> | direct_or_implicit_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4489 | R1325 | R1314 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:206</code> | direct_or_implicit_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4306 | R1325 | R1335 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:187</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4307 | R1326 | R1343 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:216</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4308 | R1328 | R1343 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:240</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4321 | R1334 | R1286 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:348</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4319 | R1334 | R1333 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:347, 海中鱼巣/核心/仓库.节点直接事务幂等.ixx:349</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4094 | R1338 | R1285 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:383</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4096 | R1340 | R1285 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:389</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4255 | R1345 | R1346 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:26</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4497 | R1360 | R1347 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:329</code> | direct_or_implicit_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4276 | R1360 | R1368 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:311</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4277 | R1361 | R1376 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:339</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4278 | R1363 | R1376 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:363</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4279 | R1366 | R1364 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:421</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4281 | R1366 | R1365 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:415</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4102 | R1367 | R1287 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:427</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4283 | R1367 | R1458 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:426</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4107 | R1372 | R1289 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:471</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4108 | R1373 | R1289 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:474</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4284 | R1374 | R1367 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:477</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4231 | R1378 | R1379 | <code>海中鱼巣/核心/仓库.节点直接类型合同.ixx:25</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4501 | R1391 | R1380 | <code>海中鱼巣/核心/仓库.节点直接类型合同.ixx:251</code> | direct_or_implicit_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4500 | R1391 | R1381 | <code>海中鱼巣/核心/仓库.节点直接类型合同.ixx:251</code> | direct_or_implicit_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4247 | R1391 | R1396 | <code>海中鱼巣/核心/仓库.节点直接类型合同.ixx:233</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4248 | R1392 | R1403 | <code>海中鱼巣/核心/仓库.节点直接类型合同.ixx:261</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4249 | R1394 | R1403 | <code>海中鱼巣/核心/仓库.节点直接类型合同.ixx:285</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4100 | R1400 | R1287 | <code>海中鱼巣/核心/仓库.节点直接类型合同.ixx:365</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4101 | R1401 | R1287 | <code>海中鱼巣/核心/仓库.节点直接类型合同.ixx:370</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4390 | R1424 | R1458 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:406</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4371 | R1438 | R1451 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:811</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4372 | R1439 | R1438 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:845</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4380 | R1444 | R1451 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:879</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4329 | R1452 | R1409 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:973</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4383 | R1454 | R1451 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:992</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4385 | R1454 | R1458 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:993</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4335 | R1456 | R1417 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:1025</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4386 | R1456 | R1449 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:1035</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4382 | R1456 | R1450 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:1025</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4389 | R1456 | R1457 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:1030</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4387 | R1456 | R1458 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:1035</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4388 | R1456 | R1459 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:1051</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
...
| RCE0389 | R0044 | R0043 | <code>海中鱼巣/核心/会话.结构写入.ixx:733</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE0464 | R0073 | F0589 | <code>海中鱼巣/核心/关系仓库.cpp:1436</code> | direct-const-member+direct-member |  | None | 令牌有效后调用无令牌审计重载；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0462 | R0073 | R0089 | <code>海中鱼巣/核心/关系仓库.cpp:1435</code> | direct-free |  | None | 令牌读取入口 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0476 | R0077 | F0620 | <code>海中鱼巣/核心/关系仓库.cpp:1544</code> | direct-member |  | None | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0479 | R0078 | F0575 | <code>海中鱼巣/核心/关系仓库.cpp:1548</code> | direct-member |  | None | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0482 | R0079 | F0578 | <code>海中鱼巣/核心/关系仓库.cpp:1560</code> | direct-member |  | None | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0557 | R0116 | F0338 | <code>海中鱼巣/核心/执行器.结构写入.ixx:77</code> | direct-const-member |  | None | 取得独占许可后复核许可有效 | 专项源码静态类型与实际装配人工复核 |
| RCE0558 | R0116 | F0339 | <code>海中鱼巣/核心/执行器.结构写入.ixx:80</code> | direct-const-member |  | None | 许可有效后读取事务令牌 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0556 | R0116 | F0398 | <code>海中鱼巣/核心/执行器.结构写入.ixx:76</code> | resolved-function-pointer |  | None | 执行器有效；生产运行期唯一正式独占许可目标 | 专项源码静态类型与实际装配人工复核 |
| RCE0559 | R0116 | R0042 | <code>海中鱼巣/核心/执行器.结构写入.ixx:80</code> | constructor |  | None | 执行器有效且独占许可有效 | 专项源码静态类型与实际装配人工复核 |
| RCE0569 | R0116 | R0056 | <code>海中鱼巣/核心/执行器.结构写入.ixx:97</code> | direct-const-member |  | None | 无失败时复核是否请求提交 | 专项源码静态类型与实际装配人工复核 |
| RCE0553 | R0116 | R0057 | <code>海中鱼巣/核心/执行器.结构写入.ixx:107</code> | direct-const-member |  | None | 未提交分支读取显式撤销决定 | 专项源码静态类型与实际装配人工复核 |
| RCE0567 | R0116 | R0058 | <code>海中鱼巣/核心/执行器.结构写入.ixx:90</code> | direct-const-member |  | None | 回调正常返回后复核会话失败 | 专项源码静态类型与实际装配人工复核 |
| RCE0568 | R0116 | R0059 | <code>海中鱼巣/核心/执行器.结构写入.ixx:91</code> | direct-const-member |  | None | 会话已有失败时读取首次失败 | 专项源码静态类型与实际装配人工复核 |
| RCE0570 | R0116 | R0060 | <code>海中鱼巣/核心/执行器.结构写入.ixx:98</code> | direct-const-member |  | None | 已请求提交时完成确认 | 专项源码静态类型与实际装配人工复核 |
| RCE0552 | R0116 | R0061 | <code>海中鱼巣/核心/执行器.结构写入.ixx:103</code> | direct-const-member |  | None | 确认成功后完成发布 | 专项源码静态类型与实际装配人工复核 |
| RCE0564 | R0116 | R0062 | <code>海中鱼巣/核心/执行器.结构写入.ixx:84, 海中鱼巣/核心/执行器.结构写入.ixx:92, 海中鱼巣/核心/执行器.结构写入.ixx:100, 海中鱼巣/核心/执行器.结构写入.ixx:108</code> | direct-const-member |  | None | 异常、失败、确认失败或未提交分支撤销会话 | 专项源码静态类型与实际装配人工复核 |
| RCE0565 | R0116 | R0105 | <code>海中鱼巣/核心/执行器.结构写入.ixx:85, 海中鱼巣/核心/执行器.结构写入.ixx:93, 海中鱼巣/核心/执行器.结构写入.ixx:101, 海中鱼巣/核心/执行器.结构写入.ixx:109</code> | direct-const-member |  | None | 撤销后复核撤销结果 | 专项源码静态类型与实际装配人工复核 |
| RCE0566 | R0116 | R0107 | <code>海中鱼巣/核心/执行器.结构写入.ixx:87, 海中鱼巣/核心/执行器.结构写入.ixx:95, 海中鱼巣/核心/执行器.结构写入.ixx:101, 海中鱼巣/核心/执行器.结构写入.ixx:109</code> | direct-const-member |  | None | 撤销不完整时隔离并返回内部不一致 | 专项源码静态类型与实际装配人工复核 |
| RCE0554 | R0116 | R0115 | <code>海中鱼巣/核心/执行器.结构写入.ixx:75</code> | direct-const-member |  | None | 执行入口 | 专项源码静态类型与实际装配人工复核 |
| RCE0571 | R0116 | R0138 | <code>海中鱼巣/核心/执行器.结构写入.ixx:99</code> | direct-const-member |  | None | 确认返回后复核成功 | 专项源码静态类型与实际装配人工复核 |
| RCE0560 | R0116 | R0341 | <code>海中鱼巣/核心/执行器.结构写入.ixx:82</code> | resolved-std-function-callback |  | None | 本次执行调用语境由 海中鱼巣/领域/数据操作.概念活动.ixx:42 注册该唯一回调 | 专项源码静态类型与实际装配人工复核 |
| RCE0561 | R0116 | R0410 | <code>海中鱼巣/核心/执行器.结构写入.ixx:82</code> | resolved-std-function-callback |  | None | 本次执行调用语境由 海中鱼巣/领域/数据操作.系统角色.ixx:124 注册该唯一回调 | 专项源码静态类型与实际装配人工复核 |
| RCE0562 | R0116 | R0433 | <code>海中鱼巣/核心/执行器.结构写入.ixx:82</code> | resolved-std-function-callback |  | None | 本次执行调用语境由 海中鱼巣/领域/数据操作.需求任务方法.ixx:1619 注册该唯一回调 | 专项源码静态类型与实际装配人工复核 |
| RCE0563 | R0116 | R0455 | <code>海中鱼巣/核心/执行器.结构写入.ixx:82</code> | resolved-std-function-callback |  | None | 本次执行调用语境由 海中鱼巣/领域/数据操作.需求任务方法.ixx:2876 注册该回调 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0581 | R0122 | R0127 | <code>海中鱼巣/核心/索引仓库.cpp:34, 海中鱼巣/核心/索引仓库.cpp:52</code> | operator |  | None | 比较现有/插入主键绑定记录 | 专项源码静态类型与实际装配人工复核 |
| RCE0583 | R0123 | R0120 | <code>海中鱼巣/核心/索引仓库.cpp:299</code> | direct+direct-free |  | None | 删除主键令牌重载进入后验证共享令牌；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0584 | R0123 | R0126 | <code>海中鱼巣/核心/索引仓库.cpp:301</code> | direct+direct-free |  | None | 共享令牌有效并取得锁后删除主键；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0615 | R0144 | R0138 | <code>海中鱼巣/核心/节点仓库.cpp:229</code> | direct-const-member |  | None | 撤销结果成功后归零当前版本 | 专项源码静态类型与实际装配人工复核 |
| RCE0611 | R0144 | R0143 | <code>海中鱼巣/核心/节点仓库.cpp:221</code> | suffix_match+direct-const-member+direct-member | None | None | 调用方可达且源码分支条件成立；候选状态允许撤销；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核 |
| RCE0613 | R0144 | R0145 | <code>海中鱼巣/核心/节点仓库.cpp:209</code> | direct-free |  | None | 结构化撤销入口验证独占令牌；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0614 | R0144 | R0146 | <code>海中鱼巣/核心/节点仓库.cpp:213</code> | direct-const-member+direct-free |  | None | 复核候选令牌一致；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0612 | R0144 | R0148 | <code>海中鱼巣/核心/节点仓库.cpp:207</code> | direct-const-member |  | None | 形成撤销结果前读取候选句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE0619 | R0150 | R0202 | <code>海中鱼巣/界面/控制面板窗口.cpp:105</code> | lsp_direct+direct-free |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 逐边源码/静态类型审计 PASS；专项源码静态类型与实际装配人工复核 |
| RCE0641 | R0158 | F0393 | <code>海中鱼巣/界面/控制面板窗口.cpp:1378</code> | unique_name+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0644 | R0158 | R0153 | <code>海中鱼巣/界面/控制面板窗口.cpp:1384</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0645 | R0158 | R0156 | <code>海中鱼巣/界面/控制面板窗口.cpp:1385</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0646 | R0158 | R0167 | <code>海中鱼巣/界面/控制面板窗口.cpp:1386</code> | unique_name+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0638 | R0158 | R0176 | <code>海中鱼巣/界面/控制面板窗口.cpp:1362</code> | unique_name+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0640 | R0158 | R0189 | <code>海中鱼巣/界面/控制面板窗口.cpp:1370, 海中鱼巣/界面/控制面板窗口.cpp:1377</code> | unique_name+direct-member+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核 |
| RCE0639 | R0158 | R0192 | <code>海中鱼巣/界面/控制面板窗口.cpp:1367, 海中鱼巣/界面/控制面板窗口.cpp:1370, 海中鱼巣/界面/控制面板窗口.cpp:1377</code> | unique_name+direct-member+direct-member+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核 |
| RCE0642 | R0158 | R0193 | <code>海中鱼巣/界面/控制面板窗口.cpp:1382</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0643 | R0158 | R0195 | <code>海中鱼巣/界面/控制面板窗口.cpp:1383</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0649 | R0161 | R0158 | <code>海中鱼巣/界面/控制面板窗口.cpp:1411</code> | unique_name+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0650 | R0163 | R0158 | <code>海中鱼巣/界面/控制面板窗口.cpp:1424</code> | unique_name+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0651 | R0164 | F0388 | <code>海中鱼巣/界面/控制面板窗口.cpp:1434</code> | unique_name+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0655 | R0164 | F0393 | <code>海中鱼巣/界面/控制面板窗口.cpp:1459</code> | unique_name+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0658 | R0164 | R0152 | <code>海中鱼巣/界面/控制面板窗口.cpp:1465</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0661 | R0164 | R0156 | <code>海中鱼巣/界面/控制面板窗口.cpp:1468</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0662 | R0164 | R0167 | <code>海中鱼巣/界面/控制面板窗口.cpp:1469</code> | unique_name+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0652 | R0164 | R0176 | <code>海中鱼巣/界面/控制面板窗口.cpp:1440</code> | unique_name+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0657 | R0164 | R0177 | <code>海中鱼巣/界面/控制面板窗口.cpp:1464</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0653 | R0164 | R0189 | <code>海中鱼巣/界面/控制面板窗口.cpp:1451, 海中鱼巣/界面/控制面板窗口.cpp:1458</code> | unique_name+direct-member+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核 |
| RCE0654 | R0164 | R0192 | <code>海中鱼巣/界面/控制面板窗口.cpp:1451, 海中鱼巣/界面/控制面板窗口.cpp:1458</code> | unique_name+direct-member+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核 |
| RCE0656 | R0164 | R0193 | <code>海中鱼巣/界面/控制面板窗口.cpp:1463</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0660 | R0164 | R0195 | <code>海中鱼巣/界面/控制面板窗口.cpp:1467</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0659 | R0164 | R0198 | <code>海中鱼巣/界面/控制面板窗口.cpp:1466</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0665 | R0165 | F0393 | <code>海中鱼巣/界面/控制面板窗口.cpp:1480</code> | unique_name+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0666 | R0165 | R0167 | <code>海中鱼巣/界面/控制面板窗口.cpp:1484</code> | unique_name+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0663 | R0165 | R0202 | <code>海中鱼巣/界面/控制面板窗口.cpp:1476</code> | direct-free |  | None | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0664 | R0165 | R0308 | <code>海中鱼巣/界面/控制面板窗口.cpp:1476</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0681 | R0175 | R0173 | <code>海中鱼巣/界面/控制面板窗口.cpp:240</code> | lsp_direct+direct-free | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 逐边源码/静态类型审计 PASS；专项源码静态类型与实际装配人工复核 |
| RCE0682 | R0175 | R0174 | <code>海中鱼巣/界面/控制面板窗口.cpp:246</code> | lsp_direct+direct-free | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 逐边源码/静态类型审计 PASS；专项源码静态类型与实际装配人工复核 |
| RCE0689 | R0177 | F0056 | <code>海中鱼巣/界面/控制面板窗口.cpp:419</code> | direct-const-member |  | None | 控制面板读取最近五十条结构统计审计材料 | 专项源码静态类型与实际装配人工复核 |
| RCE0690 | R0183 | F0393 | <code>海中鱼巣/界面/控制面板窗口.cpp:561, 海中鱼巣/界面/控制面板窗口.cpp:568, 海中鱼巣/界面/控制面板窗口.cpp:574</code> | unique_name+direct-member+direct-member+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核 |
| RCE0691 | R0183 | R0178 | <code>海中鱼巣/界面/控制面板窗口.cpp:565</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0693 | R0183 | R0179 | <code>海中鱼巣/界面/控制面板窗口.cpp:572</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0692 | R0183 | R0180 | <code>海中鱼巣/界面/控制面板窗口.cpp:567</code> | unique_name+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0694 | R0186 | R0185 | <code>海中鱼巣/界面/控制面板窗口.cpp:598</code> | unique_name+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0700 | R0189 | F0393 | <code>海中鱼巣/界面/控制面板窗口.cpp:643, 海中鱼巣/界面/控制面板窗口.cpp:666, 海中鱼巣/界面/控制面板窗口.cpp:676, 海中鱼巣/界面/控制面板窗口.cpp:685</code> | unique_name+direct-member+direct-member+direct-member+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核 |
| RCE0703 | R0189 | R0187 | <code>海中鱼巣/界面/控制面板窗口.cpp:670</code> | unique_name+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0701 | R0189 | R0188 | <code>海中鱼巣/界面/控制面板窗口.cpp:659</code> | unique_name+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0702 | R0189 | R0190 | <code>海中鱼巣/界面/控制面板窗口.cpp:661, 海中鱼巣/界面/控制面板窗口.cpp:667, 海中鱼巣/界面/控制面板窗口.cpp:671, 海中鱼巣/界面/控制面板窗口.cpp:677, 海中鱼巣/界面/控制面板窗口.cpp:686, 海中鱼巣/界面/控制面板窗口.cpp:689</code> | implicit-local-destructor-of-explicit-project-definition |  | None | line 653 局部收口器已构造；后续任一 return 或正常作用域退出均调用源码显式定义析构 | 专项源码静态类型与实际装配人工复核 |
| RCE0704 | R0191 | F0393 | <code>海中鱼巣/界面/控制面板窗口.cpp:696</code> | unique_name+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0705 | R0192 | F0393 | <code>海中鱼巣/界面/控制面板窗口.cpp:707, 海中鱼巣/界面/控制面板窗口.cpp:716, 海中鱼巣/界面/控制面板窗口.cpp:728, 海中鱼巣/界面/控制面板窗口.cpp:736</code> | unique_name+direct-member+direct-member+direct-member+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核 |
| RCE0706 | R0192 | R0303 | <code>海中鱼巣/界面/控制面板窗口.cpp:722</code> | direct-const-member |  | None | 逐项发布概念根下拉选项前复核选项完整 | 专项源码静态类型与实际装配人工复核 |
| RCE0709 | R0195 | R0169 | <code>海中鱼巣/界面/控制面板窗口.cpp:772, 海中鱼巣/界面/控制面板窗口.cpp:773, 海中鱼巣/界面/控制面板窗口.cpp:774, 海中鱼巣/界面/控制面板窗口.cpp:775, 海中鱼巣/界面/控制面板窗口.cpp:776, 海中鱼巣/界面/控制面板窗口.cpp:777, 海中鱼巣/界面/控制面板窗口.cpp:778, 海中鱼巣/界面/控制面板窗口.cpp:779, 海中鱼巣/界面/控制面板窗口.cpp:780, 海中鱼巣/界面/控制面板窗口.cpp:781, 海中鱼巣/界面/控制面板窗口.cpp:782</code> | direct-free |  | None | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0708 | R0195 | R0181 | <code>海中鱼巣/界面/控制面板窗口.cpp:769, 海中鱼巣/界面/控制面板窗口.cpp:770</code> | unique_name+direct-member+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核 |
| RCE0711 | R0197 | F0563 | <code>海中鱼巣/界面/控制面板窗口.cpp:866, 海中鱼巣/界面/控制面板窗口.cpp:880</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0713 | R0197 | R0171 | <code>海中鱼巣/界面/控制面板窗口.cpp:873, 海中鱼巣/界面/控制面板窗口.cpp:875, 海中鱼巣/界面/控制面板窗口.cpp:877</code> | direct-free |  | None | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0712 | R0197 | R0182 | <code>海中鱼巣/界面/控制面板窗口.cpp:872, 海中鱼巣/界面/控制面板窗口.cpp:874, 海中鱼巣/界面/控制面板窗口.cpp:876</code> | unique_name+direct-member+direct-member+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核 |
| RCE0714 | R0198 | R0153 | <code>海中鱼巣/界面/控制面板窗口.cpp:892</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0717 | R0198 | R0155 | <code>海中鱼巣/界面/控制面板窗口.cpp:897</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0716 | R0198 | R0181 | <code>海中鱼巣/界面/控制面板窗口.cpp:896</code> | unique_name+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0715 | R0198 | R0196 | <code>海中鱼巣/界面/控制面板窗口.cpp:895</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0718 | R0198 | R0197 | <code>海中鱼巣/界面/控制面板窗口.cpp:901</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0720 | R0199 | F0393 | <code>海中鱼巣/界面/控制面板窗口.cpp:908</code> | unique_name+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0726 | R0199 | R0156 | <code>海中鱼巣/界面/控制面板窗口.cpp:921</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0719 | R0199 | R0159 | <code>海中鱼巣/界面/控制面板窗口.cpp:907, 海中鱼巣/界面/控制面板窗口.cpp:923</code> | direct-free |  | None | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0727 | R0199 | R0167 | <code>海中鱼巣/界面/控制面板窗口.cpp:925</code> | unique_name+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0721 | R0199 | R0183 | <code>海中鱼巣/界面/控制面板窗口.cpp:912</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0722 | R0199 | R0191 | <code>海中鱼巣/界面/控制面板窗口.cpp:915</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0723 | R0199 | R0194 | <code>海中鱼巣/界面/控制面板窗口.cpp:918</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0724 | R0199 | R0195 | <code>海中鱼巣/界面/控制面板窗口.cpp:919</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0725 | R0199 | R0198 | <code>海中鱼巣/界面/控制面板窗口.cpp:920</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0728 | R0200 | R0159 | <code>海中鱼巣/界面/控制面板窗口.cpp:931</code> | direct-free |  | None | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0729 | R0200 | R0162 | <code>海中鱼巣/界面/控制面板窗口.cpp:933</code> | direct-free |  | None | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0730 | R0200 | R0199 | <code>海中鱼巣/界面/控制面板窗口.cpp:933</code> | unique_name+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
...
| RCE0784 | R0225 | F0168 | <code>海中鱼巣/领域/初始化.世界树.ixx:137, 海中鱼巣/领域/初始化.世界树.ixx:140, 海中鱼巣/领域/初始化.世界树.ixx:143</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0785 | R0225 | R0075 | <code>海中鱼巣/领域/初始化.世界树.ixx:138, 海中鱼巣/领域/初始化.世界树.ixx:141, 海中鱼巣/领域/初始化.世界树.ixx:144</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0786 | R0225 | R0224 | <code>海中鱼巣/领域/初始化.世界树.ixx:146, 海中鱼巣/领域/初始化.世界树.ixx:147, 海中鱼巣/领域/初始化.世界树.ixx:148</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0796 | R0230 | R0565 | <code>海中鱼巣/领域/初始化.系统角色.ixx:242</code> | direct_const_member |  | None | 形成身份进入后查找具名系统角色键占用材料 | 专项源码静态类型与实际装配人工复核 |
| RCE0804 | R0233 | R0407 | <code>海中鱼巣/领域/初始化.系统角色.ixx:385</code> | direct_const_member |  | None | 目标占用材料存在且已占用，并已读取主键状态材料 | 专项源码静态类型与实际装配人工复核 |
| RCE0805 | R0233 | R0434 | <code>海中鱼巣/领域/初始化.系统角色.ixx:393</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0803 | R0233 | R0565 | <code>海中鱼巣/领域/初始化.系统角色.ixx:355, 海中鱼巣/领域/初始化.系统角色.ixx:356, 海中鱼巣/领域/初始化.系统角色.ixx:357, 海中鱼巣/领域/初始化.系统角色.ixx:358, 海中鱼巣/领域/初始化.系统角色.ixx:359, 海中鱼巣/领域/初始化.系统角色.ixx:360, 海中鱼巣/领域/初始化.系统角色.ixx:361</code> | direct_const_member |  | None | 完成安全组和服务组用途选择后查找七类占用材料 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0807 | R0234 | R0235 | <code>海中鱼巣/领域/初始化.系统角色.ixx:410, 海中鱼巣/领域/初始化.系统角色.ixx:411, 海中鱼巣/领域/初始化.系统角色.ixx:412</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0808 | R0234 | R0497 | <code>海中鱼巣/领域/初始化.系统角色.ixx:418</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0806 | R0234 | R0565 | <code>海中鱼巣/领域/初始化.系统角色.ixx:406, 海中鱼巣/领域/初始化.系统角色.ixx:407, 海中鱼巣/领域/初始化.系统角色.ixx:408, 海中鱼巣/领域/初始化.系统角色.ixx:409</code> | direct_const_member |  | None | 已有方法根语义匹配后查找登记根和三状态角色用途 | 专项源码静态类型与实际装配人工复核 |
| RCE0816 | R0237 | R0343 | <code>海中鱼巣/领域/初始化.系统角色.ixx:494</code> | direct_const_member |  | None | 定义材料完整且身份匹配后复核槽位材料 | 专项源码静态类型与实际装配人工复核 |
| RCE0815 | R0237 | R0390 | <code>海中鱼巣/领域/初始化.系统角色.ixx:492</code> | direct_const_member |  | None | 复核根需求组完成五类材料读取后进入合取链第一项 | 专项源码静态类型与实际装配人工复核 |
| RCE0817 | R0237 | R0407 | <code>海中鱼巣/领域/初始化.系统角色.ixx:502</code> | direct_const_member |  | None | 根需求组特征材料复核通过后复核目标抽象状态完整 | 专项源码静态类型与实际装配人工复核 |
| RCE0818 | R0237 | R0434 | <code>海中鱼巣/领域/初始化.系统角色.ixx:504</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0819 | R0238 | R0407 | <code>海中鱼巣/领域/初始化.系统角色.ixx:518</code> | direct_const_member |  | None | 复核抽象状态进入并读取身份稳定主键材料 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0820 | R0241 | F0163 | <code>海中鱼巣/领域/初始化.语素.ixx:178</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 冻结源码 3920a746 + 本批现状图、逐行映射与重载调用点专项复核 |
...
| RCE0823 | R0241 | F0364 | <code>海中鱼巣/领域/初始化.语素.ixx:182</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0821 | R0241 | R0242 | <code>海中鱼巣/领域/初始化.语素.ixx:178</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0824 | R0241 | R0243 | <code>海中鱼巣/领域/初始化.语素.ixx:184</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0822 | R0241 | R0244 | <code>海中鱼巣/领域/初始化.语素.ixx:179</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0825 | R0241 | R0245 | <code>海中鱼巣/领域/初始化.语素.ixx:185</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE0836 | R0246 | R0245 | <code>海中鱼巣/领域/初始化.语素.ixx:264</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0839 | R0249 | F0163 | <code>海中鱼巣/领域/初始化.需求.ixx:124, 海中鱼巣/领域/初始化.需求.ixx:138, 海中鱼巣/领域/初始化.需求.ixx:142, 海中鱼巣/领域/初始化.需求.ixx:156</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 冻结源码 3920a746 + 本批现状图、逐行映射与重载调用点专项复核 |
| RCE0840 | R0249 | F0184 | <code>海中鱼巣/领域/初始化.需求.ixx:124, 海中鱼巣/领域/初始化.需求.ixx:130, 海中鱼巣/领域/初始化.需求.ixx:138, 海中鱼巣/领域/初始化.需求.ixx:142, 海中鱼巣/领域/初始化.需求.ixx:156, 海中鱼巣/领域/初始化.需求.ixx:178</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0841 | R0249 | F0364 | <code>海中鱼巣/领域/初始化.需求.ixx:128</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0848 | R0249 | F0496 | <code>海中鱼巣/领域/初始化.需求.ixx:165</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0849 | R0249 | F0497 | <code>海中鱼巣/领域/初始化.需求.ixx:166</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0845 | R0249 | F0554 | <code>海中鱼巣/领域/初始化.需求.ixx:161</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0846 | R0249 | F0555 | <code>海中鱼巣/领域/初始化.需求.ixx:162</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0838 | R0249 | R0560 | <code>海中鱼巣/领域/初始化.需求.ixx:123</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0842 | R0249 | R0562 | <code>海中鱼巣/领域/初始化.需求.ixx:143</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0843 | R0249 | R0579 | <code>海中鱼巣/领域/初始化.需求.ixx:148</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0844 | R0249 | R0581 | <code>海中鱼巣/领域/初始化.需求.ixx:159</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0892 | R0275 | R0276 | <code>海中鱼巣/领域/场景服务.h:53</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0986 | R0303 | F0163 | <code>海中鱼巣/领域/控制面板服务.h:203</code> | source-static-type+direct-free |  | None | 控制面板按需树路径；字段静态类型/重载专项复核；根类别在范围内 | 专项源码静态类型与实际装配人工复核 |
| RCE1000 | R0307 | R0278 | <code>海中鱼巣/领域/控制面板服务.h:409</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0996 | R0307 | R0283 | <code>海中鱼巣/领域/控制面板服务.h:352, 海中鱼巣/领域/控制面板服务.h:359</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0997 | R0307 | R0284 | <code>海中鱼巣/领域/控制面板服务.h:361</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1001 | R0307 | R0287 | <code>海中鱼巣/领域/控制面板服务.h:412</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1002 | R0307 | R0289 | <code>海中鱼巣/领域/控制面板服务.h:415</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1003 | R0307 | R0292 | <code>海中鱼巣/领域/控制面板服务.h:418</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0991 | R0307 | R0302 | <code>海中鱼巣/领域/控制面板服务.h:313</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0995 | R0307 | R0313 | <code>海中鱼巣/领域/控制面板服务.h:346, 海中鱼巣/领域/控制面板服务.h:380</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0998 | R0307 | R0317 | <code>海中鱼巣/领域/控制面板服务.h:381</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0994 | R0307 | R0318 | <code>海中鱼巣/领域/控制面板服务.h:339, 海中鱼巣/领域/控制面板服务.h:342</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0992 | R0307 | R0319 | <code>海中鱼巣/领域/控制面板服务.h:315, 海中鱼巣/领域/控制面板服务.h:319, 海中鱼巣/领域/控制面板服务.h:322, 海中鱼巣/领域/控制面板服务.h:325, 海中鱼巣/领域/控制面板服务.h:331, 海中鱼巣/领域/控制面板服务.h:372, 海中鱼巣/领域/控制面板服务.h:375, 海中鱼巣/领域/控制面板服务.h:378, 海中鱼巣/领域/控制面板服务.h:391, 海中鱼巣/领域/控制面板服务.h:397, 海中鱼巣/领域/控制面板服务.h:427</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1004 | R0307 | R0320 | <code>海中鱼巣/领域/控制面板服务.h:434</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0993 | R0307 | R0321 | <code>海中鱼巣/领域/控制面板服务.h:328</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0999 | R0307 | R0326 | <code>海中鱼巣/领域/控制面板服务.h:406</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1059 | R0333 | R0542 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:198</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1075 | R0338 | F0441 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:298</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1073 | R0338 | R0540 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:293</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1074 | R0338 | R0541 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:294</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1192 | R0383 | F0338 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:566</code> | source-audited |  | None | 共享许可静态类型为结构事务许可 | 专项源码静态类型与实际装配人工复核 |
| RCE1193 | R0383 | F0339 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:567</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1194 | R0383 | R0344 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:567</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1306 | R0420 | R0078 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:360</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1307 | R0421 | F0339 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:378</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE2860 | R0421 | F0345 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:376-410</code> | implicit_destructor | this=&amp;许可 | None | 调用方从 F0001 可达且对应源码分支成立 | 冻结源码 3920a746 + 本批现状单函数图、逐行映射与调用点复核 |
...
| RCE1309 | R0421 | R0413 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:380</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1311 | R0421 | R0416 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:392</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1312 | R0421 | R0419 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:398, 海中鱼巣/领域/数据操作.系统角色.ixx:400</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1310 | R0421 | R0420 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:384, 海中鱼巣/领域/数据操作.系统角色.ixx:388</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1308 | R0421 | R0564 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:379</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1341 | R0432 | R0116 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:1632</code> | direct-const-member |  | None | 外层入口前置通过并形成 std::function&lt;void(结构写入会话&amp;)&gt; | 专项源码静态类型与实际装配人工复核 |
| RCE1338 | R0432 | R0430 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:1621, 海中鱼巣/领域/数据操作.需求任务方法.ixx:1649</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1339 | R0432 | R0460 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:1623, 海中鱼巣/领域/数据操作.需求任务方法.ixx:1650</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1340 | R0432 | R0461 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:1628</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1342 | R0432 | R0462 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:1658</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1514 | R0512 | R0423 | <code>海中鱼巣/领域/服务.轻量因果.ixx:52</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1515 | R0514 | R0431 | <code>海中鱼巣/领域/服务.需求.ixx:104</code> | direct-const-member |  | None | 写入规格有值后创建完整目标状态需求 | 专项源码静态类型与实际装配人工复核 |
| RCE1520 | R0514 | R0467 | <code>海中鱼巣/领域/服务.需求.ixx:99</code> | unique_name+direct-const-member | None | None | 调用方可达且源码分支条件成立；状态规格成功后形成完整需求写入规格 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
| RCE1518 | R0514 | R0510 | <code>海中鱼巣/领域/服务.需求.ixx:98</code> | direct-const-member |  | None | 抽象状态规格结果静态类型复核成功 | 专项源码静态类型与实际装配人工复核 |
| RCE1517 | R0514 | R0511 | <code>海中鱼巣/领域/服务.需求.ixx:97</code> | direct-const-member |  | None | 状态服务字段形成目标抽象状态规格 | 专项源码静态类型与实际装配人工复核 |
| RCE1519 | R0514 | R0513 | <code>海中鱼巣/领域/服务.需求.ixx:98</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1527 | R0524 | F0168 | <code>海中鱼巣/领域/概念图服务.h:3958</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1526 | R0524 | F0184 | <code>海中鱼巣/领域/概念图服务.h:3943, 海中鱼巣/领域/概念图服务.h:3947, 海中鱼巣/领域/概念图服务.h:3958</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1543 | R0536 | R0535 | <code>海中鱼巣/领域/概念图算法.h:677</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1554 | R0546 | R0547 | <code>海中鱼巣/领域/特征值服务.h:674</code> | standard-library-callback |  | None | std::find_if 注册非 const Vec 记录匹配谓词 | 专项源码静态类型与实际装配人工复核 |
...
| RCE1575 | R0566 | R0389 | <code>海中鱼巣/领域/组合.特征状态.ixx:40</code> | direct-const-member |  | None | 两份规格成功后创建槽位并发布初始状态 | 专项源码静态类型与实际装配人工复核 |
| RCE1570 | R0566 | R0502 | <code>海中鱼巣/领域/组合.特征状态.ixx:34</code> | unique_name+direct-const-member | None | None | 调用方可达且源码分支条件成立；形成实例特征槽位规格 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
| RCE1574 | R0566 | R0503 | <code>海中鱼巣/领域/组合.特征状态.ixx:37</code> | unique_name+direct-const-member | None | None | 调用方可达且源码分支条件成立；形成初始特征值规格 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
...
| RCE1573 | R0566 | R0567 | <code>海中鱼巣/领域/组合.特征状态.ixx:36, 海中鱼巣/领域/组合.特征状态.ixx:39</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE2040 | R0689 | R0684 | <code>海中鱼巣/领域/数据操作.轻量因果.ixx:140, 海中鱼巣/领域/数据操作.轻量因果.ixx:168</code> | direct_const_member | 规格 | 被调函数结果按当前调用表达式接收或用于条件判断 | 外层创建函数在写前读取或写后读回幂等主键 | 本批逐函数源码函数范围、静态接收者与调用点拆账复核 |
...
| RCE3619 | R1006 | F0438 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1823</code> | formal_03a8_identity | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3620 | R1006 | R0745 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2789</code> | formal_03a8_identity | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3571 | R1006 | R0919 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1445</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3552 | R1006 | R0920 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1464, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1551, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1577, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1579, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1647, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1674, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1694, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1696, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1700, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1703, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1816, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1824, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1848, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1879, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1883, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1885, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1888, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1893, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2010, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2032, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2052, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2055, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2059, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2061, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2248, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2271, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2309, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2313, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2317, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2319, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2448, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2455, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2468, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2483, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2491, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2507, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2516, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2562, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2564, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2578, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2579, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2580, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2589, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2595, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2605, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2648, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2651, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2789, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2816, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2843, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2872, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2880, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2888, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2961, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2964, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2966, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2967, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2968, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2969, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2977, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2989, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3002, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3007</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3554 | R1006 | R0921 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1449</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3559 | R1006 | R0923 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1469, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1499, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1531, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1572, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1582, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1612, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1712, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1740, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1769, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1902, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1926, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1956, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2076, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2100, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2130, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2332, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2356, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2386, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2583, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2614, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2638, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2671, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3015, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3041, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3047, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3076, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3097</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3561 | R1006 | R0927 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1444</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3562 | R1006 | R0929 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1581, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1705, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1890, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2063, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2321, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2582, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2971</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3563 | R1006 | R0936 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1424</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3564 | R1006 | R0952 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2551, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2553</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3565 | R1006 | R0953 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2300, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2301, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2302, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2548, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2897, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2899, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2902, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2903, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2904, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2905, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2908, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2910, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2913, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2915</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3566 | R1006 | R0955 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2552, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2898, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2906, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2907, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2914</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3567 | R1006 | R0956 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2550, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2912</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3568 | R1006 | R0963 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1473</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3569 | R1006 | R0969 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2192, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2782, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2805</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3570 | R1006 | R0971 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1478</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3553 | R1006 | R0975 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1485, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2305, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2555, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2917</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3555 | R1006 | R0977 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1428</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3556 | R1006 | R0978 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1453, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1713, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1898, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2072, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2328, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2610, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2972</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3557 | R1006 | R0985 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2197</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3558 | R1006 | R0989 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1429</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3560 | R1006 | R0999 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1464</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3621 | R1006 | R1007 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1621</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3622 | R1006 | R1008 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1638</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3590 | R1006 | R1009 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1752</code> | frozen_source_exact_local_lambda_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3623 | R1006 | R1010 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1775</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4528 | R1006 | R1011 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1779</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3624 | R1006 | R1012 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1796</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3589 | R1006 | R1013 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1937</code> | frozen_source_exact_local_lambda_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4529 | R1006 | R1014 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1870</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4530 | R1006 | R1015 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1887</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3625 | R1006 | R1016 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1963</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3626 | R1006 | R1017 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1979</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3627 | R1006 | R1018 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1998</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3591 | R1006 | R1019 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2111</code> | frozen_source_exact_local_lambda_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3628 | R1006 | R1020 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2068</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3629 | R1006 | R1021 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2136</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3630 | R1006 | R1022 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2140</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3631 | R1006 | R1023 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2163</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3617 | R1006 | R1024 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2193, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2213</code> | frozen_source_exact_local_lambda_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3632 | R1006 | R1025 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2224</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3588 | R1006 | R1026 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2367</code> | frozen_source_exact_local_lambda_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4531 | R1006 | R1027 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2294</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3633 | R1006 | R1028 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2392</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3634 | R1006 | R1029 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2398</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3635 | R1006 | R1030 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2415</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3636 | R1006 | R1032 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2425</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4533 | R1006 | R1033 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2539</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3637 | R1006 | R1034 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2677</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3638 | R1006 | R1035 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2683</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4534 | R1006 | R1036 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2718</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3639 | R1006 | R1037 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2732</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3618 | R1006 | R1040 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2806, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2807, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2836</code> | frozen_source_exact_local_lambda_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3587 | R1006 | R1041 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3057</code> | frozen_source_exact_local_lambda_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4536 | R1006 | R1042 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2933</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4537 | R1006 | R1043 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2942</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4538 | R1006 | R1044 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2951</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3572 | R1006 | R1074 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1450</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3573 | R1006 | R1111 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1579, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1700, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1703, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1885, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1888, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2059, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2061, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2317, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2319, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2578, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2580, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2967, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2968, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2969</code> | virtual_dispatch_target | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3574 | R1006 | R1112 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1579, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1700, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1703, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1885, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1888, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2059, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2061, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2317, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2319, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2578, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2580, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2967, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2968, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2969</code> | virtual_dispatch_target | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3575 | R1006 | R1115 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1497</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3576 | R1006 | R1116 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1595, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1725, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1911, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2085, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2341, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2623, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3026</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3577 | R1006 | R1117 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1524, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1564, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1760, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1946, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2120, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2376, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2661, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3066, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3089</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3578 | R1006 | R1126 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1579, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1700, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1703, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1885, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1888, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2059, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2061, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2317, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2319, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2578, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2580, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2967, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2968, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2969</code> | virtual_dispatch_target | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3581 | R1006 | R1163 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2454, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2842</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3582 | R1006 | R1164 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2467</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3583 | R1006 | R1166 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2589, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3002</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3579 | R1006 | R1169 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2651</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3586 | R1006 | R1188 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1823</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3593 | R1006 | R1203 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2814</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3594 | R1006 | R1204 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1824</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3595 | R1006 | R1208 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1815, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1892, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2988</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3592 | R1006 | R1223 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1848, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2880</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3601 | R1006 | R1286 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1426, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1427</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3597 | R1006 | R1318 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1515</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3598 | R1006 | R1319 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1568, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1765, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1952, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2126, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2382, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2667, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3072, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3093</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3596 | R1006 | R1321 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1601, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1606, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1610, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1729, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1734, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1738, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1915, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1920, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1924, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2089, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2094, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2098, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2345, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2350, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2354, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2627, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2632, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2636, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3030, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3035, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3039</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3600 | R1006 | R1329 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1550, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1694, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1879, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2051, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2309, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2562, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2961</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3599 | R1006 | R1330 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1577, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1696, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1883, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2055, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2313, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2564, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2964</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3605 | R1006 | R1348 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1997, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2066, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2223, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2324</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3603 | R1006 | R1350 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2248</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3604 | R1006 | R1351 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2009</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3602 | R1006 | R1352 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2032, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2271</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3608 | R1006 | R1382 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1708, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2194</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3607 | R1006 | R1383 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1646</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3606 | R1006 | R1384 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1674</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3585 | R1006 | R1417 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1437</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3584 | R1006 | R1418 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1438</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3612 | R1006 | R1430 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2872</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3609 | R1006 | R1432 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2966</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3614 | R1006 | R1433 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2491</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3613 | R1006 | R1434 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2516</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3611 | R1006 | R1435 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2647</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3610 | R1006 | R1436 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2579</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3616 | R1006 | R1438 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2595, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3007</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3615 | R1006 | R1441 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2448, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2482, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2604, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2976</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3580 | R1006 | R1487 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2507, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2888</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3648 | R1049 | R1113 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3137-3144, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3140</code> | virtual_dispatch_target | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3649 | R1049 | R1114 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3137-3144, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3140</code> | virtual_dispatch_target | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3650 | R1049 | R1127 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3137-3144, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:3140</code> | virtual_dispatch_target | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4507 | R1059 | R1060 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:136</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3378 | R1073 | R1075 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:412, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:413, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:417, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:438, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:439, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:443, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:453</code> | raw_full_signature_rebound_to_sibling_payload | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4485 | R1073 | R1076 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:467</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3369 | R1073 | R1077 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:403, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:404, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:405, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:409, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:414, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:415, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:417, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:436, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:439, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:440, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:441, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:442, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:443, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:444, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:450, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:453, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:457, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:458, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:459</code> | local_lambda_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3370 | R1073 | R1078 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:442, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:444, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:446, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:447, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:467</code> | local_lambda_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3371 | R1073 | R1079 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:445, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:446, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:460</code> | local_lambda_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3372 | R1073 | R1080 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:440, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:441, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:443, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:456</code> | local_lambda_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3373 | R1073 | R1081 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:440, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:441, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:443, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:456</code> | local_lambda_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4518 | R1073 | R1083 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:346</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3374 | R1073 | R1085 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:441, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:443, 海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:445</code> | local_lambda_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3375 | R1073 | R1086 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:443</code> | local_lambda_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3376 | R1073 | R1087 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:439</code> | local_lambda_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3379 | R1073 | R1088 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:431</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3380 | R1073 | R1089 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:463</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3377 | R1073 | R1294 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:443</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3755 | R1137 | R0022 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:804, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:805</code> | formal_03a8_identity | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3745 | R1137 | R1097 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:802, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:803</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3746 | R1137 | R1101 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:809, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:810</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3747 | R1137 | R1102 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:809, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:810</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3749 | R1137 | R1209 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:814</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3748 | R1137 | R1242 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:806, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:817, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:820</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3754 | R1137 | R1245 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:811</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3750 | R1137 | R1246 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:815</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3752 | R1137 | R1247 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:817</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3751 | R1137 | R1248 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:819</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3753 | R1137 | R1249 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:820</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3982 | R1227 | F0168 | <code>海中鱼巣/核心/仓库.正式关系.ixx:707</code> | direct | 句柄 | 有效性布尔值 | 无条件 | 4b80f161 冻结源码逐调用点复核 |
| RCE4139 | R1296 | R1282 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:168</code> | defaulted | vector元素比较 | bool | 编译器生成比较体 | 4b80f161 冻结源码逐调用点复核 |
| RCE4140 | R1297 | R1458 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:176</code> | defaulted | 材料身份成员比较 | bool | 编译器生成比较体 | 4b80f161 冻结源码逐调用点复核 |
| RCE4103 | R1305 | R1287 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:252</code> | defaulted | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4142 | R1308 | R1282 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:311</code> | defaulted | optional节点目标比较 | bool | 编译器生成比较体 | 4b80f161 冻结源码逐调用点复核 |
| RCE4138 | R1308 | R1284 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:311</code> | defaulted | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4141 | R1308 | R1291 | <code>海中鱼巣/核心/节点直接结构合同.数据.h:311</code> | defaulted | 索引键成员比较 | bool | 编译器生成比较体 | 4b80f161 冻结源码逐调用点复核 |
| RCE4093 | R1335 | R1285 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:355</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4322 | R1335 | R1286 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:355</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4320 | R1335 | R1333 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:355</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4323 | R1335 | R1336 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:356</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4324 | R1335 | R1337 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:361</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4097 | R1341 | R1285 | <code>海中鱼巣/核心/仓库.节点直接事务幂等.ixx:392</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4280 | R1365 | R1457 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:410</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4106 | R1368 | R1289 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:430</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4282 | R1368 | R1366 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:430</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4285 | R1368 | R1369 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:431</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4286 | R1368 | R1370 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:434</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4287 | R1368 | R1371 | <code>海中鱼巣/核心/仓库.节点直接类型化值.ixx:438</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4099 | R1396 | R1287 | <code>海中鱼巣/核心/仓库.节点直接类型合同.ixx:328</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4250 | R1396 | R1395 | <code>海中鱼巣/核心/仓库.节点直接类型合同.ixx:328</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4251 | R1396 | R1397 | <code>海中鱼巣/核心/仓库.节点直接类型合同.ixx:329</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4252 | R1396 | R1398 | <code>海中鱼巣/核心/仓库.节点直接类型合同.ixx:332</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4253 | R1396 | R1399 | <code>海中鱼巣/核心/仓库.节点直接类型合同.ixx:336</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4328 | R1409 | R1457 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:148</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
...
| RCE0418 | R0062 | R0006 | <code>海中鱼巣/核心/会话.结构写入.ixx:951</code> | direct-const-member |  | None | 逆序撤销主信息候选 | 专项源码静态类型与实际装配人工复核 |
| RCE0412 | R0062 | R0043 | <code>海中鱼巣/核心/会话.结构写入.ixx:931</code> | unique_name+direct-const-member |  | None | 调用方可达且源码分支条件成立；完成撤销入口复核当前线程 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0413 | R0062 | R0072 | <code>海中鱼巣/核心/会话.结构写入.ixx:938</code> | unique_name+direct-const-member | None | None | 调用方可达且源码分支条件成立；逆序撤销关系变更 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
| RCE0416 | R0062 | R0076 | <code>海中鱼巣/核心/会话.结构写入.ixx:945</code> | unique_name+direct-const-member | None | None | 调用方可达且源码分支条件成立；逆序严格删除新关系 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
| RCE0415 | R0062 | R0125 | <code>海中鱼巣/核心/会话.结构写入.ixx:941, 海中鱼巣/核心/会话.结构写入.ixx:942</code> | unique_name+direct-const-member | None | None | 调用方可达且源码分支条件成立；逆序严格删除索引绑定 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
| RCE0414 | R0062 | R0138 | <code>海中鱼巣/核心/会话.结构写入.ixx:938, 海中鱼巣/核心/会话.结构写入.ixx:942, 海中鱼巣/核心/会话.结构写入.ixx:945, 海中鱼巣/核心/会话.结构写入.ixx:948, 海中鱼巣/核心/会话.结构写入.ixx:951</code> | direct-const-member |  | None | 每项撤销或严格删除后复核成功 | 专项源码静态类型与实际装配人工复核 |
| RCE0417 | R0062 | R0144 | <code>海中鱼巣/核心/会话.结构写入.ixx:948</code> | direct-const-member |  | None | 逆序撤销节点候选 | 专项源码静态类型与实际装配人工复核 |
| RCE0454 | R0071 | R0064 | <code>海中鱼巣/核心/关系仓库.cpp:1385</code> | direct-free |  | None | 锁内复核写后关系记录；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0451 | R0071 | R0070 | <code>海中鱼巣/核心/关系仓库.cpp:1375</code> | direct-const-member+direct-member |  | None | 复核关系变更能力完整；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0453 | R0071 | R0080 | <code>海中鱼巣/核心/关系仓库.cpp:1381</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
| RCE0450 | R0071 | R0091 | <code>海中鱼巣/核心/关系仓库.cpp:1374</code> | direct-free |  | None | 结构化确认入口验证独占令牌；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0452 | R0071 | R0092 | <code>海中鱼巣/核心/关系仓库.cpp:1377</code> | direct-free |  | None | 复核能力令牌一致；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0449 | R0071 | R0095 | <code>海中鱼巣/核心/关系仓库.cpp:1368</code> | direct-const-member |  | None | 结构化确认先读取能力写后记录 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0470 | R0075 | F0590 | <code>海中鱼巣/核心/关系仓库.cpp:1448</code> | direct-member |  | None | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0542 | R0107 | R0106 | <code>海中鱼巣/核心/执行器.结构写入.ixx:372</code> | suffix_match+source-audited | None | None | 调用方可达且源码分支条件成立；撤销失败进入隔离标记 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0591 | R0127 | F0051 | <code>海中鱼巣/核心/索引仓库.h:52</code> | operator |  | None | 比较绑定节点句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE0592 | R0127 | R0132 | <code>海中鱼巣/核心/索引仓库.h:53</code> | operator |  | None | 比较所有者声明 | 专项源码静态类型与实际装配人工复核 |
| RCE0605 | R0142 | R0141 | <code>海中鱼巣/核心/节点仓库.cpp:167</code> | suffix_match+direct-const-member+direct-member | None | None | 调用方可达且源码分支条件成立；候选处于未发布阶段时执行确认；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核 |
| RCE0607 | R0142 | R0145 | <code>海中鱼巣/核心/节点仓库.cpp:151</code> | direct-free |  | None | 结构化确认入口验证独占令牌；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0608 | R0142 | R0146 | <code>海中鱼巣/核心/节点仓库.cpp:155</code> | direct-free |  | None | 复核候选令牌一致；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0606 | R0142 | R0148 | <code>海中鱼巣/核心/节点仓库.cpp:149</code> | direct-const-member |  | None | 结构化确认先读取候选节点 | 专项源码静态类型与实际装配人工复核 |
| RCE0609 | R0143 | F0632 | <code>海中鱼巣/核心/节点仓库.cpp:179</code> | direct-const-member+direct-free |  | None | 撤销候选入口验证共享令牌；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0610 | R0143 | R0146 | <code>海中鱼巣/核心/节点仓库.cpp:181</code> | direct-const-member+direct-free |  | None | 复核候选令牌一致；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0674 | R0171 | F0268 | <code>海中鱼巣/界面/控制面板窗口.cpp:193</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0675 | R0171 | F0270 | <code>海中鱼巣/界面/控制面板窗口.cpp:194</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0676 | R0171 | R0170 | <code>海中鱼巣/界面/控制面板窗口.cpp:198</code> | lsp_direct+direct-free | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | LSP 直接解析并经源码调用词复核；专项源码静态类型与实际装配人工复核 |
| RCE0678 | R0173 | R0172 | <code>海中鱼巣/界面/控制面板窗口.cpp:213</code> | direct-free |  | None | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0679 | R0174 | F0168 | <code>海中鱼巣/界面/控制面板窗口.cpp:219</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0680 | R0174 | R0174 | <code>海中鱼巣/界面/控制面板窗口.cpp:229</code> | direct-free |  | None | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0696 | R0187 | F0393 | <code>海中鱼巣/界面/控制面板窗口.cpp:610</code> | unique_name+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0695 | R0187 | R0184 | <code>海中鱼巣/界面/控制面板窗口.cpp:607</code> | unique_name+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0697 | R0187 | R0187 | <code>海中鱼巣/界面/控制面板窗口.cpp:614</code> | direct-member |  | None | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0698 | R0188 | F0393 | <code>海中鱼巣/界面/控制面板窗口.cpp:624, 海中鱼巣/界面/控制面板窗口.cpp:635</code> | unique_name+direct-member+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核 |
| RCE0699 | R0188 | R0184 | <code>海中鱼巣/界面/控制面板窗口.cpp:632</code> | unique_name+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0710 | R0196 | R0181 | <code>海中鱼巣/界面/控制面板窗口.cpp:787, 海中鱼巣/界面/控制面板窗口.cpp:803, 海中鱼巣/界面/控制面板窗口.cpp:822</code> | unique_name+direct-member+direct-member+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核 |
...
| RCE0783 | R0224 | R0008 | <code>海中鱼巣/领域/初始化.世界树.ixx:133</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0782 | R0224 | R0147 | <code>海中鱼巣/领域/初始化.世界树.ixx:132</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0809 | R0235 | R0407 | <code>海中鱼巣/领域/初始化.系统角色.ixx:430</code> | direct_const_member |  | None | 占用材料非空且已占用，并已读取主键状态材料 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0826 | R0242 | F0624 | <code>海中鱼巣/领域/初始化.语素.ixx:195</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 冻结源码 3920a746 + 本批现状图、逐行映射与重载调用点专项复核 |
| RCE0827 | R0243 | F0496 | <code>海中鱼巣/领域/初始化.语素.ixx:199</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0828 | R0243 | F0497 | <code>海中鱼巣/领域/初始化.语素.ixx:200</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0829 | R0244 | F0523 | <code>海中鱼巣/领域/初始化.语素.ixx:220</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 冻结源码 3920a746 + 本批现状图、逐行映射与重载调用点专项复核 |
| RCE0830 | R0244 | R0761 | <code>海中鱼巣/领域/初始化.语素.ixx:221</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 冻结源码 3920a746 + 本批现状图、逐行映射与重载调用点专项复核 |
...
| RCE0831 | R0245 | F0168 | <code>海中鱼巣/领域/初始化.语素.ixx:225, 海中鱼巣/领域/初始化.语素.ixx:228</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 冻结源码 3920a746 + 本批现状图、逐行映射与重载调用点专项复核 |
| RCE0833 | R0245 | F0523 | <code>海中鱼巣/领域/初始化.语素.ixx:232</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 冻结源码 3920a746 + 本批现状图、逐行映射与重载调用点专项复核 |
...
| RCE0832 | R0245 | F0590 | <code>海中鱼巣/领域/初始化.语素.ixx:226, 海中鱼巣/领域/初始化.语素.ixx:229</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 冻结源码 3920a746 + 本批现状图、逐行映射与重载调用点专项复核 |
| RCE0835 | R0245 | R0244 | <code>海中鱼巣/领域/初始化.语素.ixx:237</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0834 | R0245 | R0761 | <code>海中鱼巣/领域/初始化.语素.ixx:235</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 冻结源码 3920a746 + 本批现状图、逐行映射与重载调用点专项复核 |
| RCE0893 | R0278 | R0314 | <code>海中鱼巣/领域/控制面板服务.h:1019</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0894 | R0278 | R0325 | <code>海中鱼巣/领域/控制面板服务.h:1048</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0895 | R0278 | R0328 | <code>海中鱼巣/领域/控制面板服务.h:1050</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE0908 | R0283 | F0190 | <code>海中鱼巣/领域/控制面板服务.h:1224</code> | source-static-type |  | None | 控制面板按需树路径；字段静态类型/重载专项复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0907 | R0283 | R0214 | <code>海中鱼巣/领域/控制面板服务.h:1222</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0905 | R0283 | R0313 | <code>海中鱼巣/领域/控制面板服务.h:1211, 海中鱼巣/领域/控制面板服务.h:1232</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0906 | R0283 | R0580 | <code>海中鱼巣/领域/控制面板服务.h:1218</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0909 | R0284 | F0190 | <code>海中鱼巣/领域/控制面板服务.h:1248, 海中鱼巣/领域/控制面板服务.h:1257</code> | source-static-type |  | None | 控制面板按需树路径；字段静态类型/重载专项复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0910 | R0284 | R0217 | <code>海中鱼巣/领域/控制面板服务.h:1253</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0912 | R0284 | R0285 | <code>海中鱼巣/领域/控制面板服务.h:1266</code> | standard-library-callback |  | None | std::sort 注册局部比较 lambda | 专项源码静态类型与实际装配人工复核 |
| RCE0911 | R0284 | R0313 | <code>海中鱼巣/领域/控制面板服务.h:1265</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0938 | R0287 | R0286 | <code>海中鱼巣/领域/控制面板服务.h:1386</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0937 | R0287 | R0313 | <code>海中鱼巣/领域/控制面板服务.h:1374</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0936 | R0287 | R0314 | <code>海中鱼巣/领域/控制面板服务.h:1373</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0954 | R0289 | R0288 | <code>海中鱼巣/领域/控制面板服务.h:1468</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0953 | R0289 | R0313 | <code>海中鱼巣/领域/控制面板服务.h:1456</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0952 | R0289 | R0314 | <code>海中鱼巣/领域/控制面板服务.h:1455</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE0973 | R0292 | R0282 | <code>海中鱼巣/领域/控制面板服务.h:1647</code> | direct-const-member |  | None | 方法来源任务具体句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE0972 | R0292 | R0290 | <code>海中鱼巣/领域/控制面板服务.h:1631</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0971 | R0292 | R0293 | <code>海中鱼巣/领域/控制面板服务.h:1615</code> | standard-library-callback |  | None | std::sort 注册局部比较 lambda | 专项源码静态类型与实际装配人工复核 |
| RCE0970 | R0292 | R0313 | <code>海中鱼巣/领域/控制面板服务.h:1604</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0969 | R0292 | R0314 | <code>海中鱼巣/领域/控制面板服务.h:1603</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1005 | R0308 | R0302 | <code>海中鱼巣/领域/控制面板服务.h:555</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1007 | R0313 | R0309 | <code>海中鱼巣/领域/控制面板服务.h:626</code> | standard-library-callback |  | None | std::sort 注册具名比较函数 | 专项源码静态类型与实际装配人工复核 |
| RCE1008 | R0317 | R0316 | <code>海中鱼巣/领域/控制面板服务.h:665, 海中鱼巣/领域/控制面板服务.h:666, 海中鱼巣/领域/控制面板服务.h:667, 海中鱼巣/领域/控制面板服务.h:669, 海中鱼巣/领域/控制面板服务.h:670, 海中鱼巣/领域/控制面板服务.h:671, 海中鱼巣/领域/控制面板服务.h:674, 海中鱼巣/领域/控制面板服务.h:675, 海中鱼巣/领域/控制面板服务.h:676</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1009 | R0318 | F0163 | <code>海中鱼巣/领域/控制面板服务.h:696</code> | source-static-type |  | None | 控制面板按需树路径；字段静态类型/重载专项复核 | 专项源码静态类型与实际装配人工复核 |
| RCE1011 | R0318 | R0313 | <code>海中鱼巣/领域/控制面板服务.h:703</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1013 | R0320 | R0296 | <code>海中鱼巣/领域/控制面板服务.h:734</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1014 | R0320 | R0299 | <code>海中鱼巣/领域/控制面板服务.h:735</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1015 | R0320 | R0301 | <code>海中鱼巣/领域/控制面板服务.h:738</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1012 | R0320 | R0319 | <code>海中鱼巣/领域/控制面板服务.h:732, 海中鱼巣/领域/控制面板服务.h:740</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1023 | R0321 | F0190 | <code>海中鱼巣/领域/控制面板服务.h:788</code> | source-static-type |  | None | 控制面板按需树路径；字段静态类型/重载专项复核 | 专项源码静态类型与实际装配人工复核 |
| RCE1019 | R0321 | F0355 | <code>海中鱼巣/领域/控制面板服务.h:768</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1029 | R0321 | R0279 | <code>海中鱼巣/领域/控制面板服务.h:857</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1022 | R0321 | R0313 | <code>海中鱼巣/领域/控制面板服务.h:780, 海中鱼巣/领域/控制面板服务.h:806</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1016 | R0321 | R0314 | <code>海中鱼巣/领域/控制面板服务.h:763</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1024 | R0321 | R0315 | <code>海中鱼巣/领域/控制面板服务.h:795</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1026 | R0321 | R0317 | <code>海中鱼巣/领域/控制面板服务.h:824</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1017 | R0321 | R0319 | <code>海中鱼巣/领域/控制面板服务.h:765, 海中鱼巣/领域/控制面板服务.h:771, 海中鱼巣/领域/控制面板服务.h:792, 海中鱼巣/领域/控制面板服务.h:811, 海中鱼巣/领域/控制面板服务.h:822, 海中鱼巣/领域/控制面板服务.h:827, 海中鱼巣/领域/控制面板服务.h:834, 海中鱼巣/领域/控制面板服务.h:836, 海中鱼巣/领域/控制面板服务.h:839, 海中鱼巣/领域/控制面板服务.h:844, 海中鱼巣/领域/控制面板服务.h:850, 海中鱼巣/领域/控制面板服务.h:854, 海中鱼巣/领域/控制面板服务.h:859</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1030 | R0321 | R0320 | <code>海中鱼巣/领域/控制面板服务.h:868</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1021 | R0321 | R0322 | <code>海中鱼巣/领域/控制面板服务.h:773</code> | standard-library-callback |  | None | std::sort 注册局部比较 lambda | 专项源码静态类型与实际装配人工复核 |
| RCE1025 | R0321 | R0323 | <code>海中鱼巣/领域/控制面板服务.h:808</code> | standard-library-callback |  | None | std::all_of 注册局部判定 lambda | 专项源码静态类型与实际装配人工复核 |
| RCE1018 | R0321 | R0515 | <code>海中鱼巣/领域/控制面板服务.h:767</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1020 | R0321 | R0516 | <code>海中鱼巣/领域/控制面板服务.h:769</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1027 | R0321 | R0517 | <code>海中鱼巣/领域/控制面板服务.h:829</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1028 | R0321 | R0530 | <code>海中鱼巣/领域/控制面板服务.h:831</code> | source-static-type |  | None | 抽象树读回已返回 | 专项源码静态类型与实际装配人工复核 |
...
| RCE1042 | R0326 | R0314 | <code>海中鱼巣/领域/控制面板服务.h:938</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1043 | R0326 | R0325 | <code>海中鱼巣/领域/控制面板服务.h:967</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1085 | R0341 | R0023 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:87</code> | direct-member |  | None | 全新前置及三项状态写入成功后创建根组关系 | 专项源码静态类型与实际装配人工复核；专项复核改挂到非平凡业务 lambda |
| RCE1081 | R0341 | R0041 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:119</code> | direct-member |  | None | 候选材料完整后请求提交 | 专项源码静态类型与实际装配人工复核；专项复核改挂到非平凡业务 lambda |
| RCE1084 | R0341 | R0334 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:81, 海中鱼巣/领域/数据操作.概念活动.ixx:82, 海中鱼巣/领域/数据操作.概念活动.ixx:83</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项复核改挂到非平凡业务 lambda |
| RCE1082 | R0341 | R0335 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:64</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项复核改挂到非平凡业务 lambda |
| RCE1086 | R0341 | R0336 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:96</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项复核改挂到非平凡业务 lambda |
| RCE1080 | R0341 | R0337 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:110</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项复核改挂到非平凡业务 lambda |
...
| RCE1083 | R0341 | R0403 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:69, 海中鱼巣/领域/数据操作.概念活动.ixx:70, 海中鱼巣/领域/数据操作.概念活动.ixx:71</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核；专项复核改挂到非平凡业务 lambda |
...
| RCE1087 | R0343 | F0163 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:104, 海中鱼巣/领域/数据操作.特征体系.ixx:105</code> | direct |  | None | 复核宿主、特征定义和实例槽位节点句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE1088 | R0343 | F0565 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:105</code> | direct |  | None | 复核槽位主信息句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE1089 | R0343 | R0387 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:106</code> | direct_const_member |  | None | 复核宿主关系和模板关系证据 | 专项源码静态类型与实际装配人工复核 |
| RCE1090 | R0344 | F0168 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1028</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1091 | R0344 | R0345 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1035</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1216 | R0389 | F0444 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:835</code> | suffix_match |  | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1233 | R0389 | R0103 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:885</code> | direct-template-member |  | None | 外层入口前置通过并形成结构写入会话回调 | 专项源码静态类型与实际装配人工复核 |
| RCE1232 | R0389 | R0269 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:884</code> | constructor |  | None | 创建槽位并发布初始状态时构造本次原始材料事务参与者 | 专项源码静态类型与实际装配人工复核 |
| RCE1222 | R0389 | R0342 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:842</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1224 | R0389 | R0343 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:846, 海中鱼巣/领域/数据操作.特征体系.ixx:862, 海中鱼巣/领域/数据操作.特征体系.ixx:902</code> | source-audited |  | None | 写前与写后槽位静态类型为特征槽位值式材料 | 专项源码静态类型与实际装配人工复核 |
| RCE1231 | R0389 | R0353 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:857</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1217 | R0389 | R0374 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:835</code> | source-audited |  | None | 槽位规格静态类型复核完整 | 专项源码静态类型与实际装配人工复核 |
...
| RCE1218 | R0389 | R0380 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:835</code> | source-audited |  | None | 初始值规格静态类型复核完整 | 专项源码静态类型与实际装配人工复核 |
| RCE1219 | R0389 | R0383 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:837</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1230 | R0389 | R0384 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:856</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1223 | R0389 | R0385 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:844, 海中鱼巣/领域/数据操作.特征体系.ixx:860, 海中鱼巣/领域/数据操作.特征体系.ixx:900</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1225 | R0389 | R0386 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:847, 海中鱼巣/领域/数据操作.特征体系.ixx:863, 海中鱼巣/领域/数据操作.特征体系.ixx:903</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1220 | R0389 | R0390 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:839</code> | source-audited |  | None | 定义静态类型为特征定义值式材料 | 专项源码静态类型与实际装配人工复核 |
...
| RCE1235 | R0390 | F0163 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:88</code> | direct |  | None | 复核特征定义节点句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE1236 | R0390 | F0565 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:88</code> | direct |  | None | 复核特征定义主信息句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE1267 | R0404 | F0163 | <code>海中鱼巣/领域/数据操作.状态动态.ixx:60</code> | direct |  | None | 关系值式证据复核源和目标节点句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE1268 | R0404 | F0168 | <code>海中鱼巣/领域/数据操作.状态动态.ixx:60</code> | unique_name+direct | None | None | 调用方可达且源码分支条件成立；关系值式证据复核关系句柄 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
...
| RCE1289 | R0410 | R0041 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:152</code> | direct-member |  | None | 世界拓扑结构发生变化后请求提交 | 专项源码静态类型与实际装配人工复核；专项复核改挂到非平凡业务 lambda |
| RCE1286 | R0410 | R0415 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:133</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项复核改挂到非平凡业务 lambda |
| RCE1287 | R0410 | R0417 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:134</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项复核改挂到非平凡业务 lambda |
| RCE1288 | R0410 | R0418 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:139, 海中鱼巣/领域/数据操作.系统角色.ixx:145</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项复核改挂到非平凡业务 lambda |
...
| RCE1290 | R0413 | F0441 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:237</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1304 | R0419 | R0079 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:342</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1305 | R0419 | R0416 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:351</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1320 | R0423 | F0339 | <code>海中鱼巣/领域/数据操作.轻量因果.ixx:129, 海中鱼巣/领域/数据操作.轻量因果.ixx:131</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1321 | R0423 | F0441 | <code>海中鱼巣/领域/数据操作.轻量因果.ixx:129</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1319 | R0423 | F0446 | <code>海中鱼巣/领域/数据操作.轻量因果.ixx:126</code> | suffix_match |  | None | 调用方可达且源码分支条件成立 | 冻结源码逐调用点、静态类型与已发布身份表复核 |
| RCE1322 | R0423 | R0425 | <code>海中鱼巣/领域/数据操作.轻量因果.ixx:131</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1334 | R0430 | F0339 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:1163, 海中鱼巣/领域/数据操作.需求任务方法.ixx:1165</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1335 | R0430 | F0441 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:1163</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1336 | R0430 | R0448 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:1165</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1337 | R0431 | R0454 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:1214</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1346 | R0433 | R0036 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:1646</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核；专项复核改挂到非平凡业务 lambda |
| RCE1347 | R0433 | R0037 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:1646</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核；专项复核改挂到非平凡业务 lambda |
| RCE1349 | R0433 | R0041 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:1647</code> | direct-member |  | None | 主信息、节点和主键绑定读回匹配后请求提交 | 专项源码静态类型与实际装配人工复核；专项复核改挂到非平凡业务 lambda |
...
| RCE1344 | R0433 | R0403 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:1635, 海中鱼巣/领域/数据操作.需求任务方法.ixx:1636, 海中鱼巣/领域/数据操作.需求任务方法.ixx:1637</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核；专项复核改挂到非平凡业务 lambda |
| RCE1343 | R0433 | R0451 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:1634</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项复核改挂到非平凡业务 lambda |
| RCE1345 | R0433 | R0452 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:1643, 海中鱼巣/领域/数据操作.需求任务方法.ixx:1644, 海中鱼巣/领域/数据操作.需求任务方法.ixx:1645</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项复核改挂到非平凡业务 lambda |
...
| RCE1510 | R0502 | R0381 | <code>海中鱼巣/领域/服务.特征.ixx:126</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1507 | R0502 | R0390 | <code>海中鱼巣/领域/服务.特征.ixx:122</code> | direct-const-member |  | None | 定义材料静态类型复核完整 | 专项源码静态类型与实际装配人工复核 |
| RCE1509 | R0502 | R0505 | <code>海中鱼巣/领域/服务.特征.ixx:125</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1508 | R0502 | R0507 | <code>海中鱼巣/领域/服务.特征.ixx:123</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1512 | R0503 | R0382 | <code>海中鱼巣/领域/服务.特征.ixx:139</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1511 | R0503 | R0506 | <code>海中鱼巣/领域/服务.特征.ixx:138</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1552 | R0544 | R0543 | <code>海中鱼巣/领域/特征值服务.h:585, 海中鱼巣/领域/特征值服务.h:588</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1555 | R0547 | F0051 | <code>海中鱼巣/领域/特征值服务.h:675</code> | direct-free |  | None | Vec 记录节点句柄与目标节点句柄比较 | 专项源码静态类型与实际装配人工复核 |
| RCE1556 | R0548 | R0549 | <code>海中鱼巣/领域/特征值服务.h:680</code> | standard-library-callback |  | None | std::find_if 注册 const Vec 记录匹配谓词 | 专项源码静态类型与实际装配人工复核 |
| RCE1560 | R0552 | R0553 | <code>海中鱼巣/领域/特征值服务.h:692</code> | standard-library-callback |  | None | std::find_if 注册 const I64 记录匹配谓词 | 专项源码静态类型与实际装配人工复核 |
| RCE1562 | R0554 | R0555 | <code>海中鱼巣/领域/特征值服务.h:699</code> | standard-library-callback |  | None | std::count_if 注册 Vec 记录计数谓词 | 专项源码静态类型与实际装配人工复核 |
| RCE1564 | R0556 | R0557 | <code>海中鱼巣/领域/特征值服务.h:706</code> | standard-library-callback |  | None | std::count_if 注册 I64 记录计数谓词 | 专项源码静态类型与实际装配人工复核 |
...
| RCE1599 | R0579 | F0168 | <code>海中鱼巣/领域/需求服务.h:321, 海中鱼巣/领域/需求服务.h:322, 海中鱼巣/领域/需求服务.h:323, 海中鱼巣/领域/需求服务.h:324, 海中鱼巣/领域/需求服务.h:325, 海中鱼巣/领域/需求服务.h:326</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1600 | R0579 | F0184 | <code>海中鱼巣/领域/需求服务.h:307, 海中鱼巣/领域/需求服务.h:311, 海中鱼巣/领域/需求服务.h:321, 海中鱼巣/领域/需求服务.h:339</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1603 | R0579 | F0553 | <code>海中鱼巣/领域/需求服务.h:337</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1597 | R0579 | F0554 | <code>海中鱼巣/领域/需求服务.h:300</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1598 | R0579 | F0555 | <code>海中鱼巣/领域/需求服务.h:302</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1601 | R0579 | R0578 | <code>海中鱼巣/领域/需求服务.h:310</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1604 | R0579 | R0585 | <code>海中鱼巣/领域/需求服务.h:338</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE3391 | R0929 | R0919 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:177</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3416 | R0936 | R0932 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:308</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3484 | R0955 | R0953 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:725, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:726</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3485 | R0955 | R0954 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:724</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3486 | R0956 | R0953 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:730, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:731, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:732, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:733, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:734</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3492 | R0963 | R0964 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:816, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:821, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:824</code> | local_lambda_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3498 | R0963 | R0965 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:828</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3499 | R0963 | R0966 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:833</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3500 | R0963 | R0967 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:836</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3501 | R0963 | R0968 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:872</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3495 | R0963 | R1209 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:853</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3496 | R0963 | R1355 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:848, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:859</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3494 | R0963 | R1417 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:817</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3493 | R0963 | R1418 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:818</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3497 | R0963 | R1447 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:848</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3502 | R0969 | R0970 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:883</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3503 | R0971 | R0952 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:909, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:912, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:921, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:993</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3504 | R0971 | R0953 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:898, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:899, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:900, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:901, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:902, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:903, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:904, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:905, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:915, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:916, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:922, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:923, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:924, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:925, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:929, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:989, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:994</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3505 | R0971 | R0972 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:934</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3506 | R0971 | R0974 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:997</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3514 | R0975 | R0976 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1023, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1027</code> | frozen_source_exact_local_lambda_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3513 | R0975 | R0977 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1028</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3515 | R0978 | R1317 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1041</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3520 | R0985 | R0982 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1115</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3521 | R0985 | R0986 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1131</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3522 | R0985 | R0987 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1137</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3523 | R0985 | R0988 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1144</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3524 | R0989 | R0991 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1170</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4525 | R0989 | R0993 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1228</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3525 | R0989 | R0994 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1232</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3526 | R0989 | R0996 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1257</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3527 | R0989 | R0997 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1265</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3528 | R0989 | R0998 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1275</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3541 | R0999 | R1002 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1347</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4233 | R0999 | R1382 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1334</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3888 | R1009 | R0920 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1667</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3889 | R1009 | R1385 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1667</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3890 | R1013 | R0920 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1842</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3891 | R1013 | R1224 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1842</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3640 | R1015 | R1193 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1887</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3892 | R1019 | R0920 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2026</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3893 | R1019 | R1353 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2026</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3894 | R1024 | R0920 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2176</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3895 | R1024 | R1441 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2175</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3896 | R1026 | R0920 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2265</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3897 | R1026 | R1353 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2265</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4532 | R1030 | R1031 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2416</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3898 | R1040 | R0920 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2772</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3899 | R1040 | R1038 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2767</code> | local_lambda_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3900 | R1040 | R1441 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2772</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3901 | R1041 | R0920 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2859, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2862, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2865</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3902 | R1041 | R1169 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2859</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3903 | R1041 | R1224 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2862</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3904 | R1041 | R1431 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2865</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3381 | R1075 | R1074 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:310</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3382 | R1077 | R1074 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:319</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3383 | R1081 | R1082 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:343</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4519 | R1083 | R1084 | <code>海中鱼巣/核心/数据操作.节点直接类型化结构.ixx:349</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3661 | R1115 | R1286 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:158, 海中鱼巣/核心/自检.节点直接身份结构写入.ixx:159</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4506 | R1433 | R1411 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:720</code> | direct_or_implicit_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4505 | R1433 | R1414 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:720</code> | direct_or_implicit_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4362 | R1433 | R1450 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:676</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4330 | R1434 | R1412 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:725</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4363 | R1434 | R1453 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:725</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4364 | R1434 | R1455 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:725</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4331 | R1435 | R1412 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:752</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4365 | R1435 | R1453 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:752</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4366 | R1435 | R1455 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:752</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4367 | R1436 | R1453 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:781</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4368 | R1436 | R1455 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:781</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
...
| RCE0353 | R0027 | R0044 | <code>海中鱼巣/核心/会话.结构写入.ixx:452</code> | suffix_match |  | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0356 | R0027 | R0052 | <code>海中鱼巣/核心/会话.结构写入.ixx:455, 海中鱼巣/核心/会话.结构写入.ixx:464</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0355 | R0027 | R0119 | <code>海中鱼巣/核心/会话.结构写入.ixx:453</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0357 | R0027 | R0125 | <code>海中鱼巣/核心/会话.结构写入.ixx:462</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0354 | R0027 | R0136 | <code>海中鱼巣/核心/会话.结构写入.ixx:452</code> | source-audited |  | None | 绑定主键入口复核请求显式完整 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0358 | R0028 | F0565 | <code>海中鱼巣/核心/会话.结构写入.ixx:474</code> | direct-free |  | None | 候选 I64 写入入口复核主信息句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE0360 | R0028 | R0010 | <code>海中鱼巣/核心/会话.结构写入.ixx:491</code> | direct-const-member |  | None | 确认候选属于本会话后写入 I64 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0359 | R0028 | R0015 | <code>海中鱼巣/核心/会话.结构写入.ixx:478</code> | direct-const-member |  | None | 遍历本会话主信息候选 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0361 | R0028 | R0052 | <code>海中鱼巣/核心/会话.结构写入.ixx:493, 海中鱼巣/核心/会话.结构写入.ixx:500</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE0362 | R0029 | F0565 | <code>海中鱼巣/核心/会话.结构写入.ixx:510</code> | direct-free |  | None | 候选 I64 读回入口复核主信息句柄 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0364 | R0029 | R0052 | <code>海中鱼巣/核心/会话.结构写入.ixx:515</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE0365 | R0030 | F0163 | <code>海中鱼巣/核心/会话.结构写入.ixx:525</code> | direct-free |  | None | 读取节点类型入口复核节点句柄 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0366 | R0031 | F0163 | <code>海中鱼巣/核心/会话.结构写入.ixx:531</code> | direct-free |  | None | 读取节点主信息入口复核节点句柄 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0376 | R0036 | R0014 | <code>海中鱼巣/核心/会话.结构写入.ixx:573</code> | direct-const-member |  | None | 逐候选读取主信息句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE0374 | R0036 | R0043 | <code>海中鱼巣/核心/会话.结构写入.ixx:567</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0375 | R0036 | R0052 | <code>海中鱼巣/核心/会话.结构写入.ixx:570</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE0377 | R0037 | R0043 | <code>海中鱼巣/核心/会话.结构写入.ixx:578</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0378 | R0037 | R0052 | <code>海中鱼巣/核心/会话.结构写入.ixx:581</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE0380 | R0038 | F0440 | <code>海中鱼巣/核心/会话.结构写入.ixx:590</code> | direct-const-member |  | None | 当前线程可访问后令牌读取关系 | 专项源码静态类型与实际装配人工复核 |
| RCE0379 | R0038 | R0043 | <code>海中鱼巣/核心/会话.结构写入.ixx:589</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0381 | R0038 | R0052 | <code>海中鱼巣/核心/会话.结构写入.ixx:592</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0382 | R0038 | R0095 | <code>海中鱼巣/核心/会话.结构写入.ixx:597</code> | direct-const-member |  | None | 逐变更能力读取写后记录 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0422 | R0064 | F0051 | <code>海中鱼巣/核心/关系仓库.cpp:105, 海中鱼巣/核心/关系仓库.cpp:106</code> | operator |  | None | 逐字段比较源/目标节点句柄 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0447 | R0070 | F0163 | <code>海中鱼巣/核心/关系仓库.cpp:138, 海中鱼巣/核心/关系仓库.cpp:139, 海中鱼巣/核心/关系仓库.cpp:140, 海中鱼巣/核心/关系仓库.cpp:141</code> | direct-free |  | None | 能力完整性复核写前/写后源目标节点句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE0446 | R0070 | F0341 | <code>海中鱼巣/核心/关系仓库.cpp:136</code> | source-audited+direct-free |  | None | 已发布关系变更能力复核写前关系类型；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0461 | R0072 | R0064 | <code>海中鱼巣/核心/关系仓库.cpp:1415, 海中鱼巣/核心/关系仓库.cpp:1420</code> | source-audited+direct-free+direct-free |  | None | 撤销前后两处关系记录一致性复核；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0458 | R0072 | R0070 | <code>海中鱼巣/核心/关系仓库.cpp:1405</code> | direct-const-member+direct-member |  | None | 撤销前复核能力完整；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0460 | R0072 | R0084 | <code>海中鱼巣/核心/关系仓库.cpp:1411</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
| RCE0457 | R0072 | R0091 | <code>海中鱼巣/核心/关系仓库.cpp:1404</code> | source-audited+direct-free |  | None | 撤销前验证独占令牌；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0459 | R0072 | R0092 | <code>海中鱼巣/核心/关系仓库.cpp:1407</code> | source-audited+direct-free |  | None | 能力完整后复核令牌一致；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0455 | R0072 | R0094 | <code>海中鱼巣/核心/关系仓库.cpp:1397</code> | source-audited |  | None | 撤销已发布关系变更先读取写前记录 | 专项源码静态类型与实际装配人工复核 |
| RCE0456 | R0072 | R0095 | <code>海中鱼巣/核心/关系仓库.cpp:1398</code> | source-audited |  | None | 读取写前记录后读取写后记录 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0473 | R0076 | F0630 | <code>海中鱼巣/核心/关系仓库.cpp:1482, 海中鱼巣/核心/关系仓库.cpp:1483</code> | direct-const-member |  | None | 严格删除前复核关系端点 | 专项源码静态类型与实际装配人工复核 |
| RCE0471 | R0076 | R0091 | <code>海中鱼巣/核心/关系仓库.cpp:1454</code> | source-audited+direct-free |  | None | 严格删除关系首先验证独占令牌；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0483 | R0080 | R0070 | <code>海中鱼巣/核心/关系仓库.cpp:162</code> | suffix_match+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0511 | R0091 | F0336 | <code>海中鱼巣/核心/关系仓库.cpp:92</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0512 | R0091 | F0400 | <code>海中鱼巣/核心/关系仓库.cpp:92</code> | resolved-function-pointer |  | None | 正式生产接线唯一独占令牌验证目标 | 专项源码静态类型与实际装配人工复核 |
| RCE0538 | R0103 | R0102 | <code>海中鱼巣/核心/执行器.结构写入.ixx:191</code> | direct-template-member |  | None | 单个参与者提升为 span 后调用多参与者重载 | 专项源码静态类型与实际装配人工复核 |
| RCE0539 | R0106 | F0338 | <code>海中鱼巣/核心/执行器.结构写入.ixx:367</code> | direct-const-member |  | None | 隔离入口复核许可有效 | 专项源码静态类型与实际装配人工复核 |
| RCE0540 | R0106 | F0339 | <code>海中鱼巣/核心/执行器.结构写入.ixx:368</code> | unique_name+direct-const-member |  | None | 调用方可达且源码分支条件成立；许可有效且隔离函数字段存在 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
| RCE0541 | R0106 | F0401 | <code>海中鱼巣/核心/执行器.结构写入.ixx:368</code> | resolved-function-pointer |  | None | 生产运行期唯一撤销失败隔离目标 | 专项源码静态类型与实际装配人工复核 |
| RCE0589 | R0125 | F0051 | <code>海中鱼巣/核心/索引仓库.cpp:376</code> | operator |  | None | 索引绑定节点与预期节点比较 | 专项源码静态类型与实际装配人工复核 |
| RCE0587 | R0125 | F0163 | <code>海中鱼巣/核心/索引仓库.cpp:366</code> | direct-free |  | None | 严格删除主键入口复核节点句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE0588 | R0125 | F0630 | <code>海中鱼巣/核心/索引仓库.cpp:367</code> | direct-const-member |  | None | 严格删除主键令牌复核目标节点 | 专项源码静态类型与实际装配人工复核 |
| RCE0586 | R0125 | R0121 | <code>海中鱼巣/核心/索引仓库.cpp:362</code> | source-audited+direct-free |  | None | 严格删除主键首先验证独占令牌；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0590 | R0125 | R0126 | <code>海中鱼巣/核心/索引仓库.cpp:393</code> | source-audited+direct-free |  | None | 正反索引一致且加锁后删除主键；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0596 | R0129 | R0134 | <code>海中鱼巣/核心/索引所有权.数据.h:119</code> | lsp_direct | None | None | 调用方可达且源码分支条件成立 | LSP 直接解析并经源码调用词复核 |
| RCE0603 | R0141 | F0632 | <code>海中鱼巣/核心/节点仓库.cpp:128</code> | direct-free |  | None | 确认候选入口验证共享令牌；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0604 | R0141 | R0146 | <code>海中鱼巣/核心/节点仓库.cpp:130</code> | direct-free |  | None | 复核候选令牌一致；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0673 | R0170 | F0268 | <code>海中鱼巣/界面/控制面板窗口.cpp:173</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0677 | R0172 | R0172 | <code>海中鱼巣/界面/控制面板窗口.cpp:205</code> | direct-free |  | None | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0764 | R0214 | R0088 | <code>海中鱼巣/领域/任务服务.h:485</code> | direct-const-member |  | None | 需求类型匹配 | 专项源码静态类型与实际装配人工复核 |
| RCE0765 | R0214 | R0213 | <code>海中鱼巣/领域/任务服务.h:489</code> | direct-const-member |  | None | 来源节点为任务 | 专项源码静态类型与实际装配人工复核 |
| RCE0767 | R0214 | R0215 | <code>海中鱼巣/领域/任务服务.h:494</code> | standard-library-callback |  | None | std::sort 注册的唯一比较回调 | 专项源码静态类型与实际装配人工复核 |
| RCE0763 | R0214 | R0222 | <code>海中鱼巣/领域/任务服务.h:482, 海中鱼巣/领域/任务服务.h:486</code> | direct-const-member |  | None | 需求入口及每个来源节点类型复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0770 | R0217 | R0218 | <code>海中鱼巣/领域/任务服务.h:544</code> | direct-const-member |  | None | 入口 | 专项源码静态类型与实际装配人工复核 |
| RCE0771 | R0217 | R0220 | <code>海中鱼巣/领域/任务服务.h:547</code> | direct-const-member |  | None | 任务承接壳完整；四参数顺序重载 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0898 | R0279 | F0163 | <code>海中鱼巣/领域/控制面板服务.h:1083, 海中鱼巣/领域/控制面板服务.h:1133</code> | source-static-type |  | None | 控制面板按需树路径；字段静态类型/重载专项复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0896 | R0279 | R0280 | <code>海中鱼巣/领域/控制面板服务.h:1064</code> | standard-library-callback |  | None | std::sort 注册局部比较 lambda | 专项源码静态类型与实际装配人工复核 |
| RCE0897 | R0279 | R0324 | <code>海中鱼巣/领域/控制面板服务.h:1077, 海中鱼巣/领域/控制面板服务.h:1127</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0900 | R0279 | R0527 | <code>海中鱼巣/领域/控制面板服务.h:1090</code> | source-static-type |  | None | 控制面板按需树路径；字段静态类型/重载专项复核 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0904 | R0282 | R0281 | <code>海中鱼巣/领域/控制面板服务.h:1204</code> | direct-const-member |  | None | 把具体句柄提升为 optional 重载 | 专项源码静态类型与实际装配人工复核 |
| RCE0913 | R0285 | R0309 | <code>海中鱼巣/领域/控制面板服务.h:1267, 海中鱼巣/领域/控制面板服务.h:1270, 海中鱼巣/领域/控制面板服务.h:1273</code> | direct-static-member |  | None | 方法来源任务组稳定排序 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0924 | R0286 | F0163 | <code>海中鱼巣/领域/控制面板服务.h:1317, 海中鱼巣/领域/控制面板服务.h:1336</code> | source-static-type |  | None | 控制面板按需树路径；字段静态类型/重载专项复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0916 | R0286 | F0552 | <code>海中鱼巣/领域/控制面板服务.h:1294</code> | direct-const-member |  | None | 需求有效 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0935 | R0286 | R0214 | <code>海中鱼巣/领域/控制面板服务.h:1358</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0926 | R0286 | R0281 | <code>海中鱼巣/领域/控制面板服务.h:1318, 海中鱼巣/领域/控制面板服务.h:1319, 海中鱼巣/领域/控制面板服务.h:1320, 海中鱼巣/领域/控制面板服务.h:1321, 海中鱼巣/领域/控制面板服务.h:1322, 海中鱼巣/领域/控制面板服务.h:1337, 海中鱼巣/领域/控制面板服务.h:1338, 海中鱼巣/领域/控制面板服务.h:1339, 海中鱼巣/领域/控制面板服务.h:1351</code> | direct-const-member |  | None | optional 目标叶项 | 专项源码静态类型与实际装配人工复核 |
| RCE0934 | R0286 | R0282 | <code>海中鱼巣/领域/控制面板服务.h:1345, 海中鱼巣/领域/控制面板服务.h:1361</code> | direct-const-member |  | None | 具体句柄目标叶项 | 专项源码静态类型与实际装配人工复核 |
| RCE0933 | R0286 | R0313 | <code>海中鱼巣/领域/控制面板服务.h:1335, 海中鱼巣/领域/控制面板服务.h:1359</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0923 | R0286 | R0324 | <code>海中鱼巣/领域/控制面板服务.h:1316, 海中鱼巣/领域/控制面板服务.h:1329</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0914 | R0286 | R0580 | <code>海中鱼巣/领域/控制面板服务.h:1289</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0918 | R0286 | R0581 | <code>海中鱼巣/领域/控制面板服务.h:1295</code> | unique_name+direct-const-member | None | None | 调用方可达且源码分支条件成立；需求有效 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
| RCE0919 | R0286 | R0582 | <code>海中鱼巣/领域/控制面板服务.h:1296</code> | unique_name+direct-const-member | None | None | 调用方可达且源码分支条件成立；需求有效 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
| RCE0920 | R0286 | R0583 | <code>海中鱼巣/领域/控制面板服务.h:1297</code> | unique_name+direct-const-member | None | None | 调用方可达且源码分支条件成立；需求有效 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
| RCE0921 | R0286 | R0584 | <code>海中鱼巣/领域/控制面板服务.h:1298</code> | unique_name+direct-const-member | None | None | 调用方可达且源码分支条件成立；需求有效 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
| RCE0922 | R0286 | R0585 | <code>海中鱼巣/领域/控制面板服务.h:1299</code> | unique_name+direct-const-member | None | None | 调用方可达且源码分支条件成立；需求有效 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
| RCE0927 | R0286 | R0587 | <code>海中鱼巣/领域/控制面板服务.h:1327</code> | unique_name+direct-const-member | None | None | 调用方可达且源码分支条件成立；需求承接材料完整 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
| RCE0928 | R0286 | R0588 | <code>海中鱼巣/领域/控制面板服务.h:1330</code> | unique_name+direct-const-member | None | None | 调用方可达且源码分支条件成立；存在最近结算 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
| RCE0929 | R0286 | R0589 | <code>海中鱼巣/领域/控制面板服务.h:1331</code> | unique_name+direct-const-member | None | None | 调用方可达且源码分支条件成立；存在最近结算 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
| RCE0930 | R0286 | R0590 | <code>海中鱼巣/领域/控制面板服务.h:1332</code> | unique_name+direct-const-member | None | None | 调用方可达且源码分支条件成立；存在最近结算 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
| RCE0931 | R0286 | R0591 | <code>海中鱼巣/领域/控制面板服务.h:1333</code> | unique_name+direct-const-member | None | None | 调用方可达且源码分支条件成立；存在最近结算 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
| RCE0932 | R0286 | R0592 | <code>海中鱼巣/领域/控制面板服务.h:1334</code> | unique_name+direct-const-member | None | None | 调用方可达且源码分支条件成立；存在最近结算 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
| RCE0915 | R0286 | R0593 | <code>海中鱼巣/领域/控制面板服务.h:1293</code> | unique_name+direct-const-member | None | None | 调用方可达且源码分支条件成立；需求有效 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
...
| RCE0946 | R0288 | F0163 | <code>海中鱼巣/领域/控制面板服务.h:1420</code> | source-static-type |  | None | 控制面板按需树路径；字段静态类型/重载专项复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0940 | R0288 | R0207 | <code>海中鱼巣/领域/控制面板服务.h:1400</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0941 | R0288 | R0208 | <code>海中鱼巣/领域/控制面板服务.h:1401</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0942 | R0288 | R0209 | <code>海中鱼巣/领域/控制面板服务.h:1402</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0943 | R0288 | R0210 | <code>海中鱼巣/领域/控制面板服务.h:1403</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0944 | R0288 | R0211 | <code>海中鱼巣/领域/控制面板服务.h:1404</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0949 | R0288 | R0212 | <code>海中鱼巣/领域/控制面板服务.h:1429</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0939 | R0288 | R0213 | <code>海中鱼巣/领域/控制面板服务.h:1399</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0950 | R0288 | R0216 | <code>海中鱼巣/领域/控制面板服务.h:1430</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0951 | R0288 | R0217 | <code>海中鱼巣/领域/控制面板服务.h:1431</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0948 | R0288 | R0281 | <code>海中鱼巣/领域/控制面板服务.h:1421, 海中鱼巣/领域/控制面板服务.h:1422, 海中鱼巣/领域/控制面板服务.h:1423, 海中鱼巣/领域/控制面板服务.h:1424, 海中鱼巣/领域/控制面板服务.h:1425, 海中鱼巣/领域/控制面板服务.h:1433, 海中鱼巣/领域/控制面板服务.h:1438, 海中鱼巣/领域/控制面板服务.h:1443</code> | direct-const-member |  | None | 任务 optional 目标叶项 | 专项源码静态类型与实际装配人工复核 |
| RCE0945 | R0288 | R0324 | <code>海中鱼巣/领域/控制面板服务.h:1419</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE0956 | R0290 | F0163 | <code>海中鱼巣/领域/控制面板服务.h:1490, 海中鱼巣/领域/控制面板服务.h:1502, 海中鱼巣/领域/控制面板服务.h:1516, 海中鱼巣/领域/控制面板服务.h:1527, 海中鱼巣/领域/控制面板服务.h:1537</code> | source-static-type |  | None | 控制面板按需树路径；字段静态类型/重载专项复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0962 | R0290 | R0281 | <code>海中鱼巣/领域/控制面板服务.h:1517, 海中鱼巣/领域/控制面板服务.h:1528, 海中鱼巣/领域/控制面板服务.h:1545, 海中鱼巣/领域/控制面板服务.h:1551, 海中鱼巣/领域/控制面板服务.h:1560</code> | direct-const-member |  | None | 方法 optional 目标叶项 | 专项源码静态类型与实际装配人工复核 |
| RCE0959 | R0290 | R0282 | <code>海中鱼巣/领域/控制面板服务.h:1503</code> | direct-const-member |  | None | 方法虚拟存在具体句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE0967 | R0290 | R0291 | <code>海中鱼巣/领域/控制面板服务.h:1575, 海中鱼巣/领域/控制面板服务.h:1582, 海中鱼巣/领域/控制面板服务.h:1588</code> | direct-lambda |  | None | 父方法/前置/后续递归投影 | 专项源码静态类型与实际装配人工复核 |
| RCE0960 | R0290 | R0313 | <code>海中鱼巣/领域/控制面板服务.h:1511, 海中鱼巣/领域/控制面板服务.h:1512, 海中鱼巣/领域/控制面板服务.h:1579, 海中鱼巣/领域/控制面板服务.h:1580</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0955 | R0290 | R0324 | <code>海中鱼巣/领域/控制面板服务.h:1489, 海中鱼巣/领域/控制面板服务.h:1501, 海中鱼巣/领域/控制面板服务.h:1514, 海中鱼巣/领域/控制面板服务.h:1525, 海中鱼巣/领域/控制面板服务.h:1536</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0958 | R0290 | R0468 | <code>海中鱼巣/领域/控制面板服务.h:1496</code> | unique_name | (方法节点, 状态_) | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0966 | R0290 | R0473 | <code>海中鱼巣/领域/控制面板服务.h:1558</code> | unique_name | (方法节点, 状态_) | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0964 | R0290 | R0474 | <code>海中鱼巣/领域/控制面板服务.h:1542</code> | unique_name | (候选材料-&gt;动作入口) | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0965 | R0290 | R0475 | <code>海中鱼巣/领域/控制面板服务.h:1543</code> | unique_name | (候选材料-&gt;动作入口) | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0961 | R0290 | R0492 | <code>海中鱼巣/领域/控制面板服务.h:1515</code> | unique_name+source-audited | (方法节点, 条件, 状态_) | None | 调用方可达且源码分支条件成立；方法树节点包含方法条件 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
| RCE0963 | R0290 | R0493 | <code>海中鱼巣/领域/控制面板服务.h:1526</code> | unique_name | (方法节点, 结果节点, 状态_) | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0974 | R0293 | R0309 | <code>海中鱼巣/领域/控制面板服务.h:1616, 海中鱼巣/领域/控制面板服务.h:1619, 海中鱼巣/领域/控制面板服务.h:1622</code> | direct-static-member |  | None | 方法来源任务组稳定排序 | 专项源码静态类型与实际装配人工复核 |
| RCE0978 | R0296 | R0294 | <code>海中鱼巣/领域/控制面板服务.h:1680</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0979 | R0296 | R0297 | <code>海中鱼巣/领域/控制面板服务.h:1682</code> | standard-library-callback |  | None | std::sort 注册局部比较 lambda | 专项源码静态类型与实际装配人工复核 |
| RCE0982 | R0299 | R0298 | <code>海中鱼巣/领域/控制面板服务.h:1703</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0985 | R0301 | R0300 | <code>海中鱼巣/领域/控制面板服务.h:1757</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1031 | R0322 | R0309 | <code>海中鱼巣/领域/控制面板服务.h:778</code> | direct-static-member |  | None | 根类别相等 | 专项源码静态类型与实际装配人工复核 |
| RCE1032 | R0323 | R0303 | <code>海中鱼巣/领域/控制面板服务.h:809</code> | direct-const-member |  | None | 逐个概念根选项 | 专项源码静态类型与实际装配人工复核 |
| RCE1037 | R0325 | F0163 | <code>海中鱼巣/领域/控制面板服务.h:908, 海中鱼巣/领域/控制面板服务.h:911, 海中鱼巣/领域/控制面板服务.h:916</code> | source-static-type |  | None | 控制面板按需树路径；字段静态类型/重载专项复核 | 专项源码静态类型与实际装配人工复核 |
| RCE1040 | R0325 | R0312 | <code>海中鱼巣/领域/控制面板服务.h:917</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1039 | R0325 | R0313 | <code>海中鱼巣/领域/控制面板服务.h:914</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1041 | R0325 | R0325 | <code>海中鱼巣/领域/控制面板服务.h:920</code> | direct-recursive |  | None | 对子节点递归规范化 | 专项源码静态类型与实际装配人工复核 |
| RCE1048 | R0328 | F0163 | <code>海中鱼巣/领域/控制面板服务.h:992, 海中鱼巣/领域/控制面板服务.h:999</code> | source-static-type |  | None | 控制面板按需树路径；字段静态类型/重载专项复核 | 专项源码静态类型与实际装配人工复核 |
| RCE1044 | R0328 | F0496 | <code>海中鱼巣/领域/控制面板服务.h:986</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1045 | R0328 | F0497 | <code>海中鱼巣/领域/控制面板服务.h:987</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1046 | R0328 | R0313 | <code>海中鱼巣/领域/控制面板服务.h:988, 海中鱼巣/领域/控制面板服务.h:989</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1047 | R0328 | R0324 | <code>海中鱼巣/领域/控制面板服务.h:991, 海中鱼巣/领域/控制面板服务.h:998</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1060 | R0335 | F0231 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:216</code> | direct_const_member |  | None | 函数进入后读取参数稳定键组并逐主键复核 | 专项源码静态类型与实际装配人工复核 |
| RCE1068 | R0335 | R0026 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:239</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1062 | R0335 | R0030 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:228</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1063 | R0335 | R0031 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:229</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1066 | R0335 | R0036 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:236</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1067 | R0335 | R0037 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:236</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1061 | R0335 | R0063 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:217, 海中鱼巣/领域/数据操作.概念活动.ixx:227</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1064 | R0335 | R0540 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:230</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1065 | R0335 | R0541 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:231</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1069 | R0336 | R0025 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:254</code> | direct-member |  | None | 读取关系材料会话入口读取关系审计 | 专项源码静态类型与实际装配人工复核 |
| RCE1070 | R0336 | R0038 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:259</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1071 | R0337 | R0034 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:270</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1072 | R0337 | R0336 | <code>海中鱼巣/领域/数据操作.概念活动.ixx:280</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1092 | R0345 | F0184 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1044</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1130 | R0353 | F0338 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1313</code> | source-audited |  | None | 共享许可静态类型为结构事务许可 | 专项源码静态类型与实际装配人工复核 |
| RCE1131 | R0353 | F0339 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1314, 海中鱼巣/领域/数据操作.特征体系.ixx:1316, 海中鱼巣/领域/数据操作.特征体系.ixx:1319, 海中鱼巣/领域/数据操作.特征体系.ixx:1321, 海中鱼巣/领域/数据操作.特征体系.ixx:1323</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1132 | R0353 | F0441 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1314</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1129 | R0353 | F0444 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1311, 海中鱼巣/领域/数据操作.特征体系.ixx:1313</code> | suffix_match |  | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1135 | R0353 | R0079 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1319</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1138 | R0353 | R0343 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1322</code> | source-audited |  | None | 读取槽位结果静态类型为特征槽位值式材料 | 专项源码静态类型与实际装配人工复核 |
| RCE1133 | R0353 | R0344 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1316</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1137 | R0353 | R0349 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1321</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1140 | R0353 | R0351 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1323</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1141 | R0353 | R0352 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1324</code> | source-audited |  | None | 输出静态类型为特征原始值式材料 | 专项源码静态类型与实际装配人工复核 |
| RCE1136 | R0353 | R0356 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1320, 海中鱼巣/领域/数据操作.特征体系.ixx:1325</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1139 | R0353 | R0357 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1322</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1134 | R0353 | R0388 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1317</code> | source-audited |  | None | 读取身份结果静态类型为特征节点身份 | 专项源码静态类型与实际装配人工复核 |
...
| RCE1196 | R0384 | F0338 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:596</code> | source-audited |  | None | 共享许可静态类型为结构事务许可 | 专项源码静态类型与实际装配人工复核 |
| RCE1197 | R0384 | F0339 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:597, 海中鱼巣/领域/数据操作.特征体系.ixx:599</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1198 | R0384 | F0441 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:597</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1199 | R0384 | R0349 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:599</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1202 | R0385 | F0338 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:605</code> | source-audited |  | None | 共享许可静态类型为结构事务许可 | 专项源码静态类型与实际装配人工复核 |
| RCE1203 | R0385 | F0339 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:606</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1204 | R0385 | R0350 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:606</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1207 | R0386 | F0338 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:612</code> | source-audited |  | None | 共享许可静态类型为结构事务许可 | 专项源码静态类型与实际装配人工复核 |
| RCE1208 | R0386 | F0339 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:613, 海中鱼巣/领域/数据操作.特征体系.ixx:615</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1210 | R0386 | R0343 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:614</code> | source-audited |  | None | 槽位静态类型为特征槽位值式材料 | 专项源码静态类型与实际装配人工复核 |
| RCE1209 | R0386 | R0349 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:613</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1212 | R0386 | R0351 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:615</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1211 | R0386 | R0357 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:614</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1213 | R0387 | F0163 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:64</code> | direct |  | None | 特征关系证据复核源和目标节点句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE1214 | R0387 | F0168 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:64</code> | unique_name+direct | None | None | 调用方可达且源码分支条件成立；特征关系证据复核关系句柄 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
| RCE1255 | R0401 | R0393 | <code>海中鱼巣/领域/数据操作.状态动态.ixx:306</code> | source-audited |  | None | 状态写入参与结果材料静态类型复核实例状态完整 | 专项源码静态类型与实际装配人工复核 |
| RCE1256 | R0401 | R0407 | <code>海中鱼巣/领域/数据操作.状态动态.ixx:306</code> | source-audited |  | None | 状态写入参与结果材料静态类型复核抽象状态完整 | 专项源码静态类型与实际装配人工复核 |
| RCE1257 | R0402 | F0163 | <code>海中鱼巣/领域/数据操作.状态动态.ixx:377</code> | direct-free |  | None | 入口复核状态节点句柄 | 专项源码静态类型与实际装配人工复核 |
...
| RCE1261 | R0402 | F0338 | <code>海中鱼巣/领域/数据操作.状态动态.ixx:379</code> | direct-const-member |  | None | 取得共享许可后复核有效 | 专项源码静态类型与实际装配人工复核 |
| RCE1262 | R0402 | F0339 | <code>海中鱼巣/领域/数据操作.状态动态.ixx:380</code> | unique_name+direct-const-member |  | None | 调用方可达且源码分支条件成立；许可有效后读取令牌 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
...
| RCE1260 | R0402 | F0397 | <code>海中鱼巣/领域/数据操作.状态动态.ixx:378</code> | resolved-function-pointer |  | None | 生产运行期唯一共享许可目标 | 专项源码静态类型与实际装配人工复核 |
| RCE1263 | R0402 | R0396 | <code>海中鱼巣/领域/数据操作.状态动态.ixx:380</code> | unique_name+direct-const-member | None | None | 调用方可达且源码分支条件成立；调用已许可状态材料读取 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE1264 | R0403 | F0443 | <code>海中鱼巣/领域/数据操作.状态动态.ixx:409</code> | suffix_match |  | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1266 | R0403 | R0400 | <code>海中鱼巣/领域/数据操作.状态动态.ixx:412</code> | direct-member |  | None | 规格完整后读取状态值作为结构写入实参 | 专项源码静态类型与实际装配人工复核 |
| RCE1265 | R0403 | R0405 | <code>海中鱼巣/领域/数据操作.状态动态.ixx:411</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1297 | R0415 | R0414 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:259</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1296 | R0415 | R0564 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:258</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1298 | R0417 | R0025 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:285</code> | direct-member |  | None | 系统角色关系材料完整后读取关系审计 | 专项源码静态类型与实际装配人工复核 |
| RCE1299 | R0417 | R0038 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:289</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1302 | R0418 | R0024 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:319</code> | direct-member |  | None | 来源普通父子关系组为空时挂载或重挂节点 | 专项源码静态类型与实际装配人工复核 |
| RCE1303 | R0418 | R0025 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:325</code> | direct-member |  | None | 挂载结果已创建且父关系存在后读取关系审计 | 专项源码静态类型与实际装配人工复核 |
| RCE1300 | R0418 | R0035 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:298</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1301 | R0418 | R0038 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:311, 海中鱼巣/领域/数据操作.系统角色.ixx:329</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1325 | R0425 | R0424 | <code>海中鱼巣/领域/数据操作.轻量因果.ixx:232</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1324 | R0425 | R0426 | <code>海中鱼巣/领域/数据操作.轻量因果.ixx:230, 海中鱼巣/领域/数据操作.轻量因果.ixx:234</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1329 | R0429 | F0338 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:1113</code> | source-audited |  | None | 共享许可静态类型为结构事务许可 | 专项源码静态类型与实际装配人工复核 |
| RCE1330 | R0429 | F0339 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:1114, 海中鱼巣/领域/数据操作.需求任务方法.ixx:1116</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1331 | R0429 | F0441 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:1114</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1328 | R0429 | F0448 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:1111, 海中鱼巣/领域/数据操作.需求任务方法.ixx:1113</code> | suffix_match+source-audited |  | None | 调用方可达且源码分支条件成立；无对象限定调用当前数据操作::有效 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE1332 | R0429 | R0442 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:1116</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1521 | R0517 | R0525 | <code>海中鱼巣/领域/概念图服务.h:2438</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1557 | R0549 | F0051 | <code>海中鱼巣/领域/特征值服务.h:681</code> | direct-free |  | None | const Vec 记录节点句柄与目标节点句柄比较 | 专项源码静态类型与实际装配人工复核 |
| RCE1561 | R0553 | F0051 | <code>海中鱼巣/领域/特征值服务.h:693</code> | direct-free |  | None | const I64 记录节点句柄与目标节点句柄比较 | 专项源码静态类型与实际装配人工复核 |
| RCE1563 | R0555 | F0051 | <code>海中鱼巣/领域/特征值服务.h:700</code> | direct-free |  | None | Vec 计数谓词比较节点句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE1565 | R0557 | F0051 | <code>海中鱼巣/领域/特征值服务.h:707</code> | direct-free |  | None | I64 计数谓词比较节点句柄 | 专项源码静态类型与实际装配人工复核 |
...
| RCE1605 | R0580 | F0336 | <code>海中鱼巣/领域/需求服务.h:349</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1606 | R0580 | R0594 | <code>海中鱼巣/领域/需求服务.h:350</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1613 | R0585 | R0576 | <code>海中鱼巣/领域/需求服务.h:553, 海中鱼巣/领域/需求服务.h:557</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE3331 | R0799 | R0894 | <code>海中鱼巣/领域/参与者.特征值原始材料.ixx:80</code> | implicit_base_destructor | this=R0799 派生对象的结构写入事务参与者基类子对象 | 无 | R0799 派生析构正文结束，基类子对象按析构顺序销毁 | 本批现状图、逐行映射与冻结源码特殊成员生命周期复核 |
...
| RCE3348 | R0888 | R0599 | <code>海中鱼巣/领域/特征值服务.h:214</code> | constructor | 无 | 局部结构事务许可 许可 | 进入R0888且接线形态有效 | 本批现状图、逐行映射与源码生命周期逐调用点复核 |
| RCE3349 | R0888 | R0600 | <code>海中鱼巣/领域/特征值服务.h:217</code> | direct-operator | this=&amp;许可, 其它=事务接线_.取得独占许可()临时 | 许可覆盖为取得的独占许可 | 事务接线已接域并取得独占许可 | 本批现状图、逐行映射与源码生命周期逐调用点复核 |
...
| RCE3483 | R0954 | R0953 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:720</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4133 | R0964 | R1310 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:810</code> | std::find equality callback | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3507 | R0972 | R0952 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:956, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:961, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:963, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:964, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:973, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:978, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:982, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:985</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3508 | R0972 | R0953 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:956, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:957, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:959, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:961, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:962, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:963, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:965, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:973, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:974, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:975, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:976, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:978, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:979, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:980, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:982, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:983, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:984</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3509 | R0972 | R0955 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:958, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:973, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:984, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:985</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3510 | R0972 | R0957 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:961, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:980</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3511 | R0972 | R0959 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:966</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4483 | R0972 | R0961 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:940</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3512 | R0972 | R0973 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:967</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3529 | R0991 | R0980 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1198, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1211, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1221</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4484 | R0991 | R0981 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1178</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3530 | R0991 | R0983 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1215</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3534 | R0991 | R0990 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1192, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1196, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1213</code> | frozen_source_exact_local_lambda_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3539 | R0991 | R0992 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1205</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3531 | R0991 | R1281 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1200</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3538 | R0991 | R1283 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1202, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1203, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1217, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1223, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1224</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3536 | R0991 | R1288 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1212, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1218</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3535 | R0991 | R1290 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1219</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3537 | R0991 | R1292 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1221, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1223</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3533 | R0991 | R1417 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1193</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3532 | R0991 | R1418 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1194</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4135 | R0993 | R1310 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1229</code> | std::find equality callback | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4526 | R0994 | R0995 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1235</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3540 | R0998 | R1292 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1297</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3543 | R1002 | R0985 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1374</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3544 | R1002 | R1000 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1376, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1379, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1392, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1402, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1406, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1412</code> | local_lambda_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3546 | R1002 | R1001 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1372</code> | frozen_source_exact_local_lambda_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4527 | R1002 | R1003 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1350</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3550 | R1002 | R1004 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1383</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3551 | R1002 | R1005 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1394</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3545 | R1002 | R1166 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1404</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3547 | R1002 | R1208 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1356</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3548 | R1002 | R1348 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1382, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1393</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3549 | R1002 | R1438 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1362, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1363, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1407</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4535 | R1038 | R1039 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2761</code> | lexical_lambda_callback_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4332 | R1453 | R1413 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:980</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4384 | R1455 | R1451 | <code>海中鱼巣/核心/仓库.节点直接身份.ixx:1002</code> | frozen_reachability_predecessor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
...
| RCE0346 | R0025 | F0168 | <code>海中鱼巣/核心/会话.结构写入.ixx:417</code> | unique_name+direct-free | None | None | 调用方可达且源码分支条件成立；关系审计入口复核关系句柄 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
| RCE0347 | R0025 | R0044 | <code>海中鱼巣/核心/会话.结构写入.ixx:417</code> | suffix_match |  | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0349 | R0025 | R0053 | <code>海中鱼巣/核心/会话.结构写入.ixx:419</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0348 | R0025 | R0073 | <code>海中鱼巣/核心/会话.结构写入.ixx:418</code> | direct-const-member |  | None | 会话审计读取令牌重载 | 专项源码静态类型与实际装配人工复核 |
| RCE0350 | R0026 | F0163 | <code>海中鱼巣/核心/会话.结构写入.ixx:426</code> | direct-free |  | None | 关系审计记录组入口复核源节点 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0352 | R0026 | R0053 | <code>海中鱼巣/核心/会话.结构写入.ixx:428</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0351 | R0026 | R0074 | <code>海中鱼巣/核心/会话.结构写入.ixx:427</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0370 | R0034 | F0163 | <code>海中鱼巣/核心/会话.结构写入.ixx:547</code> | direct-free |  | None | 读取关系记录组入口复核源节点 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0371 | R0034 | R0078 | <code>海中鱼巣/核心/会话.结构写入.ixx:548</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0372 | R0035 | F0163 | <code>海中鱼巣/核心/会话.结构写入.ixx:554</code> | direct-free |  | None | 读取来源关系记录组入口复核目标节点 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0373 | R0035 | R0079 | <code>海中鱼巣/核心/会话.结构写入.ixx:555</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0419 | R0063 | R0046 | <code>海中鱼巣/核心/会话.结构写入.ixx:101</code> | suffix_match |  | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0421 | R0063 | R0052 | <code>海中鱼巣/核心/会话.结构写入.ixx:113</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0420 | R0063 | R0124 | <code>海中鱼巣/核心/会话.结构写入.ixx:102</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0429 | R0066 | F0163 | <code>海中鱼巣/核心/关系仓库.cpp:1047, 海中鱼巣/核心/关系仓库.cpp:1048</code> | direct-free |  | None | 结构化创建复核源/目标节点句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE0432 | R0066 | F0168 | <code>海中鱼巣/核心/关系仓库.cpp:1055</code> | direct-free |  | None | 创建返回后复核关系句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE0428 | R0066 | F0341 | <code>海中鱼巣/核心/关系仓库.cpp:1046</code> | source-audited+direct-free |  | None | 独占令牌有效后复核关系类型；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0430 | R0066 | F0630 | <code>海中鱼巣/核心/关系仓库.cpp:1049, 海中鱼巣/核心/关系仓库.cpp:1050</code> | direct-const-member |  | None | 句柄前置通过后复核两个节点 | 专项源码静态类型与实际装配人工复核 |
| RCE0431 | R0066 | R0065 | <code>海中鱼巣/核心/关系仓库.cpp:1054</code> | direct-const-member+direct-member |  | None | 入口材料通过后调用令牌创建重载；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0427 | R0066 | R0091 | <code>海中鱼巣/核心/关系仓库.cpp:1042</code> | source-audited+direct-free |  | None | 结构化创建关系首先验证独占令牌；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0489 | R0082 | F0580 | <code>海中鱼巣/核心/关系仓库.cpp:1645</code> | direct-member |  | None | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0493 | R0084 | R0070 | <code>海中鱼巣/核心/关系仓库.cpp:166</code> | suffix_match+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0522 | R0102 | F0338 | <code>海中鱼巣/核心/执行器.结构写入.ixx:120</code> | source-audited |  | None | 取得独占许可后复核结构事务许可 | 专项源码静态类型与实际装配人工复核 |
| RCE0523 | R0102 | F0339 | <code>海中鱼巣/核心/执行器.结构写入.ixx:122</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0529 | R0102 | R0057 | <code>海中鱼巣/核心/执行器.结构写入.ixx:141</code> | source-audited |  | None | 会话静态类型复核撤销请求 | 专项源码静态类型与实际装配人工复核 |
| RCE0527 | R0102 | R0058 | <code>海中鱼巣/核心/执行器.结构写入.ixx:133</code> | source-audited |  | None | 会话静态类型复核失败 | 专项源码静态类型与实际装配人工复核 |
| RCE0528 | R0102 | R0059 | <code>海中鱼巣/核心/执行器.结构写入.ixx:134</code> | source-audited |  | None | 会话静态类型读取首次失败 | 专项源码静态类型与实际装配人工复核 |
| RCE0533 | R0102 | R0060 | <code>海中鱼巣/核心/执行器.结构写入.ixx:162</code> | source-audited |  | None | 会话静态类型完成确认 | 专项源码静态类型与实际装配人工复核 |
| RCE0535 | R0102 | R0061 | <code>海中鱼巣/核心/执行器.结构写入.ixx:180</code> | source-audited |  | None | 会话静态类型完成发布 | 专项源码静态类型与实际装配人工复核 |
| RCE0525 | R0102 | R0062 | <code>海中鱼巣/核心/执行器.结构写入.ixx:127, 海中鱼巣/核心/执行器.结构写入.ixx:136, 海中鱼巣/核心/执行器.结构写入.ixx:143, 海中鱼巣/核心/执行器.结构写入.ixx:156, 海中鱼巣/核心/执行器.结构写入.ixx:165, 海中鱼巣/核心/执行器.结构写入.ixx:174</code> | source-audited |  | None | 六个撤销收口点调用会话完成撤销 | 专项源码静态类型与实际装配人工复核 |
| RCE0519 | R0102 | R0104 | <code>海中鱼巣/核心/执行器.结构写入.ixx:116</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0530 | R0102 | R0105 | <code>海中鱼巣/核心/执行器.结构写入.ixx:144</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0531 | R0102 | R0107 | <code>海中鱼巣/核心/执行器.结构写入.ixx:145</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0526 | R0102 | R0108 | <code>海中鱼巣/核心/执行器.结构写入.ixx:128, 海中鱼巣/核心/执行器.结构写入.ixx:137, 海中鱼巣/核心/执行器.结构写入.ixx:157, 海中鱼巣/核心/执行器.结构写入.ixx:166, 海中鱼巣/核心/执行器.结构写入.ixx:175</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0524 | R0102 | R0109 | <code>海中鱼巣/核心/执行器.结构写入.ixx:126, 海中鱼巣/核心/执行器.结构写入.ixx:135, 海中鱼巣/核心/执行器.结构写入.ixx:142, 海中鱼巣/核心/执行器.结构写入.ixx:155, 海中鱼巣/核心/执行器.结构写入.ixx:164, 海中鱼巣/核心/执行器.结构写入.ixx:173</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0532 | R0102 | R0110 | <code>海中鱼巣/核心/执行器.结构写入.ixx:153</code> | direct-template-member |  | None | 旧结构写入执行器按结构写入事务参与者静态层级准备提交 | 专项源码静态类型与实际装配人工复核 |
| RCE0534 | R0102 | R0112 | <code>海中鱼巣/核心/执行器.结构写入.ixx:171</code> | direct-template-member |  | None | 旧结构写入执行器按结构写入事务参与者静态层级确认待发布 | 专项源码静态类型与实际装配人工复核 |
| RCE0536 | R0102 | R0113 | <code>海中鱼巣/核心/执行器.结构写入.ixx:181</code> | direct-template-member |  | None | 旧结构写入执行器按结构写入事务参与者静态层级完成发布 | 专项源码静态类型与实际装配人工复核 |
| RCE0520 | R0102 | R0115 | <code>海中鱼巣/核心/执行器.结构写入.ixx:116</code> | source-audited |  | None | 无对象限定调用当前结构写入执行器::有效 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0574 | R0119 | F0630 | <code>海中鱼巣/核心/索引仓库.cpp:136</code> | direct-const-member |  | None | 结构化绑定主键复核目标节点 | 专项源码静态类型与实际装配人工复核 |
| RCE0573 | R0119 | R0121 | <code>海中鱼巣/核心/索引仓库.cpp:132</code> | source-audited+direct-free |  | None | 结构化绑定主键首先验证独占令牌；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0576 | R0119 | R0122 | <code>海中鱼巣/核心/索引仓库.cpp:162</code> | source-audited+direct-free |  | None | 校验及加锁完成后绑定主键；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0575 | R0119 | R0128 | <code>海中鱼巣/核心/索引仓库.cpp:136</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0579 | R0121 | F0336 | <code>海中鱼巣/核心/索引仓库.cpp:23</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0580 | R0121 | F0400 | <code>海中鱼巣/核心/索引仓库.cpp:23</code> | resolved-function-pointer |  | None | 运行期上下文把结构事务协调器::生成接线的独占验证 lambda 按值装入索引仓库接线 | 专项源码静态类型与实际装配人工复核 |
| RCE0585 | R0124 | R0120 | <code>海中鱼巣/核心/索引仓库.cpp:307</code> | direct+direct-free |  | None | 读取主键令牌重载进入后验证共享令牌；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0597 | R0134 | R0133 | <code>海中鱼巣/核心/索引所有权.数据.h:83</code> | lsp_direct |  | None | 调用方可达且源码分支条件成立 | LSP 直接解析并经源码调用词复核 |
| RCE0601 | R0136 | F0163 | <code>海中鱼巣/核心/索引所有权.数据.h:98</code> | source-audited |  | None | 绑定请求复核目标节点句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE0602 | R0136 | R0135 | <code>海中鱼巣/核心/索引所有权.数据.h:98</code> | source-audited |  | None | 物理键和目标句柄有效后复核所有者声明 | 专项源码静态类型与实际装配人工复核 |
| RCE0748 | R0207 | R0218 | <code>海中鱼巣/领域/任务服务.h:414</code> | direct-const-member |  | None | 入口 | 专项源码静态类型与实际装配人工复核 |
| RCE0749 | R0207 | R0219 | <code>海中鱼巣/领域/任务服务.h:417</code> | direct-const-member |  | None | 任务承接壳完整 | 专项源码静态类型与实际装配人工复核 |
| RCE0750 | R0208 | R0218 | <code>海中鱼巣/领域/任务服务.h:421</code> | direct-const-member |  | None | 入口 | 专项源码静态类型与实际装配人工复核 |
| RCE0751 | R0208 | R0219 | <code>海中鱼巣/领域/任务服务.h:424</code> | direct-const-member |  | None | 任务承接壳完整 | 专项源码静态类型与实际装配人工复核 |
| RCE0752 | R0209 | R0218 | <code>海中鱼巣/领域/任务服务.h:428</code> | direct-const-member |  | None | 入口 | 专项源码静态类型与实际装配人工复核 |
| RCE0753 | R0209 | R0219 | <code>海中鱼巣/领域/任务服务.h:431</code> | direct-const-member |  | None | 任务承接壳完整 | 专项源码静态类型与实际装配人工复核 |
| RCE0754 | R0210 | R0218 | <code>海中鱼巣/领域/任务服务.h:435</code> | direct-const-member |  | None | 入口 | 专项源码静态类型与实际装配人工复核 |
| RCE0755 | R0210 | R0219 | <code>海中鱼巣/领域/任务服务.h:438</code> | direct-const-member |  | None | 任务承接壳完整 | 专项源码静态类型与实际装配人工复核 |
| RCE0757 | R0211 | R0221 | <code>海中鱼巣/领域/任务服务.h:445</code> | direct-const-member |  | None | 任务类型匹配 | 专项源码静态类型与实际装配人工复核 |
| RCE0756 | R0211 | R0222 | <code>海中鱼巣/领域/任务服务.h:442</code> | direct-const-member |  | None | 入口 | 专项源码静态类型与实际装配人工复核 |
| RCE0759 | R0212 | R0221 | <code>海中鱼巣/领域/任务服务.h:452</code> | direct-const-member |  | None | 任务类型匹配 | 专项源码静态类型与实际装配人工复核 |
| RCE0758 | R0212 | R0222 | <code>海中鱼巣/领域/任务服务.h:449</code> | direct-const-member |  | None | 入口 | 专项源码静态类型与实际装配人工复核 |
| RCE0760 | R0213 | R0218 | <code>海中鱼巣/领域/任务服务.h:456</code> | direct-const-member |  | None | 入口 | 专项源码静态类型与实际装配人工复核 |
| RCE0761 | R0213 | R0219 | <code>海中鱼巣/领域/任务服务.h:459, 海中鱼巣/领域/任务服务.h:460, 海中鱼巣/领域/任务服务.h:461, 海中鱼巣/领域/任务服务.h:462</code> | direct-const-member |  | None | 任务承接壳完整；四类承接目标 | 专项源码静态类型与实际装配人工复核 |
| RCE0762 | R0213 | R0221 | <code>海中鱼巣/领域/任务服务.h:463</code> | direct-const-member |  | None | 任务承接壳完整；读取已创建状态 | 专项源码静态类型与实际装配人工复核 |
| RCE0768 | R0216 | R0218 | <code>海中鱼巣/领域/任务服务.h:517</code> | direct-const-member |  | None | 入口 | 专项源码静态类型与实际装配人工复核 |
| RCE0769 | R0216 | R0220 | <code>海中鱼巣/领域/任务服务.h:520</code> | direct-const-member |  | None | 任务承接壳完整；四参数顺序重载 | 专项源码静态类型与实际装配人工复核 |
| RCE0772 | R0218 | R0219 | <code>海中鱼巣/领域/任务服务.h:727, 海中鱼巣/领域/任务服务.h:728, 海中鱼巣/领域/任务服务.h:729, 海中鱼巣/领域/任务服务.h:730</code> | direct-const-member |  | None | 短路读取四类承接目标 | 专项源码静态类型与实际装配人工复核 |
| RCE0773 | R0218 | R0221 | <code>海中鱼巣/领域/任务服务.h:731</code> | direct-const-member |  | None | 四类承接目标均存在 | 专项源码静态类型与实际装配人工复核 |
| RCE0776 | R0220 | F0620 | <code>海中鱼巣/领域/任务服务.h:744</code> | source-audited |  | None | 顺序号有值；三实参仓库重载 | 专项源码静态类型与实际装配人工复核 |
| RCE0777 | R0220 | F0621 | <code>海中鱼巣/领域/任务服务.h:745</code> | source-audited |  | None | 顺序号无值；两实参仓库重载 | 专项源码静态类型与实际装配人工复核 |
| RCE0775 | R0220 | R0222 | <code>海中鱼巣/领域/任务服务.h:740, 海中鱼巣/领域/任务服务.h:748</code> | direct-const-member |  | None | 源任务及每个关系目标类型复核 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0901 | R0280 | R0310 | <code>海中鱼巣/领域/控制面板服务.h:1068</code> | direct-static-member |  | None | 投影深度相等 | 专项源码静态类型与实际装配人工复核 |
| RCE0903 | R0281 | F0163 | <code>海中鱼巣/领域/控制面板服务.h:1193</code> | source-static-type+direct-free |  | None | 控制面板按需树路径；字段静态类型/重载专项复核；子项已生成 | 专项源码静态类型与实际装配人工复核 |
| RCE0902 | R0281 | R0324 | <code>海中鱼巣/领域/控制面板服务.h:1192</code> | direct-const-member |  | None | 目标存在 | 专项源码静态类型与实际装配人工复核 |
| RCE0968 | R0291 | R0290 | <code>海中鱼巣/领域/控制面板服务.h:1567</code> | direct-const-member |  | None | 关联方法递归展开 | 专项源码静态类型与实际装配人工复核 |
| RCE0975 | R0294 | R0294 | <code>海中鱼巣/领域/控制面板服务.h:1661</code> | direct-recursive |  | None | 对子节点递归排序 | 专项源码静态类型与实际装配人工复核 |
| RCE0976 | R0294 | R0295 | <code>海中鱼巣/领域/控制面板服务.h:1663</code> | standard-library-callback |  | None | std::sort 注册局部比较 lambda | 专项源码静态类型与实际装配人工复核 |
| RCE0980 | R0297 | R0309 | <code>海中鱼巣/领域/控制面板服务.h:1683</code> | direct-static-member |  | None | 根节点稳定排序 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0981 | R0298 | R0298 | <code>海中鱼巣/领域/控制面板服务.h:1696</code> | direct-recursive |  | None | 对子节点递归标记 | 专项源码静态类型与实际装配人工复核 |
| RCE0983 | R0300 | F0190 | <code>海中鱼巣/领域/控制面板服务.h:1718, 海中鱼巣/领域/控制面板服务.h:1727</code> | source-static-type |  | None | 控制面板按需树路径；字段静态类型/重载专项复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0984 | R0300 | R0300 | <code>海中鱼巣/领域/控制面板服务.h:1734</code> | direct-recursive |  | None | 对子节点递归复核 | 专项源码静态类型与实际装配人工复核 |
| RCE1006 | R0312 | R0311 | <code>海中鱼巣/领域/控制面板服务.h:614</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1033 | R0324 | F0190 | <code>海中鱼巣/领域/控制面板服务.h:879</code> | source-static-type |  | None | 控制面板按需树路径；字段静态类型/重载专项复核 | 专项源码静态类型与实际装配人工复核 |
| RCE1035 | R0324 | R0312 | <code>海中鱼巣/领域/控制面板服务.h:891</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1034 | R0324 | R0313 | <code>海中鱼巣/领域/控制面板服务.h:883</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1036 | R0324 | R0327 | <code>海中鱼巣/领域/控制面板服务.h:896</code> | direct-free |  | None | 形成关系角色人读文本 | 专项源码静态类型与实际装配人工复核 |
...
| RCE1093 | R0346 | F0168 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1054, 海中鱼巣/领域/数据操作.特征体系.ixx:1055</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1094 | R0347 | F0441 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1073</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1097 | R0348 | R0078 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1094</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1095 | R0348 | R0344 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1085</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1098 | R0348 | R0347 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1098</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1099 | R0348 | R0354 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1099</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1096 | R0348 | R0388 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1086</code> | source-audited |  | None | 身份静态类型为特征节点身份 | 专项源码静态类型与实际装配人工复核 |
| RCE1104 | R0349 | R0078 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1124</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1108 | R0349 | R0079 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1135</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1109 | R0349 | R0342 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1140</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1100 | R0349 | R0344 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1112, 海中鱼巣/领域/数据操作.特征体系.ixx:1139</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1105 | R0349 | R0346 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1130, 海中鱼巣/领域/数据操作.特征体系.ixx:1137</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1102 | R0349 | R0347 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1121</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1106 | R0349 | R0348 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1132</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1103 | R0349 | R0355 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1122, 海中鱼巣/领域/数据操作.特征体系.ixx:1131, 海中鱼巣/领域/数据操作.特征体系.ixx:1133, 海中鱼巣/领域/数据操作.特征体系.ixx:1136, 海中鱼巣/领域/数据操作.特征体系.ixx:1138, 海中鱼巣/领域/数据操作.特征体系.ixx:1141</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1101 | R0349 | R0388 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1113, 海中鱼巣/领域/数据操作.特征体系.ixx:1140</code> | source-audited |  | None | 身份与宿主静态类型为特征节点身份 | 专项源码静态类型与实际装配人工复核 |
| RCE1107 | R0349 | R0390 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1133</code> | source-audited |  | None | 定义静态类型为特征定义值式材料 | 专项源码静态类型与实际装配人工复核 |
...
| RCE1114 | R0350 | R0078 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1174</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1111 | R0350 | R0342 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1166</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1118 | R0350 | R0343 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1182</code> | source-audited |  | None | 槽位静态类型为特征槽位值式材料 | 专项源码静态类型与实际装配人工复核 |
| RCE1110 | R0350 | R0344 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1161, 海中鱼巣/领域/数据操作.特征体系.ixx:1177</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1115 | R0350 | R0346 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1175</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1112 | R0350 | R0348 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1167</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1117 | R0350 | R0349 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1180</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1116 | R0350 | R0355 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1176, 海中鱼巣/领域/数据操作.特征体系.ixx:1178, 海中鱼巣/领域/数据操作.特征体系.ixx:1184</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1113 | R0350 | R0390 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1168</code> | source-audited |  | None | 定义静态类型为特征定义值式材料 | 专项源码静态类型与实际装配人工复核 |
...
| RCE1120 | R0351 | R0078 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1203</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1126 | R0351 | R0266 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1219</code> | direct-const-member |  | None | 读取当前值时读取原始材料侧表 | 专项源码静态类型与实际装配人工复核 |
| RCE1127 | R0351 | R0268 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1224</code> | direct-const-member |  | None | 侧表快照静态类型复核可读性 | 专项源码静态类型与实际装配人工复核 |
| RCE1119 | R0351 | R0343 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1199</code> | source-audited |  | None | 槽位形参静态类型复核完整 | 专项源码静态类型与实际装配人工复核 |
| RCE1123 | R0351 | R0344 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1212</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1122 | R0351 | R0346 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1210</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1125 | R0351 | R0347 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1216</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1121 | R0351 | R0356 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1209, 海中鱼巣/领域/数据操作.特征体系.ixx:1211, 海中鱼巣/领域/数据操作.特征体系.ixx:1214, 海中鱼巣/领域/数据操作.特征体系.ixx:1217, 海中鱼巣/领域/数据操作.特征体系.ixx:1224, 海中鱼巣/领域/数据操作.特征体系.ixx:1235, 海中鱼巣/领域/数据操作.特征体系.ixx:1238</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1124 | R0351 | R0388 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1213</code> | source-audited |  | None | 读取身份结果静态类型为特征节点身份 | 专项源码静态类型与实际装配人工复核 |
| RCE1128 | R0352 | F0168 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:125, 海中鱼巣/领域/数据操作.特征体系.ixx:126</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1144 | R0356 | F0184 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1403</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1243 | R0392 | R0394 | <code>海中鱼巣/领域/数据操作.状态动态.ixx:1021</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1251 | R0396 | R0078 | <code>海中鱼巣/领域/数据操作.状态动态.ixx:1107, 海中鱼巣/领域/数据操作.状态动态.ixx:1125</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1249 | R0396 | R0082 | <code>海中鱼巣/领域/数据操作.状态动态.ixx:1087</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1247 | R0396 | R0392 | <code>海中鱼巣/领域/数据操作.状态动态.ixx:1058, 海中鱼巣/领域/数据操作.状态动态.ixx:1110</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1252 | R0396 | R0395 | <code>海中鱼巣/领域/数据操作.状态动态.ixx:1108, 海中鱼巣/领域/数据操作.状态动态.ixx:1128</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1248 | R0396 | R0397 | <code>海中鱼巣/领域/数据操作.状态动态.ixx:1069, 海中鱼巣/领域/数据操作.状态动态.ixx:1074, 海中鱼巣/领域/数据操作.状态动态.ixx:1088, 海中鱼巣/领域/数据操作.状态动态.ixx:1098, 海中鱼巣/领域/数据操作.状态动态.ixx:1102, 海中鱼巣/领域/数据操作.状态动态.ixx:1109, 海中鱼巣/领域/数据操作.状态动态.ixx:1111, 海中鱼巣/领域/数据操作.状态动态.ixx:1113, 海中鱼巣/领域/数据操作.状态动态.ixx:1116, 海中鱼巣/领域/数据操作.状态动态.ixx:1121, 海中鱼巣/领域/数据操作.状态动态.ixx:1129, 海中鱼巣/领域/数据操作.状态动态.ixx:1130, 海中鱼巣/领域/数据操作.状态动态.ixx:1133</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1269 | R0405 | R0021 | <code>海中鱼巣/领域/数据操作.状态动态.ixx:902</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1271 | R0405 | R0022 | <code>海中鱼巣/领域/数据操作.状态动态.ixx:906</code> | direct-member |  | None | 主键和主信息候选写入成功后创建节点候选 | 专项源码静态类型与实际装配人工复核 |
| RCE1272 | R0405 | R0027 | <code>海中鱼巣/领域/数据操作.状态动态.ixx:909</code> | direct-member |  | None | 节点候选成功后绑定主键 | 专项源码静态类型与实际装配人工复核 |
| RCE1270 | R0405 | R0028 | <code>海中鱼巣/领域/数据操作.状态动态.ixx:905</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1275 | R0405 | R0029 | <code>海中鱼巣/领域/数据操作.状态动态.ixx:912</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1274 | R0405 | R0036 | <code>海中鱼巣/领域/数据操作.状态动态.ixx:911</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1276 | R0405 | R0037 | <code>海中鱼巣/领域/数据操作.状态动态.ixx:913</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1273 | R0405 | R0129 | <code>海中鱼巣/领域/数据操作.状态动态.ixx:909</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1278 | R0405 | R0407 | <code>海中鱼巣/领域/数据操作.状态动态.ixx:923</code> | direct_const_member |  | None | 抽象状态结构候选读回完成后复核输出完整抽象状态 | 专项源码静态类型与实际装配人工复核 |
...
| RCE1291 | R0414 | R0030 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:247</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1292 | R0414 | R0031 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:248</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1294 | R0414 | R0033 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:250</code> | direct-member |  | None | 身份、类型、主信息和可读校验成立后读取节点主键组 | 专项源码静态类型与实际装配人工复核 |
| RCE1293 | R0414 | R0036 | <code>海中鱼巣/领域/数据操作.系统角色.ixx:249</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1323 | R0424 | F0441 | <code>海中鱼巣/领域/数据操作.轻量因果.ixx:208</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1326 | R0426 | F0184 | <code>海中鱼巣/领域/数据操作.轻量因果.ixx:243</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1351 | R0435 | F0168 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:1940</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1529 | R0525 | F0184 | <code>海中鱼巣/领域/概念图服务.h:4344, 海中鱼巣/领域/概念图服务.h:4357, 海中鱼巣/领域/概念图服务.h:4387, 海中鱼巣/领域/概念图服务.h:4395</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1528 | R0525 | R0523 | <code>海中鱼巣/领域/概念图服务.h:4342</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1530 | R0525 | R0528 | <code>海中鱼巣/领域/概念图服务.h:4395</code> | direct_const_member |  | None | 抽象树遍历正常完成后最终追根因检查；视图静态类型为抽象树视图材料 | 专项源码静态类型与实际装配人工复核 |
| RCE1533 | R0527 | F0051 | <code>海中鱼巣/领域/概念图服务.h:670</code> | operator |  | None | 比较投影路径末尾节点与概念节点 | 专项源码静态类型与实际装配人工复核 |
| RCE1532 | R0527 | F0163 | <code>海中鱼巣/领域/概念图服务.h:666</code> | direct |  | None | 抽象树投影项复核概念节点句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE1535 | R0528 | F0051 | <code>海中鱼巣/领域/概念图服务.h:687</code> | operator |  | None | 比较首个投影项概念与根概念 | 专项源码静态类型与实际装配人工复核 |
| RCE1534 | R0528 | F0163 | <code>海中鱼巣/领域/概念图服务.h:685</code> | direct |  | None | 复核根概念节点句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE1536 | R0528 | R0529 | <code>海中鱼巣/领域/概念图服务.h:688</code> | standard-library-callback |  | None | std::all_of 注册局部投影项完整性 lambda | 专项源码静态类型与实际装配人工复核 |
| RCE1558 | R0550 | R0551 | <code>海中鱼巣/领域/特征值服务.h:686</code> | standard-library-callback |  | None | std::find_if 注册非 const I64 记录匹配谓词 | 专项源码静态类型与实际装配人工复核 |
...
| RCE1617 | R0587 | R0596 | <code>海中鱼巣/领域/需求服务.h:713</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1618 | R0588 | R0597 | <code>海中鱼巣/领域/需求服务.h:749</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1619 | R0589 | R0597 | <code>海中鱼巣/领域/需求服务.h:753</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1620 | R0590 | R0597 | <code>海中鱼巣/领域/需求服务.h:757</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1621 | R0591 | R0577 | <code>海中鱼巣/领域/需求服务.h:761</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1622 | R0592 | R0597 | <code>海中鱼巣/领域/需求服务.h:765</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1624 | R0593 | R0581 | <code>海中鱼巣/领域/需求服务.h:776</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE3332 | R0773 | F0051 | <code>海中鱼巣/领域/数据操作.语素基础.ixx:550</code> | implicit-underlying-equality | 左=*F0441反查节点；右=目标 | bool 取反后参与身份反查一致性判断 | 期望主键存在，且 F0441 返回有值节点句柄 | 本批现状图、逐行映射与 optional 底层比较静态类型复核 |
...
| RCE3487 | R0957 | R0958 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:738</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3488 | R0959 | R0960 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:748</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3489 | R0961 | R0962 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:775</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3516 | R0980 | R0979 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1054</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3517 | R0980 | R1283 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1053</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3519 | R0983 | R0984 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1107</code> | callback_registration | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3518 | R0983 | R1457 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1106</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3886 | R0990 | R0979 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1164</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4134 | R0990 | R1310 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1165</code> | std::find equality callback | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3542 | R1000 | R1441 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1327</code> | frozen_source_exact_binding | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3887 | R1001 | R1382 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1334</code> | frozen_source_definition | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
...
| RCE0368 | R0032 | R0044 | <code>海中鱼巣/核心/会话.结构写入.ixx:537</code> | suffix_match |  | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0369 | R0033 | F0163 | <code>海中鱼巣/核心/会话.结构写入.ixx:542</code> | direct-free |  | None | 读取节点主键组入口复核节点句柄 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0391 | R0046 | R0043 | <code>海中鱼巣/核心/会话.结构写入.ixx:743</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE0426 | R0065 | F0167 | <code>海中鱼巣/核心/关系仓库.cpp:1033</code> | direct-const-member+direct-member |  | None | 令牌范围建立后调用无令牌重载；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0424 | R0065 | F0340 | <code>海中鱼巣/核心/关系仓库.cpp:1032</code> | constructor |  | None | 共享令牌有效后建立令牌范围 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0423 | R0065 | R0089 | <code>海中鱼巣/核心/关系仓库.cpp:1032</code> | direct-free |  | None | 令牌薄包装入口 | 专项源码静态类型与实际装配人工复核 |
| RCE0435 | R0068 | F0051 | <code>海中鱼巣/核心/关系仓库.cpp:1235, 海中鱼巣/核心/关系仓库.cpp:1274, 海中鱼巣/核心/关系仓库.cpp:1283, 海中鱼巣/核心/关系仓库.cpp:1284, 海中鱼巣/核心/关系仓库.cpp:1329, 海中鱼巣/核心/关系仓库.cpp:1331</code> | operator |  | None | 节点/父节点/关系记录端点比较 | 专项源码静态类型与实际装配人工复核 |
| RCE0439 | R0068 | F0184 | <code>海中鱼巣/核心/关系仓库.cpp:1263, 海中鱼巣/核心/关系仓库.cpp:1360</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0434 | R0068 | F0630 | <code>海中鱼巣/核心/关系仓库.cpp:1231, 海中鱼巣/核心/关系仓库.cpp:1232, 海中鱼巣/核心/关系仓库.cpp:1249, 海中鱼巣/核心/关系仓库.cpp:1254</code> | direct-const-member |  | None | 挂载写前端点与父链逐节点复核 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0440 | R0068 | R0067 | <code>海中鱼巣/核心/关系仓库.cpp:1288, 海中鱼巣/核心/关系仓库.cpp:1318, 海中鱼巣/核心/关系仓库.cpp:1347</code> | source-audited+direct-free+direct-free+direct-free |  | None | 三个发布分支形成关系句柄；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0438 | R0068 | R0069 | <code>海中鱼巣/核心/关系仓库.cpp:1250</code> | standard-library-callback |  | None | std::all_of 注册父链端点验证回调 | 专项源码静态类型与实际装配人工复核 |
| RCE0443 | R0068 | R0080 | <code>海中鱼巣/核心/关系仓库.cpp:1342</code> | unique_name+direct-member |  | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
| RCE0436 | R0068 | R0086 | <code>海中鱼巣/核心/关系仓库.cpp:1245, 海中鱼巣/核心/关系仓库.cpp:1268</code> | unique_name+direct-member+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核 |
| RCE0437 | R0068 | R0087 | <code>海中鱼巣/核心/关系仓库.cpp:1246, 海中鱼巣/核心/关系仓库.cpp:1269</code> | unique_name+direct-member+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核 |
| RCE0433 | R0068 | R0091 | <code>海中鱼巣/核心/关系仓库.cpp:1227</code> | source-audited+direct-free |  | None | 结构化挂载或重挂首先验证独占令牌；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0444 | R0068 | R0093 | <code>海中鱼巣/核心/关系仓库.cpp:1355</code> | move-constructor |  | None | optional emplace 移入能力 | 专项源码静态类型与实际装配人工复核 |
| RCE0442 | R0068 | R0096 | <code>海中鱼巣/核心/关系仓库.cpp:1340, 海中鱼巣/核心/关系仓库.cpp:1341</code> | constructor |  | None | 重挂分支形成变更能力 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0467 | R0074 | F0582 | <code>海中鱼巣/核心/关系仓库.cpp:1440</code> | direct-member |  | None | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0543 | R0108 | R0105 | <code>海中鱼巣/核心/执行器.结构写入.ixx:382</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0544 | R0108 | R0107 | <code>海中鱼巣/核心/执行器.结构写入.ixx:383</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0545 | R0109 | R0111 | <code>海中鱼巣/核心/执行器.结构写入.ixx:390</code> | direct-template-member |  | None | 逆序逐项完成旧结构写入参与者撤销 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0546 | R0110 | R0039 | <code>海中鱼巣/核心/执行器.结构写入.ixx:402</code> | constructor |  | None | 安全准备参与者显式构造只读准备视图 | 专项源码静态类型与实际装配人工复核 |
| RCE0547 | R0110 | R0260 | <code>海中鱼巣/核心/执行器.结构写入.ixx:403</code> | resolved-virtual |  | None | 可达特征值原始材料参与者上下文中的虚调用 | 专项源码静态类型与实际装配人工复核 |
| RCE0549 | R0112 | R0261 | <code>海中鱼巣/核心/执行器.结构写入.ixx:423</code> | resolved-virtual |  | None | 可达特征值原始材料参与者上下文中的虚调用 | 专项源码静态类型与实际装配人工复核 |
| RCE0550 | R0113 | R0262 | <code>海中鱼巣/核心/执行器.结构写入.ixx:432</code> | resolved-virtual |  | None | 可达特征值原始材料参与者上下文中的虚调用 | 专项源码静态类型与实际装配人工复核 |
| RCE0593 | R0128 | F0163 | <code>海中鱼巣/核心/索引所有权.数据.h:103</code> | source-audited |  | None | 兼容绑定请求复核目标节点句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE0594 | R0128 | R0131 | <code>海中鱼巣/核心/索引所有权.数据.h:104</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0595 | R0128 | R0135 | <code>海中鱼巣/核心/索引所有权.数据.h:104</code> | source-audited |  | None | 兼容完整性复核所有者声明 | 专项源码静态类型与实际装配人工复核 |
| RCE0598 | R0135 | R0130 | <code>海中鱼巣/核心/索引所有权.数据.h:88</code> | source-audited |  | None | 所有者声明符合规范首先复核显式完整 | 专项源码静态类型与实际装配人工复核 |
| RCE0599 | R0135 | R0132 | <code>海中鱼巣/核心/索引所有权.数据.h:88</code> | source-audited |  | None | 显式完整后比较声明与规范声明 | 专项源码静态类型与实际装配人工复核 |
| RCE0600 | R0135 | R0134 | <code>海中鱼巣/核心/索引所有权.数据.h:88</code> | lsp_direct | None | None | 调用方可达且源码分支条件成立 | LSP 直接解析并经源码调用词复核 |
| RCE0774 | R0219 | R0220 | <code>海中鱼巣/领域/任务服务.h:735</code> | direct-const-member |  | None | 显式第四参数 std::nullopt | 专项源码静态类型与实际装配人工复核 |
...
| RCE0779 | R0221 | F0621 | <code>海中鱼巣/领域/任务服务.h:764</code> | source-audited |  | None | 任务类型匹配 | 专项源码静态类型与实际装配人工复核 |
| RCE0778 | R0221 | R0222 | <code>海中鱼巣/领域/任务服务.h:761, 海中鱼巣/领域/任务服务.h:767</code> | direct-const-member |  | None | 任务及每个关系目标类型复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0877 | R0266 | F0163 | <code>海中鱼巣/领域/参与者.特征值原始材料.ixx:247</code> | direct-free |  | None | 侧表读取入口复核节点句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE0883 | R0266 | R0544 | <code>海中鱼巣/领域/参与者.特征值原始材料.ixx:273</code> | unique_name+direct-static-member | None | None | 调用方可达且源码分支条件成立；复核 Vec 记录内部一致 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
| RCE0881 | R0266 | R0545 | <code>海中鱼巣/领域/参与者.特征值原始材料.ixx:262</code> | unique_name+direct-static-member | None | None | 调用方可达且源码分支条件成立；复核 I64 版本记录内部一致 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
| RCE0882 | R0266 | R0548 | <code>海中鱼巣/领域/参与者.特征值原始材料.ixx:272</code> | unique_name+direct-const-member | None | None | 调用方可达且源码分支条件成立；const 服务选择 Vec 记录 const 查找重载 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
| RCE0880 | R0266 | R0552 | <code>海中鱼巣/领域/参与者.特征值原始材料.ixx:261</code> | unique_name+direct-const-member | None | None | 调用方可达且源码分支条件成立；const 服务选择 I64 记录 const 查找重载 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
| RCE0878 | R0266 | R0554 | <code>海中鱼巣/领域/参与者.特征值原始材料.ixx:254</code> | unique_name+direct-const-member | None | None | 调用方可达且源码分支条件成立；const 服务读取 Vec 记录数量 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
| RCE0879 | R0266 | R0556 | <code>海中鱼巣/领域/参与者.特征值原始材料.ixx:255</code> | unique_name+direct-const-member | None | None | 调用方可达且源码分支条件成立；const 服务读取 I64 版本记录数量 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
| RCE0886 | R0268 | F0163 | <code>海中鱼巣/领域/参与者.特征值原始材料.ixx:63</code> | direct-free |  | None | 快照中的特征值节点静态类型为节点句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE0977 | R0295 | R0309 | <code>海中鱼巣/领域/控制面板服务.h:1668, 海中鱼巣/领域/控制面板服务.h:1671</code> | direct-static-member |  | None | 关系角色相同 | 专项源码静态类型与实际装配人工复核 |
...
| RCE1142 | R0354 | F0184 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1387</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1143 | R0355 | F0184 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:1395</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1241 | R0391 | R0041 | <code>海中鱼巣/领域/数据操作.特征体系.ixx:897</code> | source-audited |  | None | lambda 形参静态类型为结构写入会话 | 专项源码静态类型与实际装配人工复核 |
...
| RCE1245 | R0394 | F0184 | <code>海中鱼巣/领域/数据操作.状态动态.ixx:1030</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1253 | R0397 | F0184 | <code>海中鱼巣/领域/数据操作.状态动态.ixx:1326</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1361 | R0441 | R0078 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:2095, 海中鱼巣/领域/数据操作.需求任务方法.ixx:2123, 海中鱼巣/领域/数据操作.需求任务方法.ixx:2137</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1362 | R0441 | R0435 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:2101, 海中鱼巣/领域/数据操作.需求任务方法.ixx:2126, 海中鱼巣/领域/数据操作.需求任务方法.ixx:2140</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1359 | R0441 | R0436 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:2080, 海中鱼巣/领域/数据操作.需求任务方法.ixx:2097, 海中鱼巣/领域/数据操作.需求任务方法.ixx:2125, 海中鱼巣/领域/数据操作.需求任务方法.ixx:2139</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1363 | R0441 | R0437 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:2104, 海中鱼巣/领域/数据操作.需求任务方法.ixx:2109, 海中鱼巣/领域/数据操作.需求任务方法.ixx:2114, 海中鱼巣/领域/数据操作.需求任务方法.ixx:2131, 海中鱼巣/领域/数据操作.需求任务方法.ixx:2145</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1360 | R0441 | R0440 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:2085</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1364 | R0441 | R0444 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:2171</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1537 | R0529 | R0527 | <code>海中鱼巣/领域/概念图服务.h:689</code> | direct_const_member |  | None | 逐个抽象树投影项复核完整性 | 专项源码静态类型与实际装配人工复核 |
| RCE1559 | R0551 | F0051 | <code>海中鱼巣/领域/特征值服务.h:687</code> | direct-free |  | None | I64 记录节点句柄与目标节点句柄比较 | 专项源码静态类型与实际装配人工复核 |
...
| RCE1628 | R0596 | R0588 | <code>海中鱼巣/领域/需求服务.h:980</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1629 | R0596 | R0589 | <code>海中鱼巣/领域/需求服务.h:981</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1630 | R0596 | R0590 | <code>海中鱼巣/领域/需求服务.h:982</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1631 | R0596 | R0591 | <code>海中鱼巣/领域/需求服务.h:983</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE2229 | R0596 | R0729 | <code>海中鱼巣/领域/需求服务.h:979</code> | direct_const_member | this,结算状态,节点类型::状态 | 类型匹配bool | R0596进入 | 本批源码逐调用点与静态接收者复核 |
| RCE1632 | R0597 | R0077 | <code>海中鱼巣/领域/需求服务.h:991</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE3490 | R0962 | R0952 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:797</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE3491 | R0962 | R0953 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:796, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:797, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:798</code> | direct_project_call | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE0445 | R0069 | F0630 | <code>海中鱼巣/核心/关系仓库.cpp:1254</code> | direct-const-member |  | None | 逐个父链节点复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0494 | R0086 | F0051 | <code>海中鱼巣/核心/关系仓库.cpp:689</code> | operator |  | None | 普通父关系复核目标节点 | 专项源码静态类型与实际装配人工复核 |
| RCE0496 | R0087 | F0051 | <code>海中鱼巣/核心/关系仓库.cpp:721, 海中鱼巣/核心/关系仓库.cpp:724</code> | operator |  | None | 父链目标比较和循环检测 | 专项源码静态类型与实际装配人工复核 |
| RCE0495 | R0087 | R0086 | <code>海中鱼巣/核心/关系仓库.cpp:710</code> | unique_name+direct-member | None | None | 调用方可达且源码分支条件成立；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0548 | R0111 | R0263 | <code>海中鱼巣/核心/执行器.结构写入.ixx:413</code> | resolved-virtual |  | None | 可达特征值原始材料参与者上下文中的虚调用 | 专项源码静态类型与实际装配人工复核 |
| RCE0867 | R0260 | R0016 | <code>海中鱼巣/领域/参与者.特征值原始材料.ixx:112</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0866 | R0260 | R0017 | <code>海中鱼巣/领域/参与者.特征值原始材料.ixx:111</code> | source-audited |  | None | 准备视图形参复核值节点属于本会话候选 | 专项源码静态类型与实际装配人工复核 |
| RCE0868 | R0260 | R0018 | <code>海中鱼巣/领域/参与者.特征值原始材料.ixx:113</code> | source-audited |  | None | 准备视图形参读取值节点候选类型 | 专项源码静态类型与实际装配人工复核 |
| RCE0869 | R0260 | R0019 | <code>海中鱼巣/领域/参与者.特征值原始材料.ixx:115</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0870 | R0260 | R0020 | <code>海中鱼巣/领域/参与者.特征值原始材料.ixx:118</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0873 | R0260 | R0264 | <code>海中鱼巣/领域/参与者.特征值原始材料.ixx:166</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0871 | R0260 | R0554 | <code>海中鱼巣/领域/参与者.特征值原始材料.ixx:129</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0872 | R0260 | R0556 | <code>海中鱼巣/领域/参与者.特征值原始材料.ixx:130</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1355 | R0440 | R0078 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:2026, 海中鱼巣/领域/数据操作.需求任务方法.ixx:2046</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1353 | R0440 | R0428 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:2006, 海中鱼巣/领域/数据操作.需求任务方法.ixx:2030</code> | source-audited |  | None | 身份与目标静态类型均为高级节点身份 | 专项源码静态类型与实际装配人工复核 |
| RCE1352 | R0440 | R0435 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:2005, 海中鱼巣/领域/数据操作.需求任务方法.ixx:2029</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1356 | R0440 | R0436 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:2027, 海中鱼巣/领域/数据操作.需求任务方法.ixx:2049</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1357 | R0440 | R0437 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:2032, 海中鱼巣/领域/数据操作.需求任务方法.ixx:2036</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1354 | R0440 | R0438 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:2019</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1358 | R0440 | R0439 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:2066, 海中鱼巣/领域/数据操作.需求任务方法.ixx:2067, 海中鱼巣/领域/数据操作.需求任务方法.ixx:2068</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE3334 | R0840 | F0163 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:273, 海中鱼巣/领域/数据操作.需求任务方法.ixx:274</code> | direct-free-overload | 来源需求、虚拟存在、场景、目标状态四个节点句柄 | 四个bool进入完整承接短路判断 | 身份当前可读且类型为任务 | 本批现状图、逐行映射与数据操作.需求任务方法.ixx blob 16ac9534复核 |
| RCE3333 | R0840 | R0428 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:272</code> | source-audited-direct | this=&amp;身份 | bool进入完整承接短路判断 | 状态等于已找到 | 本批现状图、逐行映射与数据操作.需求任务方法.ixx blob 16ac9534复核 |
| RCE3335 | R0840 | R0830 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:275, 海中鱼巣/领域/数据操作.需求任务方法.ixx:276, 海中鱼巣/领域/数据操作.需求任务方法.ixx:277</code> | source-audited-direct | this依次绑定需求拥有任务、任务来源需求、虚拟存在、场景、目标状态五条关系证据 | 五个bool进入完整承接短路判断 | 前序身份和节点句柄检查均为真 | 本批现状图、逐行映射与数据操作.需求任务方法.ixx blob 16ac9534复核 |
| RCE3336 | R0840 | R0843 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:277</code> | source-audited-direct | this=&amp;当前生命周期 | bool作为完整承接短路末项 | 五条关系证据均当前有效 | 本批现状图、逐行映射与数据操作.需求任务方法.ixx blob 16ac9534复核 |
| RCE3338 | R0841 | F0163 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:134, 海中鱼巣/领域/数据操作.需求任务方法.ixx:141, 海中鱼巣/领域/数据操作.需求任务方法.ixx:146, 海中鱼巣/领域/数据操作.需求任务方法.ixx:150, 海中鱼巣/领域/数据操作.需求任务方法.ixx:154, 海中鱼巣/领域/数据操作.需求任务方法.ixx:158</code> | direct-free-overload | 因果引用、需求、来源任务、目标状态、实际状态、动态证据六个节点句柄 | 六个bool分别进入因果或主返回短路判断 | 按源码从因果可选值分支或主返回前序条件逐项成立 | 本批现状图、逐行映射与数据操作.需求任务方法.ixx blob 16ac9534复核 |
| RCE3337 | R0841 | R0393 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:139</code> | source-audited-direct | this=&amp;结算状态 | bool进入完整性短路判断 | 因果引用与因果引用关系存在性一致且内容有效 | 本批现状图、逐行映射与数据操作.需求任务方法.ixx blob 16ac9534复核 |
| RCE3339 | R0841 | R0830 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:134, 海中鱼巣/领域/数据操作.需求任务方法.ixx:141, 海中鱼巣/领域/数据操作.需求任务方法.ixx:146, 海中鱼巣/领域/数据操作.需求任务方法.ixx:150, 海中鱼巣/领域/数据操作.需求任务方法.ixx:154, 海中鱼巣/领域/数据操作.需求任务方法.ixx:158</code> | source-audited-direct | this依次绑定因果引用、需求归属、来源任务、目标状态、实际状态、动态证据六条关系证据 | 六个bool分别进入因果或主返回短路判断 | 对应节点句柄有效且按源码前序条件成立 | 本批现状图、逐行映射与数据操作.需求任务方法.ixx blob 16ac9534复核 |
...
| RCE0874 | R0263 | R0264 | <code>海中鱼巣/领域/参与者.特征值原始材料.ixx:197</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0875 | R0264 | R0546 | <code>海中鱼巣/领域/参与者.特征值原始材料.ixx:207</code> | direct-member |  | None | 非 const 服务引用选择 Vec 记录非 const 查找重载 | 专项源码静态类型与实际装配人工复核 |
| RCE0876 | R0264 | R0550 | <code>海中鱼巣/领域/参与者.特征值原始材料.ixx:215</code> | direct-member |  | None | 非 const 服务引用选择 I64 记录非 const 查找重载 | 专项源码静态类型与实际装配人工复核 |
| RCE0887 | R0270 | R0267 | <code>海中鱼巣/领域/参与者.特征值原始材料.ixx:83</code> | source-audited |  | None | 材料形参静态类型复核字段自洽 | 专项源码静态类型与实际装配人工复核 |
| RCE0888 | R0270 | R0271 | <code>海中鱼巣/领域/参与者.特征值原始材料.ixx:84</code> | standard-library-callback |  | None | std::find_if 注册并调用本地唯一重复身份谓词 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0393 | R0047 | R0045 | <code>海中鱼巣/核心/会话.结构写入.ixx:750</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE0395 | R0048 | R0045 | <code>海中鱼巣/核心/会话.结构写入.ixx:758</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE0396 | R0049 | R0048 | <code>海中鱼巣/核心/会话.结构写入.ixx:766</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE0397 | R0050 | R0048 | <code>海中鱼巣/核心/会话.结构写入.ixx:772</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE0398 | R0051 | R0047 | <code>海中鱼巣/核心/会话.结构写入.ixx:780</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0884 | R0267 | F0163 | <code>海中鱼巣/领域/参与者.特征值原始材料.ixx:31</code> | direct-free |  | None | 特征值节点形参静态类型为节点句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE0885 | R0267 | F0565 | <code>海中鱼巣/领域/参与者.特征值原始材料.ixx:31</code> | direct-free |  | None | 主信息形参静态类型为主信息句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE0889 | R0271 | R0259 | <code>海中鱼巣/领域/参与者.特征值原始材料.ixx:85</code> | direct-static-member |  | None | find_if 谓词调用同类静态节点身份比较 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0390 | R0045 | R0043 | <code>海中鱼巣/核心/会话.结构写入.ixx:738</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE4544 | R1245 | F0051 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:136</code> | rewritten_operator_call | 候选节点句柄、输入节点句柄 | 相等布尔值 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4545 | R1249 | R1291 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:220</code> | rewritten_operator_call | 候选物理键、输入物理键 | 相等布尔值 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4546 | R1203 | R1191 | <code>海中鱼巣/核心/仓库.正式关系.ixx:348-349</code> | direct_or_implicit_move_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4547 | R1240 | R1191 | <code>海中鱼巣/核心/仓库.正式关系.ixx:990-991</code> | direct_or_implicit_move_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4548 | R1265 | R1191 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:331, 海中鱼巣/核心/会话.节点直接身份结构写入.ixx:334</code> | direct_or_implicit_move_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4549 | R1006 | R1191 | <code>海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:1837, 海中鱼巣/核心/执行器.节点直接身份结构写入.ixx:2831</code> | direct_or_implicit_move_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4550 | R1147 | R1194 | <code>海中鱼巣/核心/自检.节点直接身份结构写入.ixx:943</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4551 | R1203 | R1195 | <code>海中鱼巣/核心/仓库.正式关系.ixx:348-349</code> | direct_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4552 | R1240 | R1195 | <code>海中鱼巣/核心/仓库.正式关系.ixx:990-991</code> | direct_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4553 | R1265 | R1196 | <code>海中鱼巣/核心/会话.节点直接身份结构写入.ixx:325</code> | direct | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4554 | R1217 | R1197 | <code>海中鱼巣/核心/仓库.正式关系.ixx:481</code> | direct_or_implicit_move_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4555 | R1164 | R1158 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:253</code> | direct_constructor | 按冻结源码实参传递 | 按冻结源码接收或直接返回 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4556 | R1164 | F0051 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:247</code> | rewritten_operator_call | 既有节点句柄、当前身份 | 相等布尔值 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4557 | R1163 | R1179 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:187, 海中鱼巣/核心/仓库.可重建索引.ixx:202</code> | standard_container_callback | 正向表物理键 | 哈希值 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4558 | R1163 | R1291 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:187, 海中鱼巣/核心/仓库.可重建索引.ixx:202</code> | standard_container_callback | 正向表物理键 | 等值布尔值 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4559 | R1163 | R1181 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:199</code> | standard_container_callback | 反向表目标标识 | 哈希值 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4560 | R1163 | R1180 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:199</code> | standard_container_callback | 反向表目标标识 | 等值布尔值 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4561 | R1164 | R1179 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:244</code> | standard_container_callback | 正向表物理键 | 哈希值 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4562 | R1164 | R1291 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:244</code> | standard_container_callback | 正向表物理键 | 等值布尔值 | 调用方可达且对应源码分支成立 | 4b80f161 冻结源码逐调用点复核 |
| RCE4563 | R1163 | R1156 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:218</code> | implicit_move_construction | 可重建索引候选临时对象 | 结果.候选所持有的可重建索引候选 | 调用方可达且已完成正向表候选插入 | 4b80f161 冻结源码逐调用点复核 |
| RCE4564 | R1164 | R1156 | <code>海中鱼巣/核心/仓库.可重建索引.ixx:253</code> | implicit_move_construction | 标记为移除的可重建索引候选临时对象 | 结果.候选所持有的可重建索引候选 | 调用方可达且索引移除前置全部成立 | 4b80f161 冻结源码逐调用点复核 |
