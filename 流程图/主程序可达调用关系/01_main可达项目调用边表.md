...
项目直接调用边：2770。多调用点保留在同一 caller/callee 边记录中。
...
| RCE1725 | R0252 | R0610 | <code>海中鱼巣/领域/动态服务.h:340</code> | direct_const_member | <code>this, 动态节点</code> | 节点记录存在且类型为动态 | 同一具名类型一参数重载与定义范围复核 |
