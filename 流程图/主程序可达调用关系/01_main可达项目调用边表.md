...
代码基线：<code>03a8b7ac099ccea83e57f2696e2290b7bcdfacaf</code>；配置：<code>Debug\|x64</code>；项目调用边：4128。
...
| RCE3212 | R0868 | R0874 | <code>海中鱼巣/领域/状态服务.h:227, 海中鱼巣/领域/状态服务.h:232</code> | source-audited-direct | 场景/目标与对应节点类型 | 两个 bool 分别用于入口拒绝与循环筛选 | 调用方当前可达且执行到相应源码分支 | 本批现状图、逐行映射与状态服务源码两处静态接收者复核 |
...
| RCE3333 | R0840 | R0428 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:272</code> | source-audited-direct | this=&amp;身份 | bool进入完整承接短路判断 | 状态等于已找到 | 本批现状图、逐行映射与冻结源码静态接收者复核 |
| RCE3334 | R0840 | F0163 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:273, 海中鱼巣/领域/数据操作.需求任务方法.ixx:274</code> | direct-free-overload | 来源需求、虚拟存在、场景、目标状态四个节点句柄 | 四个bool进入完整承接短路判断 | 身份当前可读且类型为任务 | 本批现状图、逐行映射与 F0163 重载签名逐调用点复核 |
| RCE3335 | R0840 | R0830 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:275, 海中鱼巣/领域/数据操作.需求任务方法.ixx:276, 海中鱼巣/领域/数据操作.需求任务方法.ixx:277</code> | source-audited-direct | 五条关系证据 | 五个bool进入完整承接短路判断 | 前序身份和节点句柄检查均为真 | 本批现状图、逐行映射与静态接收者逐调用点复核 |
| RCE3336 | R0840 | R0843 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:277</code> | source-audited-direct | this=&amp;当前生命周期 | bool作为完整承接短路末项 | 五条关系证据均当前有效 | 本批现状图、逐行映射与 R0843 完整签名复核 |
| RCE3337 | R0841 | R0393 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:139</code> | source-audited-direct | this=&amp;结算状态 | bool进入完整性短路判断 | 因果引用与因果关系存在性一致且内容有效 | 本批现状图、逐行映射与 R0393 完整签名复核 |
| RCE3338 | R0841 | F0163 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:134, 海中鱼巣/领域/数据操作.需求任务方法.ixx:141, 海中鱼巣/领域/数据操作.需求任务方法.ixx:146, 海中鱼巣/领域/数据操作.需求任务方法.ixx:150, 海中鱼巣/领域/数据操作.需求任务方法.ixx:154, 海中鱼巣/领域/数据操作.需求任务方法.ixx:158</code> | direct-free-overload | 六个节点句柄 | 六个bool分别进入因果或主返回短路判断 | 按源码前序条件逐项成立 | 本批现状图、逐行映射与 F0163 重载签名逐调用点复核 |
| RCE3339 | R0841 | R0830 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:134, 海中鱼巣/领域/数据操作.需求任务方法.ixx:141, 海中鱼巣/领域/数据操作.需求任务方法.ixx:146, 海中鱼巣/领域/数据操作.需求任务方法.ixx:150, 海中鱼巣/领域/数据操作.需求任务方法.ixx:154, 海中鱼巣/领域/数据操作.需求任务方法.ixx:158</code> | source-audited-direct | 六条关系证据 | 六个bool分别进入因果或主返回短路判断 | 对应节点句柄有效且前序条件成立 | 本批现状图、逐行映射与 R0830 静态接收者逐调用点复核 |
| RCE3340 | R0864 | R0599 | <code>海中鱼巣/领域/特征值服务.h:292</code> | constructor | 无 | 局部结构事务许可 <code>许可</code> | 进入 R0864 且接线形态有效 | 本批现状图、逐行映射与源码生命周期逐调用点复核 |
| RCE3341 | R0864 | R0600 | <code>海中鱼巣/领域/特征值服务.h:295</code> | direct-operator | <code>this=&amp;许可</code>，其它=取得独占许可临时量 | 许可覆盖为取得的独占许可 | 事务接线已接域并取得独占许可 | 本批现状图、逐行映射与源码生命周期逐调用点复核 |
| RCE3342 | R0865 | R0599 | <code>海中鱼巣/领域/特征值服务.h:349</code> | constructor | 无 | 局部结构事务许可 <code>许可</code> | 进入 R0865 且接线形态有效 | 本批现状图、逐行映射与源码生命周期逐调用点复核 |
| RCE3343 | R0865 | R0600 | <code>海中鱼巣/领域/特征值服务.h:352</code> | direct-operator | <code>this=&amp;许可</code>，其它=取得共享许可临时量 | 许可覆盖为取得的共享许可 | 事务接线已接域并取得共享许可 | 本批现状图、逐行映射与源码生命周期逐调用点复核 |
| RCE3344 | R0866 | R0599 | <code>海中鱼巣/领域/特征值服务.h:371</code> | constructor | 无 | 局部结构事务许可 <code>许可</code> | 进入 R0866 且接线形态有效 | 本批现状图、逐行映射与源码生命周期逐调用点复核 |
| RCE3345 | R0866 | R0600 | <code>海中鱼巣/领域/特征值服务.h:374</code> | direct-operator | <code>this=&amp;许可</code>，其它=取得独占许可临时量 | 许可覆盖为取得的独占许可 | 事务接线已接域并取得独占许可 | 本批现状图、逐行映射与源码生命周期逐调用点复核 |
| RCE3346 | R0867 | R0599 | <code>海中鱼巣/领域/特征值服务.h:428</code> | constructor | 无 | 局部结构事务许可 <code>许可</code> | 进入 R0867 且接线形态有效 | 本批现状图、逐行映射与源码生命周期逐调用点复核 |
| RCE3347 | R0867 | R0600 | <code>海中鱼巣/领域/特征值服务.h:431</code> | direct-operator | <code>this=&amp;许可</code>，其它=取得共享许可临时量 | 许可覆盖为取得的共享许可 | 事务接线已接域并取得共享许可 | 本批现状图、逐行映射与源码生命周期逐调用点复核 |
| RCE3348 | R0888 | R0599 | <code>海中鱼巣/领域/特征值服务.h:214</code> | constructor | 无 | 局部结构事务许可 <code>许可</code> | 进入 R0888 且接线形态有效 | 本批现状图、逐行映射与源码生命周期逐调用点复核 |
| RCE3349 | R0888 | R0600 | <code>海中鱼巣/领域/特征值服务.h:217</code> | direct-operator | <code>this=&amp;许可</code>，其它=取得独占许可临时量 | 许可覆盖为取得的独占许可 | 事务接线已接域并取得独占许可 | 本批现状图、逐行映射与源码生命周期逐调用点复核 |
