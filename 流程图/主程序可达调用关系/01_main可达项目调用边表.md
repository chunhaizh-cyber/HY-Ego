...
代码基线：<code>0a93526882cb33c61c2fbb04ecad1aeaddcfe225</code>；配置：<code>Debug\|x64</code>；项目调用边：4030。
...
| RCE0001 | F0007 | F0045 | <code>海中鱼巣/启动.应用程序.ixx:59</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0002 | F0007 | F0046 | <code>海中鱼巣/启动.应用程序.ixx:60</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0003 | F0007 | F0048 | <code>海中鱼巣/启动.应用程序.ixx:61</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0004 | F0007 | F0053 | <code>海中鱼巣/启动.应用程序.ixx:82</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0005 | F0007 | F0054 | <code>海中鱼巣/启动.应用程序.ixx:87</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0006 | F0010 | F0045 | <code>海中鱼巣/启动.应用程序.ixx:123</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0007 | F0010 | F0046 | <code>海中鱼巣/启动.应用程序.ixx:124</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0008 | F0010 | F0048 | <code>海中鱼巣/启动.应用程序.ixx:125</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0009 | F0010 | F0053 | <code>海中鱼巣/启动.应用程序.ixx:146</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0010 | F0010 | F0054 | <code>海中鱼巣/启动.应用程序.ixx:151</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0026 | F0032 | F0045 | <code>海中鱼巣/启动.应用程序.ixx:221</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0027 | F0032 | F0046 | <code>海中鱼巣/启动.应用程序.ixx:227</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0028 | F0032 | F0048 | <code>海中鱼巣/启动.应用程序.ixx:233</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0094 | F0265 | R0586 | <code>海中鱼巣/自检.入口初始化.ixx:406</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0743 | R0204 | R0077 | <code>海中鱼巣/领域/二次特征服务.h:111</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0847 | R0249 | R0586 | <code>海中鱼巣/领域/初始化.需求.ixx:164</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0917 | R0286 | R0586 | <code>海中鱼巣/领域/控制面板服务.h:1294</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1505 | R0502 | F0168 | <code>海中鱼巣/领域/服务.特征.ixx:118, 海中鱼巣/领域/服务.特征.ixx:119</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1506 | R0502 | R0504 | <code>海中鱼巣/领域/服务.特征.ixx:121</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1513 | R0504 | F0168 | <code>海中鱼巣/领域/服务.特征.ixx:233</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1516 | R0514 | F0168 | <code>海中鱼巣/领域/服务.需求.ixx:91, 海中鱼巣/领域/服务.需求.ixx:92, 海中鱼巣/领域/服务.需求.ixx:93</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1691 | R0531 | F0051 | <code>海中鱼巣/领域/概念图服务.h:922</code> | operator |  | None | 概念根登记槽有值后比较登记根节点 | 专项源码静态类型与实际装配人工复核 |
...
| RCE1551 | R0544 | F0168 | <code>海中鱼巣/领域/特征值服务.h:581</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1553 | R0545 | F0168 | <code>海中鱼巣/领域/特征值服务.h:594</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1566 | R0560 | F0622 | <code>海中鱼巣/领域/特征服务.h:217</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1567 | R0560 | F0623 | <code>海中鱼巣/领域/特征服务.h:217</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1568 | R0562 | R0558 | <code>海中鱼巣/领域/特征服务.h:357</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1569 | R0566 | F0168 | <code>海中鱼巣/领域/组合.特征状态.ixx:33</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1571 | R0566 | R0508 | <code>海中鱼巣/领域/组合.特征状态.ixx:36, 海中鱼巣/领域/组合.特征状态.ixx:39</code> | direct-const-member |  | None | 槽位规格静态类型复核成功 | 专项源码静态类型与实际装配人工复核 |
| RCE1572 | R0566 | R0509 | <code>海中鱼巣/领域/组合.特征状态.ixx:36, 海中鱼巣/领域/组合.特征状态.ixx:39</code> | direct-const-member |  | None | 初始值规格静态类型复核成功 | 专项源码静态类型与实际装配人工复核 |
...
| RCE1578 | R0573 | F0441 | <code>海中鱼巣/领域/语素服务.h:331, 海中鱼巣/领域/语素服务.h:362</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1579 | R0573 | F0622 | <code>海中鱼巣/领域/语素服务.h:335</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1580 | R0573 | F0168 | <code>海中鱼巣/领域/语素服务.h:336, 海中鱼巣/领域/语素服务.h:341, 海中鱼巣/领域/语素服务.h:347</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1581 | R0573 | F0623 | <code>海中鱼巣/领域/语素服务.h:340</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1583 | R0573 | R0568 | <code>海中鱼巣/领域/语素服务.h:360</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1586 | R0574 | F0441 | <code>海中鱼巣/领域/语素服务.h:374</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1588 | R0574 | F0168 | <code>海中鱼巣/领域/语素服务.h:379, 海中鱼巣/领域/语素服务.h:382, 海中鱼巣/领域/语素服务.h:385</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1589 | R0574 | R0075 | <code>海中鱼巣/领域/语素服务.h:380</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1590 | R0574 | R0147 | <code>海中鱼巣/领域/语素服务.h:383</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1591 | R0574 | R0008 | <code>海中鱼巣/领域/语素服务.h:386</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1592 | R0575 | R0569 | <code>海中鱼巣/领域/语素服务.h:66</code> | suffix_match | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1593 | R0576 | R0077 | <code>海中鱼巣/领域/需求服务.h:1010</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1594 | R0577 | R0077 | <code>海中鱼巣/领域/需求服务.h:1030</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1595 | R0578 | F0622 | <code>海中鱼巣/领域/需求服务.h:132</code> | unique_name |  | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1596 | R0578 | F0623 | <code>海中鱼巣/领域/需求服务.h:132</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1599 | R0579 | F0168 | <code>海中鱼巣/领域/需求服务.h:307, 海中鱼巣/领域/需求服务.h:311, 海中鱼巣/领域/需求服务.h:321, 海中鱼巣/领域/需求服务.h:322, 海中鱼巣/领域/需求服务.h:323, 海中鱼巣/领域/需求服务.h:324, 海中鱼巣/领域/需求服务.h:325, 海中鱼巣/领域/需求服务.h:326</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1602 | R0579 | R0586 | <code>海中鱼巣/领域/需求服务.h:331</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1607 | R0581 | R0077 | <code>海中鱼巣/领域/需求服务.h:357</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1611 | R0583 | R0078 | <code>海中鱼巣/领域/需求服务.h:527</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1614 | R0586 | R0580 | <code>海中鱼巣/领域/需求服务.h:577</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1615 | R0586 | R0595 | <code>海中鱼巣/领域/需求服务.h:578, 海中鱼巣/领域/需求服务.h:579, 海中鱼巣/领域/需求服务.h:580, 海中鱼巣/领域/需求服务.h:581</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1616 | R0587 | R0078 | <code>海中鱼巣/领域/需求服务.h:708</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1623 | R0593 | F0168 | <code>海中鱼巣/领域/需求服务.h:773</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1624 | R0593 | R0581 | <code>海中鱼巣/领域/需求服务.h:776</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1625 | R0593 | R0586 | <code>海中鱼巣/领域/需求服务.h:780</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1626 | R0595 | R0594 | <code>海中鱼巣/领域/需求服务.h:826, 海中鱼巣/领域/需求服务.h:831</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE1627 | R0595 | R0077 | <code>海中鱼巣/领域/需求服务.h:830</code> | unique_name | None | None | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE1693 | R0604 | F0168 | <code>海中鱼巣/领域/概念图服务.h:244, 海中鱼巣/领域/概念图服务.h:245, 海中鱼巣/领域/概念图服务.h:246</code> | unique_name+direct_free | None | None | 调用方可达且源码分支条件成立；复核关系句柄有效 | 全项目唯一函数名并经调用方源码范围复核；专项源码静态类型与实际装配人工复核 |
