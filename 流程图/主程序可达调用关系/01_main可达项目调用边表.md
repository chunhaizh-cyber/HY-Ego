...
项目直接调用边：2793。多调用点保留在同一 caller/callee 边记录中。
...
| E0093 | F0025 | F0067 | <code>海中鱼巣/启动.程序运行宿主.ixx:49/53/56</code> | callback_invoke_resolved_test | <code>信号常量, 对应原处理器</code> | 安装函数实例来自入口端口合同自检且对应信号已安装 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
...
| E0282 | F0048 | F0180 | <code>海中鱼巣/领域/初始化.概念图.ixx:104-105, 海中鱼巣/领域/初始化.概念图.ixx:106-107, 海中鱼巣/领域/初始化.概念图.ixx:108-109, 海中鱼巣/领域/初始化.概念图.ixx:110-111</code> | direct_member_template_instance | <code>存在根项,存在类别,存在根稳定键,F0185</code> | 无完整已发布结果；存在根确保成功；动态根确保成功；关系根确保成功 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E0283 | F0048 | F0185 | <code>海中鱼巣/领域/初始化.概念图.ixx:105</code> | callback_bind | <code>捕获this并绑定到F0177创建参数</code> | 构造F0177实参 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| RCE0029 | F0048 | F0365 | <code>海中鱼巣/领域/初始化.概念图.ixx:105</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
| E0285 | F0048 | F0186 | <code>海中鱼巣/领域/初始化.概念图.ixx:107</code> | callback_bind | <code>捕获this并绑定到F0178创建参数</code> | 构造F0178实参 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| RCE0030 | F0048 | F0366 | <code>海中鱼巣/领域/初始化.概念图.ixx:107</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
| E0287 | F0048 | F0187 | <code>海中鱼巣/领域/初始化.概念图.ixx:109</code> | callback_bind | <code>捕获this并绑定到F0179创建参数</code> | 构造F0179实参 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| RCE0031 | F0048 | F0367 | <code>海中鱼巣/领域/初始化.概念图.ixx:109</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
| E0289 | F0048 | F0188 | <code>海中鱼巣/领域/初始化.概念图.ixx:111</code> | callback_bind | <code>捕获this并绑定到F0180创建参数</code> | 构造F0180实参 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| RCE0032 | F0048 | F0368 | <code>海中鱼巣/领域/初始化.概念图.ixx:111</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
...
| E0614 | F0136 | F0321 | <code>海中鱼巣/核心/节点仓库.cpp:45, 海中鱼巣/核心/节点仓库.cpp:45（右操作数）, 海中鱼巣/核心/节点仓库.cpp:45（左操作数）</code> | direct_const_member+unique_name | <code>this=&事务接线_</code> | 全部成员初始化成功；当前仓库接线形态有效；调用方可达且源码分支条件成立 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核；全项目唯一函数名并经调用方源码范围复核 |
...
| E0629 | F0160 | F0329 | <code>海中鱼巣/领域/方法服务.h:1343, 海中鱼巣/领域/方法服务.h:1344</code> | direct_member | <code>登记根材料_->活跃状态</code> | 全部前置成立；读取活跃状态值完成 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E0631 | F0160 | F0330 | <code>海中鱼巣/领域/方法服务.h:1345-1346, 海中鱼巣/领域/方法服务.h:1347-1348</code> | direct_member | <code>登记根,模板,状态,根活跃状态顺序号</code> | 两状态值读取完成；活跃目标读取完成 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
...
| E0634 | F0162 | F0331 | <code>海中鱼巣/领域/方法服务.h:310</code> | direct_member | <code>未单独冻结；读取源码调用点</code> | 函数进入 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
...
| E0647 | F0167 | F0337 | <code>海中鱼巣/核心/关系仓库.cpp:119, 海中鱼巣/核心/关系仓库.cpp:185, 海中鱼巣/核心/关系仓库.cpp:205, 海中鱼巣/核心/关系仓库.cpp:212, 海中鱼巣/核心/关系仓库.cpp:220</code> | direct_free+direct-free+direct-free+direct-free+direct-free | <code>*this</code> | 已接域；任务方法选择类型；方法动作场景类型；用途观察证据角色类型；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核；调用方可达且 libclang 直接引用项目定义；源码位置复核 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核；专项源码静态类型与实际装配人工复核 |
...
| E0663 | F0167 | F0345 | <code>海中鱼巣/核心/关系仓库.cpp:185-275, 海中鱼巣/核心/关系仓库.cpp:185（宏展开120完整表达式末）</code> | direct_destructor+implicit_destructor | <code>自动许可</code> | 已取得许可离开作用域；取得共享许可返回值已移动进optional | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
...
| E0715 | F0180 | F0185 | <code>海中鱼巣/领域/初始化.概念图.ixx:161</code> | callback_invoke | <code>创建回调，无参数</code> | 不存在已登记根 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E0721 | F0180 | F0186 | <code>海中鱼巣/领域/初始化.概念图.ixx:161</code> | callback_invoke | <code>创建回调，无参数</code> | 动态根未登记 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E0727 | F0180 | F0187 | <code>海中鱼巣/领域/初始化.概念图.ixx:161</code> | callback_invoke | <code>创建回调，无参数</code> | 关系根未登记 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E0733 | F0180 | F0188 | <code>海中鱼巣/领域/初始化.概念图.ixx:161</code> | callback_invoke | <code>创建回调，无参数</code> | 因果根未登记 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E0716 | F0180 | F0163 | <code>海中鱼巣/领域/初始化.概念图.ixx:162</code> | direct_free | <code>根节点</code> | 创建回调返回；F0186返回；F0187返回；F0188返回 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E0717 | F0180 | F0356 | <code>海中鱼巣/领域/初始化.概念图.ixx:165</code> | direct_member | <code>this=&概念图_,材料={存在,固定稳定键,根节点}</code> | 根节点有效 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E0719 | F0180 | F0184 | <code>海中鱼巣/领域/初始化.概念图.ixx:166-167</code> | direct_free | <code>登记有值且同根,L"概念根创建后登记不符合内部预期。"</code> | 登记完成；条件真假均调用 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E0718 | F0180 | F0051 | <code>海中鱼巣/领域/初始化.概念图.ixx:166</code> | direct_operator | <code>登记结果.value(),根节点</code> | 登记结果有值 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
...
| RCE0039 | F0182 | R0520 | <code>海中鱼巣/领域/概念图服务.h:1007</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| E0794 | F0198 | F0345 | <code>海中鱼巣/核心/关系仓库.cpp:1013-1025, 海中鱼巣/核心/关系仓库.cpp:1013（宏展开120完整表达式末）</code> | implicit_destructor | <code>this=&已移空临时许可</code> | U0005返回值已移动进optional；退出且自动许可已承载；F0344之后 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E0791 | F0198 | F0336 | <code>海中鱼巣/核心/关系仓库.cpp:1013（宏展开119）</code> | direct_const_member | <code>this=&事务接线_</code> | 函数进入 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E0792 | F0198 | F0337 | <code>海中鱼巣/核心/关系仓库.cpp:1013（宏展开119）, 海中鱼巣/核心/关系仓库.cpp:119</code> | direct_free+direct-free | <code>*this</code> | 已接域；调用方可达且 libclang 直接引用项目定义；源码位置复核 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核；专项源码静态类型与实际装配人工复核 |
| E0793 | F0198 | F0375 | <code>海中鱼巣/核心/关系仓库.cpp:1013（宏展开120）</code> | move_constructor | <code>U0005返回临时许可</code> | 已接域且无当前关系令牌 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E0795 | F0198 | F0338 | <code>海中鱼巣/核心/关系仓库.cpp:1013（宏展开121）</code> | direct_const_member | <code>this=&自动许可.value()</code> | 自动许可已承载 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E0796 | F0198 | F0339 | <code>海中鱼巣/核心/关系仓库.cpp:1013（宏展开122）</code> | direct_const_member | <code>this=&自动许可.value()</code> | 许可有效 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E0797 | F0198 | F0340 | <code>海中鱼巣/核心/关系仓库.cpp:1013（宏展开122）</code> | constructor | <code>*this,自动许可令牌</code> | 许可有效 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
...
| E0864 | F0223 | F0396 | <code>海中鱼巣/界面/控制面板窗口.cpp:1578,1595</code> | external_callback | <code>窗口消息参数</code> | DispatchMessageW或同步窗口API回调 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
...
| E0867 | F0227 | F0230 | <code>海中鱼巣/生产运行期配置.数据.h:68（右操作数）, 海中鱼巣/生产运行期配置.数据.h:68（左操作数）</code> | direct_const_member | <code>this=&this->系统角色</code> | 前五项字段比较均相等；与右操作数的求值先后未固定；前五项字段比较均相等；与左操作数的求值先后未固定 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
...
| E0949 | F0244 | F0456 | <code>海中鱼巣/领域/系统角色清单.数据.h:217,264</code> | defaulted_const_member | <code>this=&this->主体,右=&右.主体</code> | 版本相等 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E0950 | F0244 | F0457 | <code>海中鱼巣/领域/系统角色清单.数据.h:218,264, 海中鱼巣/领域/系统角色清单.数据.h:219,264</code> | defaulted_const_member | <code>this=&this->世界根到场景关系,右=&右.世界根到场景关系</code> | E0949返回true；E0950返回true | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
...
| RCE0064 | F0258 | F0376 | <code>海中鱼巣/自检.入口初始化.ixx:209, 海中鱼巣/自检.入口初始化.ixx:218</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0076 | F0261 | F0376 | <code>海中鱼巣/自检.入口初始化.ixx:291, 海中鱼巣/自检.入口初始化.ixx:299</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0081 | F0262 | F0376 | <code>海中鱼巣/自检.入口初始化.ixx:324</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0102 | F0266 | F0376 | <code>海中鱼巣/自检.入口初始化.ixx:443, 海中鱼巣/自检.入口初始化.ixx:450</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| RCE0104 | F0267 | F0376 | <code>海中鱼巣/自检.入口初始化.ixx:476</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| E1639 | F0321 | F0336 | <code>海中鱼巣/核心/结构事务接线.数据.h:83, 海中鱼巣/核心/结构事务接线.数据.h:83（右操作数）</code> | direct_const_member+unique_name | <code>同一隐式const this</code> | F0618返回false；调用方可达且源码分支条件成立 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核；同一具名类型内直接调用；源码调用词与定义范围闭合 |
| E1638 | F0321 | F0618 | <code>海中鱼巣/核心/结构事务接线.数据.h:83, 海中鱼巣/核心/结构事务接线.数据.h:83（左操作数）</code> | direct_const_member+unique_name | <code>同一隐式const this</code> | 函数进入；总是求值；调用方可达且源码分支条件成立 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核；同一具名类型内直接调用；源码调用词与定义范围闭合 |
| E1640 | F0322 | F0336 | <code>海中鱼巣/核心/节点仓库.cpp:17, 海中鱼巣/核心/节点仓库.cpp:17（右操作数）, 海中鱼巣/核心/节点仓库.cpp:17（左操作数）, 海中鱼巣/核心/节点仓库.cpp:18, 海中鱼巣/核心/节点仓库.cpp:18（右操作数）, 海中鱼巣/核心/节点仓库.cpp:18（左操作数）</code> | direct_const_member+unique_name | <code>this=&左</code> | 函数进入；总是求值；左首次接域为false；双方未接域提前返回条件不成立；左二次接域为true；调用方可达且源码分支条件成立 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核；全项目唯一函数名并经调用方源码范围复核 |
| E1644 | F0323 | F0336 | <code>海中鱼巣/核心/关系仓库.cpp:82, 海中鱼巣/核心/关系仓库.cpp:82（右操作数）, 海中鱼巣/核心/关系仓库.cpp:82（左操作数）, 海中鱼巣/核心/关系仓库.cpp:83, 海中鱼巣/核心/关系仓库.cpp:83（右操作数）, 海中鱼巣/核心/关系仓库.cpp:83（左操作数）</code> | direct_const_member+unique_name | <code>this=&左</code> | 函数进入；总是求值；左首次接域为false；双方未接域提前返回条件不成立；左二次接域为true；调用方可达且源码分支条件成立 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核；全项目唯一函数名并经调用方源码范围复核 |
| E1648 | F0324 | F0336 | <code>海中鱼巣/核心/索引仓库.cpp:13, 海中鱼巣/核心/索引仓库.cpp:13（右操作数）, 海中鱼巣/核心/索引仓库.cpp:13（左操作数）, 海中鱼巣/核心/索引仓库.cpp:14, 海中鱼巣/核心/索引仓库.cpp:14（右操作数）, 海中鱼巣/核心/索引仓库.cpp:14（左操作数）</code> | direct_const_member+unique_name | <code>this=&左</code> | 函数进入；总是求值；左首次接域为false；双方未接域提前返回条件不成立；左二次接域为true；调用方可达且源码分支条件成立 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核；全项目唯一函数名并经调用方源码范围复核 |
...
| E1668 | F0330 | F0333 | <code>海中鱼巣/领域/方法服务.h:1713, 海中鱼巣/领域/方法服务.h:1721</code> | direct_const_member | <code>this=&方法服务,源节点,节点类型::方法</code> | 函数进入；遍历每个关系目标 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
...
| RCE0106 | F0331 | F0397 | <code>海中鱼巣/核心/主信息仓库.cpp:40</code> | resolved-function-pointer | <code>未单独冻结；读取源码调用点</code> | 事务接线已接域；生产运行期唯一正式共享许可目标 | 专项源码静态类型与实际装配人工复核 |
| E1676 | F0331 | F0345 | <code>海中鱼巣/核心/主信息仓库.cpp:41-42</code> | implicit_destructor | <code>this=&许可</code> | 接域分支返回对象形成后或许可形成后的异常展开 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
...
| E1675 | F0331 | F0622 | <code>海中鱼巣/核心/主信息仓库.cpp:41</code> | direct_member+direct-member | <code>this=&主信息仓库,许可.读取令牌()</code> | 许可有效且令牌借用已取得；调用方可达且 libclang 直接引用项目定义；源码位置复核 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核；专项源码静态类型与实际装配人工复核 |
...
| E1842 | F0349 | F0637 | <code>海中鱼巣/线程/自我线程.ixx:339</code> | direct_member+unique_name | <code>this=当前自我线程,治理初始化快照</code> | 快照已发布、停止请求为false且治理邮箱非空；调用方可达且源码分支条件成立 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核；同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE0109 | F0353 | R0520 | <code>海中鱼巣/领域/概念图服务.h:1866</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE0110 | F0356 | R0521 | <code>海中鱼巣/领域/概念图服务.h:851</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0111 | F0356 | F0639 | <code>海中鱼巣/领域/概念图服务.h:852</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0112 | F0356 | F0640 | <code>海中鱼巣/领域/概念图服务.h:880, 海中鱼巣/领域/概念图服务.h:881</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0113 | F0356 | F0184 | <code>海中鱼巣/领域/概念图服务.h:882</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
| E1707 | F0357 | F0190 | <code>海中鱼巣/领域/概念图服务.h:938</code> | direct_const_member | <code>this=&节点_,状态节点</code> | F0357函数进入 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1667 | F0357 | F0329 | <code>海中鱼巣/领域/概念图服务.h:939</code> | direct_const_member | <code>this=&状态,状态节点</code> | E1707节点记录读取完成；不要求记录有值，且位于if短路判断之前 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| RCE0114 | F0357 | F0641 | <code>海中鱼巣/领域/概念图服务.h:940</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| E1664 | F0357 | F0328 | <code>海中鱼巣/领域/概念图服务.h:945</code> | direct_const_member+unique_name | <code>this=&状态,状态节点</code> | 阶段有效、节点可读且类型为状态、状态值存在并匹配阶段；调用方可达且源码分支条件成立 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核；全项目唯一函数名并经调用方源码范围复核 |
| RCE0115 | F0357 | F0642 | <code>海中鱼巣/领域/概念图服务.h:950</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0116 | F0357 | F0184 | <code>海中鱼巣/领域/概念图服务.h:962</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
| RCE0117 | F0358 | F0377 | <code>海中鱼巣/领域/概念图服务.h:3005</code> | direct-const-member | <code>未单独冻结；读取源码调用点</code> | optional 状态有值后复核节点有效；单实参无令牌重载 | 专项源码静态类型与实际装配人工复核 |
| RCE0118 | F0358 | R0518 | <code>海中鱼巣/领域/概念图服务.h:3010</code> | standard-library-callback | <code>未单独冻结；读取源码调用点</code> | std::sort 注册同类静态比较函数 | 专项源码静态类型与实际装配人工复核 |
| RCE0119 | F0359 | F0369 | <code>海中鱼巣/领域/概念图服务.h:3047</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0120 | F0359 | F0641 | <code>海中鱼巣/领域/概念图服务.h:3048</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0121 | F0359 | F0354 | <code>海中鱼巣/领域/概念图服务.h:3054</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0122 | F0359 | F0184 | <code>海中鱼巣/领域/概念图服务.h:3062, 海中鱼巣/领域/概念图服务.h:3068, 海中鱼巣/领域/概念图服务.h:3072, 海中鱼巣/领域/概念图服务.h:3090, 海中鱼巣/领域/概念图服务.h:3114, 海中鱼巣/领域/概念图服务.h:3121, 海中鱼巣/领域/概念图服务.h:3128</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
| RCE0123 | F0359 | R0519 | <code>海中鱼巣/领域/概念图服务.h:3067</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0124 | F0359 | F0168 | <code>海中鱼巣/领域/概念图服务.h:3121, 海中鱼巣/领域/概念图服务.h:3127</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0125 | F0361 | F0590 | <code>海中鱼巣/领域/概念图服务.h:3231</code> | direct-member | <code>未单独冻结；读取源码调用点</code> | 反向清理已登记生命周期关系；单实参写重载 | 专项源码静态类型与实际装配人工复核 |
| RCE0126 | F0361 | F0587 | <code>海中鱼巣/领域/概念图服务.h:3232</code> | direct-const-member | <code>未单独冻结；读取源码调用点</code> | 删除失败后复核关系已不可读；单实参无令牌重载 | 专项源码静态类型与实际装配人工复核 |
| RCE0127 | F0362 | R0531 | <code>海中鱼巣/领域/概念图服务.h:4202</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0128 | F0362 | F0358 | <code>海中鱼巣/领域/概念图服务.h:4208</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0129 | F0362 | R0520 | <code>海中鱼巣/领域/概念图服务.h:4212</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0130 | F0362 | F0369 | <code>海中鱼巣/领域/概念图服务.h:4223, 海中鱼巣/领域/概念图服务.h:4249</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0131 | F0362 | R0532 | <code>海中鱼巣/领域/概念图服务.h:4226</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
| RCE0132 | F0362 | R0523 | <code>海中鱼巣/领域/概念图服务.h:4240, 海中鱼巣/领域/概念图服务.h:4241, 海中鱼巣/领域/概念图服务.h:4250, 海中鱼巣/领域/概念图服务.h:4259</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0133 | F0362 | R0533 | <code>海中鱼巣/领域/概念图服务.h:4244</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
| RCE0134 | F0362 | R0522 | <code>海中鱼巣/领域/概念图服务.h:4261</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0135 | F0363 | F0168 | <code>海中鱼巣/领域/语素服务.h:35, 海中鱼巣/领域/语素服务.h:36, 海中鱼巣/领域/语素服务.h:37, 海中鱼巣/领域/语素服务.h:38</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0136 | F0364 | R0571 | <code>海中鱼巣/领域/语素服务.h:101</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0137 | F0364 | R0572 | <code>海中鱼巣/领域/语素服务.h:106</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0138 | F0364 | R0573 | <code>海中鱼巣/领域/语素服务.h:111</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0139 | F0364 | F0168 | <code>海中鱼巣/领域/语素服务.h:112, 海中鱼巣/领域/语素服务.h:116</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0140 | F0364 | F0497 | <code>海中鱼巣/领域/语素服务.h:116</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0141 | F0364 | R0570 | <code>海中鱼巣/领域/语素服务.h:116</code> | suffix_match | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0142 | F0364 | R0574 | <code>海中鱼巣/领域/语素服务.h:119</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0143 | F0364 | R0575 | <code>海中鱼巣/领域/语素服务.h:96</code> | suffix_match | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE0146 | F0366 | R0250 | <code>海中鱼巣/领域/动态服务.h:294</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE0150 | F0368 | R0274 | <code>海中鱼巣/领域/因果服务.h:57</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0151 | F0368 | F0184 | <code>海中鱼巣/领域/因果服务.h:59</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 逐边源码/静态类型审计 PASS |
...
| E1699 | F0387 | F0337 | <code>海中鱼巣/核心/关系仓库.cpp:119, 海中鱼巣/核心/关系仓库.cpp:734（宏展开119）</code> | direct_free+direct-free | <code>*this</code> | 已接域；调用方可达且 libclang 直接引用项目定义；源码位置复核 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核；专项源码静态类型与实际装配人工复核 |
...
| E1817 | F0387 | F0345 | <code>海中鱼巣/核心/关系仓库.cpp:733-758, 海中鱼巣/核心/关系仓库.cpp:734（宏展开120完整表达式末）</code> | implicit_destructor | <code>this=&已移空临时许可</code> | 取得共享许可返回值已移动进optional；正常或异常退出且自动许可已承载；F0344之后 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1715 | F0387 | F0338 | <code>海中鱼巣/核心/关系仓库.cpp:734（宏展开121）</code> | direct_const_member | <code>this=&自动许可.value()</code> | 已接域且当前关系令牌为空；自动许可已承载 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1729 | F0387 | F0339 | <code>海中鱼巣/核心/关系仓库.cpp:734（宏展开122）</code> | direct_const_member | <code>this=&自动许可.value()</code> | 已接域、当前关系令牌为空且自动许可有效 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1743 | F0387 | F0340 | <code>海中鱼巣/核心/关系仓库.cpp:734（宏展开122）</code> | constructor | <code>*this,自动许可->读取令牌()</code> | 已接域、当前关系令牌为空且自动许可有效 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
...
| RCE0208 | F0440 | R0089 | <code>海中鱼巣/核心/关系仓库.cpp:1028</code> | direct-free | <code>未单独冻结；读取源码调用点</code> | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| E1751 | F0440 | F0340 | <code>海中鱼巣/核心/关系仓库.cpp:1029, 海中鱼巣/核心/关系仓库.cpp:1431（宏展开1029）</code> | direct_constructor+constructor | <code>*this,令牌</code> | 共享令牌验证通过；调用方可达且 libclang 直接引用项目定义；源码位置复核 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核；专项源码静态类型与实际装配人工复核 |
...
| RCE0243 | F0465 | R0538 | <code>海中鱼巣/领域/概念活动状态.数据.h:138</code> | direct-const-member | <code>未单独冻结；读取源码调用点</code> | 根材料比较需要复核给定活跃角色 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0249 | F0468 | F0376 | <code>海中鱼巣/自检.入口初始化.ixx:62</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
...
| E1702 | F0575 | F0337 | <code>海中鱼巣/核心/关系仓库.cpp:119, 海中鱼巣/核心/关系仓库.cpp:844（宏展开119）</code> | direct_free+direct-free | <code>*this</code> | 已接域；调用方可达且 libclang 直接引用项目定义；源码位置复核 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核；专项源码静态类型与实际装配人工复核 |
...
| E1823 | F0575 | F0345 | <code>海中鱼巣/核心/关系仓库.cpp:843-863, 海中鱼巣/核心/关系仓库.cpp:844（宏展开120完整表达式末）</code> | implicit_destructor | <code>this=&已移空临时许可</code> | 取得共享许可返回值已移动进optional；正常或异常退出且自动许可已承载；F0344之后 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1718 | F0575 | F0338 | <code>海中鱼巣/核心/关系仓库.cpp:844（宏展开121）</code> | direct_const_member | <code>this=&自动许可.value()</code> | 已接域且当前关系令牌为空；自动许可已承载 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1732 | F0575 | F0339 | <code>海中鱼巣/核心/关系仓库.cpp:844（宏展开122）</code> | direct_const_member | <code>this=&自动许可.value()</code> | 已接域、当前关系令牌为空且自动许可有效 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1746 | F0575 | F0340 | <code>海中鱼巣/核心/关系仓库.cpp:844（宏展开122）</code> | constructor | <code>*this,自动许可->读取令牌()</code> | 已接域、当前关系令牌为空且自动许可有效 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
...
| E1703 | F0578 | F0337 | <code>海中鱼巣/核心/关系仓库.cpp:119, 海中鱼巣/核心/关系仓库.cpp:920（宏展开119）</code> | direct_free+direct-free | <code>*this</code> | 已接域；调用方可达且 libclang 直接引用项目定义；源码位置复核 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核；专项源码静态类型与实际装配人工复核 |
...
| E1825 | F0578 | F0345 | <code>海中鱼巣/核心/关系仓库.cpp:919-947, 海中鱼巣/核心/关系仓库.cpp:920（宏展开120完整表达式末）</code> | implicit_destructor | <code>this=&已移空临时许可</code> | 取得共享许可返回值已移动进optional；正常或异常退出且自动许可已承载；F0344之后 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1719 | F0578 | F0338 | <code>海中鱼巣/核心/关系仓库.cpp:920（宏展开121）</code> | direct_const_member | <code>this=&自动许可.value()</code> | 已接域且当前关系令牌为空；自动许可已承载 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1733 | F0578 | F0339 | <code>海中鱼巣/核心/关系仓库.cpp:920（宏展开122）</code> | direct_const_member | <code>this=&自动许可.value()</code> | 已接域、当前关系令牌为空且自动许可有效 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1747 | F0578 | F0340 | <code>海中鱼巣/核心/关系仓库.cpp:920（宏展开122）</code> | constructor | <code>*this,自动许可->读取令牌()</code> | 已接域、当前关系令牌为空且自动许可有效 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
...
| E1705 | F0579 | F0337 | <code>海中鱼巣/核心/关系仓库.cpp:119, 海中鱼巣/核心/关系仓库.cpp:981（宏展开119）</code> | direct_free+direct-free | <code>*this</code> | 已接域；调用方可达且 libclang 直接引用项目定义；源码位置复核 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核；专项源码静态类型与实际装配人工复核 |
...
| E1829 | F0579 | F0345 | <code>海中鱼巣/核心/关系仓库.cpp:980-994, 海中鱼巣/核心/关系仓库.cpp:981（宏展开120完整表达式末）</code> | implicit_destructor | <code>this=&已移空临时许可</code> | 取得共享许可返回值已移动进optional；正常或异常退出且自动许可已承载；F0344之后 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1721 | F0579 | F0338 | <code>海中鱼巣/核心/关系仓库.cpp:981（宏展开121）</code> | direct_const_member | <code>this=&自动许可.value()</code> | 已接域且当前关系令牌为空；自动许可已承载 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1735 | F0579 | F0339 | <code>海中鱼巣/核心/关系仓库.cpp:981（宏展开122）</code> | direct_const_member | <code>this=&自动许可.value()</code> | 已接域、当前关系令牌为空且自动许可有效 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1749 | F0579 | F0340 | <code>海中鱼巣/核心/关系仓库.cpp:981（宏展开122）</code> | constructor | <code>*this,自动许可->读取令牌()</code> | 已接域、当前关系令牌为空且自动许可有效 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
...
| E1706 | F0580 | F0337 | <code>海中鱼巣/核心/关系仓库.cpp:119, 海中鱼巣/核心/关系仓库.cpp:997（宏展开119）</code> | direct_free+direct-free | <code>*this</code> | 已接域；调用方可达且 libclang 直接引用项目定义；源码位置复核 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核；专项源码静态类型与实际装配人工复核 |
...
| E1831 | F0580 | F0345 | <code>海中鱼巣/核心/关系仓库.cpp:996-1010, 海中鱼巣/核心/关系仓库.cpp:997（宏展开120完整表达式末）</code> | implicit_destructor | <code>this=&已移空临时许可</code> | 取得共享许可返回值已移动进optional；正常或异常退出且自动许可已承载；F0344之后 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1722 | F0580 | F0338 | <code>海中鱼巣/核心/关系仓库.cpp:997（宏展开121）</code> | direct_const_member | <code>this=&自动许可.value()</code> | 已接域且当前关系令牌为空；自动许可已承载 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1736 | F0580 | F0339 | <code>海中鱼巣/核心/关系仓库.cpp:997（宏展开122）</code> | direct_const_member | <code>this=&自动许可.value()</code> | 已接域、当前关系令牌为空且自动许可有效 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1750 | F0580 | F0340 | <code>海中鱼巣/核心/关系仓库.cpp:997（宏展开122）</code> | constructor | <code>*this,自动许可->读取令牌()</code> | 已接域、当前关系令牌为空且自动许可有效 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
...
| E1704 | F0581 | F0337 | <code>海中鱼巣/核心/关系仓库.cpp:119, 海中鱼巣/核心/关系仓库.cpp:950（宏展开119）</code> | direct_free+direct-free | <code>*this</code> | 已接域；调用方可达且 libclang 直接引用项目定义；源码位置复核 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核；专项源码静态类型与实际装配人工复核 |
...
| E1827 | F0581 | F0345 | <code>海中鱼巣/核心/关系仓库.cpp:949-978, 海中鱼巣/核心/关系仓库.cpp:950（宏展开120完整表达式末）</code> | implicit_destructor | <code>this=&已移空临时许可</code> | 取得共享许可返回值已移动进optional；正常或异常退出且自动许可已承载；F0344之后 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1720 | F0581 | F0338 | <code>海中鱼巣/核心/关系仓库.cpp:950（宏展开121）</code> | direct_const_member | <code>this=&自动许可.value()</code> | 已接域且当前关系令牌为空；自动许可已承载 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1734 | F0581 | F0339 | <code>海中鱼巣/核心/关系仓库.cpp:950（宏展开122）</code> | direct_const_member | <code>this=&自动许可.value()</code> | 已接域、当前关系令牌为空且自动许可有效 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1748 | F0581 | F0340 | <code>海中鱼巣/核心/关系仓库.cpp:950（宏展开122）</code> | constructor | <code>*this,自动许可->读取令牌()</code> | 已接域、当前关系令牌为空且自动许可有效 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
...
| E1695 | F0582 | F0337 | <code>海中鱼巣/核心/关系仓库.cpp:119, 海中鱼巣/核心/关系仓库.cpp:317（宏展开119）</code> | direct_free+direct-free | <code>*this</code> | 已接域；调用方可达且 libclang 直接引用项目定义；源码位置复核 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核；专项源码静态类型与实际装配人工复核 |
...
| E1809 | F0582 | F0345 | <code>海中鱼巣/核心/关系仓库.cpp:314-337, 海中鱼巣/核心/关系仓库.cpp:317（宏展开120完整表达式末）</code> | implicit_destructor | <code>this=&已移空临时许可</code> | 取得共享许可返回值已移动进optional；正常或异常退出且自动许可已承载；F0344之后 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1711 | F0582 | F0338 | <code>海中鱼巣/核心/关系仓库.cpp:317（宏展开121）</code> | direct_const_member | <code>this=&自动许可.value()</code> | 已接域且当前关系令牌为空；自动许可已承载 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1725 | F0582 | F0339 | <code>海中鱼巣/核心/关系仓库.cpp:317（宏展开122）</code> | direct_const_member | <code>this=&自动许可.value()</code> | 已接域、当前关系令牌为空且自动许可有效 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1739 | F0582 | F0340 | <code>海中鱼巣/核心/关系仓库.cpp:317（宏展开122）</code> | constructor | <code>*this,自动许可->读取令牌()</code> | 已接域、当前关系令牌为空且自动许可有效 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
...
| E1698 | F0586 | F0337 | <code>海中鱼巣/核心/关系仓库.cpp:119, 海中鱼巣/核心/关系仓库.cpp:435（宏展开119）</code> | direct_free+direct-free | <code>*this</code> | 已接域；调用方可达且 libclang 直接引用项目定义；源码位置复核 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核；专项源码静态类型与实际装配人工复核 |
...
| E1815 | F0586 | F0345 | <code>海中鱼巣/核心/关系仓库.cpp:431-479, 海中鱼巣/核心/关系仓库.cpp:435（宏展开120完整表达式末）</code> | implicit_destructor | <code>this=&已移空临时许可</code> | 取得共享许可返回值已移动进optional；正常或异常退出且自动许可已承载；F0344之后 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1714 | F0586 | F0338 | <code>海中鱼巣/核心/关系仓库.cpp:435（宏展开121）</code> | direct_const_member | <code>this=&自动许可.value()</code> | 已接域且当前关系令牌为空；自动许可已承载 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1728 | F0586 | F0339 | <code>海中鱼巣/核心/关系仓库.cpp:435（宏展开122）</code> | direct_const_member | <code>this=&自动许可.value()</code> | 已接域、当前关系令牌为空且自动许可有效 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1742 | F0586 | F0340 | <code>海中鱼巣/核心/关系仓库.cpp:435（宏展开122）</code> | constructor | <code>*this,自动许可->读取令牌()</code> | 已接域、当前关系令牌为空且自动许可有效 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
...
| E1693 | F0587 | F0337 | <code>海中鱼巣/核心/关系仓库.cpp:119, 海中鱼巣/核心/关系仓库.cpp:278（宏展开119）</code> | direct_free+direct-free | <code>*this</code> | 已接域；调用方可达且 libclang 直接引用项目定义；源码位置复核 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核；专项源码静态类型与实际装配人工复核 |
...
| E1805 | F0587 | F0345 | <code>海中鱼巣/核心/关系仓库.cpp:277-293, 海中鱼巣/核心/关系仓库.cpp:278（宏展开120完整表达式末）</code> | implicit_destructor | <code>this=&已移空临时许可</code> | 取得共享许可返回值已移动进optional；正常或异常退出且自动许可已承载；F0344之后 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1709 | F0587 | F0338 | <code>海中鱼巣/核心/关系仓库.cpp:278（宏展开121）</code> | direct_const_member | <code>this=&自动许可.value()</code> | 已接域且当前关系令牌为空；自动许可已承载 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1723 | F0587 | F0339 | <code>海中鱼巣/核心/关系仓库.cpp:278（宏展开122）</code> | direct_const_member | <code>this=&自动许可.value()</code> | 已接域、当前关系令牌为空且自动许可有效 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1737 | F0587 | F0340 | <code>海中鱼巣/核心/关系仓库.cpp:278（宏展开122）</code> | constructor | <code>*this,自动许可->读取令牌()</code> | 已接域、当前关系令牌为空且自动许可有效 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
...
| E1694 | F0589 | F0337 | <code>海中鱼巣/核心/关系仓库.cpp:119, 海中鱼巣/核心/关系仓库.cpp:296（宏展开119）</code> | direct_free+direct-free | <code>*this</code> | 已接域；调用方可达且 libclang 直接引用项目定义；源码位置复核 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核；专项源码静态类型与实际装配人工复核 |
...
| E1807 | F0589 | F0345 | <code>海中鱼巣/核心/关系仓库.cpp:295-312, 海中鱼巣/核心/关系仓库.cpp:296（宏展开120完整表达式末）</code> | implicit_destructor | <code>this=&已移空临时许可</code> | 取得共享许可返回值已移动进optional；正常或异常退出且自动许可已承载；F0344之后 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1710 | F0589 | F0338 | <code>海中鱼巣/核心/关系仓库.cpp:296（宏展开121）</code> | direct_const_member | <code>this=&自动许可.value()</code> | 已接域且当前关系令牌为空；自动许可已承载 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1724 | F0589 | F0339 | <code>海中鱼巣/核心/关系仓库.cpp:296（宏展开122）</code> | direct_const_member | <code>this=&自动许可.value()</code> | 已接域、当前关系令牌为空且自动许可有效 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1738 | F0589 | F0340 | <code>海中鱼巣/核心/关系仓库.cpp:296（宏展开122）</code> | constructor | <code>*this,自动许可->读取令牌()</code> | 已接域、当前关系令牌为空且自动许可有效 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
...
| E1697 | F0590 | F0337 | <code>海中鱼巣/核心/关系仓库.cpp:119, 海中鱼巣/核心/关系仓库.cpp:410（宏展开119）</code> | direct_free+direct-free | <code>*this</code> | 已接域；调用方可达且 libclang 直接引用项目定义；源码位置复核 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核；专项源码静态类型与实际装配人工复核 |
...
| E1813 | F0590 | F0345 | <code>海中鱼巣/核心/关系仓库.cpp:409-424, 海中鱼巣/核心/关系仓库.cpp:410（宏展开120完整表达式末）</code> | implicit_destructor | <code>this=&已移空临时许可</code> | 取得共享许可返回值已移动进optional；正常或异常退出且自动许可已承载；F0344之后 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1713 | F0590 | F0338 | <code>海中鱼巣/核心/关系仓库.cpp:410（宏展开121）</code> | direct_const_member | <code>this=&自动许可.value()</code> | 已接域且当前关系令牌为空；自动许可已承载 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1727 | F0590 | F0339 | <code>海中鱼巣/核心/关系仓库.cpp:410（宏展开122）</code> | direct_const_member | <code>this=&自动许可.value()</code> | 已接域、当前关系令牌为空且自动许可有效 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1741 | F0590 | F0340 | <code>海中鱼巣/核心/关系仓库.cpp:410（宏展开122）</code> | constructor | <code>*this,自动许可->读取令牌()</code> | 已接域、当前关系令牌为空且自动许可有效 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1696 | F0591 | F0337 | <code>海中鱼巣/核心/关系仓库.cpp:119, 海中鱼巣/核心/关系仓库.cpp:340（宏展开119）</code> | direct_free+direct-free | <code>*this</code> | 已接域；调用方可达且 libclang 直接引用项目定义；源码位置复核 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核；专项源码静态类型与实际装配人工复核 |
...
| E1811 | F0591 | F0345 | <code>海中鱼巣/核心/关系仓库.cpp:339-407, 海中鱼巣/核心/关系仓库.cpp:340（宏展开120完整表达式末）</code> | implicit_destructor | <code>this=&已移空临时许可</code> | 取得共享许可返回值已移动进optional；正常或异常退出且自动许可已承载；F0344之后 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1712 | F0591 | F0338 | <code>海中鱼巣/核心/关系仓库.cpp:340（宏展开121）</code> | direct_const_member | <code>this=&自动许可.value()</code> | 已接域且当前关系令牌为空；自动许可已承载 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1726 | F0591 | F0339 | <code>海中鱼巣/核心/关系仓库.cpp:340（宏展开122）</code> | direct_const_member | <code>this=&自动许可.value()</code> | 已接域、当前关系令牌为空且自动许可有效 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1740 | F0591 | F0340 | <code>海中鱼巣/核心/关系仓库.cpp:340（宏展开122）</code> | constructor | <code>*this,自动许可->读取令牌()</code> | 已接域、当前关系令牌为空且自动许可有效 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
...
| E1701 | F0620 | F0337 | <code>海中鱼巣/核心/关系仓库.cpp:119, 海中鱼巣/核心/关系仓库.cpp:824（宏展开119）</code> | direct_free+direct-free | <code>*this</code> | 已接域；调用方可达且 libclang 直接引用项目定义；源码位置复核 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核；专项源码静态类型与实际装配人工复核 |
...
| E1821 | F0620 | F0345 | <code>海中鱼巣/核心/关系仓库.cpp:823-841, 海中鱼巣/核心/关系仓库.cpp:824（宏展开120完整表达式末）</code> | implicit_destructor | <code>this=&已移空临时许可</code> | 取得共享许可返回值已移动进optional；正常或异常退出且自动许可已承载；F0344之后 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1717 | F0620 | F0338 | <code>海中鱼巣/核心/关系仓库.cpp:824（宏展开121）</code> | direct_const_member | <code>this=&自动许可.value()</code> | 已接域且当前关系令牌为空；自动许可已承载 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1731 | F0620 | F0339 | <code>海中鱼巣/核心/关系仓库.cpp:824（宏展开122）</code> | direct_const_member | <code>this=&自动许可.value()</code> | 已接域、当前关系令牌为空且自动许可有效 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1745 | F0620 | F0340 | <code>海中鱼巣/核心/关系仓库.cpp:824（宏展开122）</code> | constructor | <code>*this,自动许可->读取令牌()</code> | 已接域、当前关系令牌为空且自动许可有效 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
...
| E1700 | F0621 | F0337 | <code>海中鱼巣/核心/关系仓库.cpp:119, 海中鱼巣/核心/关系仓库.cpp:791（宏展开119）</code> | direct_free+direct-free | <code>*this</code> | 已接域；调用方可达且 libclang 直接引用项目定义；源码位置复核 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核；专项源码静态类型与实际装配人工复核 |
...
| E1819 | F0621 | F0345 | <code>海中鱼巣/核心/关系仓库.cpp:790-821, 海中鱼巣/核心/关系仓库.cpp:791（宏展开120完整表达式末）</code> | implicit_destructor | <code>this=&已移空临时许可</code> | 取得共享许可返回值已移动进optional；正常或异常退出且自动许可已承载；F0344之后 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1716 | F0621 | F0338 | <code>海中鱼巣/核心/关系仓库.cpp:791（宏展开121）</code> | direct_const_member | <code>this=&自动许可.value()</code> | 已接域且当前关系令牌为空；自动许可已承载 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1730 | F0621 | F0339 | <code>海中鱼巣/核心/关系仓库.cpp:791（宏展开122）</code> | direct_const_member | <code>this=&自动许可.value()</code> | 已接域、当前关系令牌为空且自动许可有效 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
| E1744 | F0621 | F0340 | <code>海中鱼巣/核心/关系仓库.cpp:791（宏展开122）</code> | constructor | <code>*this,自动许可->读取令牌()</code> | 已接域、当前关系令牌为空且自动许可有效 | HEAD 已发布图谱；源码自冻结提交至当前基线零差异；Debug\|x64 条件复核 |
...
| RCE0423 | R0065 | R0089 | <code>海中鱼巣/核心/关系仓库.cpp:1028, 海中鱼巣/核心/关系仓库.cpp:1032</code> | direct-free | <code>未单独冻结；读取源码调用点</code> | 令牌薄包装入口；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0424 | R0065 | F0340 | <code>海中鱼巣/核心/关系仓库.cpp:1029, 海中鱼巣/核心/关系仓库.cpp:1032</code> | constructor | <code>未单独冻结；读取源码调用点</code> | 共享令牌有效后建立令牌范围；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0425 | R0065 | F0344 | <code>海中鱼巣/核心/关系仓库.cpp:1031-1034（作用域退出）</code> | implicit-destructor | <code>未单独冻结；读取源码调用点</code> | 令牌范围析构 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0462 | R0073 | R0089 | <code>海中鱼巣/核心/关系仓库.cpp:1028, 海中鱼巣/核心/关系仓库.cpp:1435</code> | direct-free | <code>未单独冻结；读取源码调用点</code> | 令牌读取入口；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0463 | R0073 | F0340 | <code>海中鱼巣/核心/关系仓库.cpp:1029</code> | constructor | <code>未单独冻结；读取源码调用点</code> | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0465 | R0074 | R0089 | <code>海中鱼巣/核心/关系仓库.cpp:1028</code> | direct-free | <code>未单独冻结；读取源码调用点</code> | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0466 | R0074 | F0340 | <code>海中鱼巣/核心/关系仓库.cpp:1029</code> | constructor | <code>未单独冻结；读取源码调用点</code> | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0468 | R0075 | R0089 | <code>海中鱼巣/核心/关系仓库.cpp:1028</code> | direct-free | <code>未单独冻结；读取源码调用点</code> | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0469 | R0075 | F0340 | <code>海中鱼巣/核心/关系仓库.cpp:1029</code> | constructor | <code>未单独冻结；读取源码调用点</code> | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0474 | R0077 | R0089 | <code>海中鱼巣/核心/关系仓库.cpp:1028</code> | direct-free | <code>未单独冻结；读取源码调用点</code> | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0475 | R0077 | F0340 | <code>海中鱼巣/核心/关系仓库.cpp:1029</code> | constructor | <code>未单独冻结；读取源码调用点</code> | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0477 | R0078 | R0089 | <code>海中鱼巣/核心/关系仓库.cpp:1028</code> | direct-free | <code>未单独冻结；读取源码调用点</code> | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0478 | R0078 | F0340 | <code>海中鱼巣/核心/关系仓库.cpp:1029</code> | constructor | <code>未单独冻结；读取源码调用点</code> | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0480 | R0079 | R0089 | <code>海中鱼巣/核心/关系仓库.cpp:1028</code> | direct-free | <code>未单独冻结；读取源码调用点</code> | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0481 | R0079 | F0340 | <code>海中鱼巣/核心/关系仓库.cpp:1029</code> | constructor | <code>未单独冻结；读取源码调用点</code> | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0484 | R0081 | R0089 | <code>海中鱼巣/核心/关系仓库.cpp:1028</code> | direct-free | <code>未单独冻结；读取源码调用点</code> | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0485 | R0081 | F0340 | <code>海中鱼巣/核心/关系仓库.cpp:1029</code> | constructor | <code>未单独冻结；读取源码调用点</code> | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0487 | R0082 | R0089 | <code>海中鱼巣/核心/关系仓库.cpp:1028</code> | direct-free | <code>未单独冻结；读取源码调用点</code> | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0488 | R0082 | F0340 | <code>海中鱼巣/核心/关系仓库.cpp:1029</code> | constructor | <code>未单独冻结；读取源码调用点</code> | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0490 | R0083 | R0089 | <code>海中鱼巣/核心/关系仓库.cpp:1028</code> | direct-free | <code>未单独冻结；读取源码调用点</code> | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0491 | R0083 | F0340 | <code>海中鱼巣/核心/关系仓库.cpp:1029</code> | constructor | <code>未单独冻结；读取源码调用点</code> | 调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0497 | R0088 | F0337 | <code>海中鱼巣/核心/关系仓库.cpp:119, 海中鱼巣/核心/关系仓库.cpp:866（宏定义119）</code> | direct-free | <code>未单独冻结；读取源码调用点</code> | 已接域；调用方可达且 libclang 直接引用项目定义；源码位置复核 | 专项源码静态类型与实际装配人工复核 |
| RCE0498 | R0088 | F0344 | <code>海中鱼巣/核心/关系仓库.cpp:865-896（作用域退出）</code> | implicit-destructor | <code>未单独冻结；读取源码调用点</code> | 自动令牌范围析构 | 专项源码静态类型与实际装配人工复核 |
| RCE0499 | R0088 | F0345 | <code>海中鱼巣/核心/关系仓库.cpp:865-896（作用域退出）, 海中鱼巣/核心/关系仓库.cpp:866（宏定义120完整表达式末）</code> | implicit-destructor | <code>未单独冻结；读取源码调用点</code> | 共享许可临时量析构；自动许可析构 | 专项源码静态类型与实际装配人工复核 |
| RCE0500 | R0088 | F0336 | <code>海中鱼巣/核心/关系仓库.cpp:866（宏定义119）</code> | direct-const-member | <code>未单独冻结；读取源码调用点</code> | 许可宏入口 | 专项源码静态类型与实际装配人工复核 |
| RCE0501 | R0088 | F0397 | <code>海中鱼巣/核心/关系仓库.cpp:866（宏定义120）</code> | resolved-function-pointer | <code>未单独冻结；读取源码调用点</code> | 已接域且当前关系令牌为空；生产运行期唯一正式共享许可目标 | 专项源码静态类型与实际装配人工复核 |
| RCE0502 | R0088 | F0338 | <code>海中鱼巣/核心/关系仓库.cpp:866（宏定义121）</code> | direct-const-member | <code>未单独冻结；读取源码调用点</code> | 自动许可已承载 | 专项源码静态类型与实际装配人工复核 |
| RCE0503 | R0088 | F0339 | <code>海中鱼巣/核心/关系仓库.cpp:866（宏定义122）</code> | direct-const-member | <code>未单独冻结；读取源码调用点</code> | 自动许可有效 | 专项源码静态类型与实际装配人工复核 |
| RCE0504 | R0088 | F0340 | <code>海中鱼巣/核心/关系仓库.cpp:866（宏定义122）</code> | constructor | <code>未单独冻结；读取源码调用点</code> | 自动许可有效 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0537 | R0103 | R0391 | <code>海中鱼巣/核心/执行器.结构写入.ixx:124</code> | resolved-std-function-callback | <code>未单独冻结；读取源码调用点</code> | 本次执行调用语境由 海中鱼巣/领域/数据操作.特征体系.ixx:832 注册该回调 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0555 | R0116 | F0345 | <code>海中鱼巣/核心/执行器.结构写入.ixx:76-111（作用域退出）</code> | scope-exit-destructor | <code>未单独冻结；读取源码调用点</code> | 局部结构事务许可在所有正常或异常退出路径析构 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0780 | R0221 | F0329 | <code>海中鱼巣/领域/任务服务.h:770</code> | source-audited | <code>未单独冻结；读取源码调用点</code> | 目标为状态 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0788 | R0229 | R0226 | <code>海中鱼巣/领域/初始化.系统角色.ixx:221, 海中鱼巣/领域/初始化.系统角色.ixx:228</code> | direct-static-member | <code>未单独冻结；读取源码调用点</code> | 特征结果状态静态类型为特征体系业务状态 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0793 | R0229 | R0227 | <code>海中鱼巣/领域/初始化.系统角色.ixx:234</code> | direct-static-member | <code>未单独冻结；读取源码调用点</code> | 需求结果状态静态类型为需求任务方法业务状态 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0795 | R0229 | R0228 | <code>海中鱼巣/领域/初始化.系统角色.ixx:235</code> | direct-static-member | <code>未单独冻结；读取源码调用点</code> | 需求结果状态静态类型为需求任务方法业务状态 | 专项源码静态类型与实际装配人工复核 |
...
| RCE0850 | R0250 | R0082 | <code>海中鱼巣/领域/动态服务.h:324</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0851 | R0252 | R0254 | <code>海中鱼巣/领域/动态服务.h:343, 海中鱼巣/领域/动态服务.h:344</code> | direct_const_member | <code>未单独冻结；读取源码调用点</code> | 实例动态成立后读取场景和主体引用 | 专项源码静态类型与实际装配人工复核 |
| RCE0852 | R0252 | R0255 | <code>海中鱼巣/领域/动态服务.h:345, 海中鱼巣/领域/动态服务.h:346, 海中鱼巣/领域/动态服务.h:347, 海中鱼巣/领域/动态服务.h:348</code> | unique_name+direct_const_member | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立；依次读取目标、前值、后值和来源动作因果来源 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0853 | R0252 | R0256 | <code>海中鱼巣/领域/动态服务.h:349, 海中鱼巣/领域/动态服务.h:350</code> | unique_name+direct_const_member | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立；读取改变前后状态节点值 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0854 | R0252 | R0251 | <code>海中鱼巣/领域/动态服务.h:351</code> | direct_const_member | <code>未单独冻结；读取源码调用点</code> | 读取动态发生时间戳 | 专项源码静态类型与实际装配人工复核 |
| RCE0855 | R0252 | F0163 | <code>海中鱼巣/领域/动态服务.h:358</code> | direct | <code>未单独冻结；读取源码调用点</code> | 来源动作值存在时复核节点句柄 | 专项源码静态类型与实际装配人工复核 |
| RCE0856 | R0252 | R0258 | <code>海中鱼巣/领域/动态服务.h:358</code> | unique_name+direct_const_member | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立；来源动作节点句柄有效后复核动作入口角色 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
| RCE0857 | R0254 | R0077 | <code>海中鱼巣/领域/动态服务.h:498</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0858 | R0255 | F0620 | <code>海中鱼巣/领域/动态服务.h:514</code> | direct_const_member | <code>未单独冻结；读取源码调用点</code> | 先按顺序号读取因果来源目标 | 专项源码静态类型与实际装配人工复核 |
| RCE0859 | R0255 | F0621 | <code>海中鱼巣/领域/动态服务.h:521</code> | direct_const_member | <code>未单独冻结；读取源码调用点</code> | 顺序号目标为空后读取旧顺序目标组 | 专项源码静态类型与实际装配人工复核 |
| RCE0860 | R0256 | F0190 | <code>海中鱼巣/领域/动态服务.h:532</code> | direct_const_member | <code>未单独冻结；读取源码调用点</code> | 状态节点 optional 有值后读取节点记录 | 专项源码静态类型与实际装配人工复核 |
| RCE0861 | R0256 | F0619 | <code>海中鱼巣/领域/动态服务.h:536</code> | direct_const_member | <code>未单独冻结；读取源码调用点</code> | 节点记录为状态后读取主信息 I64 值 | 专项源码静态类型与实际装配人工复核 |
| RCE0862 | R0257 | R0077 | <code>海中鱼巣/领域/动态服务.h:540</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE0863 | R0257 | R0256 | <code>海中鱼巣/领域/动态服务.h:543</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
| RCE0864 | R0258 | R0253 | <code>海中鱼巣/领域/动态服务.h:556</code> | direct_const_member | <code>未单独冻结；读取源码调用点</code> | 入口节点首先复核方法节点类型 | 专项源码静态类型与实际装配人工复核 |
| RCE0865 | R0258 | R0257 | <code>海中鱼巣/领域/动态服务.h:559, 海中鱼巣/领域/动态服务.h:560</code> | unique_name+direct_const_member | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立；方法节点类型成立后读取角色和动作入口状态 | 同一具名类型内直接调用；源码调用词与定义范围闭合；专项源码静态类型与实际装配人工复核 |
...
| RCE0890 | R0273 | R0252 | <code>海中鱼巣/领域/因果服务.h:77</code> | direct_const_member | <code>未单独冻结；读取源码调用点</code> | 读取因果准入动态材料进入；形参静态类型 const 动态服务& | 专项源码静态类型与实际装配人工复核 |
| RCE0891 | R0274 | R0273 | <code>海中鱼巣/领域/因果服务.h:100</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1440 | R0469 | F0330 | <code>海中鱼巣/领域/方法服务.h:1049</code> | direct-const-member | <code>未单独冻结；读取源码调用点</code> | 四参数读取来源任务；顺序号20 | 专项源码静态类型与实际装配人工复核 |
...
| RCE1442 | R0470 | F0330 | <code>海中鱼巣/领域/方法服务.h:1066</code> | direct-const-member | <code>未单独冻结；读取源码调用点</code> | 四参数读取父方法；顺序号21 | 专项源码静态类型与实际装配人工复核 |
...
| RCE1450 | R0474 | F0330 | <code>海中鱼巣/领域/方法服务.h:1210</code> | direct-const-member | <code>未单独冻结；读取源码调用点</code> | 四参数读取动作输入规格；顺序号1 | 专项源码静态类型与实际装配人工复核 |
| RCE1451 | R0475 | F0330 | <code>海中鱼巣/领域/方法服务.h:1214</code> | direct-const-member | <code>未单独冻结；读取源码调用点</code> | 四参数读取动作输出规格；顺序号2 | 专项源码静态类型与实际装配人工复核 |
...
| RCE1485 | R0487 | F0330 | <code>海中鱼巣/领域/方法服务.h:1822</code> | direct-const-member | <code>未单独冻结；读取源码调用点</code> | 四参数读取动作入口状态；顺序号1 | 专项源码静态类型与实际装配人工复核 |
| RCE1486 | R0487 | F0329 | <code>海中鱼巣/领域/方法服务.h:1826</code> | direct-const-member | <code>未单独冻结；读取源码调用点</code> | 动作入口状态节点存在 | 专项源码静态类型与实际装配人工复核 |
...
| RCE1522 | R0520 | R0078 | <code>海中鱼巣/领域/概念图服务.h:3180</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1523 | R0520 | F0184 | <code>海中鱼巣/领域/概念图服务.h:3185, 海中鱼巣/领域/概念图服务.h:3191, 海中鱼巣/领域/概念图服务.h:3206, 海中鱼巣/领域/概念图服务.h:3212</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1524 | R0520 | R0519 | <code>海中鱼巣/领域/概念图服务.h:3190</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 同一具名类型内直接调用；源码调用词与定义范围闭合 |
...
| RCE1576 | R0571 | R0082 | <code>海中鱼巣/领域/语素服务.h:287, 海中鱼巣/领域/语素服务.h:288</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
| RCE1577 | R0572 | R0082 | <code>海中鱼巣/领域/语素服务.h:321, 海中鱼巣/领域/语素服务.h:323</code> | unique_name | <code>未单独冻结；读取源码调用点</code> | 调用方可达且源码分支条件成立 | 全项目唯一函数名并经调用方源码范围复核 |
