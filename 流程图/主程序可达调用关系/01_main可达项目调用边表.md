...
代码基线：<code>3920a74638264f9f539d50f32f3c9fe5fb1982ab</code>；配置：<code>Debug\|x64</code>；项目调用边：3883。
...
| RCE1415 | R0456 | F0163 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:293, 海中鱼巣/领域/数据操作.需求任务方法.ixx:294</code> | overload_resolved_free_function | 角色状态 / 活跃状态 / 失效状态 | bool；参与方法登记根材料完整性短路合取 | 身份当前可读且类型为方法 | 冻结源码实参静态类型、完整重载集合与三次调用复核 |
...
| RCE2965 | R0456 | R0428 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:292</code> | direct_const_member | this=&amp;身份 | bool；参与方法登记根材料完整性短路合取 | 读取状态为已找到 | 冻结源码接收者静态类型与完整签名复核 |
| RCE2966 | R0456 | R0830 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:296, 海中鱼巣/领域/数据操作.需求任务方法.ixx:297</code> | direct_const_member | this=&amp;角色关系 / &amp;活跃状态关系 / &amp;失效状态关系 | bool；参与方法登记根材料完整性短路合取 | 三个状态节点句柄有效且互不相同 | 冻结源码接收者静态类型、完整签名与三次调用复核 |
| RCE2967 | R0447 | R0830 | <code>海中鱼巣/领域/数据操作.需求任务方法.ixx:2458</code> | direct_const_member | this=&amp;方法投影 / &amp;发布 | bool；任一无效时返回std::nullopt | 身份当前可读且类型为任务方法选择记录 | 冻结源码接收者静态类型、完整签名与两次调用复核 |
