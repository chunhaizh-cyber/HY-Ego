...
bool 世界树存在信息结果_v4::成功(const 世界树存在信息读取请求_v4&r) const noexcept {
  try {
...
世界树概念创建结果_v4 世界树应用服务::创建场景并纳入现实世界(
    const 世界树场景创建请求_v4 &r) noexcept {return 创建概念世界(r,true);}
世界树概念创建结果_v4 世界树应用服务::创建存在并纳入现实世界(
...
bool 世界树概念创建结果_v4::成功(const 世界树场景创建请求_v4&r) const noexcept {
...
bool 世界树概念创建结果_v4::成功(const 世界树存在创建请求_v4&r) const noexcept {
  if(!(版本==4&&r.版本==4&&(状态==世界树概念创建状态_v4::已完成||
      状态==世界树概念创建状态_v4::精确重复)&&阶段==世界树概念创建阶段_v4::最终读回&&
      Gread&&世界首次H&&*世界首次H<=Gread&&请求回显&&
