# WORLD-TREE-P1BF 特征查询服务合同骨架代码实施切片 v0.1

计划身份：WORLD-TREE-P1BF

版本：v0.1

创建侧仓库基线：`9838fc044b7e944238da394d50d9d79d577e23ba`
...
- `规范/详细设计/20260803_WORLD-TREE-P1BF_特征服务合同骨架详细设计_v0.1.md` 全文；
- `流程图/20260803_节点直接特征查询服务读取宿主组完整当前特征_函数流程图_v0.1.md`。
