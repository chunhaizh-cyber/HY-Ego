...
#ifndef __I配置及测试窗口类_FWD_DEFINED__
#define __I配置及测试窗口类_FWD_DEFINED__
typedef interface I配置及测试窗口类 I配置及测试窗口类;

#endif 	/* __I配置及测试窗口类_FWD_DEFINED__ */


#ifndef __配置及测试窗口类_FWD_DEFINED__
#define __配置及测试窗口类_FWD_DEFINED__

#ifdef __cplusplus
typedef class 配置及测试窗口类 配置及测试窗口类;
#else
typedef struct 配置及测试窗口类 配置及测试窗口类;
#endif /* __cplusplus */

#endif 	/* __配置及测试窗口类_FWD_DEFINED__ */
...
#ifndef __I配置及测试窗口类_DISPINTERFACE_DEFINED__
#define __I配置及测试窗口类_DISPINTERFACE_DEFINED__

/* dispinterface I配置及测试窗口类 */
/* [uuid] */ 


EXTERN_C const IID DIID_I配置及测试窗口类;

#if defined(__cplusplus) && !defined(CINTERFACE)

    MIDL_INTERFACE("c728ff46-9563-475b-b5e3-69a8cd6a6411")
    I配置及测试窗口类 : public IDispatch
    {
    };
    
#else 	/* C style interface */

    typedef struct I配置及测试窗口类Vtbl
    {
        BEGIN_INTERFACE
    ...
    interface I配置及测试窗口类
    {
        CONST_VTBL struct I配置及测试窗口类Vtbl *lpVtbl;
    };
...
#define I配置及测试窗口类_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define I配置及测试窗口类_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define I配置及测试窗口类_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define I配置及测试窗口类_GetTypeInfoCount(This,pctinfo)	\
    ( (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo) ) 

#define I配置及测试窗口类_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    ( (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo) ) 

#define I配置及测试窗口类_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    ( (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId) ) 

#define I配置及测试窗口类_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    ( (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr) ) 
...
#endif 	/* __I配置及测试窗口类_DISPINTERFACE_DEFINED__ */


EXTERN_C const CLSID CLSID_配置及测试窗口类;

#ifdef __cplusplus

class DECLSPEC_UUID("9e9d783b-151e-40e7-b3a3-b6657e85de98")
配置及测试窗口类;
#endif
