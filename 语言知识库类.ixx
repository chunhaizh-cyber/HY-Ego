...
import 世界树模块;          // 世界树类  
import 世界树环境模块;        // 世界树类, 节点类, 场景节点类 等
import 语言环境模块;    // 文章/段落/自然句/子句 主信息 + 自然句节点类/子句节点类
import 语素环境模块;          // 词性节点类 等
import 模板模块;
import 基础数据类型模块;
...
public:
    // 方便起见，给一个句子词序列的别名
    using 词序列类型 = std::vector<const 词性节点类*>;
...
private:
    ...
    using 融合函数 =
        std::function<bool(const std::vector<const 词性节点类*>& 词序列,
            世界树类& 世界树,
            场景节点类* 场景)>;
    ...
    static bool 尝试融合(const std::vector<const 词性节点类*>& 词序列,世界树类& 世界树,场景节点类* 场景)
    {
...
private:
    ...
    // 17 个原子用途对应的融合函数
//    static bool 融合_空间位置(const std::vector<const 词性节点类*>&, 世界树类&, 场景节点类*);
//    static bool 融合_时间定位(const std::vector<const 词性节点类*>&, 世界树类&, 场景节点类*);
//    static bool 融合_比较排序(const std::vector<const 词性节点类*>&, 世界树类&, 场景节点类*);
//    static bool 融合_数量范围(const std::vector<const 词性节点类*>&, 世界树类&, 场景节点类*);
//    static bool 融合_否定排除(const std::vector<const 词性节点类*>&, 世界树类&, 场景节点类*);
//    static bool 融合_疑问需求(const std::vector<const 词性节点类*>&, 世界树类&, 场景节点类*);
//    static bool 融合_条件假设(const std::vector<const 词性节点类*>&, 世界树类&, 场景节点类*);
//    static bool 融合_因果解释(const std::vector<const 词性节点类*>&, 世界树类&, 场景节点类*);
//    static bool 融合_时间体貌(const std::vector<const 词性节点类*>&, 世界树类&, 场景节点类*);
//    static bool 融合_评价立场(const std::vector<const 词性节点类*>&, 世界树类&, 场景节点类*);
//    static bool 融合_来源引述(const std::vector<const 词性节点类*>&, 世界树类&, 场景节点类*);
//    static bool 融合_定义分类(const std::vector<const 词性节点类*>&, 世界树类&, 场景节点类*);
//    static bool 融合_角色标注(const std::vector<const 词性节点类*>&, 世界树类&, 场景节点类*);
//    static bool 融合_约束义务(const std::vector<const 词性节点类*>&, 世界树类&, 场景节点类*);
//    static bool 融合_例外对照(const std::vector<const 词性节点类*>&, 世界树类&, 场景节点类*);
//    static bool 融合_单位度量(const std::vector<const 词性节点类*>&, 世界树类&, 场景节点类*);
//    static bool 融合_指代省略(const std::vector<const 词性节点类*>&, 世界树类&, 场景节点类*);
//
