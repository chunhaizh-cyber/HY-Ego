...
MIDL_DEFINE_GUID(IID, DIID_I配置及测试窗口类,0xc728ff46,0x9563,0x475b,0xb5,0xe3,0x69,0xa8,0xcd,0x6a,0x64,0x11);


MIDL_DEFINE_GUID(CLSID, CLSID_配置及测试窗口类,0x9e9d783b,0x151e,0x40e7,0xb3,0xa3,0xb6,0x65,0x7e,0x85,0xde,0x98);
